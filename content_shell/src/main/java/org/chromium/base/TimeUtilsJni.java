...
public class TimeUtilsJni implements TimeUtils.Natives {
  ...
  public static final JniStaticTestMocker<TimeUtils.Natives> TEST_HOOKS = new JniStaticTestMocker<TimeUtils.Natives>() {
    @Override
    public void setInstanceForTesting(TimeUtils.Natives instance) {

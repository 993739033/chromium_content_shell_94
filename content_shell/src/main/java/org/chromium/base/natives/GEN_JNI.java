...
public final class GEN_JNI {
  ...
  /**
   * org.chromium.base.metrics.RecordHistogram.forgetHistogramForTesting
   * @param name (java.lang.String)
   * @return (void)
   */
  public static final native void org_chromium_base_metrics_RecordHistogram_forgetHistogramForTesting(
      String name);

...
class AppBannerController_Internal {
    ...
    public static final Interface.Manager<AppBannerController, AppBannerController.Proxy> MANAGER = new Interface.Manager<AppBannerController, AppBannerController.Proxy>() { // from class: org.chromium.blink.mojom.AppBannerController_Internal.1
        ...
        public AppBannerController.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AppBannerController.Proxy {
        ...
        @Override // org.chromium.blink.mojom.AppBannerController
        public void bannerPromptRequest(AppBannerService service, InterfaceRequest<AppBannerEvent> eventReceiver, String[] platform, BannerPromptRequestResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new AppBannerControllerBannerPromptRequestResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<AppBannerController> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AppBannerController_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        AppBannerControllerBannerPromptRequestParams data = AppBannerControllerBannerPromptRequestParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class AppBannerControllerBannerPromptRequestParams extends Struct {
        ...
        public static AppBannerControllerBannerPromptRequestParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AppBannerControllerBannerPromptRequestParams result = new AppBannerControllerBannerPromptRequestParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class AppBannerControllerBannerPromptRequestResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static AppBannerControllerBannerPromptRequestResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AppBannerControllerBannerPromptRequestResponseParams result = new AppBannerControllerBannerPromptRequestResponseParams(elementsOrVersion);

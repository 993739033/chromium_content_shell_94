...
import org.chromium.blink.mojom.AppBannerService;
...
class AppBannerService_Internal {
    ...
    public static final Interface.Manager<AppBannerService, AppBannerService.Proxy> MANAGER = new Interface.Manager<AppBannerService, AppBannerService.Proxy>() { // from class: org.chromium.blink.mojom.AppBannerService_Internal.1
        ...
        public AppBannerService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AppBannerService.Proxy {
        ...
        @Override // org.chromium.blink.mojom.AppBannerService
    ...
    public static final class Stub extends Interface.Stub<AppBannerService> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AppBannerService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AppBannerServiceDisplayAppBannerParams extends Struct {
        ...
        public static AppBannerServiceDisplayAppBannerParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AppBannerServiceDisplayAppBannerParams result = new AppBannerServiceDisplayAppBannerParams(elementsOrVersion);
                return result;
            } finally {

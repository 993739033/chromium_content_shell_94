...
import org.chromium.blink.mojom.AssociatedInterfaceProvider;
...
class AssociatedInterfaceProvider_Internal {
    ...
    public static final Interface.Manager<AssociatedInterfaceProvider, AssociatedInterfaceProvider.Proxy> MANAGER = new Interface.Manager<AssociatedInterfaceProvider, AssociatedInterfaceProvider.Proxy>() { // from class: org.chromium.blink.mojom.AssociatedInterfaceProvider_Internal.1
        ...
        public AssociatedInterfaceProvider.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AssociatedInterfaceProvider.Proxy {
        ...
        @Override // org.chromium.blink.mojom.AssociatedInterfaceProvider
        public void getAssociatedInterface(String name, AssociatedInterfaceRequestNotSupported receiver) {
    ...
    public static final class Stub extends Interface.Stub<AssociatedInterfaceProvider> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        AssociatedInterfaceProviderGetAssociatedInterfaceParams data = AssociatedInterfaceProviderGetAssociatedInterfaceParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AssociatedInterfaceProvider_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AssociatedInterfaceProviderGetAssociatedInterfaceParams extends Struct {
        ...
        public static AssociatedInterfaceProviderGetAssociatedInterfaceParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AssociatedInterfaceProviderGetAssociatedInterfaceParams result = new AssociatedInterfaceProviderGetAssociatedInterfaceParams(elementsOrVersion);

...
import org.chromium.blink.mojom.AutoplayConfigurationClient;
...
class AutoplayConfigurationClient_Internal {
    ...
    public static final Interface.Manager<AutoplayConfigurationClient, AutoplayConfigurationClient.Proxy> MANAGER = new Interface.Manager<AutoplayConfigurationClient, AutoplayConfigurationClient.Proxy>() { // from class: org.chromium.blink.mojom.AutoplayConfigurationClient_Internal.1
        ...
        public AutoplayConfigurationClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AutoplayConfigurationClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.AutoplayConfigurationClient
    ...
    public static final class Stub extends Interface.Stub<AutoplayConfigurationClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        AutoplayConfigurationClientAddAutoplayFlagsParams data = AutoplayConfigurationClientAddAutoplayFlagsParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AutoplayConfigurationClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AutoplayConfigurationClientAddAutoplayFlagsParams extends Struct {
        ...
        public static AutoplayConfigurationClientAddAutoplayFlagsParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AutoplayConfigurationClientAddAutoplayFlagsParams result = new AutoplayConfigurationClientAddAutoplayFlagsParams(elementsOrVersion);

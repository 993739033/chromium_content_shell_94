...
class BackgroundFetchRegistrationObserver_Internal {
    public static final Interface.Manager<BackgroundFetchRegistrationObserver, BackgroundFetchRegistrationObserver.Proxy> MANAGER = new Interface.Manager<BackgroundFetchRegistrationObserver, BackgroundFetchRegistrationObserver.Proxy>() { // from class: org.chromium.blink.mojom.BackgroundFetchRegistrationObserver_Internal.1
        ...
        public BackgroundFetchRegistrationObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements BackgroundFetchRegistrationObserver.Proxy {
        ...
        @Override // org.chromium.blink.mojom.BackgroundFetchRegistrationObserver
    ...
    public static final class Stub extends Interface.Stub<BackgroundFetchRegistrationObserver> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        BackgroundFetchRegistrationObserverOnProgressParams data = BackgroundFetchRegistrationObserverOnProgressParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        BackgroundFetchRegistrationObserverOnRequestCompletedParams data2 = BackgroundFetchRegistrationObserverOnRequestCompletedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BackgroundFetchRegistrationObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class BackgroundFetchRegistrationObserverOnProgressParams extends Struct {
        ...
        public static BackgroundFetchRegistrationObserverOnProgressParams decode(Decoder decoder0) {
            ...
            try {
                ...
                BackgroundFetchRegistrationObserverOnProgressParams result = new BackgroundFetchRegistrationObserverOnProgressParams(elementsOrVersion);
    ...
    static final class BackgroundFetchRegistrationObserverOnRecordsUnavailableParams extends Struct {
        ...
        public static BackgroundFetchRegistrationObserverOnRecordsUnavailableParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationObserverOnRecordsUnavailableParams result = new BackgroundFetchRegistrationObserverOnRecordsUnavailableParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class BackgroundFetchRegistrationObserverOnRequestCompletedParams extends Struct {
        ...
        public static BackgroundFetchRegistrationObserverOnRequestCompletedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationObserverOnRequestCompletedParams result = new BackgroundFetchRegistrationObserverOnRequestCompletedParams(elementsOrVersion);

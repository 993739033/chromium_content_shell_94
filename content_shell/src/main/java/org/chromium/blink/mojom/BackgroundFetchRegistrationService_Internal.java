...
import org.chromium.blink.mojom.BackgroundFetchRegistrationService;
...
class BackgroundFetchRegistrationService_Internal {
    ...
    public static final Interface.Manager<BackgroundFetchRegistrationService, BackgroundFetchRegistrationService.Proxy> MANAGER = new Interface.Manager<BackgroundFetchRegistrationService, BackgroundFetchRegistrationService.Proxy>() { // from class: org.chromium.blink.mojom.BackgroundFetchRegistrationService_Internal.1
        ...
        public BackgroundFetchRegistrationService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements BackgroundFetchRegistrationService.Proxy {
        ...
        @Override // org.chromium.blink.mojom.BackgroundFetchRegistrationService
        public void updateUi(String title, BitmapN32 icon, UpdateUiResponse callback) {
            BackgroundFetchRegistrationServiceUpdateUiParams _message = new BackgroundFetchRegistrationServiceUpdateUiParams();
            _message.title = title;
            _message.icon = icon;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new BackgroundFetchRegistrationServiceUpdateUiResponseParamsForwardToCallback(callback));
        }
        ...
        public void abort(AbortResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new BackgroundFetchRegistrationServiceAbortResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.BackgroundFetchRegistrationService
        public void matchRequests(FetchApiRequest requestToMatch, CacheQueryOptions cacheQueryOptions, boolean matchAll, MatchRequestsResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new BackgroundFetchRegistrationServiceMatchRequestsResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<BackgroundFetchRegistrationService> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 3:
                        BackgroundFetchRegistrationServiceAddRegistrationObserverParams data = BackgroundFetchRegistrationServiceAddRegistrationObserverParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BackgroundFetchRegistrationService_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        BackgroundFetchRegistrationServiceUpdateUiParams data = BackgroundFetchRegistrationServiceUpdateUiParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        BackgroundFetchRegistrationServiceMatchRequestsParams data2 = BackgroundFetchRegistrationServiceMatchRequestsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().matchRequests(data2.requestToMatch, data2.cacheQueryOptions, data2.matchAll, new BackgroundFetchRegistrationServiceMatchRequestsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class BackgroundFetchRegistrationServiceUpdateUiParams extends Struct {
        ...
        public static BackgroundFetchRegistrationServiceUpdateUiParams decode(Decoder decoder0) {
            ...
            try {
                ...
                BackgroundFetchRegistrationServiceUpdateUiParams result = new BackgroundFetchRegistrationServiceUpdateUiParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class BackgroundFetchRegistrationServiceUpdateUiResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static BackgroundFetchRegistrationServiceUpdateUiResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationServiceUpdateUiResponseParams result = new BackgroundFetchRegistrationServiceUpdateUiResponseParams(elementsOrVersion);
    ...
    static final class BackgroundFetchRegistrationServiceAbortParams extends Struct {
        ...
        public static BackgroundFetchRegistrationServiceAbortParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationServiceAbortParams result = new BackgroundFetchRegistrationServiceAbortParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class BackgroundFetchRegistrationServiceAbortResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        public int error;
        ...
        public static BackgroundFetchRegistrationServiceAbortResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationServiceAbortResponseParams result = new BackgroundFetchRegistrationServiceAbortResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                BackgroundFetchError.validate(readInt);
                result.error = BackgroundFetchError.toKnownValue(result.error);
    ...
    static final class BackgroundFetchRegistrationServiceMatchRequestsParams extends Struct {
        ...
        public static BackgroundFetchRegistrationServiceMatchRequestsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationServiceMatchRequestsParams result = new BackgroundFetchRegistrationServiceMatchRequestsParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class BackgroundFetchRegistrationServiceMatchRequestsResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static BackgroundFetchRegistrationServiceMatchRequestsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationServiceMatchRequestsResponseParams result = new BackgroundFetchRegistrationServiceMatchRequestsResponseParams(elementsOrVersion);
    ...
    static final class BackgroundFetchRegistrationServiceAddRegistrationObserverParams extends Struct {
        ...
        public static BackgroundFetchRegistrationServiceAddRegistrationObserverParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchRegistrationServiceAddRegistrationObserverParams result = new BackgroundFetchRegistrationServiceAddRegistrationObserverParams(elementsOrVersion);

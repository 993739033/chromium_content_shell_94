...
class BackgroundFetchService_Internal {
    ...
    public static final Interface.Manager<BackgroundFetchService, BackgroundFetchService.Proxy> MANAGER = new Interface.Manager<BackgroundFetchService, BackgroundFetchService.Proxy>() { // from class: org.chromium.blink.mojom.BackgroundFetchService_Internal.1
        ...
        public BackgroundFetchService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements BackgroundFetchService.Proxy {
        ...
        public void fetch(long serviceWorkerRegistrationId, String developerId, FetchApiRequest[] requests, BackgroundFetchOptions options, BitmapN32 icon, BackgroundFetchUkmData ukmData, FetchResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new BackgroundFetchServiceFetchResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.BackgroundFetchService
        public void getRegistration(long serviceWorkerRegistrationId, String developerId, GetRegistrationResponse callback) {
            BackgroundFetchServiceGetRegistrationParams _message = new BackgroundFetchServiceGetRegistrationParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            _message.developerId = developerId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new BackgroundFetchServiceGetRegistrationResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.BackgroundFetchService
        public void getDeveloperIds(long serviceWorkerRegistrationId, GetDeveloperIdsResponse callback) {
            BackgroundFetchServiceGetDeveloperIdsParams _message = new BackgroundFetchServiceGetDeveloperIdsParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new BackgroundFetchServiceGetDeveloperIdsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.BackgroundFetchService
        public void getIconDisplaySize(GetIconDisplaySizeResponse callback) {
            BackgroundFetchServiceGetIconDisplaySizeParams _message = new BackgroundFetchServiceGetIconDisplaySizeParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new BackgroundFetchServiceGetIconDisplaySizeResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<BackgroundFetchService> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BackgroundFetchService_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        BackgroundFetchServiceFetchParams data = BackgroundFetchServiceFetchParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        BackgroundFetchServiceGetRegistrationParams data2 = BackgroundFetchServiceGetRegistrationParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getRegistration(data2.serviceWorkerRegistrationId, data2.developerId, new BackgroundFetchServiceGetRegistrationResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        getImpl().getDeveloperIds(BackgroundFetchServiceGetDeveloperIdsParams.deserialize(messageWithHeader.getPayload()).serviceWorkerRegistrationId, new BackgroundFetchServiceGetDeveloperIdsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
    ...
    static final class BackgroundFetchServiceFetchParams extends Struct {
        ...
        public static BackgroundFetchServiceFetchParams decode(Decoder decoder0) {
            ...
            try {
                ...
                BackgroundFetchServiceFetchParams result = new BackgroundFetchServiceFetchParams(elementsOrVersion);
    ...
    public static final class BackgroundFetchServiceFetchResponseParams extends Struct {
        ...
        public static BackgroundFetchServiceFetchResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceFetchResponseParams result = new BackgroundFetchServiceFetchResponseParams(elementsOrVersion);
    ...
    static final class BackgroundFetchServiceGetRegistrationParams extends Struct {
        ...
        public static BackgroundFetchServiceGetRegistrationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceGetRegistrationParams result = new BackgroundFetchServiceGetRegistrationParams(elementsOrVersion);
                result.serviceWorkerRegistrationId = decoder0.readLong(8);
                result.developerId = decoder0.readString(16, false);
                return result;
            } finally {
    ...
    public static final class BackgroundFetchServiceGetRegistrationResponseParams extends Struct {
        ...
        public static BackgroundFetchServiceGetRegistrationResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceGetRegistrationResponseParams result = new BackgroundFetchServiceGetRegistrationResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                BackgroundFetchError.validate(readInt);
                result.error = BackgroundFetchError.toKnownValue(result.error);
    ...
    static final class BackgroundFetchServiceGetDeveloperIdsParams extends Struct {
        ...
        public static BackgroundFetchServiceGetDeveloperIdsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceGetDeveloperIdsParams result = new BackgroundFetchServiceGetDeveloperIdsParams(elementsOrVersion);
                result.serviceWorkerRegistrationId = decoder0.readLong(8);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    public static final class BackgroundFetchServiceGetDeveloperIdsResponseParams extends Struct {
        ...
        public static BackgroundFetchServiceGetDeveloperIdsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceGetDeveloperIdsResponseParams result = new BackgroundFetchServiceGetDeveloperIdsResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                BackgroundFetchError.validate(readInt);
                result.error = BackgroundFetchError.toKnownValue(result.error);
    ...
    static final class BackgroundFetchServiceGetIconDisplaySizeParams extends Struct {
        ...
        public static BackgroundFetchServiceGetIconDisplaySizeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceGetIconDisplaySizeParams result = new BackgroundFetchServiceGetIconDisplaySizeParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class BackgroundFetchServiceGetIconDisplaySizeResponseParams extends Struct {
        ...
        public static BackgroundFetchServiceGetIconDisplaySizeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BackgroundFetchServiceGetIconDisplaySizeResponseParams result = new BackgroundFetchServiceGetIconDisplaySizeResponseParams(elementsOrVersion);

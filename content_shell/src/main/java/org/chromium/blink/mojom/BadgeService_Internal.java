...
class BadgeService_Internal {
    ...
    public static final Interface.Manager<BadgeService, BadgeService.Proxy> MANAGER = new Interface.Manager<BadgeService, BadgeService.Proxy>() { // from class: org.chromium.blink.mojom.BadgeService_Internal.1
        ...
        public BadgeService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements BadgeService.Proxy {
        ...
        @Override // org.chromium.blink.mojom.BadgeService
    ...
    public static final class Stub extends Interface.Stub<BadgeService> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        BadgeServiceSetBadgeParams data = BadgeServiceSetBadgeParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BadgeService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {

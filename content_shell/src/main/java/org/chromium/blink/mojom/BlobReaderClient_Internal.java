...
class BlobReaderClient_Internal {
    public static final Interface.Manager<BlobReaderClient, BlobReaderClient.Proxy> MANAGER = new Interface.Manager<BlobReaderClient, BlobReaderClient.Proxy>() { // from class: org.chromium.blink.mojom.BlobReaderClient_Internal.1
        ...
        public BlobReaderClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<BlobReaderClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        BlobReaderClientOnCalculatedSizeParams data = BlobReaderClientOnCalculatedSizeParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onCalculatedSize(data.totalSize, data.expectedContentSize);
                        return true;
                    case 1:
                        BlobReaderClientOnCompleteParams data2 = BlobReaderClientOnCompleteParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BlobReaderClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class BlobReaderClientOnCalculatedSizeParams extends Struct {
        ...
        public static BlobReaderClientOnCalculatedSizeParams decode(Decoder decoder0) {
            ...
            try {
                ...
                BlobReaderClientOnCalculatedSizeParams result = new BlobReaderClientOnCalculatedSizeParams(elementsOrVersion);
    ...
    static final class BlobReaderClientOnCompleteParams extends Struct {
        ...
        public static BlobReaderClientOnCompleteParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobReaderClientOnCompleteParams result = new BlobReaderClientOnCompleteParams(elementsOrVersion);

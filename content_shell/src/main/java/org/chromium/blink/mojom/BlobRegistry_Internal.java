...
class BlobRegistry_Internal {
    ...
    public static final Interface.Manager<BlobRegistry, BlobRegistry.Proxy> MANAGER = new Interface.Manager<BlobRegistry, BlobRegistry.Proxy>() { // from class: org.chromium.blink.mojom.BlobRegistry_Internal.1
        ...
        public BlobRegistry.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements BlobRegistry.Proxy {
        ...
        public void register(InterfaceRequest<Blob> blob, String uuid, String contentType, String contentDisposition, DataElement[] elements, RegisterResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new BlobRegistryRegisterResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.BlobRegistry
        public void registerFromStream(String contentType, String contentDisposition, long lengthHint, DataPipe.ConsumerHandle data, AssociatedInterfaceNotSupported progressClient, RegisterFromStreamResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new BlobRegistryRegisterFromStreamResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.BlobRegistry
        public void getBlobFromUuid(InterfaceRequest<Blob> blob, String uuid, GetBlobFromUuidResponse callback) {
            BlobRegistryGetBlobFromUuidParams _message = new BlobRegistryGetBlobFromUuidParams();
            _message.blob = blob;
            _message.uuid = uuid;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new BlobRegistryGetBlobFromUuidResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<BlobRegistry> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 3:
                        BlobRegistryUrlStoreForOriginParams data = BlobRegistryUrlStoreForOriginParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BlobRegistry_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        BlobRegistryRegisterParams data = BlobRegistryRegisterParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        BlobRegistryRegisterFromStreamParams data2 = BlobRegistryRegisterFromStreamParams.deserialize(messageWithHeader.getPayload());
                        getImpl().registerFromStream(data2.contentType, data2.contentDisposition, data2.lengthHint, data2.data, data2.progressClient, new BlobRegistryRegisterFromStreamResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        BlobRegistryGetBlobFromUuidParams data3 = BlobRegistryGetBlobFromUuidParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getBlobFromUuid(data3.blob, data3.uuid, new BlobRegistryGetBlobFromUuidResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class BlobRegistryRegisterResponseParams extends Struct {
        ...
        public static BlobRegistryRegisterResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobRegistryRegisterResponseParams result = new BlobRegistryRegisterResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class BlobRegistryRegisterFromStreamParams extends Struct {
        ...
        public static BlobRegistryRegisterFromStreamParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobRegistryRegisterFromStreamParams result = new BlobRegistryRegisterFromStreamParams(elementsOrVersion);
    ...
    public static final class BlobRegistryRegisterFromStreamResponseParams extends Struct {
        ...
        public static BlobRegistryRegisterFromStreamResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobRegistryRegisterFromStreamResponseParams result = new BlobRegistryRegisterFromStreamResponseParams(elementsOrVersion);
    ...
    static final class BlobRegistryGetBlobFromUuidParams extends Struct {
        ...
        public static BlobRegistryGetBlobFromUuidParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobRegistryGetBlobFromUuidParams result = new BlobRegistryGetBlobFromUuidParams(elementsOrVersion);
                result.blob = decoder0.readInterfaceRequest(8, false);
                result.uuid = decoder0.readString(16, false);
                return result;
            } finally {
    ...
    static final class BlobRegistryGetBlobFromUuidResponseParams extends Struct {
        ...
        public static BlobRegistryGetBlobFromUuidResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobRegistryGetBlobFromUuidResponseParams result = new BlobRegistryGetBlobFromUuidResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class BlobRegistryUrlStoreForOriginParams extends Struct {
        ...
        public static BlobRegistryUrlStoreForOriginParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobRegistryUrlStoreForOriginParams result = new BlobRegistryUrlStoreForOriginParams(elementsOrVersion);

...
import org.chromium.blink.mojom.BlobUrlToken;
...
class BlobUrlToken_Internal {
    ...
    public static final Interface.Manager<BlobUrlToken, BlobUrlToken.Proxy> MANAGER = new Interface.Manager<BlobUrlToken, BlobUrlToken.Proxy>() { // from class: org.chromium.blink.mojom.BlobUrlToken_Internal.1
        ...
        public BlobUrlToken.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements BlobUrlToken.Proxy {
        ...
        @Override // org.chromium.blink.mojom.BlobUrlToken
        ...
        @Override // org.chromium.blink.mojom.BlobUrlToken
        public void getToken(GetTokenResponse callback) {
            BlobUrlTokenGetTokenParams _message = new BlobUrlTokenGetTokenParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new BlobUrlTokenGetTokenResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<BlobUrlToken> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        BlobUrlTokenCloneParams data = BlobUrlTokenCloneParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BlobUrlToken_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    default:
                        return false;
                    case 1:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class BlobUrlTokenGetTokenResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static BlobUrlTokenGetTokenResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobUrlTokenGetTokenResponseParams result = new BlobUrlTokenGetTokenResponseParams(elementsOrVersion);

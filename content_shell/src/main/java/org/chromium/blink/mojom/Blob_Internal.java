...
class Blob_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Blob.Proxy {
        ...
        @Override // org.chromium.blink.mojom.Blob
        public void load(InterfaceRequest<UrlLoader> loader, String requestMethod, HttpRequestHeaders headers, UrlLoaderClient client) {
        ...
        @Override // org.chromium.blink.mojom.Blob
        public void readSideData(ReadSideDataResponse callback) {
            BlobReadSideDataParams _message = new BlobReadSideDataParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new BlobReadSideDataResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.Blob
        public void captureSnapshot(CaptureSnapshotResponse callback) {
            BlobCaptureSnapshotParams _message = new BlobCaptureSnapshotParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new BlobCaptureSnapshotResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.Blob
        public void getInternalUuid(GetInternalUuidResponse callback) {
            BlobGetInternalUuidParams _message = new BlobGetInternalUuidParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(7, 1, 0L)), new BlobGetInternalUuidResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<Blob> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        BlobAsDataPipeGetterParams data2 = BlobAsDataPipeGetterParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        BlobReadRangeParams data4 = BlobReadRangeParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), Blob_Internal.MANAGER, messageWithHeader, receiver);
                    case 5:
    ...
    public static final class BlobReadSideDataResponseParams extends Struct {
        ...
        public static BlobReadSideDataResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobReadSideDataResponseParams result = new BlobReadSideDataResponseParams(elementsOrVersion);
    ...
    public static final class BlobCaptureSnapshotResponseParams extends Struct {
        ...
        public static BlobCaptureSnapshotResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobCaptureSnapshotResponseParams result = new BlobCaptureSnapshotResponseParams(elementsOrVersion);
    ...
    static class BlobCaptureSnapshotResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(Long.valueOf(response.length), response.modificationTime);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class BlobCaptureSnapshotResponseParamsProxyToResponder implements Blob.CaptureSnapshotResponse {
        ...
        BlobCaptureSnapshotResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    public static final class BlobGetInternalUuidResponseParams extends Struct {
        ...
        public static BlobGetInternalUuidResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                BlobGetInternalUuidResponseParams result = new BlobGetInternalUuidResponseParams(elementsOrVersion);

...
import org.chromium.blink.mojom.BrowserInterfaceBroker;
...
class BrowserInterfaceBroker_Internal {
    ...
    public static final Interface.Manager<BrowserInterfaceBroker, BrowserInterfaceBroker.Proxy> MANAGER = new Interface.Manager<BrowserInterfaceBroker, BrowserInterfaceBroker.Proxy>() { // from class: org.chromium.blink.mojom.BrowserInterfaceBroker_Internal.1
        ...
        public BrowserInterfaceBroker.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements BrowserInterfaceBroker.Proxy {
        ...
        @Override // org.chromium.blink.mojom.BrowserInterfaceBroker
    ...
    public static final class Stub extends Interface.Stub<BrowserInterfaceBroker> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(BrowserInterfaceBroker_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        BrowserInterfaceBrokerGetInterfaceParams data = BrowserInterfaceBrokerGetInterfaceParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), BrowserInterfaceBroker_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class BrowserInterfaceBrokerGetInterfaceParams extends Struct {
        ...
        public static BrowserInterfaceBrokerGetInterfaceParams decode(Decoder decoder0) {
            ...
            try {
                ...
                BrowserInterfaceBrokerGetInterfaceParams result = new BrowserInterfaceBrokerGetInterfaceParams(elementsOrVersion);

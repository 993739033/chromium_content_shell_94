...
class CacheStorage_Internal {
    ...
    public static final Interface.Manager<CacheStorage, CacheStorage.Proxy> MANAGER = new Interface.Manager<CacheStorage, CacheStorage.Proxy>() { // from class: org.chromium.blink.mojom.CacheStorage_Internal.1
        ...
        public CacheStorage.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements CacheStorage.Proxy {
        ...
        public void has(String16 cacheName, long traceId, HasResponse callback) {
            CacheStorageHasParams _message = new CacheStorageHasParams();
            _message.cacheName = cacheName;
            _message.traceId = traceId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new CacheStorageHasResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CacheStorage
        public void delete(String16 cacheName, long traceId, DeleteResponse callback) {
            CacheStorageDeleteParams _message = new CacheStorageDeleteParams();
            _message.cacheName = cacheName;
            _message.traceId = traceId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new CacheStorageDeleteResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CacheStorage
        public void keys(long traceId, KeysResponse callback) {
            CacheStorageKeysParams _message = new CacheStorageKeysParams();
            _message.traceId = traceId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new CacheStorageKeysResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CacheStorage
        public void match(FetchApiRequest request, MultiCacheQueryOptions matchOptions, boolean inRelatedFetchEvent, long traceId, MatchResponse callback) {
            ...
            _message.traceId = traceId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new CacheStorageMatchResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CacheStorage
        public void open(String16 cacheName, long traceId, OpenResponse callback) {
            CacheStorageOpenParams _message = new CacheStorageOpenParams();
            _message.cacheName = cacheName;
            _message.traceId = traceId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new CacheStorageOpenResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<CacheStorage> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CacheStorage_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        CacheStorageHasParams data = CacheStorageHasParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        CacheStorageDeleteParams data2 = CacheStorageDeleteParams.deserialize(messageWithHeader.getPayload());
                        getImpl().delete(data2.cacheName, data2.traceId, new CacheStorageDeleteResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        getImpl().keys(CacheStorageKeysParams.deserialize(messageWithHeader.getPayload()).traceId, new CacheStorageKeysResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        CacheStorageMatchParams data3 = CacheStorageMatchParams.deserialize(messageWithHeader.getPayload());
                        getImpl().match(data3.request, data3.matchOptions, data3.inRelatedFetchEvent, data3.traceId, new CacheStorageMatchResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        CacheStorageOpenParams data4 = CacheStorageOpenParams.deserialize(messageWithHeader.getPayload());
                        getImpl().open(data4.cacheName, data4.traceId, new CacheStorageOpenResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class CacheStorageHasResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class CacheStorageDeleteResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        public int result;
        ...
        public static CacheStorageDeleteResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CacheStorageDeleteResponseParams result = new CacheStorageDeleteResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.result = readInt;
                CacheStorageError.validate(readInt);
                result.result = CacheStorageError.toKnownValue(result.result);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class CacheStorageKeysResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static CacheStorageKeysResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CacheStorageKeysResponseParams result = new CacheStorageKeysResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class CacheStorageMatchResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 24;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static CacheStorageMatchResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CacheStorageMatchResponseParams result = new CacheStorageMatchResponseParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class CacheStorageOpenResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 24;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static CacheStorageOpenResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CacheStorageOpenResponseParams result = new CacheStorageOpenResponseParams(elementsOrVersion);

...
class ClipboardHost_Internal {
    ...
    public static final Interface.Manager<ClipboardHost, ClipboardHost.Proxy> MANAGER = new Interface.Manager<ClipboardHost, ClipboardHost.Proxy>() { // from class: org.chromium.blink.mojom.ClipboardHost_Internal.1
        ...
        public ClipboardHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    private static final int READ_AVAILABLE_CUSTOM_AND_STANDARD_FORMATS_ORDINAL = 11;
    private static final int READ_AVAILABLE_TYPES_ORDINAL = 2;
    private static final int READ_CUSTOM_DATA_ORDINAL = 10;
    private static final int READ_FILES_ORDINAL = 9;
    ...
    private static final int READ_UNSANITIZED_CUSTOM_FORMAT_ORDINAL = 12;
    private static final int WRITE_BOOKMARK_ORDINAL = 18;
    private static final int WRITE_CUSTOM_DATA_ORDINAL = 17;
    private static final int WRITE_HTML_ORDINAL = 14;
    private static final int WRITE_IMAGE_ORDINAL = 19;
    private static final int WRITE_SMART_PASTE_MARKER_ORDINAL = 16;
    private static final int WRITE_SVG_ORDINAL = 15;
    private static final int WRITE_TEXT_ORDINAL = 13;
    private static final int WRITE_UNSANITIZED_CUSTOM_FORMAT_ORDINAL = 20;
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ClipboardHost.Proxy {
        ...
        public void getSequenceNumber(int buffer, GetSequenceNumberResponse callback) {
            ClipboardHostGetSequenceNumberParams _message = new ClipboardHostGetSequenceNumberParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new ClipboardHostGetSequenceNumberResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void isFormatAvailable(int format, int buffer, IsFormatAvailableResponse callback) {
            ClipboardHostIsFormatAvailableParams _message = new ClipboardHostIsFormatAvailableParams();
            _message.format = format;
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new ClipboardHostIsFormatAvailableResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readAvailableTypes(int buffer, ReadAvailableTypesResponse callback) {
            ClipboardHostReadAvailableTypesParams _message = new ClipboardHostReadAvailableTypesParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new ClipboardHostReadAvailableTypesResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readText(int buffer, ReadTextResponse callback) {
            ClipboardHostReadTextParams _message = new ClipboardHostReadTextParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new ClipboardHostReadTextResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readHtml(int buffer, ReadHtmlResponse callback) {
            ClipboardHostReadHtmlParams _message = new ClipboardHostReadHtmlParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new ClipboardHostReadHtmlResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readSvg(int buffer, ReadSvgResponse callback) {
            ClipboardHostReadSvgParams _message = new ClipboardHostReadSvgParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new ClipboardHostReadSvgResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readRtf(int buffer, ReadRtfResponse callback) {
            ClipboardHostReadRtfParams _message = new ClipboardHostReadRtfParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new ClipboardHostReadRtfResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readPng(int buffer, ReadPngResponse callback) {
            ClipboardHostReadPngParams _message = new ClipboardHostReadPngParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(7, 1, 0L)), new ClipboardHostReadPngResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readImage(int buffer, ReadImageResponse callback) {
            ClipboardHostReadImageParams _message = new ClipboardHostReadImageParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(8, 1, 0L)), new ClipboardHostReadImageResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readFiles(int buffer, ReadFilesResponse callback) {
            ClipboardHostReadFilesParams _message = new ClipboardHostReadFilesParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(9, 1, 0L)), new ClipboardHostReadFilesResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readCustomData(int buffer, String16 type, ReadCustomDataResponse callback) {
            ClipboardHostReadCustomDataParams _message = new ClipboardHostReadCustomDataParams();
            _message.buffer = buffer;
            _message.type = type;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(10, 1, 0L)), new ClipboardHostReadCustomDataResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readAvailableCustomAndStandardFormats(ReadAvailableCustomAndStandardFormatsResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(11, 1, 0L)), new ClipboardHostReadAvailableCustomAndStandardFormatsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ClipboardHost
        public void readUnsanitizedCustomFormat(String16 format, ReadUnsanitizedCustomFormatResponse callback) {
            ClipboardHostReadUnsanitizedCustomFormatParams _message = new ClipboardHostReadUnsanitizedCustomFormatParams();
            _message.format = format;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(12, 1, 0L)), new ClipboardHostReadUnsanitizedCustomFormatResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<ClipboardHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 13:
                        getImpl().writeText(ClipboardHostWriteTextParams.deserialize(messageWithHeader.getPayload()).text);
                        return true;
                    case 14:
                        ClipboardHostWriteHtmlParams data = ClipboardHostWriteHtmlParams.deserialize(messageWithHeader.getPayload());
                        getImpl().writeHtml(data.markup, data.url);
                        return true;
                    case 15:
                        ClipboardHostWriteSvgParams data2 = ClipboardHostWriteSvgParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 16:
                        ...
                        return true;
                    case 17:
                        ClipboardHostWriteCustomDataParams data3 = ClipboardHostWriteCustomDataParams.deserialize(messageWithHeader.getPayload());
                        getImpl().writeCustomData(data3.data);
                        return true;
                    case 18:
                        ClipboardHostWriteBookmarkParams data4 = ClipboardHostWriteBookmarkParams.deserialize(messageWithHeader.getPayload());
                        getImpl().writeBookmark(data4.url, data4.title);
                        return true;
                    case 19:
                        ClipboardHostWriteImageParams data5 = ClipboardHostWriteImageParams.deserialize(messageWithHeader.getPayload());
                        getImpl().writeImage(data5.image);
                        return true;
                    case 20:
                        ClipboardHostWriteUnsanitizedCustomFormatParams data6 = ClipboardHostWriteUnsanitizedCustomFormatParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ClipboardHost_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        getImpl().getSequenceNumber(ClipboardHostGetSequenceNumberParams.deserialize(messageWithHeader.getPayload()).buffer, new ClipboardHostGetSequenceNumberResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 1:
                        ClipboardHostIsFormatAvailableParams data = ClipboardHostIsFormatAvailableParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 2:
                        ClipboardHostReadAvailableTypesParams data2 = ClipboardHostReadAvailableTypesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readAvailableTypes(data2.buffer, new ClipboardHostReadAvailableTypesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        ClipboardHostReadTextParams data3 = ClipboardHostReadTextParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readText(data3.buffer, new ClipboardHostReadTextResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        ClipboardHostReadHtmlParams data4 = ClipboardHostReadHtmlParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readHtml(data4.buffer, new ClipboardHostReadHtmlResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 5:
                        ClipboardHostReadSvgParams data5 = ClipboardHostReadSvgParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readSvg(data5.buffer, new ClipboardHostReadSvgResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        ClipboardHostReadRtfParams data6 = ClipboardHostReadRtfParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readRtf(data6.buffer, new ClipboardHostReadRtfResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 7:
                        ClipboardHostReadPngParams data7 = ClipboardHostReadPngParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readPng(data7.buffer, new ClipboardHostReadPngResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 8:
                        ClipboardHostReadImageParams data8 = ClipboardHostReadImageParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readImage(data8.buffer, new ClipboardHostReadImageResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 9:
                        ClipboardHostReadFilesParams data9 = ClipboardHostReadFilesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readFiles(data9.buffer, new ClipboardHostReadFilesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 10:
                        ClipboardHostReadCustomDataParams data10 = ClipboardHostReadCustomDataParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readCustomData(data10.buffer, data10.type, new ClipboardHostReadCustomDataResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 11:
                        ...
                        return true;
                    case 12:
                        ClipboardHostReadUnsanitizedCustomFormatParams data11 = ClipboardHostReadUnsanitizedCustomFormatParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readUnsanitizedCustomFormat(data11.format, new ClipboardHostReadUnsanitizedCustomFormatResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class ClipboardHostGetSequenceNumberParams extends Struct {
        ...
        public static ClipboardHostGetSequenceNumberParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ClipboardHostGetSequenceNumberParams result = new ClipboardHostGetSequenceNumberParams(elementsOrVersion);
    ...
    public static final class ClipboardHostGetSequenceNumberResponseParams extends Struct {
        ...
        public static ClipboardHostGetSequenceNumberResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostGetSequenceNumberResponseParams result = new ClipboardHostGetSequenceNumberResponseParams(elementsOrVersion);
    ...
    static final class ClipboardHostIsFormatAvailableParams extends Struct {
        ...
        public static ClipboardHostIsFormatAvailableParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostIsFormatAvailableParams result = new ClipboardHostIsFormatAvailableParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    public static final class ClipboardHostIsFormatAvailableResponseParams extends Struct {
        ...
        public static ClipboardHostIsFormatAvailableResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostIsFormatAvailableResponseParams result = new ClipboardHostIsFormatAvailableResponseParams(elementsOrVersion);
    ...
    static final class ClipboardHostReadAvailableTypesParams extends Struct {
        ...
        public static ClipboardHostReadAvailableTypesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadAvailableTypesParams result = new ClipboardHostReadAvailableTypesParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.buffer = readInt;
                ClipboardBuffer.validate(readInt);
                result.buffer = ClipboardBuffer.toKnownValue(result.buffer);
    ...
    public static final class ClipboardHostReadAvailableTypesResponseParams extends Struct {
        ...
        public static ClipboardHostReadAvailableTypesResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadAvailableTypesResponseParams result = new ClipboardHostReadAvailableTypesResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class ClipboardHostReadTextResponseParams extends Struct {
        ...
        public static ClipboardHostReadTextResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadTextResponseParams result = new ClipboardHostReadTextResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class ClipboardHostReadHtmlResponseParams extends Struct {
        ...
        public static ClipboardHostReadHtmlResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadHtmlResponseParams result = new ClipboardHostReadHtmlResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class ClipboardHostReadSvgResponseParams extends Struct {
        ...
        public static ClipboardHostReadSvgResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadSvgResponseParams result = new ClipboardHostReadSvgResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = BigString16.decode(decoder1);
                return result;
            } finally {
    ...
    static class ClipboardHostReadSvgResponseParamsProxyToResponder implements ClipboardHost.ReadSvgResponse {
        ...
        ClipboardHostReadSvgResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    public static final class ClipboardHostReadRtfResponseParams extends Struct {
        ...
        public static ClipboardHostReadRtfResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadRtfResponseParams result = new ClipboardHostReadRtfResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class ClipboardHostReadPngResponseParams extends Struct {
        ...
        public static ClipboardHostReadPngResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadPngResponseParams result = new ClipboardHostReadPngResponseParams(elementsOrVersion);
    ...
    static class ClipboardHostReadPngResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final ClipboardHost.ReadPngResponse mCallback;

        ClipboardHostReadPngResponseParamsForwardToCallback(ClipboardHost.ReadPngResponse callback) {
            this.mCallback = callback;
        }
    ...
    /* loaded from: classes2.dex */
    static class ClipboardHostReadPngResponseParamsProxyToResponder implements ClipboardHost.ReadPngResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        ClipboardHostReadPngResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class ClipboardHostReadImageParams extends Struct {
        ...
        public static ClipboardHostReadImageParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadImageParams result = new ClipboardHostReadImageParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.buffer = readInt;
                ClipboardBuffer.validate(readInt);
                result.buffer = ClipboardBuffer.toKnownValue(result.buffer);
    ...
    public static final class ClipboardHostReadImageResponseParams extends Struct {
        ...
        public static ClipboardHostReadImageResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadImageResponseParams result = new ClipboardHostReadImageResponseParams(elementsOrVersion);
    ...
    static class ClipboardHostReadImageResponseParamsProxyToResponder implements ClipboardHost.ReadImageResponse {
        ...
        @Override // org.chromium.mojo.bindings.Callbacks.Callback1
        public void call(BitmapN32 image) {
    ...
    public static final class ClipboardHostReadFilesResponseParams extends Struct {
        ...
        public static ClipboardHostReadFilesResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadFilesResponseParams result = new ClipboardHostReadFilesResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static class ClipboardHostReadFilesResponseParamsProxyToResponder implements ClipboardHost.ReadFilesResponse {
        ...
        ClipboardHostReadFilesResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class ClipboardHostReadCustomDataParams extends Struct {
        ...
        public static ClipboardHostReadCustomDataParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadCustomDataParams result = new ClipboardHostReadCustomDataParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.buffer = readInt;
                ClipboardBuffer.validate(readInt);
                result.buffer = ClipboardBuffer.toKnownValue(result.buffer);
    ...
    public static final class ClipboardHostReadCustomDataResponseParams extends Struct {
        ...
        public static ClipboardHostReadCustomDataResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadCustomDataResponseParams result = new ClipboardHostReadCustomDataResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = BigString16.decode(decoder1);
                return result;
            } finally {
    ...
    static final class ClipboardHostReadAvailableCustomAndStandardFormatsParams extends Struct {
        ...
        public static ClipboardHostReadAvailableCustomAndStandardFormatsParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ClipboardHostReadAvailableCustomAndStandardFormatsParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadAvailableCustomAndStandardFormatsParams result = new ClipboardHostReadAvailableCustomAndStandardFormatsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class ClipboardHostReadAvailableCustomAndStandardFormatsResponseParams extends Struct {
        ...
        public static ClipboardHostReadAvailableCustomAndStandardFormatsResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ClipboardHostReadAvailableCustomAndStandardFormatsResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadAvailableCustomAndStandardFormatsResponseParams result = new ClipboardHostReadAvailableCustomAndStandardFormatsResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
    ...
    static class ClipboardHostReadAvailableCustomAndStandardFormatsResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final ClipboardHost.ReadAvailableCustomAndStandardFormatsResponse mCallback;

        ClipboardHostReadAvailableCustomAndStandardFormatsResponseParamsForwardToCallback(ClipboardHost.ReadAvailableCustomAndStandardFormatsResponse callback) {
            this.mCallback = callback;
        }
    ...
    /* loaded from: classes2.dex */
    static class ClipboardHostReadAvailableCustomAndStandardFormatsResponseParamsProxyToResponder implements ClipboardHost.ReadAvailableCustomAndStandardFormatsResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        ClipboardHostReadAvailableCustomAndStandardFormatsResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class ClipboardHostReadUnsanitizedCustomFormatParams extends Struct {
        ...
        public static ClipboardHostReadUnsanitizedCustomFormatParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadUnsanitizedCustomFormatParams result = new ClipboardHostReadUnsanitizedCustomFormatParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class ClipboardHostReadUnsanitizedCustomFormatResponseParams extends Struct {
        ...
        public static ClipboardHostReadUnsanitizedCustomFormatResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static ClipboardHostReadUnsanitizedCustomFormatResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostReadUnsanitizedCustomFormatResponseParams result = new ClipboardHostReadUnsanitizedCustomFormatResponseParams(elementsOrVersion);
    ...
    static class ClipboardHostReadUnsanitizedCustomFormatResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final ClipboardHost.ReadUnsanitizedCustomFormatResponse mCallback;

        ClipboardHostReadUnsanitizedCustomFormatResponseParamsForwardToCallback(ClipboardHost.ReadUnsanitizedCustomFormatResponse callback) {
            this.mCallback = callback;
        }
    ...
    /* loaded from: classes2.dex */
    static class ClipboardHostReadUnsanitizedCustomFormatResponseParamsProxyToResponder implements ClipboardHost.ReadUnsanitizedCustomFormatResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        ClipboardHostReadUnsanitizedCustomFormatResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class ClipboardHostWriteSmartPasteMarkerParams extends Struct {
        ...
        public static ClipboardHostWriteSmartPasteMarkerParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostWriteSmartPasteMarkerParams result = new ClipboardHostWriteSmartPasteMarkerParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class ClipboardHostWriteCustomDataParams extends Struct {
        ...
        public static ClipboardHostWriteCustomDataParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostWriteCustomDataParams result = new ClipboardHostWriteCustomDataParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class ClipboardHostWriteBookmarkParams extends Struct {
        ...
        public static ClipboardHostWriteBookmarkParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostWriteBookmarkParams result = new ClipboardHostWriteBookmarkParams(elementsOrVersion);
    ...
    static final class ClipboardHostWriteUnsanitizedCustomFormatParams extends Struct {
        ...
        public static ClipboardHostWriteUnsanitizedCustomFormatParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostWriteUnsanitizedCustomFormatParams result = new ClipboardHostWriteUnsanitizedCustomFormatParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.format = String16.decode(decoder1);
    ...
    static final class ClipboardHostCommitWriteParams extends Struct {
        ...
        public static ClipboardHostCommitWriteParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ClipboardHostCommitWriteParams result = new ClipboardHostCommitWriteParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

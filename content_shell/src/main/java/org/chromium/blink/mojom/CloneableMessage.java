...
public final class CloneableMessage extends Struct {
    ...
    public static CloneableMessage decode(Decoder decoder0) {
        ...
        try {
            ...
            result.lockedAgentClusterId = UnguessableToken.decode(decoder0.readPointer(72, true));
            result.fileSystemAccessTokens = (FileSystemAccessTransferToken[]) decoder0.readServiceInterfaces(80, 0, -1, FileSystemAccessTransferToken.MANAGER);
            return result;
        } finally {
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode((Struct) this.lockedAgentClusterId, 72, true);

...
class CodeCacheHost_Internal {
    ...
    public static final Interface.Manager<CodeCacheHost, CodeCacheHost.Proxy> MANAGER = new Interface.Manager<CodeCacheHost, CodeCacheHost.Proxy>() { // from class: org.chromium.blink.mojom.CodeCacheHost_Internal.1
        ...
        public CodeCacheHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements CodeCacheHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.CodeCacheHost
        public void fetchCachedCode(int cacheType, Url url, FetchCachedCodeResponse callback) {
            CodeCacheHostFetchCachedCodeParams _message = new CodeCacheHostFetchCachedCodeParams();
            _message.cacheType = cacheType;
            _message.url = url;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new CodeCacheHostFetchCachedCodeResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<CodeCacheHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        CodeCacheHostDidGenerateCacheableMetadataParams data = CodeCacheHostDidGenerateCacheableMetadataParams.deserialize(messageWithHeader.getPayload());
                        getImpl().didGenerateCacheableMetadata(data.cacheType, data.url, data.expectedResponseTime, data.data);
                        return true;
                    case 2:
                        CodeCacheHostClearCodeCacheEntryParams data2 = CodeCacheHostClearCodeCacheEntryParams.deserialize(messageWithHeader.getPayload());
                        getImpl().clearCodeCacheEntry(data2.cacheType, data2.url);
                        return true;
                    case 3:
                        CodeCacheHostDidGenerateCacheableMetadataInCacheStorageParams data3 = CodeCacheHostDidGenerateCacheableMetadataInCacheStorageParams.deserialize(messageWithHeader.getPayload());
                        getImpl().didGenerateCacheableMetadataInCacheStorage(data3.url, data3.expectedResponseTime, data3.data, data3.cacheStorageOrigin, data3.cacheStorageCacheName);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CodeCacheHost_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    default:
                        return false;
                    case 1:
                        CodeCacheHostFetchCachedCodeParams data = CodeCacheHostFetchCachedCodeParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class CodeCacheHostDidGenerateCacheableMetadataParams extends Struct {
        ...
        public static CodeCacheHostDidGenerateCacheableMetadataParams decode(Decoder decoder0) {
            ...
            try {
                ...
                CodeCacheHostDidGenerateCacheableMetadataParams result = new CodeCacheHostDidGenerateCacheableMetadataParams(elementsOrVersion);
    ...
    static final class CodeCacheHostFetchCachedCodeParams extends Struct {
        ...
        public static CodeCacheHostFetchCachedCodeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CodeCacheHostFetchCachedCodeParams result = new CodeCacheHostFetchCachedCodeParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.cacheType = readInt;
                CodeCacheType.validate(readInt);
                result.cacheType = CodeCacheType.toKnownValue(result.cacheType);
    ...
    public static final class CodeCacheHostFetchCachedCodeResponseParams extends Struct {
        ...
        public static CodeCacheHostFetchCachedCodeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CodeCacheHostFetchCachedCodeResponseParams result = new CodeCacheHostFetchCachedCodeResponseParams(elementsOrVersion);
    ...
    static final class CodeCacheHostClearCodeCacheEntryParams extends Struct {
        ...
        public static CodeCacheHostClearCodeCacheEntryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CodeCacheHostClearCodeCacheEntryParams result = new CodeCacheHostClearCodeCacheEntryParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.cacheType = readInt;
                CodeCacheType.validate(readInt);
                result.cacheType = CodeCacheType.toKnownValue(result.cacheType);
    ...
    static final class CodeCacheHostDidGenerateCacheableMetadataInCacheStorageParams extends Struct {
        ...
        public static CodeCacheHostDidGenerateCacheableMetadataInCacheStorageParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CodeCacheHostDidGenerateCacheableMetadataInCacheStorageParams result = new CodeCacheHostDidGenerateCacheableMetadataInCacheStorageParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.url = Url.decode(decoder1);
                ...
                result.cacheStorageOrigin = Origin.decode(decoder13);

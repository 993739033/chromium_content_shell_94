...
class ColorChooserClient_Internal {
    ...
    public static final Interface.Manager<ColorChooserClient, ColorChooserClient.Proxy> MANAGER = new Interface.Manager<ColorChooserClient, ColorChooserClient.Proxy>() { // from class: org.chromium.blink.mojom.ColorChooserClient_Internal.1
        ...
        public ColorChooserClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ColorChooserClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ColorChooserClient
    ...
    public static final class Stub extends Interface.Stub<ColorChooserClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ColorChooserClientDidChooseColorParams data = ColorChooserClientDidChooseColorParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ColorChooserClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ColorChooserClientDidChooseColorParams extends Struct {
        ...
        public static ColorChooserClientDidChooseColorParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ColorChooserClientDidChooseColorParams result = new ColorChooserClientDidChooseColorParams(elementsOrVersion);

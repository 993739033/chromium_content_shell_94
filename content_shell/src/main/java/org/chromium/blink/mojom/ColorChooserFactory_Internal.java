...
import org.chromium.blink.mojom.ColorChooserFactory;
...
class ColorChooserFactory_Internal {
    public static final Interface.Manager<ColorChooserFactory, ColorChooserFactory.Proxy> MANAGER = new Interface.Manager<ColorChooserFactory, ColorChooserFactory.Proxy>() { // from class: org.chromium.blink.mojom.ColorChooserFactory_Internal.1
        ...
        public ColorChooserFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ColorChooserFactory.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ColorChooserFactory
    ...
    public static final class Stub extends Interface.Stub<ColorChooserFactory> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ColorChooserFactoryOpenColorChooserParams data = ColorChooserFactoryOpenColorChooserParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ColorChooserFactory_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ColorChooserFactoryOpenColorChooserParams extends Struct {
        ...
        public static ColorChooserFactoryOpenColorChooserParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ColorChooserFactoryOpenColorChooserParams result = new ColorChooserFactoryOpenColorChooserParams(elementsOrVersion);

...
import org.chromium.blink.mojom.ColorChooser;
...
class ColorChooser_Internal {
    public static final Interface.Manager<ColorChooser, ColorChooser.Proxy> MANAGER = new Interface.Manager<ColorChooser, ColorChooser.Proxy>() { // from class: org.chromium.blink.mojom.ColorChooser_Internal.1
        ...
        public ColorChooser.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ColorChooser.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ColorChooser
    ...
    public static final class Stub extends Interface.Stub<ColorChooser> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ColorChooserSetSelectedColorParams data = ColorChooserSetSelectedColorParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ColorChooser_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ColorChooserSetSelectedColorParams extends Struct {
        ...
        public static ColorChooserSetSelectedColorParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ColorChooserSetSelectedColorParams result = new ColorChooserSetSelectedColorParams(elementsOrVersion);

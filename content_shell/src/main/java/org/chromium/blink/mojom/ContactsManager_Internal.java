...
class ContactsManager_Internal {
    public static final Interface.Manager<ContactsManager, ContactsManager.Proxy> MANAGER = new Interface.Manager<ContactsManager, ContactsManager.Proxy>() { // from class: org.chromium.blink.mojom.ContactsManager_Internal.1
        ...
        public ContactsManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ContactsManager.Proxy {
        ...
        public void select(boolean multiple, boolean includeNames, boolean includeEmails, boolean includeTel, boolean includeAddresses, boolean includeIcons, SelectResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new ContactsManagerSelectResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<ContactsManager> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ContactsManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        ContactsManagerSelectParams data = ContactsManagerSelectParams.deserialize(messageWithHeader.getPayload());
    ...
    public static final class ContactsManagerSelectResponseParams extends Struct {
        ...
        public static ContactsManagerSelectResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContactsManagerSelectResponseParams result = new ContactsManagerSelectResponseParams(elementsOrVersion);

...
class ContentIndexService_Internal {
    ...
    public static final Interface.Manager<ContentIndexService, ContentIndexService.Proxy> MANAGER = new Interface.Manager<ContentIndexService, ContentIndexService.Proxy>() { // from class: org.chromium.blink.mojom.ContentIndexService_Internal.1
        ...
        public ContentIndexService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ContentIndexService.Proxy {
        ...
        public void getIconSizes(int category, GetIconSizesResponse callback) {
            ContentIndexServiceGetIconSizesParams _message = new ContentIndexServiceGetIconSizesParams();
            _message.category = category;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new ContentIndexServiceGetIconSizesResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ContentIndexService
        public void checkOfflineCapability(long serviceWorkerRegistrationId, Url launchUrl, CheckOfflineCapabilityResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new ContentIndexServiceCheckOfflineCapabilityResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ContentIndexService
        public void add(long serviceWorkerRegistrationId, ContentDescription description, BitmapN32[] icon, Url launchUrl, AddResponse callback) {
            ContentIndexServiceAddParams _message = new ContentIndexServiceAddParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            _message.description = description;
            _message.icon = icon;
            _message.launchUrl = launchUrl;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new ContentIndexServiceAddResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ContentIndexService
        public void delete(long serviceWorkerRegistrationId, String id, DeleteResponse callback) {
            ContentIndexServiceDeleteParams _message = new ContentIndexServiceDeleteParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            _message.id = id;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new ContentIndexServiceDeleteResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ContentIndexService
        public void getDescriptions(long serviceWorkerRegistrationId, GetDescriptionsResponse callback) {
            ContentIndexServiceGetDescriptionsParams _message = new ContentIndexServiceGetDescriptionsParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new ContentIndexServiceGetDescriptionsResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<ContentIndexService> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ContentIndexService_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        getImpl().getIconSizes(ContentIndexServiceGetIconSizesParams.deserialize(messageWithHeader.getPayload()).category, new ContentIndexServiceGetIconSizesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 1:
                        ContentIndexServiceCheckOfflineCapabilityParams data = ContentIndexServiceCheckOfflineCapabilityParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 2:
                        ContentIndexServiceAddParams data2 = ContentIndexServiceAddParams.deserialize(messageWithHeader.getPayload());
                        getImpl().add(data2.serviceWorkerRegistrationId, data2.description, data2.icon, data2.launchUrl, new ContentIndexServiceAddResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        ContentIndexServiceDeleteParams data3 = ContentIndexServiceDeleteParams.deserialize(messageWithHeader.getPayload());
                        getImpl().delete(data3.serviceWorkerRegistrationId, data3.id, new ContentIndexServiceDeleteResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        ContentIndexServiceGetDescriptionsParams data4 = ContentIndexServiceGetDescriptionsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getDescriptions(data4.serviceWorkerRegistrationId, new ContentIndexServiceGetDescriptionsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class ContentIndexServiceGetIconSizesParams extends Struct {
        ...
        public static ContentIndexServiceGetIconSizesParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ContentIndexServiceGetIconSizesParams result = new ContentIndexServiceGetIconSizesParams(elementsOrVersion);
    ...
    public static final class ContentIndexServiceGetIconSizesResponseParams extends Struct {
        ...
        public static ContentIndexServiceGetIconSizesResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceGetIconSizesResponseParams result = new ContentIndexServiceGetIconSizesResponseParams(elementsOrVersion);
    ...
    static class ContentIndexServiceGetIconSizesResponseParamsProxyToResponder implements ContentIndexService.GetIconSizesResponse {
        ...
        ContentIndexServiceGetIconSizesResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class ContentIndexServiceCheckOfflineCapabilityParams extends Struct {
        ...
        public static ContentIndexServiceCheckOfflineCapabilityParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceCheckOfflineCapabilityParams result = new ContentIndexServiceCheckOfflineCapabilityParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class ContentIndexServiceCheckOfflineCapabilityResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static ContentIndexServiceCheckOfflineCapabilityResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static ContentIndexServiceCheckOfflineCapabilityResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static ContentIndexServiceCheckOfflineCapabilityResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceCheckOfflineCapabilityResponseParams result = new ContentIndexServiceCheckOfflineCapabilityResponseParams(elementsOrVersion);
    ...
    static class ContentIndexServiceCheckOfflineCapabilityResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(Boolean.valueOf(response.isOfflineCapable));
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class ContentIndexServiceCheckOfflineCapabilityResponseParamsProxyToResponder implements ContentIndexService.CheckOfflineCapabilityResponse {
        ...
        ContentIndexServiceCheckOfflineCapabilityResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
        ...
        public void call(Boolean isOfflineCapable) {
            ...
            _response.isOfflineCapable = isOfflineCapable.booleanValue();
    ...
    public static final class ContentIndexServiceAddResponseParams extends Struct {
        ...
        public static ContentIndexServiceAddResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceAddResponseParams result = new ContentIndexServiceAddResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class ContentIndexServiceDeleteParams extends Struct {
        ...
        public static ContentIndexServiceDeleteParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceDeleteParams result = new ContentIndexServiceDeleteParams(elementsOrVersion);
                result.serviceWorkerRegistrationId = decoder0.readLong(8);
    ...
    public static final class ContentIndexServiceDeleteResponseParams extends Struct {
        ...
        public static ContentIndexServiceDeleteResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceDeleteResponseParams result = new ContentIndexServiceDeleteResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                ContentIndexError.validate(readInt);
                result.error = ContentIndexError.toKnownValue(result.error);
    ...
    static final class ContentIndexServiceGetDescriptionsParams extends Struct {
        ...
        public static ContentIndexServiceGetDescriptionsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceGetDescriptionsParams result = new ContentIndexServiceGetDescriptionsParams(elementsOrVersion);
                result.serviceWorkerRegistrationId = decoder0.readLong(8);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    public static final class ContentIndexServiceGetDescriptionsResponseParams extends Struct {
        ...
        public static ContentIndexServiceGetDescriptionsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentIndexServiceGetDescriptionsResponseParams result = new ContentIndexServiceGetDescriptionsResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                ContentIndexError.validate(readInt);
                result.error = ContentIndexError.toKnownValue(result.error);

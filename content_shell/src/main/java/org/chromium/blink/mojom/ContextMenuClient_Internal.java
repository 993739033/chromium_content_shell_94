...
import org.chromium.blink.mojom.ContextMenuClient;
...
class ContextMenuClient_Internal {
    ...
    public static final Interface.Manager<ContextMenuClient, ContextMenuClient.Proxy> MANAGER = new Interface.Manager<ContextMenuClient, ContextMenuClient.Proxy>() { // from class: org.chromium.blink.mojom.ContextMenuClient_Internal.1
        ...
        public ContextMenuClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ContextMenuClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ContextMenuClient
    ...
    public static final class Stub extends Interface.Stub<ContextMenuClient> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(ContextMenuClient_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ContextMenuClientCustomContextMenuActionParams data = ContextMenuClientCustomContextMenuActionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().customContextMenuAction(data.action);
                        return true;
                    case 1:
                        ContextMenuClientContextMenuClosedParams data2 = ContextMenuClientContextMenuClosedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ContextMenuClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ContextMenuClientCustomContextMenuActionParams extends Struct {
        ...
        public static ContextMenuClientCustomContextMenuActionParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ContextMenuClientCustomContextMenuActionParams result = new ContextMenuClientCustomContextMenuActionParams(elementsOrVersion);
    ...
    static final class ContextMenuClientContextMenuClosedParams extends Struct {
        ...
        public static ContextMenuClientContextMenuClosedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContextMenuClientContextMenuClosedParams result = new ContextMenuClientContextMenuClosedParams(elementsOrVersion);

...
class ControllerServiceWorker_Internal {
    ...
    public static final Interface.Manager<ControllerServiceWorker, ControllerServiceWorker.Proxy> MANAGER = new Interface.Manager<ControllerServiceWorker, ControllerServiceWorker.Proxy>() { // from class: org.chromium.blink.mojom.ControllerServiceWorker_Internal.1
        ...
        public ControllerServiceWorker.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ControllerServiceWorker.Proxy {
        @Override
        ...
        @Override // org.chromium.blink.mojom.ControllerServiceWorker
        public void dispatchFetchEventForSubresource(DispatchFetchEventParams params, ServiceWorkerFetchResponseCallback responseCallback, DispatchFetchEventForSubresourceResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new ControllerServiceWorkerDispatchFetchEventForSubresourceResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ControllerServiceWorker
        public void clone(InterfaceRequest<ControllerServiceWorker> receiver, CrossOriginEmbedderPolicy crossOriginEmbedderPolicy, CrossOriginEmbedderPolicyReporter coepReporter) {
    ...
    public static final class Stub extends Interface.Stub<ControllerServiceWorker> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ControllerServiceWorkerCloneParams data = ControllerServiceWorkerCloneParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ControllerServiceWorker_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        ControllerServiceWorkerDispatchFetchEventForSubresourceParams data = ControllerServiceWorkerDispatchFetchEventForSubresourceParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class ControllerServiceWorkerDispatchFetchEventForSubresourceParams extends Struct {
        ...
        public static ControllerServiceWorkerDispatchFetchEventForSubresourceParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ControllerServiceWorkerDispatchFetchEventForSubresourceParams result = new ControllerServiceWorkerDispatchFetchEventForSubresourceParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class ControllerServiceWorkerDispatchFetchEventForSubresourceResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static ControllerServiceWorkerDispatchFetchEventForSubresourceResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ControllerServiceWorkerDispatchFetchEventForSubresourceResponseParams result = new ControllerServiceWorkerDispatchFetchEventForSubresourceResponseParams(elementsOrVersion);
    ...
    static final class ControllerServiceWorkerCloneParams extends Struct {
        ...
        public static ControllerServiceWorkerCloneParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ControllerServiceWorkerCloneParams result = new ControllerServiceWorkerCloneParams(elementsOrVersion);
                result.receiver = decoder0.readInterfaceRequest(8, false);
                Decoder decoder1 = decoder0.readPointer(16, false);
                result.crossOriginEmbedderPolicy = CrossOriginEmbedderPolicy.decode(decoder1);
                result.coepReporter = (CrossOriginEmbedderPolicyReporter) decoder0.readServiceInterface(24, true, CrossOriginEmbedderPolicyReporter.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

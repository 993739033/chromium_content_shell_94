...
class CookieStore_Internal {
    ...
    public static final Interface.Manager<CookieStore, CookieStore.Proxy> MANAGER = new Interface.Manager<CookieStore, CookieStore.Proxy>() { // from class: org.chromium.blink.mojom.CookieStore_Internal.1
        ...
        public CookieStore.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements CookieStore.Proxy {
        ...
        public void addSubscriptions(long serviceWorkerRegistrationId, CookieChangeSubscription[] subscription, AddSubscriptionsResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new CookieStoreAddSubscriptionsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CookieStore
        public void removeSubscriptions(long serviceWorkerRegistrationId, CookieChangeSubscription[] subscription, RemoveSubscriptionsResponse callback) {
            CookieStoreRemoveSubscriptionsParams _message = new CookieStoreRemoveSubscriptionsParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            _message.subscription = subscription;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new CookieStoreRemoveSubscriptionsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CookieStore
        public void getSubscriptions(long serviceWorkerRegistrationId, GetSubscriptionsResponse callback) {
            CookieStoreGetSubscriptionsParams _message = new CookieStoreGetSubscriptionsParams();
            _message.serviceWorkerRegistrationId = serviceWorkerRegistrationId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new CookieStoreGetSubscriptionsResponseParamsForwardToCallback(callback));
        }
    }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        CookieStoreAddSubscriptionsParams data = CookieStoreAddSubscriptionsParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        CookieStoreRemoveSubscriptionsParams data2 = CookieStoreRemoveSubscriptionsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().removeSubscriptions(data2.serviceWorkerRegistrationId, data2.subscription, new CookieStoreRemoveSubscriptionsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        getImpl().getSubscriptions(CookieStoreGetSubscriptionsParams.deserialize(messageWithHeader.getPayload()).serviceWorkerRegistrationId, new CookieStoreGetSubscriptionsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class CookieStoreAddSubscriptionsParams extends Struct {
        ...
        public static CookieStoreAddSubscriptionsParams decode(Decoder decoder0) {
            ...
            try {
                ...
                CookieStoreAddSubscriptionsParams result = new CookieStoreAddSubscriptionsParams(elementsOrVersion);
    ...
    public static final class CookieStoreAddSubscriptionsResponseParams extends Struct {
        ...
        public static CookieStoreAddSubscriptionsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CookieStoreAddSubscriptionsResponseParams result = new CookieStoreAddSubscriptionsResponseParams(elementsOrVersion);
    ...
    static class CookieStoreAddSubscriptionsResponseParamsProxyToResponder implements CookieStore.AddSubscriptionsResponse {
        ...
        CookieStoreAddSubscriptionsResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class CookieStoreRemoveSubscriptionsParams extends Struct {
        ...
        public static CookieStoreRemoveSubscriptionsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CookieStoreRemoveSubscriptionsParams result = new CookieStoreRemoveSubscriptionsParams(elementsOrVersion);
                result.serviceWorkerRegistrationId = decoder0.readLong(8);
                Decoder decoder1 = decoder0.readPointer(16, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.subscription = new CookieChangeSubscription[si1.elementsOrVersion];
    ...
    public static final class CookieStoreRemoveSubscriptionsResponseParams extends Struct {
        ...
        public static CookieStoreRemoveSubscriptionsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CookieStoreRemoveSubscriptionsResponseParams result = new CookieStoreRemoveSubscriptionsResponseParams(elementsOrVersion);
                result.success = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    static class CookieStoreRemoveSubscriptionsResponseParamsProxyToResponder implements CookieStore.RemoveSubscriptionsResponse {
        ...
        CookieStoreRemoveSubscriptionsResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class CookieStoreGetSubscriptionsParams extends Struct {
        ...
        public static CookieStoreGetSubscriptionsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CookieStoreGetSubscriptionsParams result = new CookieStoreGetSubscriptionsParams(elementsOrVersion);
                result.serviceWorkerRegistrationId = decoder0.readLong(8);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    public static final class CookieStoreGetSubscriptionsResponseParams extends Struct {
        ...
        public static CookieStoreGetSubscriptionsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CookieStoreGetSubscriptionsResponseParams result = new CookieStoreGetSubscriptionsResponseParams(elementsOrVersion);

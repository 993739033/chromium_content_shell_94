...
class CredentialManager_Internal {
    ...
    public static final Interface.Manager<CredentialManager, CredentialManager.Proxy> MANAGER = new Interface.Manager<CredentialManager, CredentialManager.Proxy>() { // from class: org.chromium.blink.mojom.CredentialManager_Internal.1
        ...
        public CredentialManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements CredentialManager.Proxy {
        ...
        public void store(CredentialInfo credential, StoreResponse callback) {
            CredentialManagerStoreParams _message = new CredentialManagerStoreParams();
            _message.credential = credential;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new CredentialManagerStoreResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CredentialManager
        public void preventSilentAccess(PreventSilentAccessResponse callback) {
            CredentialManagerPreventSilentAccessParams _message = new CredentialManagerPreventSilentAccessParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new CredentialManagerPreventSilentAccessResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.CredentialManager
        public void get(int mediation, boolean includePasswords, Url[] federations, GetResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new CredentialManagerGetResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<CredentialManager> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CredentialManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        getImpl().store(CredentialManagerStoreParams.deserialize(messageWithHeader.getPayload()).credential, new CredentialManagerStoreResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 1:
                        ...
                        return true;
                    case 2:
                        CredentialManagerGetParams data = CredentialManagerGetParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class CredentialManagerStoreResponseParams extends Struct {
        ...
        public static CredentialManagerStoreResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CredentialManagerStoreResponseParams result = new CredentialManagerStoreResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class CredentialManagerPreventSilentAccessParams extends Struct {
        ...
        public static CredentialManagerPreventSilentAccessParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CredentialManagerPreventSilentAccessParams result = new CredentialManagerPreventSilentAccessParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class CredentialManagerPreventSilentAccessResponseParams extends Struct {
        ...
        public static CredentialManagerPreventSilentAccessResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CredentialManagerPreventSilentAccessResponseParams result = new CredentialManagerPreventSilentAccessResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class CredentialManagerGetResponseParams extends Struct {
        ...
        public static CredentialManagerGetResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CredentialManagerGetResponseParams result = new CredentialManagerGetResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);

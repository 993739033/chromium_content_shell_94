...
class DedicatedWorkerHostFactoryClient_Internal {
    public static final Interface.Manager<DedicatedWorkerHostFactoryClient, DedicatedWorkerHostFactoryClient.Proxy> MANAGER = new Interface.Manager<DedicatedWorkerHostFactoryClient, DedicatedWorkerHostFactoryClient.Proxy>() { // from class: org.chromium.blink.mojom.DedicatedWorkerHostFactoryClient_Internal.1
        ...
        public DedicatedWorkerHostFactoryClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements DedicatedWorkerHostFactoryClient.Proxy {
        ...
        public void onWorkerHostCreated(BrowserInterfaceBroker browserInterfaceBroker, DedicatedWorkerHost host) {
        ...
        @Override // org.chromium.blink.mojom.DedicatedWorkerHostFactoryClient
        public void onScriptLoadStarted(ServiceWorkerContainerInfoForClient serviceWorkerContainerInfo, WorkerMainScriptLoadParams mainScriptLoadParams, UrlLoaderFactoryBundle subresourceLoaderFactories, InterfaceRequest<SubresourceLoaderUpdater> subresourceLoaderUpdater, ControllerServiceWorkerInfo controllerInfo) {
    ...
    public static final class Stub extends Interface.Stub<DedicatedWorkerHostFactoryClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        DedicatedWorkerHostFactoryClientOnWorkerHostCreatedParams data = DedicatedWorkerHostFactoryClientOnWorkerHostCreatedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onWorkerHostCreated(data.browserInterfaceBroker, data.host);
                        return true;
                    case 1:
                        DedicatedWorkerHostFactoryClientOnScriptLoadStartedParams data2 = DedicatedWorkerHostFactoryClientOnScriptLoadStartedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onScriptLoadStarted(data2.serviceWorkerContainerInfo, data2.mainScriptLoadParams, data2.subresourceLoaderFactories, data2.subresourceLoaderUpdater, data2.controllerInfo);
                        return true;
                    case 2:
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DedicatedWorkerHostFactoryClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DedicatedWorkerHostFactoryClientOnWorkerHostCreatedParams extends Struct {
        ...
        public static DedicatedWorkerHostFactoryClientOnWorkerHostCreatedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DedicatedWorkerHostFactoryClientOnWorkerHostCreatedParams result = new DedicatedWorkerHostFactoryClientOnWorkerHostCreatedParams(elementsOrVersion);
                result.browserInterfaceBroker = (BrowserInterfaceBroker) decoder0.readServiceInterface(8, false, BrowserInterfaceBroker.MANAGER);
                result.host = (DedicatedWorkerHost) decoder0.readServiceInterface(16, false, DedicatedWorkerHost.MANAGER);
                return result;
            } finally {
    ...
    static final class DedicatedWorkerHostFactoryClientOnScriptLoadStartedParams extends Struct {
        ...
        public static DedicatedWorkerHostFactoryClientOnScriptLoadStartedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DedicatedWorkerHostFactoryClientOnScriptLoadStartedParams result = new DedicatedWorkerHostFactoryClientOnScriptLoadStartedParams(elementsOrVersion);
    ...
    static final class DedicatedWorkerHostFactoryClientOnScriptLoadStartFailedParams extends Struct {
        ...
        public static DedicatedWorkerHostFactoryClientOnScriptLoadStartFailedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DedicatedWorkerHostFactoryClientOnScriptLoadStartFailedParams result = new DedicatedWorkerHostFactoryClientOnScriptLoadStartFailedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

...
class DedicatedWorkerHostFactory_Internal {
    ...
    public static final Interface.Manager<DedicatedWorkerHostFactory, DedicatedWorkerHostFactory.Proxy> MANAGER = new Interface.Manager<DedicatedWorkerHostFactory, DedicatedWorkerHostFactory.Proxy>() { // from class: org.chromium.blink.mojom.DedicatedWorkerHostFactory_Internal.1
        ...
        public DedicatedWorkerHostFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements DedicatedWorkerHostFactory.Proxy {
        ...
        public void createWorkerHost(DedicatedWorkerToken token, Url scriptUrl, InterfaceRequest<BrowserInterfaceBroker> browserInterfaceBroker, InterfaceRequest<DedicatedWorkerHost> host, CreateWorkerHostResponse callback) {
            ...
            _message.host = host;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new DedicatedWorkerHostFactoryCreateWorkerHostResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.DedicatedWorkerHostFactory
        public void createWorkerHostAndStartScriptLoad(DedicatedWorkerToken token, Url scriptUrl, int credentialsMode, FetchClientSettingsObject outsideFetchClientSettingsObject, BlobUrlToken blobUrlToken, DedicatedWorkerHostFactoryClient client) {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        DedicatedWorkerHostFactoryCreateWorkerHostAndStartScriptLoadParams data = DedicatedWorkerHostFactoryCreateWorkerHostAndStartScriptLoadParams.deserialize(messageWithHeader.getPayload());
    ...
    public static final class DedicatedWorkerHostFactoryCreateWorkerHostResponseParams extends Struct {
        ...
        public static DedicatedWorkerHostFactoryCreateWorkerHostResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static DedicatedWorkerHostFactoryCreateWorkerHostResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DedicatedWorkerHostFactoryCreateWorkerHostResponseParams result = new DedicatedWorkerHostFactoryCreateWorkerHostResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static class DedicatedWorkerHostFactoryCreateWorkerHostResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.parentCoep);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class DedicatedWorkerHostFactoryCreateWorkerHostResponseParamsProxyToResponder implements DedicatedWorkerHostFactory.CreateWorkerHostResponse {
        ...
        DedicatedWorkerHostFactoryCreateWorkerHostResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
        ...
        public void call(CrossOriginEmbedderPolicy parentCoep) {

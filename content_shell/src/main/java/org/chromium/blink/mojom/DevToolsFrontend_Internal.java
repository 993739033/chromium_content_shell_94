...
class DevToolsFrontend_Internal {
    public static final Interface.Manager<DevToolsFrontend, DevToolsFrontend.Proxy> MANAGER = new Interface.Manager<DevToolsFrontend, DevToolsFrontend.Proxy>() { // from class: org.chromium.blink.mojom.DevToolsFrontend_Internal.1
        ...
        public DevToolsFrontend.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<DevToolsFrontend> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        DevToolsFrontendSetupDevToolsFrontendParams data = DevToolsFrontendSetupDevToolsFrontendParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setupDevToolsFrontend(data.apiScript, data.host);
                        return true;
                    case 1:
                        getImpl().setupDevToolsExtensionApi(DevToolsFrontendSetupDevToolsExtensionApiParams.deserialize(messageWithHeader.getPayload()).extensionApi);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DevToolsFrontend_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DevToolsFrontendSetupDevToolsFrontendParams extends Struct {
        ...
        public static DevToolsFrontendSetupDevToolsFrontendParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DevToolsFrontendSetupDevToolsFrontendParams result = new DevToolsFrontendSetupDevToolsFrontendParams(elementsOrVersion);
    ...
    static final class DevToolsFrontendSetupDevToolsExtensionApiParams extends Struct {
        ...
        public static DevToolsFrontendSetupDevToolsExtensionApiParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsFrontendSetupDevToolsExtensionApiParams result = new DevToolsFrontendSetupDevToolsExtensionApiParams(elementsOrVersion);

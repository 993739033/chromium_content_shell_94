...
import org.chromium.blink.mojom.DevToolsSessionHost;
...
class DevToolsSessionHost_Internal {
    ...
    public static final Interface.Manager<DevToolsSessionHost, DevToolsSessionHost.Proxy> MANAGER = new Interface.Manager<DevToolsSessionHost, DevToolsSessionHost.Proxy>() { // from class: org.chromium.blink.mojom.DevToolsSessionHost_Internal.1
        ...
        public DevToolsSessionHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements DevToolsSessionHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.DevToolsSessionHost
    ...
    public static final class Stub extends Interface.Stub<DevToolsSessionHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        DevToolsSessionHostDispatchProtocolResponseParams data = DevToolsSessionHostDispatchProtocolResponseParams.deserialize(messageWithHeader.getPayload());
                        getImpl().dispatchProtocolResponse(data.message, data.callId, data.updates);
                        return true;
                    case 1:
                        DevToolsSessionHostDispatchProtocolNotificationParams data2 = DevToolsSessionHostDispatchProtocolNotificationParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DevToolsSessionHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DevToolsSessionHostDispatchProtocolResponseParams extends Struct {
        ...
        public static DevToolsSessionHostDispatchProtocolResponseParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DevToolsSessionHostDispatchProtocolResponseParams result = new DevToolsSessionHostDispatchProtocolResponseParams(elementsOrVersion);
    ...
    static final class DevToolsSessionHostDispatchProtocolNotificationParams extends Struct {
        ...
        public static DevToolsSessionHostDispatchProtocolNotificationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsSessionHostDispatchProtocolNotificationParams result = new DevToolsSessionHostDispatchProtocolNotificationParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.message = DevToolsMessage.decode(decoder1);

...
import org.chromium.blink.mojom.DevToolsSession;
...
class DevToolsSession_Internal {
    ...
    public static final Interface.Manager<DevToolsSession, DevToolsSession.Proxy> MANAGER = new Interface.Manager<DevToolsSession, DevToolsSession.Proxy>() { // from class: org.chromium.blink.mojom.DevToolsSession_Internal.1
        ...
        public DevToolsSession.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements DevToolsSession.Proxy {
        ...
        @Override // org.chromium.blink.mojom.DevToolsSession
    ...
    public static final class Stub extends Interface.Stub<DevToolsSession> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        DevToolsSessionDispatchProtocolCommandParams data = DevToolsSessionDispatchProtocolCommandParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DevToolsSession_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DevToolsSessionDispatchProtocolCommandParams extends Struct {
        ...
        public static DevToolsSessionDispatchProtocolCommandParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DevToolsSessionDispatchProtocolCommandParams result = new DevToolsSessionDispatchProtocolCommandParams(elementsOrVersion);

...
class DisplayCutoutClient_Internal {
    public static final Interface.Manager<DisplayCutoutClient, DisplayCutoutClient.Proxy> MANAGER = new Interface.Manager<DisplayCutoutClient, DisplayCutoutClient.Proxy>() { // from class: org.chromium.blink.mojom.DisplayCutoutClient_Internal.1
        ...
        public DisplayCutoutClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements DisplayCutoutClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.DisplayCutoutClient
    ...
    public static final class Stub extends Interface.Stub<DisplayCutoutClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        DisplayCutoutClientSetSafeAreaParams data = DisplayCutoutClientSetSafeAreaParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DisplayCutoutClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DisplayCutoutClientSetSafeAreaParams extends Struct {
        ...
        public static DisplayCutoutClientSetSafeAreaParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DisplayCutoutClientSetSafeAreaParams result = new DisplayCutoutClientSetSafeAreaParams(elementsOrVersion);

...
import org.chromium.blink.mojom.DisplayCutoutHost;
...
class DisplayCutoutHost_Internal {
    public static final Interface.Manager<DisplayCutoutHost, DisplayCutoutHost.Proxy> MANAGER = new Interface.Manager<DisplayCutoutHost, DisplayCutoutHost.Proxy>() { // from class: org.chromium.blink.mojom.DisplayCutoutHost_Internal.1
        ...
        public DisplayCutoutHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements DisplayCutoutHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.DisplayCutoutHost
    ...
    public static final class Stub extends Interface.Stub<DisplayCutoutHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        DisplayCutoutHostNotifyViewportFitChangedParams data = DisplayCutoutHostNotifyViewportFitChangedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DisplayCutoutHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DisplayCutoutHostNotifyViewportFitChangedParams extends Struct {
        ...
        public static DisplayCutoutHostNotifyViewportFitChangedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DisplayCutoutHostNotifyViewportFitChangedParams result = new DisplayCutoutHostNotifyViewportFitChangedParams(elementsOrVersion);

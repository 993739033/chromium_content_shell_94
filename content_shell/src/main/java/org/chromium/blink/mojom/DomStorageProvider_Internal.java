...
import org.chromium.blink.mojom.DomStorageProvider;
...
class DomStorageProvider_Internal {
    ...
    public static final Interface.Manager<DomStorageProvider, DomStorageProvider.Proxy> MANAGER = new Interface.Manager<DomStorageProvider, DomStorageProvider.Proxy>() { // from class: org.chromium.blink.mojom.DomStorageProvider_Internal.1
        ...
        public DomStorageProvider.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements DomStorageProvider.Proxy {
        @Override
        ...
        @Override // org.chromium.blink.mojom.DomStorageProvider
    ...
    public static final class Stub extends Interface.Stub<DomStorageProvider> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(DomStorageProvider_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        DomStorageProviderBindDomStorageParams data = DomStorageProviderBindDomStorageParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DomStorageProvider_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DomStorageProviderBindDomStorageParams extends Struct {
        ...
        public static DomStorageProviderBindDomStorageParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DomStorageProviderBindDomStorageParams result = new DomStorageProviderBindDomStorageParams(elementsOrVersion);
                result.receiver = decoder0.readInterfaceRequest(8, false);
                result.client = (DomStorageClient) decoder0.readServiceInterface(12, false, DomStorageClient.MANAGER);
                return result;
            } finally {

...
class EmbeddedWorkerInstanceHost_Internal {
    ...
    public static final Interface.Manager<EmbeddedWorkerInstanceHost, EmbeddedWorkerInstanceHost.Proxy> MANAGER = new Interface.Manager<EmbeddedWorkerInstanceHost, EmbeddedWorkerInstanceHost.Proxy>() { // from class: org.chromium.blink.mojom.EmbeddedWorkerInstanceHost_Internal.1
        ...
        public EmbeddedWorkerInstanceHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements EmbeddedWorkerInstanceHost.Proxy {
        ...
        public void requestTermination(RequestTerminationResponse callback) {
        ...
        @Override // org.chromium.blink.mojom.EmbeddedWorkerInstanceHost
        public void onStarted(int status, boolean hasFetchHandler, int threadId, EmbeddedWorkerStartTiming startTiming) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        EmbeddedWorkerInstanceHostOnReadyForInspectionParams data = EmbeddedWorkerInstanceHostOnReadyForInspectionParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 4:
                        ...
                        return true;
                    case 5:
                        EmbeddedWorkerInstanceHostOnStartedParams data2 = EmbeddedWorkerInstanceHostOnStartedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onStarted(data2.status, data2.hasFetchHandler, data2.threadId, data2.startTiming);
                        return true;
                    case 6:
                        EmbeddedWorkerInstanceHostOnReportExceptionParams data3 = EmbeddedWorkerInstanceHostOnReportExceptionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onReportException(data3.errorMessage, data3.lineNumber, data3.columnNumber, data3.sourceUrl);
                        return true;
                    case 7:
                        EmbeddedWorkerInstanceHostOnReportConsoleMessageParams data4 = EmbeddedWorkerInstanceHostOnReportConsoleMessageParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onReportConsoleMessage(data4.source, data4.messageLevel, data4.message, data4.lineNumber, data4.sourceUrl);
                        return true;
                    case 8:

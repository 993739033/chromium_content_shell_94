...
import org.chromium.blink.mojom.FileSystemAccessDirectoryEntriesListener;
...
class FileSystemAccessDirectoryEntriesListener_Internal {
    ...
    public static final Interface.Manager<FileSystemAccessDirectoryEntriesListener, FileSystemAccessDirectoryEntriesListener.Proxy> MANAGER = new Interface.Manager<FileSystemAccessDirectoryEntriesListener, FileSystemAccessDirectoryEntriesListener.Proxy>() { // from class: org.chromium.blink.mojom.FileSystemAccessDirectoryEntriesListener_Internal.1
        ...
        public FileSystemAccessDirectoryEntriesListener.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements FileSystemAccessDirectoryEntriesListener.Proxy {
        ...
        @Override // org.chromium.blink.mojom.FileSystemAccessDirectoryEntriesListener
        public void didReadDirectory(FileSystemAccessError result, FileSystemAccessEntry[] entries, boolean hasMoreEntries) {
    ...
    public static final class Stub extends Interface.Stub<FileSystemAccessDirectoryEntriesListener> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(FileSystemAccessDirectoryEntriesListener_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams data = FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FileSystemAccessDirectoryEntriesListener_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams extends Struct {
        ...
        public static FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams result = new FileSystemAccessDirectoryEntriesListenerDidReadDirectoryParams(elementsOrVersion);

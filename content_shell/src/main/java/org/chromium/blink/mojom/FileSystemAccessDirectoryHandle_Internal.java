...
class FileSystemAccessDirectoryHandle_Internal {
    ...
    public static final Interface.Manager<FileSystemAccessDirectoryHandle, FileSystemAccessDirectoryHandle.Proxy> MANAGER = new Interface.Manager<FileSystemAccessDirectoryHandle, FileSystemAccessDirectoryHandle.Proxy>() { // from class: org.chromium.blink.mojom.FileSystemAccessDirectoryHandle_Internal.1
        ...
        public FileSystemAccessDirectoryHandle.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    private static final int REMOVE_ENTRY_ORDINAL = 6;
    private static final int REMOVE_ORDINAL = 5;
    private static final int REQUEST_PERMISSION_ORDINAL = 1;
    private static final int RESOLVE_ORDINAL = 7;
    private static final int TRANSFER_ORDINAL = 8;
    ...
    public static final class Proxy extends Interface.AbstractProxy implements FileSystemAccessDirectoryHandle.Proxy {
        ...
        public void getPermissionStatus(boolean writable, GetPermissionStatusResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new FileSystemAccessDirectoryHandleGetPermissionStatusResponseParamsForwardToCallback(callback));
        }
        ...
        public void requestPermission(boolean writable, RequestPermissionResponse callback) {
            ...
            _message.writable = writable;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new FileSystemAccessDirectoryHandleRequestPermissionResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemAccessDirectoryHandle
        public void getFile(String basename, boolean create, GetFileResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new FileSystemAccessDirectoryHandleGetFileResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemAccessDirectoryHandle
        public void getDirectory(String basename, boolean create, GetDirectoryResponse callback) {
            FileSystemAccessDirectoryHandleGetDirectoryParams _message = new FileSystemAccessDirectoryHandleGetDirectoryParams();
            _message.basename = basename;
            _message.create = create;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new FileSystemAccessDirectoryHandleGetDirectoryResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.FileSystemAccessDirectoryHandle
        public void remove(boolean recurse, RemoveResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new FileSystemAccessDirectoryHandleRemoveResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemAccessDirectoryHandle
        public void removeEntry(String basename, boolean recurse, RemoveEntryResponse callback) {
            FileSystemAccessDirectoryHandleRemoveEntryParams _message = new FileSystemAccessDirectoryHandleRemoveEntryParams();
            _message.basename = basename;
            _message.recurse = recurse;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new FileSystemAccessDirectoryHandleRemoveEntryResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemAccessDirectoryHandle
        public void resolve(FileSystemAccessTransferToken possibleChild, ResolveResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(7, 1, 0L)), new FileSystemAccessDirectoryHandleResolveResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<FileSystemAccessDirectoryHandle> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(FileSystemAccessDirectoryHandle_Internal.MANAGER, messageWithHeader);
                    case 4:
                        FileSystemAccessDirectoryHandleGetEntriesParams data = FileSystemAccessDirectoryHandleGetEntriesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getEntries(data.listener);
                        return true;
                    case 8:
                        FileSystemAccessDirectoryHandleTransferParams data2 = FileSystemAccessDirectoryHandleTransferParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FileSystemAccessDirectoryHandle_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        FileSystemAccessDirectoryHandleGetPermissionStatusParams data = FileSystemAccessDirectoryHandleGetPermissionStatusParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        FileSystemAccessDirectoryHandleRequestPermissionParams data2 = FileSystemAccessDirectoryHandleRequestPermissionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().requestPermission(data2.writable, new FileSystemAccessDirectoryHandleRequestPermissionResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        FileSystemAccessDirectoryHandleGetFileParams data3 = FileSystemAccessDirectoryHandleGetFileParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getFile(data3.basename, data3.create, new FileSystemAccessDirectoryHandleGetFileResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        FileSystemAccessDirectoryHandleGetDirectoryParams data4 = FileSystemAccessDirectoryHandleGetDirectoryParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getDirectory(data4.basename, data4.create, new FileSystemAccessDirectoryHandleGetDirectoryResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                    default:
                        return false;
                    case 5:
                        FileSystemAccessDirectoryHandleRemoveParams data5 = FileSystemAccessDirectoryHandleRemoveParams.deserialize(messageWithHeader.getPayload());
                        getImpl().remove(data5.recurse, new FileSystemAccessDirectoryHandleRemoveResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        FileSystemAccessDirectoryHandleRemoveEntryParams data6 = FileSystemAccessDirectoryHandleRemoveEntryParams.deserialize(messageWithHeader.getPayload());
                        getImpl().removeEntry(data6.basename, data6.recurse, new FileSystemAccessDirectoryHandleRemoveEntryResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 7:
                        FileSystemAccessDirectoryHandleResolveParams data7 = FileSystemAccessDirectoryHandleResolveParams.deserialize(messageWithHeader.getPayload());
                        getImpl().resolve(data7.possibleChild, new FileSystemAccessDirectoryHandleResolveResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class FileSystemAccessDirectoryHandleGetPermissionStatusParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetPermissionStatusParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessDirectoryHandleGetPermissionStatusParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                FileSystemAccessDirectoryHandleGetPermissionStatusParams result = new FileSystemAccessDirectoryHandleGetPermissionStatusParams(elementsOrVersion);
    ...
    public static final class FileSystemAccessDirectoryHandleGetPermissionStatusResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetPermissionStatusResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessDirectoryHandleGetPermissionStatusResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleGetPermissionStatusResponseParams result = new FileSystemAccessDirectoryHandleGetPermissionStatusResponseParams(elementsOrVersion);
    ...
    static class FileSystemAccessDirectoryHandleGetPermissionStatusResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.GetPermissionStatusResponse {
        ...
        FileSystemAccessDirectoryHandleGetPermissionStatusResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class FileSystemAccessDirectoryHandleRequestPermissionParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleRequestPermissionParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static FileSystemAccessDirectoryHandleRequestPermissionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleRequestPermissionParams result = new FileSystemAccessDirectoryHandleRequestPermissionParams(elementsOrVersion);
                result.writable = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    public static final class FileSystemAccessDirectoryHandleRequestPermissionResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleRequestPermissionResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessDirectoryHandleRequestPermissionResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleRequestPermissionResponseParams result = new FileSystemAccessDirectoryHandleRequestPermissionResponseParams(elementsOrVersion);
    ...
    static class FileSystemAccessDirectoryHandleRequestPermissionResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.RequestPermissionResponse {
        ...
        FileSystemAccessDirectoryHandleRequestPermissionResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class FileSystemAccessDirectoryHandleGetFileParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetFileParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleGetFileParams result = new FileSystemAccessDirectoryHandleGetFileParams(elementsOrVersion);
    ...
    public static final class FileSystemAccessDirectoryHandleGetFileResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetFileResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static FileSystemAccessDirectoryHandleGetFileResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleGetFileResponseParams result = new FileSystemAccessDirectoryHandleGetFileResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = FileSystemAccessError.decode(decoder1);
                result.file = (FileSystemAccessFileHandle) decoder0.readServiceInterface(16, true, FileSystemAccessFileHandle.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static class FileSystemAccessDirectoryHandleGetFileResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.GetFileResponse {
        ...
        FileSystemAccessDirectoryHandleGetFileResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class FileSystemAccessDirectoryHandleGetDirectoryParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetDirectoryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleGetDirectoryParams result = new FileSystemAccessDirectoryHandleGetDirectoryParams(elementsOrVersion);
                result.basename = decoder0.readString(8, false);
                result.create = decoder0.readBoolean(16, 0);
                return result;
            } finally {
    ...
    public static final class FileSystemAccessDirectoryHandleGetDirectoryResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetDirectoryResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessDirectoryHandleGetDirectoryResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleGetDirectoryResponseParams result = new FileSystemAccessDirectoryHandleGetDirectoryResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = FileSystemAccessError.decode(decoder1);
    ...
    static class FileSystemAccessDirectoryHandleGetDirectoryResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.GetDirectoryResponse {
        ...
        FileSystemAccessDirectoryHandleGetDirectoryResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class FileSystemAccessDirectoryHandleGetEntriesParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleGetEntriesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleGetEntriesParams result = new FileSystemAccessDirectoryHandleGetEntriesParams(elementsOrVersion);
                result.listener = (FileSystemAccessDirectoryEntriesListener) decoder0.readServiceInterface(8, false, FileSystemAccessDirectoryEntriesListener.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class FileSystemAccessDirectoryHandleRemoveParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleRemoveParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleRemoveParams result = new FileSystemAccessDirectoryHandleRemoveParams(elementsOrVersion);
    ...
    public static final class FileSystemAccessDirectoryHandleRemoveResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleRemoveResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleRemoveResponseParams result = new FileSystemAccessDirectoryHandleRemoveResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = FileSystemAccessError.decode(decoder1);
                return result;
            } finally {
    ...
    static class FileSystemAccessDirectoryHandleRemoveResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final FileSystemAccessDirectoryHandle.RemoveResponse mCallback;

        FileSystemAccessDirectoryHandleRemoveResponseParamsForwardToCallback(FileSystemAccessDirectoryHandle.RemoveResponse callback) {
            this.mCallback = callback;
        }
    ...
    /* loaded from: classes2.dex */
    static class FileSystemAccessDirectoryHandleRemoveResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.RemoveResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        FileSystemAccessDirectoryHandleRemoveResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class FileSystemAccessDirectoryHandleRemoveEntryParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleRemoveEntryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleRemoveEntryParams result = new FileSystemAccessDirectoryHandleRemoveEntryParams(elementsOrVersion);
                result.basename = decoder0.readString(8, false);
    ...
    public static final class FileSystemAccessDirectoryHandleRemoveEntryResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleRemoveEntryResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessDirectoryHandleRemoveEntryResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleRemoveEntryResponseParams result = new FileSystemAccessDirectoryHandleRemoveEntryResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = FileSystemAccessError.decode(decoder1);
                return result;
            } finally {
    ...
    static class FileSystemAccessDirectoryHandleRemoveEntryResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.RemoveEntryResponse {
        ...
        FileSystemAccessDirectoryHandleRemoveEntryResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class FileSystemAccessDirectoryHandleResolveParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleResolveParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleResolveParams result = new FileSystemAccessDirectoryHandleResolveParams(elementsOrVersion);
                result.possibleChild = (FileSystemAccessTransferToken) decoder0.readServiceInterface(8, false, FileSystemAccessTransferToken.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class FileSystemAccessDirectoryHandleResolveResponseParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleResolveResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static FileSystemAccessDirectoryHandleResolveResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleResolveResponseParams result = new FileSystemAccessDirectoryHandleResolveResponseParams(elementsOrVersion);
    ...
    static class FileSystemAccessDirectoryHandleResolveResponseParamsProxyToResponder implements FileSystemAccessDirectoryHandle.ResolveResponse {
        ...
        FileSystemAccessDirectoryHandleResolveResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class FileSystemAccessDirectoryHandleTransferParams extends Struct {
        ...
        public static FileSystemAccessDirectoryHandleTransferParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessDirectoryHandleTransferParams result = new FileSystemAccessDirectoryHandleTransferParams(elementsOrVersion);

...
public final class FileSystemAccessHandle extends Union {
    ...
    public static final FileSystemAccessHandle decode(Decoder decoder0, int offset) {
        ...
        switch (dataHeader.elementsOrVersion) {
            case 0:
                result.mFile = (FileSystemAccessFileHandle) decoder0.readServiceInterface(offset + 8, false, FileSystemAccessFileHandle.MANAGER);
                result.mTag = 0;
                break;
            case 1:
                result.mDirectory = (FileSystemAccessDirectoryHandle) decoder0.readServiceInterface(offset + 8, false, FileSystemAccessDirectoryHandle.MANAGER);
                result.mTag = 1;
                break;
        }
        return result;

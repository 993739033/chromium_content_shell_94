...
class FileSystemAccessTransferToken_Internal {
    ...
    public static final Interface.Manager<FileSystemAccessTransferToken, FileSystemAccessTransferToken.Proxy> MANAGER = new Interface.Manager<FileSystemAccessTransferToken, FileSystemAccessTransferToken.Proxy>() { // from class: org.chromium.blink.mojom.FileSystemAccessTransferToken_Internal.1
        ...
        public FileSystemAccessTransferToken.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements FileSystemAccessTransferToken.Proxy {
        ...
        public void getInternalId(GetInternalIdResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new FileSystemAccessTransferTokenGetInternalIdResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<FileSystemAccessTransferToken> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(FileSystemAccessTransferToken_Internal.MANAGER, messageWithHeader);
                    case 1:
                        FileSystemAccessTransferTokenCloneParams data = FileSystemAccessTransferTokenCloneParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FileSystemAccessTransferToken_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
    ...
    static final class FileSystemAccessTransferTokenGetInternalIdParams extends Struct {
        ...
        public static FileSystemAccessTransferTokenGetInternalIdParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FileSystemAccessTransferTokenGetInternalIdParams result = new FileSystemAccessTransferTokenGetInternalIdParams(elementsOrVersion);
                return result;
            } finally {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class FileSystemAccessTransferTokenGetInternalIdResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static FileSystemAccessTransferTokenGetInternalIdResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static FileSystemAccessTransferTokenGetInternalIdResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FileSystemAccessTransferTokenGetInternalIdResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessTransferTokenGetInternalIdResponseParams result = new FileSystemAccessTransferTokenGetInternalIdResponseParams(elementsOrVersion);
    ...
    static class FileSystemAccessTransferTokenGetInternalIdResponseParamsProxyToResponder implements FileSystemAccessTransferToken.GetInternalIdResponse {
        ...
        FileSystemAccessTransferTokenGetInternalIdResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class FileSystemAccessTransferTokenCloneParams extends Struct {
        ...
        public static FileSystemAccessTransferTokenCloneParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemAccessTransferTokenCloneParams result = new FileSystemAccessTransferTokenCloneParams(elementsOrVersion);

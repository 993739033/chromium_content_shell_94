...
import org.chromium.blink.mojom.FileSystemCancellableOperation;
...
class FileSystemCancellableOperation_Internal {
    ...
    public static final Interface.Manager<FileSystemCancellableOperation, FileSystemCancellableOperation.Proxy> MANAGER = new Interface.Manager<FileSystemCancellableOperation, FileSystemCancellableOperation.Proxy>() { // from class: org.chromium.blink.mojom.FileSystemCancellableOperation_Internal.1
        ...
        public FileSystemCancellableOperation.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements FileSystemCancellableOperation.Proxy {
        ...
        @Override // org.chromium.blink.mojom.FileSystemCancellableOperation
        public void cancel(CancelResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new FileSystemCancellableOperationCancelResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<FileSystemCancellableOperation> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FileSystemCancellableOperation_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
    ...
    static final class FileSystemCancellableOperationCancelParams extends Struct {
        ...
        public static FileSystemCancellableOperationCancelParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FileSystemCancellableOperationCancelParams result = new FileSystemCancellableOperationCancelParams(elementsOrVersion);
                return result;
            } finally {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class FileSystemCancellableOperationCancelResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static FileSystemCancellableOperationCancelResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemCancellableOperationCancelResponseParams result = new FileSystemCancellableOperationCancelResponseParams(elementsOrVersion);

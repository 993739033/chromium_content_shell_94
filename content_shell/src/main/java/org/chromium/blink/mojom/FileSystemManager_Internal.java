...
class FileSystemManager_Internal {
    ...
    public static final Interface.Manager<FileSystemManager, FileSystemManager.Proxy> MANAGER = new Interface.Manager<FileSystemManager, FileSystemManager.Proxy>() { // from class: org.chromium.blink.mojom.FileSystemManager_Internal.1
        ...
        public FileSystemManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements FileSystemManager.Proxy {
        ...
        public void open(Origin origin, int fileSystemType, OpenResponse callback) {
            FileSystemManagerOpenParams _message = new FileSystemManagerOpenParams();
            _message.origin = origin;
            _message.fileSystemType = fileSystemType;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new FileSystemManagerOpenResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void resolveUrl(Url filesystemUrl, ResolveUrlResponse callback) {
            FileSystemManagerResolveUrlParams _message = new FileSystemManagerResolveUrlParams();
            _message.filesystemUrl = filesystemUrl;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new FileSystemManagerResolveUrlResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void move(Url srcPath, Url destPath, MoveResponse callback) {
            FileSystemManagerMoveParams _message = new FileSystemManagerMoveParams();
            _message.srcPath = srcPath;
            _message.destPath = destPath;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new FileSystemManagerMoveResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void copy(Url srcPath, Url destPath, CopyResponse callback) {
            FileSystemManagerCopyParams _message = new FileSystemManagerCopyParams();
            _message.srcPath = srcPath;
            _message.destPath = destPath;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new FileSystemManagerCopyResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void remove(Url path, boolean recursive, RemoveResponse callback) {
            FileSystemManagerRemoveParams _message = new FileSystemManagerRemoveParams();
            _message.path = path;
            _message.recursive = recursive;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new FileSystemManagerRemoveResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void readMetadata(Url path, ReadMetadataResponse callback) {
            FileSystemManagerReadMetadataParams _message = new FileSystemManagerReadMetadataParams();
            _message.path = path;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new FileSystemManagerReadMetadataResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void create(Url path, boolean exclusive, boolean isDirectory, boolean recursive, CreateResponse callback) {
            ...
            _message.recursive = recursive;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new FileSystemManagerCreateResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void exists(Url path, boolean isDirectory, ExistsResponse callback) {
            FileSystemManagerExistsParams _message = new FileSystemManagerExistsParams();
            _message.path = path;
            _message.isDirectory = isDirectory;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(7, 1, 0L)), new FileSystemManagerExistsResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.FileSystemManager
        public void readDirectorySync(Url path, ReadDirectorySyncResponse callback) {
            FileSystemManagerReadDirectorySyncParams _message = new FileSystemManagerReadDirectorySyncParams();
            _message.path = path;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(9, 1, 0L)), new FileSystemManagerReadDirectorySyncResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void write(Url filePath, String blobUuid, long position, InterfaceRequest<FileSystemCancellableOperation> opReceiver, FileSystemOperationListener listener) {
        ...
        @Override // org.chromium.blink.mojom.FileSystemManager
        public void writeSync(Url filePath, String blobUuid, long position, WriteSyncResponse callback) {
            FileSystemManagerWriteSyncParams _message = new FileSystemManagerWriteSyncParams();
            _message.filePath = filePath;
            _message.blobUuid = blobUuid;
            _message.position = position;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(11, 1, 0L)), new FileSystemManagerWriteSyncResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void truncate(Url filePath, long length, InterfaceRequest<FileSystemCancellableOperation> opReceiver, TruncateResponse callback) {
            FileSystemManagerTruncateParams _message = new FileSystemManagerTruncateParams();
            _message.filePath = filePath;
            _message.length = length;
            _message.opReceiver = opReceiver;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(12, 1, 0L)), new FileSystemManagerTruncateResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void truncateSync(Url filePath, long length, TruncateSyncResponse callback) {
            FileSystemManagerTruncateSyncParams _message = new FileSystemManagerTruncateSyncParams();
            _message.filePath = filePath;
            _message.length = length;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(13, 1, 0L)), new FileSystemManagerTruncateSyncResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void createSnapshotFile(Url filePath, CreateSnapshotFileResponse callback) {
            FileSystemManagerCreateSnapshotFileParams _message = new FileSystemManagerCreateSnapshotFileParams();
            _message.filePath = filePath;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(14, 1, 0L)), new FileSystemManagerCreateSnapshotFileResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.FileSystemManager
        public void getPlatformPath(Url filePath, GetPlatformPathResponse callback) {
            FileSystemManagerGetPlatformPathParams _message = new FileSystemManagerGetPlatformPathParams();
            _message.filePath = filePath;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(15, 1, 0L)), new FileSystemManagerGetPlatformPathResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<FileSystemManager> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 8:
                        FileSystemManagerReadDirectoryParams data = FileSystemManagerReadDirectoryParams.deserialize(messageWithHeader.getPayload());
                        getImpl().readDirectory(data.path, data.listener);
                        return true;
                    case 10:
                        FileSystemManagerWriteParams data2 = FileSystemManagerWriteParams.deserialize(messageWithHeader.getPayload());
                        getImpl().write(data2.filePath, data2.blobUuid, data2.position, data2.opReceiver, data2.listener);
                        return true;
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FileSystemManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        FileSystemManagerOpenParams data = FileSystemManagerOpenParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        getImpl().resolveUrl(FileSystemManagerResolveUrlParams.deserialize(messageWithHeader.getPayload()).filesystemUrl, new FileSystemManagerResolveUrlResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        FileSystemManagerMoveParams data2 = FileSystemManagerMoveParams.deserialize(messageWithHeader.getPayload());
                        getImpl().move(data2.srcPath, data2.destPath, new FileSystemManagerMoveResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        FileSystemManagerCopyParams data3 = FileSystemManagerCopyParams.deserialize(messageWithHeader.getPayload());
                        getImpl().copy(data3.srcPath, data3.destPath, new FileSystemManagerCopyResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        FileSystemManagerRemoveParams data4 = FileSystemManagerRemoveParams.deserialize(messageWithHeader.getPayload());
                        getImpl().remove(data4.path, data4.recursive, new FileSystemManagerRemoveResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 5:
                        getImpl().readMetadata(FileSystemManagerReadMetadataParams.deserialize(messageWithHeader.getPayload()).path, new FileSystemManagerReadMetadataResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        FileSystemManagerCreateParams data5 = FileSystemManagerCreateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().create(data5.path, data5.exclusive, data5.isDirectory, data5.recursive, new FileSystemManagerCreateResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 7:
                        FileSystemManagerExistsParams data6 = FileSystemManagerExistsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().exists(data6.path, data6.isDirectory, new FileSystemManagerExistsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 8:
                    case 10:
                    default:
                        return false;
                    case 9:
                        getImpl().readDirectorySync(FileSystemManagerReadDirectorySyncParams.deserialize(messageWithHeader.getPayload()).path, new FileSystemManagerReadDirectorySyncResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 11:
                        FileSystemManagerWriteSyncParams data7 = FileSystemManagerWriteSyncParams.deserialize(messageWithHeader.getPayload());
                        getImpl().writeSync(data7.filePath, data7.blobUuid, data7.position, new FileSystemManagerWriteSyncResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 12:
                        FileSystemManagerTruncateParams data8 = FileSystemManagerTruncateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().truncate(data8.filePath, data8.length, data8.opReceiver, new FileSystemManagerTruncateResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 13:
                        FileSystemManagerTruncateSyncParams data9 = FileSystemManagerTruncateSyncParams.deserialize(messageWithHeader.getPayload());
                        getImpl().truncateSync(data9.filePath, data9.length, new FileSystemManagerTruncateSyncResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 14:
                        getImpl().createSnapshotFile(FileSystemManagerCreateSnapshotFileParams.deserialize(messageWithHeader.getPayload()).filePath, new FileSystemManagerCreateSnapshotFileResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 15:
                        getImpl().getPlatformPath(FileSystemManagerGetPlatformPathParams.deserialize(messageWithHeader.getPayload()).filePath, new FileSystemManagerGetPlatformPathResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    public static final class FileSystemManagerOpenResponseParams extends Struct {
        ...
        public static FileSystemManagerOpenResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerOpenResponseParams result = new FileSystemManagerOpenResponseParams(elementsOrVersion);
    ...
    static final class FileSystemManagerResolveUrlParams extends Struct {
        ...
        public static FileSystemManagerResolveUrlParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerResolveUrlParams result = new FileSystemManagerResolveUrlParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class FileSystemManagerResolveUrlResponseParams extends Struct {
        ...
        public static FileSystemManagerResolveUrlResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerResolveUrlResponseParams result = new FileSystemManagerResolveUrlResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class FileSystemManagerMoveResponseParams extends Struct {
        ...
        public static FileSystemManagerMoveResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerMoveResponseParams result = new FileSystemManagerMoveResponseParams(elementsOrVersion);
    ...
    public static final class FileSystemManagerCopyResponseParams extends Struct {
        ...
        public static FileSystemManagerCopyResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerCopyResponseParams result = new FileSystemManagerCopyResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.errorCode = readInt;
                FileError.validate(readInt);
                result.errorCode = FileError.toKnownValue(result.errorCode);
    ...
    public static final class FileSystemManagerRemoveResponseParams extends Struct {
        ...
        public static FileSystemManagerRemoveResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerRemoveResponseParams result = new FileSystemManagerRemoveResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.errorCode = readInt;
                FileError.validate(readInt);
                result.errorCode = FileError.toKnownValue(result.errorCode);
    ...
    static final class FileSystemManagerReadMetadataParams extends Struct {
        ...
        public static FileSystemManagerReadMetadataParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerReadMetadataParams result = new FileSystemManagerReadMetadataParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.path = Url.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class FileSystemManagerReadMetadataResponseParams extends Struct {
        ...
        public static FileSystemManagerReadMetadataResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerReadMetadataResponseParams result = new FileSystemManagerReadMetadataResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class FileSystemManagerCreateResponseParams extends Struct {
        ...
        public static FileSystemManagerCreateResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerCreateResponseParams result = new FileSystemManagerCreateResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.errorCode = readInt;
                FileError.validate(readInt);
                result.errorCode = FileError.toKnownValue(result.errorCode);
    ...
    public static final class FileSystemManagerExistsResponseParams extends Struct {
        ...
        public static FileSystemManagerExistsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerExistsResponseParams result = new FileSystemManagerExistsResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.errorCode = readInt;
                FileError.validate(readInt);
                result.errorCode = FileError.toKnownValue(result.errorCode);
    ...
    static final class FileSystemManagerReadDirectoryParams extends Struct {
        ...
        public static FileSystemManagerReadDirectoryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerReadDirectoryParams result = new FileSystemManagerReadDirectoryParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.path = Url.decode(decoder1);
    ...
    static final class FileSystemManagerReadDirectorySyncParams extends Struct {
        ...
        public static FileSystemManagerReadDirectorySyncParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerReadDirectorySyncParams result = new FileSystemManagerReadDirectorySyncParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.path = Url.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class FileSystemManagerReadDirectorySyncResponseParams extends Struct {
        ...
        public static FileSystemManagerReadDirectorySyncResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerReadDirectorySyncResponseParams result = new FileSystemManagerReadDirectorySyncResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class FileSystemManagerWriteSyncParams extends Struct {
        ...
        public static FileSystemManagerWriteSyncParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerWriteSyncParams result = new FileSystemManagerWriteSyncParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.filePath = Url.decode(decoder1);
                result.blobUuid = decoder0.readString(16, false);
                result.position = decoder0.readLong(24);
    ...
    public static final class FileSystemManagerWriteSyncResponseParams extends Struct {
        ...
        public static FileSystemManagerWriteSyncResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerWriteSyncResponseParams result = new FileSystemManagerWriteSyncResponseParams(elementsOrVersion);
    ...
    static final class FileSystemManagerTruncateParams extends Struct {
        ...
        public static FileSystemManagerTruncateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerTruncateParams result = new FileSystemManagerTruncateParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.filePath = Url.decode(decoder1);
    ...
    public static final class FileSystemManagerTruncateResponseParams extends Struct {
        ...
        public static FileSystemManagerTruncateResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerTruncateResponseParams result = new FileSystemManagerTruncateResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.errorCode = readInt;
                FileError.validate(readInt);
                result.errorCode = FileError.toKnownValue(result.errorCode);
    ...
    static final class FileSystemManagerTruncateSyncParams extends Struct {
        ...
        public static FileSystemManagerTruncateSyncParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerTruncateSyncParams result = new FileSystemManagerTruncateSyncParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.filePath = Url.decode(decoder1);
                result.length = decoder0.readLong(16);
                return result;
    ...
    public static final class FileSystemManagerTruncateSyncResponseParams extends Struct {
        ...
        public static FileSystemManagerTruncateSyncResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerTruncateSyncResponseParams result = new FileSystemManagerTruncateSyncResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.errorCode = readInt;
                FileError.validate(readInt);
                result.errorCode = FileError.toKnownValue(result.errorCode);
    ...
    static final class FileSystemManagerCreateSnapshotFileParams extends Struct {
        ...
        public static FileSystemManagerCreateSnapshotFileParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerCreateSnapshotFileParams result = new FileSystemManagerCreateSnapshotFileParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.filePath = Url.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class FileSystemManagerCreateSnapshotFileResponseParams extends Struct {
        ...
        public static FileSystemManagerCreateSnapshotFileResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerCreateSnapshotFileResponseParams result = new FileSystemManagerCreateSnapshotFileResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.fileInfo = FileInfo.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, false);
    ...
    static final class FileSystemManagerGetPlatformPathParams extends Struct {
        ...
        public static FileSystemManagerGetPlatformPathParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerGetPlatformPathParams result = new FileSystemManagerGetPlatformPathParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.filePath = Url.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class FileSystemManagerGetPlatformPathResponseParams extends Struct {
        ...
        public static FileSystemManagerGetPlatformPathResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemManagerGetPlatformPathResponseParams result = new FileSystemManagerGetPlatformPathResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static class FileSystemManagerGetPlatformPathResponseParamsProxyToResponder implements FileSystemManager.GetPlatformPathResponse {
        ...
        public void call(FilePath platformPath) {
            ...
            _response.platformPath = platformPath;
            ServiceMessage _message = _response.serializeWithHeader(this.mCore, new MessageHeader(15, 6, this.mRequestId));
            this.mMessageReceiver.accept(_message);
        }
    }
}

...
class FileSystemOperationListener_Internal {
    ...
    public static final Interface.Manager<FileSystemOperationListener, FileSystemOperationListener.Proxy> MANAGER = new Interface.Manager<FileSystemOperationListener, FileSystemOperationListener.Proxy>() { // from class: org.chromium.blink.mojom.FileSystemOperationListener_Internal.1
        ...
        public FileSystemOperationListener.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<FileSystemOperationListener> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        FileSystemOperationListenerResultsRetrievedParams data = FileSystemOperationListenerResultsRetrievedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().resultsRetrieved(data.entries, data.hasMore);
                        return true;
                    case 1:
                        FileSystemOperationListenerDidWriteParams data2 = FileSystemOperationListenerDidWriteParams.deserialize(messageWithHeader.getPayload());
                        getImpl().didWrite(data2.byteCount, data2.complete);
                        return true;
                    case 2:
                        getImpl().errorOccurred(FileSystemOperationListenerErrorOccurredParams.deserialize(messageWithHeader.getPayload()).errorCode);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FileSystemOperationListener_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class FileSystemOperationListenerResultsRetrievedParams extends Struct {
        ...
        public static FileSystemOperationListenerResultsRetrievedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FileSystemOperationListenerResultsRetrievedParams result = new FileSystemOperationListenerResultsRetrievedParams(elementsOrVersion);
    ...
    static final class FileSystemOperationListenerDidWriteParams extends Struct {
        ...
        public static FileSystemOperationListenerDidWriteParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemOperationListenerDidWriteParams result = new FileSystemOperationListenerDidWriteParams(elementsOrVersion);
    ...
    static final class FileSystemOperationListenerErrorOccurredParams extends Struct {
        ...
        public static FileSystemOperationListenerErrorOccurredParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FileSystemOperationListenerErrorOccurredParams result = new FileSystemOperationListenerErrorOccurredParams(elementsOrVersion);

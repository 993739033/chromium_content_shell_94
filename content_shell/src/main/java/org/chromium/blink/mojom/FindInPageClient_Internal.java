...
class FindInPageClient_Internal {
    public static final Interface.Manager<FindInPageClient, FindInPageClient.Proxy> MANAGER = new Interface.Manager<FindInPageClient, FindInPageClient.Proxy>() { // from class: org.chromium.blink.mojom.FindInPageClient_Internal.1
        ...
        public FindInPageClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements FindInPageClient.Proxy {
    ...
    public static final class Stub extends Interface.Stub<FindInPageClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        FindInPageClientSetNumberOfMatchesParams data = FindInPageClientSetNumberOfMatchesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setNumberOfMatches(data.requestId, data.numberOfMatches, data.updateType);
                        return true;
                    case 1:
                        FindInPageClientSetActiveMatchParams data2 = FindInPageClientSetActiveMatchParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setActiveMatch(data2.requestId, data2.activeMatchRect, data2.activeMatchOrdinal, data2.updateType);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FindInPageClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class FindInPageClientSetNumberOfMatchesParams extends Struct {
        ...
        public static FindInPageClientSetNumberOfMatchesParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FindInPageClientSetNumberOfMatchesParams result = new FindInPageClientSetNumberOfMatchesParams(elementsOrVersion);
    ...
    static final class FindInPageClientSetActiveMatchParams extends Struct {
        ...
        public static FindInPageClientSetActiveMatchParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FindInPageClientSetActiveMatchParams result = new FindInPageClientSetActiveMatchParams(elementsOrVersion);
                result.requestId = decoder0.readInt(8);

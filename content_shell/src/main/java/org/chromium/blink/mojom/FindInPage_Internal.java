...
class FindInPage_Internal {
    ...
    public static final Interface.Manager<FindInPage, FindInPage.Proxy> MANAGER = new Interface.Manager<FindInPage, FindInPage.Proxy>() { // from class: org.chromium.blink.mojom.FindInPage_Internal.1
        ...
        public FindInPage.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements FindInPage.Proxy {
        ...
        @Override // org.chromium.blink.mojom.FindInPage
        public void getNearestFindResult(PointF point, GetNearestFindResultResponse callback) {
        ...
        @Override // org.chromium.blink.mojom.FindInPage
        public void findMatchRects(int currentVersion, FindMatchRectsResponse callback) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().stopFinding(FindInPageStopFindingParams.deserialize(messageWithHeader.getPayload()).action);
                        return true;
                    case 2:
                        ...
                        return true;
                    case 4:
                        FindInPageActivateNearestFindResultParams data2 = FindInPageActivateNearestFindResultParams.deserialize(messageWithHeader.getPayload());

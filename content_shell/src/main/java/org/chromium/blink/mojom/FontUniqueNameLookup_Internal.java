...
import org.chromium.blink.mojom.FontUniqueNameLookup;
...
class FontUniqueNameLookup_Internal {
    ...
    public static final Interface.Manager<FontUniqueNameLookup, FontUniqueNameLookup.Proxy> MANAGER = new Interface.Manager<FontUniqueNameLookup, FontUniqueNameLookup.Proxy>() { // from class: org.chromium.blink.mojom.FontUniqueNameLookup_Internal.1
        ...
        public FontUniqueNameLookup.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements FontUniqueNameLookup.Proxy {
        ...
        @Override // org.chromium.blink.mojom.FontUniqueNameLookup
        public void getUniqueNameLookupTableIfAvailable(GetUniqueNameLookupTableIfAvailableResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableResponseParamsForwardToCallback(callback));
        }
        ...
        public void getUniqueNameLookupTable(GetUniqueNameLookupTableResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new FontUniqueNameLookupGetUniqueNameLookupTableResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<FontUniqueNameLookup> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FontUniqueNameLookup_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
    ...
    static final class FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableParams extends Struct {
        ...
        public static FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableParams result = new FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableParams(elementsOrVersion);
                return result;
            } finally {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableResponseParams result = new FontUniqueNameLookupGetUniqueNameLookupTableIfAvailableResponseParams(elementsOrVersion);
    ...
    static final class FontUniqueNameLookupGetUniqueNameLookupTableParams extends Struct {
        ...
        public static FontUniqueNameLookupGetUniqueNameLookupTableParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FontUniqueNameLookupGetUniqueNameLookupTableParams result = new FontUniqueNameLookupGetUniqueNameLookupTableParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class FontUniqueNameLookupGetUniqueNameLookupTableResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static FontUniqueNameLookupGetUniqueNameLookupTableResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FontUniqueNameLookupGetUniqueNameLookupTableResponseParams result = new FontUniqueNameLookupGetUniqueNameLookupTableResponseParams(elementsOrVersion);

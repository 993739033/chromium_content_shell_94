...
public final class FrameState extends Struct {
    ...
    public String16 appHistoryId;
    public String16 appHistoryKey;
    public String16 appHistoryState;
    ...
    static {
        DataHeader[] dataHeaderArr = {new DataHeader(96, 0), new DataHeader(104, 2), new DataHeader(120, 3), new DataHeader(128, 4)};
    ...
    public static FrameState decode(Decoder decoder0) {
        ...
        try {
            ...
            if (elementsOrVersion >= 3) {
                ...
                result.appHistoryKey = String16.decode(decoder19);
                Decoder decoder110 = decoder0.readPointer(112, true);
                result.appHistoryId = String16.decode(decoder110);
            }
            if (elementsOrVersion >= 4) {
                Decoder decoder111 = decoder0.readPointer(120, true);
                result.appHistoryState = String16.decode(decoder111);
            }
            return result;
        } finally {
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode((Struct) this.appHistoryKey, 104, true);
        encoder0.encode((Struct) this.appHistoryId, 112, true);
        encoder0.encode((Struct) this.appHistoryState, 120, true);
    }
}

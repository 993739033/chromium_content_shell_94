...
class FrameWidgetHost_Internal {
    ...
    public static final Interface.Manager<FrameWidgetHost, FrameWidgetHost.Proxy> MANAGER = new Interface.Manager<FrameWidgetHost, FrameWidgetHost.Proxy>() { // from class: org.chromium.blink.mojom.FrameWidgetHost_Internal.1
        ...
        public FrameWidgetHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements FrameWidgetHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.FrameWidgetHost
        public void startDragging(DragData dragData, AllowedDragOperations operationsAllowed, BitmapN32 image, Vector2d bitmapOffsetInDip, DragEventSourceInfo eventInfo) {
    ...
    public static final class Stub extends Interface.Stub<FrameWidgetHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(FrameWidgetHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams data = FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams.deserialize(messageWithHeader.getPayload());
                        getImpl().animateDoubleTapZoomInMainFrame(data.tapPoint, data.rectToZoom);
                        return true;
                    case 1:
                        getImpl().zoomToFindInPageRectInMainFrame(FrameWidgetHostZoomToFindInPageRectInMainFrameParams.deserialize(messageWithHeader.getPayload()).rectToZoom);
                        return true;
                    case 2:
                        getImpl().setHasTouchEventConsumers(FrameWidgetHostSetHasTouchEventConsumersParams.deserialize(messageWithHeader.getPayload()).touchEventConsumers);
                        return true;
                    case 3:
                        getImpl().intrinsicSizingInfoChanged(FrameWidgetHostIntrinsicSizingInfoChangedParams.deserialize(messageWithHeader.getPayload()).sizingInfo);
                        return true;
                    case 4:
                        getImpl().autoscrollStart(FrameWidgetHostAutoscrollStartParams.deserialize(messageWithHeader.getPayload()).position);
                        return true;
                    case 5:
                        getImpl().autoscrollFling(FrameWidgetHostAutoscrollFlingParams.deserialize(messageWithHeader.getPayload()).velocity);
                        return true;
                    case 6:
                        ...
                        return true;
                    case 7:
                        FrameWidgetHostStartDraggingParams data2 = FrameWidgetHostStartDraggingParams.deserialize(messageWithHeader.getPayload());
                        getImpl().startDragging(data2.dragData, data2.operationsAllowed, data2.image, data2.bitmapOffsetInDip, data2.eventInfo);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FrameWidgetHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams extends Struct {
        ...
        public static FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams deserialize(ByteBuffer data) {
        ...
        public static FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams result = new FrameWidgetHostAnimateDoubleTapZoomInMainFrameParams(elementsOrVersion);
    ...
    static final class FrameWidgetHostZoomToFindInPageRectInMainFrameParams extends Struct {
        ...
        public static FrameWidgetHostZoomToFindInPageRectInMainFrameParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static FrameWidgetHostZoomToFindInPageRectInMainFrameParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostZoomToFindInPageRectInMainFrameParams result = new FrameWidgetHostZoomToFindInPageRectInMainFrameParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class FrameWidgetHostSetHasTouchEventConsumersParams extends Struct {
        ...
        public static FrameWidgetHostSetHasTouchEventConsumersParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostSetHasTouchEventConsumersParams result = new FrameWidgetHostSetHasTouchEventConsumersParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class FrameWidgetHostIntrinsicSizingInfoChangedParams extends Struct {
        ...
        public static FrameWidgetHostIntrinsicSizingInfoChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostIntrinsicSizingInfoChangedParams result = new FrameWidgetHostIntrinsicSizingInfoChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class FrameWidgetHostAutoscrollStartParams extends Struct {
        ...
        public static FrameWidgetHostAutoscrollStartParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostAutoscrollStartParams result = new FrameWidgetHostAutoscrollStartParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class FrameWidgetHostAutoscrollFlingParams extends Struct {
        ...
        public static FrameWidgetHostAutoscrollFlingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostAutoscrollFlingParams result = new FrameWidgetHostAutoscrollFlingParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class FrameWidgetHostAutoscrollEndParams extends Struct {
        ...
        public static FrameWidgetHostAutoscrollEndParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostAutoscrollEndParams result = new FrameWidgetHostAutoscrollEndParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class FrameWidgetHostStartDraggingParams extends Struct {
        ...
        public static FrameWidgetHostStartDraggingParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FrameWidgetHostStartDraggingParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameWidgetHostStartDraggingParams result = new FrameWidgetHostStartDraggingParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                ...
                result.bitmapOffsetInDip = Vector2d.decode(decoder14);
                Decoder decoder15 = decoder0.readPointer(40, false);
                result.eventInfo = DragEventSourceInfo.decode(decoder15);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public final void encode(Encoder encoder) {
            ...
            encoder0.encode((Struct) this.bitmapOffsetInDip, 32, false);
            encoder0.encode((Struct) this.eventInfo, 40, false);
        }
    }
}

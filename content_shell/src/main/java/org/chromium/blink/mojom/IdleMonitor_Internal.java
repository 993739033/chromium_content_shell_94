...
class IdleMonitor_Internal {
    public static final Interface.Manager<IdleMonitor, IdleMonitor.Proxy> MANAGER = new Interface.Manager<IdleMonitor, IdleMonitor.Proxy>() { // from class: org.chromium.blink.mojom.IdleMonitor_Internal.1
        ...
        public IdleMonitor.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements IdleMonitor.Proxy {
        ...
        @Override // org.chromium.blink.mojom.IdleMonitor
    ...
    public static final class Stub extends Interface.Stub<IdleMonitor> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        IdleMonitorUpdateParams data = IdleMonitorUpdateParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), IdleMonitor_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {

...
class InstallationService_Internal {
    public static final Interface.Manager<InstallationService, InstallationService.Proxy> MANAGER = new Interface.Manager<InstallationService, InstallationService.Proxy>() { // from class: org.chromium.blink.mojom.InstallationService_Internal.1
        ...
        public InstallationService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements InstallationService.Proxy {
        ...
        @Override // org.chromium.blink.mojom.InstallationService
    ...
    public static final class Stub extends Interface.Stub<InstallationService> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), InstallationService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class InstallationServiceOnInstallParams extends Struct {
        ...
        public static InstallationServiceOnInstallParams decode(Decoder decoder0) {
            ...
            try {
                ...
                InstallationServiceOnInstallParams result = new InstallationServiceOnInstallParams(elementsOrVersion);
                return result;
            } finally {

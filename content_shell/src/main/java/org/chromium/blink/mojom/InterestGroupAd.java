...
public final class InterestGroupAd extends Struct {
    ...
    public static InterestGroupAd decode(Decoder decoder0) {
        ...
        try {
            ...
            result.renderUrl = Url.decode(decoder1);
            result.metadata = decoder0.readString(16, true);
            return result;
        } finally {
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode((Struct) this.renderUrl, 8, false);
        encoder0.encode(this.metadata, 16, true);
    }
}

...
class KeyboardLockService_Internal {
    ...
    public static final Interface.Manager<KeyboardLockService, KeyboardLockService.Proxy> MANAGER = new Interface.Manager<KeyboardLockService, KeyboardLockService.Proxy>() { // from class: org.chromium.blink.mojom.KeyboardLockService_Internal.1
        ...
        public KeyboardLockService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements KeyboardLockService.Proxy {
        ...
        public void requestKeyboardLock(String[] keyCodes, RequestKeyboardLockResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new KeyboardLockServiceRequestKeyboardLockResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.KeyboardLockService
        public void getKeyboardLayoutMap(GetKeyboardLayoutMapResponse callback) {
            KeyboardLockServiceGetKeyboardLayoutMapParams _message = new KeyboardLockServiceGetKeyboardLayoutMapParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new KeyboardLockServiceGetKeyboardLayoutMapResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<KeyboardLockService> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), KeyboardLockService_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        KeyboardLockServiceRequestKeyboardLockParams data = KeyboardLockServiceRequestKeyboardLockParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class KeyboardLockServiceRequestKeyboardLockParams extends Struct {
        ...
        public static KeyboardLockServiceRequestKeyboardLockParams decode(Decoder decoder0) {
            ...
            try {
                ...
                KeyboardLockServiceRequestKeyboardLockParams result = new KeyboardLockServiceRequestKeyboardLockParams(elementsOrVersion);
    ...
    public static final class KeyboardLockServiceRequestKeyboardLockResponseParams extends Struct {
        ...
        public static KeyboardLockServiceRequestKeyboardLockResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                KeyboardLockServiceRequestKeyboardLockResponseParams result = new KeyboardLockServiceRequestKeyboardLockResponseParams(elementsOrVersion);
    ...
    static final class KeyboardLockServiceCancelKeyboardLockParams extends Struct {
        ...
        public static KeyboardLockServiceCancelKeyboardLockParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                KeyboardLockServiceCancelKeyboardLockParams result = new KeyboardLockServiceCancelKeyboardLockParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class KeyboardLockServiceGetKeyboardLayoutMapParams extends Struct {
        ...
        public static KeyboardLockServiceGetKeyboardLayoutMapParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                KeyboardLockServiceGetKeyboardLayoutMapParams result = new KeyboardLockServiceGetKeyboardLayoutMapParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class KeyboardLockServiceGetKeyboardLayoutMapResponseParams extends Struct {
        ...
        public static KeyboardLockServiceGetKeyboardLayoutMapResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                KeyboardLockServiceGetKeyboardLayoutMapResponseParams result = new KeyboardLockServiceGetKeyboardLayoutMapResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);

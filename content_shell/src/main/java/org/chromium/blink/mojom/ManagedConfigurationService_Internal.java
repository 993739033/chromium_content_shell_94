...
class ManagedConfigurationService_Internal {
    ...
    public static final Interface.Manager<ManagedConfigurationService, ManagedConfigurationService.Proxy> MANAGER = new Interface.Manager<ManagedConfigurationService, ManagedConfigurationService.Proxy>() { // from class: org.chromium.blink.mojom.ManagedConfigurationService_Internal.1
        ...
        public ManagedConfigurationService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ManagedConfigurationService.Proxy {
        ...
        public void getManagedConfiguration(String[] keys, GetManagedConfigurationResponse callback) {
            ...
            _message.keys = keys;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new ManagedConfigurationServiceGetManagedConfigurationResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<ManagedConfigurationService> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(ManagedConfigurationService_Internal.MANAGER, messageWithHeader);
                    case 1:
                        ManagedConfigurationServiceSubscribeToManagedConfigurationParams data = ManagedConfigurationServiceSubscribeToManagedConfigurationParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ManagedConfigurationService_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        ManagedConfigurationServiceGetManagedConfigurationParams data = ManagedConfigurationServiceGetManagedConfigurationParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class ManagedConfigurationServiceGetManagedConfigurationParams extends Struct {
        ...
        public static ManagedConfigurationServiceGetManagedConfigurationParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ManagedConfigurationServiceGetManagedConfigurationParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                ManagedConfigurationServiceGetManagedConfigurationParams result = new ManagedConfigurationServiceGetManagedConfigurationParams(elementsOrVersion);
    ...
    public static final class ManagedConfigurationServiceGetManagedConfigurationResponseParams extends Struct {
        ...
        public static ManagedConfigurationServiceGetManagedConfigurationResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ManagedConfigurationServiceGetManagedConfigurationResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ManagedConfigurationServiceGetManagedConfigurationResponseParams result = new ManagedConfigurationServiceGetManagedConfigurationResponseParams(elementsOrVersion);
    ...
    static class ManagedConfigurationServiceGetManagedConfigurationResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        ManagedConfigurationServiceGetManagedConfigurationResponseParamsForwardToCallback(ManagedConfigurationService.GetManagedConfigurationResponse callback) {
    ...
    static class ManagedConfigurationServiceGetManagedConfigurationResponseParamsProxyToResponder implements ManagedConfigurationService.GetManagedConfigurationResponse {
        ...
        ManagedConfigurationServiceGetManagedConfigurationResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class ManagedConfigurationServiceSubscribeToManagedConfigurationParams extends Struct {
        ...
        public static ManagedConfigurationServiceSubscribeToManagedConfigurationParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ManagedConfigurationServiceSubscribeToManagedConfigurationParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ManagedConfigurationServiceSubscribeToManagedConfigurationParams result = new ManagedConfigurationServiceSubscribeToManagedConfigurationParams(elementsOrVersion);
                result.observer = (ManagedConfigurationObserver) decoder0.readServiceInterface(8, false, ManagedConfigurationObserver.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

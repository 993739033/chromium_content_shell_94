...
import org.chromium.blink.mojom.MediaDevicesListener;
...
class MediaDevicesListener_Internal {
    public static final Interface.Manager<MediaDevicesListener, MediaDevicesListener.Proxy> MANAGER = new Interface.Manager<MediaDevicesListener, MediaDevicesListener.Proxy>() { // from class: org.chromium.blink.mojom.MediaDevicesListener_Internal.1
        ...
        public MediaDevicesListener.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements MediaDevicesListener.Proxy {
        ...
        @Override // org.chromium.blink.mojom.MediaDevicesListener
    ...
    public static final class Stub extends Interface.Stub<MediaDevicesListener> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        MediaDevicesListenerOnDevicesChangedParams data = MediaDevicesListenerOnDevicesChangedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), MediaDevicesListener_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class MediaDevicesListenerOnDevicesChangedParams extends Struct {
        ...
        public static MediaDevicesListenerOnDevicesChangedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                MediaDevicesListenerOnDevicesChangedParams result = new MediaDevicesListenerOnDevicesChangedParams(elementsOrVersion);

...
class MediaSessionClient_Internal {
    ...
    public static final Interface.Manager<MediaSessionClient, MediaSessionClient.Proxy> MANAGER = new Interface.Manager<MediaSessionClient, MediaSessionClient.Proxy>() { // from class: org.chromium.blink.mojom.MediaSessionClient_Internal.1
        ...
        public MediaSessionClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements MediaSessionClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.MediaSessionClient
    ...
    public static final class Stub extends Interface.Stub<MediaSessionClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        MediaSessionClientDidReceiveActionParams data = MediaSessionClientDidReceiveActionParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), MediaSessionClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class MediaSessionClientDidReceiveActionParams extends Struct {
        ...
        public static MediaSessionClientDidReceiveActionParams decode(Decoder decoder0) {
            ...
            try {
                ...
                MediaSessionClientDidReceiveActionParams result = new MediaSessionClientDidReceiveActionParams(elementsOrVersion);

...
class MediaSessionService_Internal {
    ...
    public static final Interface.Manager<MediaSessionService, MediaSessionService.Proxy> MANAGER = new Interface.Manager<MediaSessionService, MediaSessionService.Proxy>() { // from class: org.chromium.blink.mojom.MediaSessionService_Internal.1
        ...
        public MediaSessionService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<MediaSessionService> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        MediaSessionServiceSetClientParams data = MediaSessionServiceSetClientParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setClient(data.client);
                        return true;
                    case 1:
                        MediaSessionServiceSetPlaybackStateParams data2 = MediaSessionServiceSetPlaybackStateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setPlaybackState(data2.state);
                        return true;
                    case 2:
                        MediaSessionServiceSetPositionStateParams data3 = MediaSessionServiceSetPositionStateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setPositionState(data3.position);
                        return true;
                    case 3:
                        MediaSessionServiceSetMetadataParams data4 = MediaSessionServiceSetMetadataParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setMetadata(data4.metadata);
                        return true;
                    case 4:
                        MediaSessionServiceSetMicrophoneStateParams data5 = MediaSessionServiceSetMicrophoneStateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setMicrophoneState(data5.microphoneState);
                        return true;
                    case 5:
                        MediaSessionServiceSetCameraStateParams data6 = MediaSessionServiceSetCameraStateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setCameraState(data6.cameraState);
                        return true;
                    case 6:
                        MediaSessionServiceEnableActionParams data7 = MediaSessionServiceEnableActionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().enableAction(data7.action);
                        return true;
                    case 7:
                        MediaSessionServiceDisableActionParams data8 = MediaSessionServiceDisableActionParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), MediaSessionService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class MediaSessionServiceSetClientParams extends Struct {
        ...
        public static MediaSessionServiceSetClientParams decode(Decoder decoder0) {
            ...
            try {
                ...
                MediaSessionServiceSetClientParams result = new MediaSessionServiceSetClientParams(elementsOrVersion);
    ...
    static final class MediaSessionServiceSetPlaybackStateParams extends Struct {
        ...
        public static MediaSessionServiceSetPlaybackStateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceSetPlaybackStateParams result = new MediaSessionServiceSetPlaybackStateParams(elementsOrVersion);
    ...
    static final class MediaSessionServiceSetPositionStateParams extends Struct {
        ...
        public static MediaSessionServiceSetPositionStateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceSetPositionStateParams result = new MediaSessionServiceSetPositionStateParams(elementsOrVersion);
    ...
    static final class MediaSessionServiceSetMetadataParams extends Struct {
        ...
        public static MediaSessionServiceSetMetadataParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceSetMetadataParams result = new MediaSessionServiceSetMetadataParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);
    ...
    static final class MediaSessionServiceSetMicrophoneStateParams extends Struct {
        ...
        public static MediaSessionServiceSetMicrophoneStateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceSetMicrophoneStateParams result = new MediaSessionServiceSetMicrophoneStateParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class MediaSessionServiceSetCameraStateParams extends Struct {
        ...
        public static MediaSessionServiceSetCameraStateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceSetCameraStateParams result = new MediaSessionServiceSetCameraStateParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class MediaSessionServiceEnableActionParams extends Struct {
        ...
        public static MediaSessionServiceEnableActionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceEnableActionParams result = new MediaSessionServiceEnableActionParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class MediaSessionServiceDisableActionParams extends Struct {
        ...
        public static MediaSessionServiceDisableActionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionServiceDisableActionParams result = new MediaSessionServiceDisableActionParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.action = readInt;
                MediaSessionAction.validate(readInt);
                result.action = MediaSessionAction.toKnownValue(result.action);

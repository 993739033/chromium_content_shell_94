...
import org.chromium.blink.mojom.MediaStreamTrackMetricsHost;
...
class MediaStreamTrackMetricsHost_Internal {
    ...
    public static final Interface.Manager<MediaStreamTrackMetricsHost, MediaStreamTrackMetricsHost.Proxy> MANAGER = new Interface.Manager<MediaStreamTrackMetricsHost, MediaStreamTrackMetricsHost.Proxy>() { // from class: org.chromium.blink.mojom.MediaStreamTrackMetricsHost_Internal.1
        ...
        public MediaStreamTrackMetricsHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements MediaStreamTrackMetricsHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.MediaStreamTrackMetricsHost
    ...
    public static final class Stub extends Interface.Stub<MediaStreamTrackMetricsHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        MediaStreamTrackMetricsHostAddTrackParams data = MediaStreamTrackMetricsHostAddTrackParams.deserialize(messageWithHeader.getPayload());
                        getImpl().addTrack(data.id, data.isAudio, data.isRemote);
                        return true;
                    case 1:
                        getImpl().removeTrack(MediaStreamTrackMetricsHostRemoveTrackParams.deserialize(messageWithHeader.getPayload()).id);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), MediaStreamTrackMetricsHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class MediaStreamTrackMetricsHostAddTrackParams extends Struct {
        ...
        public static MediaStreamTrackMetricsHostAddTrackParams decode(Decoder decoder0) {
            ...
            try {
                ...
                MediaStreamTrackMetricsHostAddTrackParams result = new MediaStreamTrackMetricsHostAddTrackParams(elementsOrVersion);
    ...
    static final class MediaStreamTrackMetricsHostRemoveTrackParams extends Struct {
        ...
        public static MediaStreamTrackMetricsHostRemoveTrackParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaStreamTrackMetricsHostRemoveTrackParams result = new MediaStreamTrackMetricsHostRemoveTrackParams(elementsOrVersion);
                result.id = decoder0.readLong(8);
                return result;
            } finally {
                decoder0.decreaseStackDepth();

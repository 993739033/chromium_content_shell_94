...
class PictureInPictureSession_Internal {
    public static final Interface.Manager<PictureInPictureSession, PictureInPictureSession.Proxy> MANAGER = new Interface.Manager<PictureInPictureSession, PictureInPictureSession.Proxy>() { // from class: org.chromium.blink.mojom.PictureInPictureSession_Internal.1
        ...
        public PictureInPictureSession.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements PictureInPictureSession.Proxy {
        ...
        public void update(int playerId, AssociatedInterfaceNotSupported playerRemote, SurfaceId surfaceId, Size naturalSize, boolean showPlayPauseButton) {
        ...
        @Override // org.chromium.blink.mojom.PictureInPictureSession
        public void stop(StopResponse callback) {
            PictureInPictureSessionStopParams _message = new PictureInPictureSessionStopParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new PictureInPictureSessionStopResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<PictureInPictureSession> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        PictureInPictureSessionUpdateParams data = PictureInPictureSessionUpdateParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PictureInPictureSession_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    default:
                        return false;
                    case 1:
    ...
    static final class PictureInPictureSessionUpdateParams extends Struct {
        ...
        public static PictureInPictureSessionUpdateParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PictureInPictureSessionUpdateParams result = new PictureInPictureSessionUpdateParams(elementsOrVersion);
    ...
    static final class PictureInPictureSessionStopParams extends Struct {
        ...
        public static PictureInPictureSessionStopParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PictureInPictureSessionStopParams result = new PictureInPictureSessionStopParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PictureInPictureSessionStopResponseParams extends Struct {
        ...
        public static PictureInPictureSessionStopResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PictureInPictureSessionStopResponseParams result = new PictureInPictureSessionStopResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

...
import org.chromium.blink.mojom.PointerLockContext;
...
class PointerLockContext_Internal {
    public static final Interface.Manager<PointerLockContext, PointerLockContext.Proxy> MANAGER = new Interface.Manager<PointerLockContext, PointerLockContext.Proxy>() { // from class: org.chromium.blink.mojom.PointerLockContext_Internal.1
        ...
        public PointerLockContext.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements PointerLockContext.Proxy {
        ...
        @Override // org.chromium.blink.mojom.PointerLockContext
        public void requestMouseLockChange(boolean unadjustedMovement, RequestMouseLockChangeResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new PointerLockContextRequestMouseLockChangeResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<PointerLockContext> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(PointerLockContext_Internal.MANAGER, messageWithHeader);
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PointerLockContext_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        PointerLockContextRequestMouseLockChangeParams data = PointerLockContextRequestMouseLockChangeParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class PointerLockContextRequestMouseLockChangeParams extends Struct {
        ...
        public static PointerLockContextRequestMouseLockChangeParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PointerLockContextRequestMouseLockChangeParams result = new PointerLockContextRequestMouseLockChangeParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class PointerLockContextRequestMouseLockChangeResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        public int result;
        ...
        public static PointerLockContextRequestMouseLockChangeResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static PointerLockContextRequestMouseLockChangeResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static PointerLockContextRequestMouseLockChangeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PointerLockContextRequestMouseLockChangeResponseParams result = new PointerLockContextRequestMouseLockChangeResponseParams(elementsOrVersion);
    ...
    /* loaded from: classes2.dex */
    static class PointerLockContextRequestMouseLockChangeResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
    ...
    static class PointerLockContextRequestMouseLockChangeResponseParamsProxyToResponder implements PointerLockContext.RequestMouseLockChangeResponse {
        ...
        PointerLockContextRequestMouseLockChangeResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;

...
import org.chromium.blink.mojom.PolicyContainerHost;
...
class PolicyContainerHost_Internal {
    ...
    public static final Interface.Manager<PolicyContainerHost, PolicyContainerHost.Proxy> MANAGER = new Interface.Manager<PolicyContainerHost, PolicyContainerHost.Proxy>() { // from class: org.chromium.blink.mojom.PolicyContainerHost_Internal.1
        ...
        public PolicyContainerHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements PolicyContainerHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.PolicyContainerHost
        ...
        @Override // org.chromium.blink.mojom.PolicyContainerHost
        public void issueKeepAliveHandle(InterfaceRequest<PolicyContainerHostKeepAliveHandle> receiver) {
    ...
    public static final class Stub extends Interface.Stub<PolicyContainerHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(PolicyContainerHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        PolicyContainerHostSetReferrerPolicyParams data = PolicyContainerHostSetReferrerPolicyParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setReferrerPolicy(data.referrerPolicy);
                        return true;
                    case 1:
                        PolicyContainerHostAddContentSecurityPoliciesParams data2 = PolicyContainerHostAddContentSecurityPoliciesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().addContentSecurityPolicies(data2.contentSecurityPolicies);
                        return true;
                    case 2:
                        PolicyContainerHostIssueKeepAliveHandleParams data3 = PolicyContainerHostIssueKeepAliveHandleParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PolicyContainerHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class PolicyContainerHostSetReferrerPolicyParams extends Struct {
        ...
        public static PolicyContainerHostSetReferrerPolicyParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PolicyContainerHostSetReferrerPolicyParams result = new PolicyContainerHostSetReferrerPolicyParams(elementsOrVersion);
    ...
    static final class PolicyContainerHostAddContentSecurityPoliciesParams extends Struct {
        ...
        public static PolicyContainerHostAddContentSecurityPoliciesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PolicyContainerHostAddContentSecurityPoliciesParams result = new PolicyContainerHostAddContentSecurityPoliciesParams(elementsOrVersion);
    ...
    static final class PolicyContainerHostIssueKeepAliveHandleParams extends Struct {
        ...
        public static PolicyContainerHostIssueKeepAliveHandleParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PolicyContainerHostIssueKeepAliveHandleParams result = new PolicyContainerHostIssueKeepAliveHandleParams(elementsOrVersion);

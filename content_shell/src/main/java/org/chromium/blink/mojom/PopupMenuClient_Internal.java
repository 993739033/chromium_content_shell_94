...
import org.chromium.blink.mojom.PopupMenuClient;
...
class PopupMenuClient_Internal {
    ...
    public static final Interface.Manager<PopupMenuClient, PopupMenuClient.Proxy> MANAGER = new Interface.Manager<PopupMenuClient, PopupMenuClient.Proxy>() { // from class: org.chromium.blink.mojom.PopupMenuClient_Internal.1
        ...
        public PopupMenuClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements PopupMenuClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.PopupMenuClient
    ...
    public static final class Stub extends Interface.Stub<PopupMenuClient> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(PopupMenuClient_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        PopupMenuClientDidAcceptIndicesParams data = PopupMenuClientDidAcceptIndicesParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PopupMenuClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class PopupMenuClientDidAcceptIndicesParams extends Struct {
        ...
        public static PopupMenuClientDidAcceptIndicesParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PopupMenuClientDidAcceptIndicesParams result = new PopupMenuClientDidAcceptIndicesParams(elementsOrVersion);
    ...
    static final class PopupMenuClientDidCancelParams extends Struct {
        ...
        public static PopupMenuClientDidCancelParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PopupMenuClientDidCancelParams result = new PopupMenuClientDidCancelParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

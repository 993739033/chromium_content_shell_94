...
class PresentationController_Internal {
    public static final Interface.Manager<PresentationController, PresentationController.Proxy> MANAGER = new Interface.Manager<PresentationController, PresentationController.Proxy>() { // from class: org.chromium.blink.mojom.PresentationController_Internal.1
        ...
        public PresentationController.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<PresentationController> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        PresentationControllerOnScreenAvailabilityUpdatedParams data = PresentationControllerOnScreenAvailabilityUpdatedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onScreenAvailabilityUpdated(data.url, data.availability);
                        return true;
                    case 1:
                        getImpl().onDefaultPresentationStarted(PresentationControllerOnDefaultPresentationStartedParams.deserialize(messageWithHeader.getPayload()).result);
                        return true;
                    case 2:
                        PresentationControllerOnConnectionStateChangedParams data2 = PresentationControllerOnConnectionStateChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onConnectionStateChanged(data2.presentationInfo, data2.newState);
                        return true;
                    case 3:
                        PresentationControllerOnConnectionClosedParams data3 = PresentationControllerOnConnectionClosedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PresentationController_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class PresentationControllerOnScreenAvailabilityUpdatedParams extends Struct {
        ...
        public static PresentationControllerOnScreenAvailabilityUpdatedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PresentationControllerOnScreenAvailabilityUpdatedParams result = new PresentationControllerOnScreenAvailabilityUpdatedParams(elementsOrVersion);
    ...
    static final class PresentationControllerOnDefaultPresentationStartedParams extends Struct {
        ...
        public static PresentationControllerOnDefaultPresentationStartedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationControllerOnDefaultPresentationStartedParams result = new PresentationControllerOnDefaultPresentationStartedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class PresentationControllerOnConnectionStateChangedParams extends Struct {
        ...
        public static PresentationControllerOnConnectionStateChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationControllerOnConnectionStateChangedParams result = new PresentationControllerOnConnectionStateChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class PresentationControllerOnConnectionClosedParams extends Struct {
        ...
        public static PresentationControllerOnConnectionClosedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationControllerOnConnectionClosedParams result = new PresentationControllerOnConnectionClosedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.presentationInfo = PresentationInfo.decode(decoder1);
                int readInt = decoder0.readInt(16);

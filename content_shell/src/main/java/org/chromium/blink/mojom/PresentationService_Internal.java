...
class PresentationService_Internal {
    ...
    public static final Interface.Manager<PresentationService, PresentationService.Proxy> MANAGER = new Interface.Manager<PresentationService, PresentationService.Proxy>() { // from class: org.chromium.blink.mojom.PresentationService_Internal.1
        ...
        public PresentationService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements PresentationService.Proxy {
        ...
        @Override // org.chromium.blink.mojom.PresentationService
        public void startPresentation(Url[] presentationUrls, StartPresentationResponse callback) {
            PresentationServiceStartPresentationParams _message = new PresentationServiceStartPresentationParams();
            _message.presentationUrls = presentationUrls;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new PresentationServiceStartPresentationResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.PresentationService
        public void reconnectPresentation(Url[] presentationUrls, String presentationId, ReconnectPresentationResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new PresentationServiceReconnectPresentationResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<PresentationService> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        PresentationServiceSetControllerParams data = PresentationServiceSetControllerParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setController(data.controller);
                        return true;
                    case 1:
                        PresentationServiceSetReceiverParams data2 = PresentationServiceSetReceiverParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setReceiver(data2.receiver);
                        return true;
                    case 2:
                        PresentationServiceSetDefaultPresentationUrlsParams data3 = PresentationServiceSetDefaultPresentationUrlsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setDefaultPresentationUrls(data3.presentationUrls);
                        return true;
                    case 3:
                        PresentationServiceListenForScreenAvailabilityParams data4 = PresentationServiceListenForScreenAvailabilityParams.deserialize(messageWithHeader.getPayload());
                        getImpl().listenForScreenAvailability(data4.availabilityUrl);
                        return true;
                    case 4:
                        PresentationServiceStopListeningForScreenAvailabilityParams data5 = PresentationServiceStopListeningForScreenAvailabilityParams.deserialize(messageWithHeader.getPayload());
                        getImpl().stopListeningForScreenAvailability(data5.availabilityUrl);
                        return true;
                    case 7:
                        PresentationServiceCloseConnectionParams data6 = PresentationServiceCloseConnectionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().closeConnection(data6.presentationUrl, data6.presentationId);
                        return true;
                    case 8:
                        PresentationServiceTerminateParams data7 = PresentationServiceTerminateParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PresentationService_Internal.MANAGER, messageWithHeader, receiver);
                    case 5:
                        getImpl().startPresentation(PresentationServiceStartPresentationParams.deserialize(messageWithHeader.getPayload()).presentationUrls, new PresentationServiceStartPresentationResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        PresentationServiceReconnectPresentationParams data = PresentationServiceReconnectPresentationParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class PresentationServiceSetControllerParams extends Struct {
        ...
        public static PresentationServiceSetControllerParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PresentationServiceSetControllerParams result = new PresentationServiceSetControllerParams(elementsOrVersion);
    ...
    static final class PresentationServiceSetReceiverParams extends Struct {
        ...
        public static PresentationServiceSetReceiverParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceSetReceiverParams result = new PresentationServiceSetReceiverParams(elementsOrVersion);
    ...
    static final class PresentationServiceSetDefaultPresentationUrlsParams extends Struct {
        ...
        public static PresentationServiceSetDefaultPresentationUrlsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceSetDefaultPresentationUrlsParams result = new PresentationServiceSetDefaultPresentationUrlsParams(elementsOrVersion);
    ...
    static final class PresentationServiceListenForScreenAvailabilityParams extends Struct {
        ...
        public static PresentationServiceListenForScreenAvailabilityParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceListenForScreenAvailabilityParams result = new PresentationServiceListenForScreenAvailabilityParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class PresentationServiceStopListeningForScreenAvailabilityParams extends Struct {
        ...
        public static PresentationServiceStopListeningForScreenAvailabilityParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceStopListeningForScreenAvailabilityParams result = new PresentationServiceStopListeningForScreenAvailabilityParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.availabilityUrl = Url.decode(decoder1);
                return result;
            } finally {
    ...
    static final class PresentationServiceStartPresentationParams extends Struct {
        ...
        public static PresentationServiceStartPresentationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceStartPresentationParams result = new PresentationServiceStartPresentationParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.presentationUrls = new Url[si1.elementsOrVersion];
                for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
    ...
    public static final class PresentationServiceStartPresentationResponseParams extends Struct {
        ...
        public static PresentationServiceStartPresentationResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceStartPresentationResponseParams result = new PresentationServiceStartPresentationResponseParams(elementsOrVersion);
    ...
    static final class PresentationServiceReconnectPresentationParams extends Struct {
        ...
        public static PresentationServiceReconnectPresentationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceReconnectPresentationParams result = new PresentationServiceReconnectPresentationParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.presentationUrls = new Url[si1.elementsOrVersion];
                for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
    ...
    public static final class PresentationServiceReconnectPresentationResponseParams extends Struct {
        ...
        public static PresentationServiceReconnectPresentationResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceReconnectPresentationResponseParams result = new PresentationServiceReconnectPresentationResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);
                result.result = PresentationConnectionResult.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, true);
                result.error = PresentationError.decode(decoder12);
    ...
    static final class PresentationServiceCloseConnectionParams extends Struct {
        ...
        public static PresentationServiceCloseConnectionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceCloseConnectionParams result = new PresentationServiceCloseConnectionParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class PresentationServiceTerminateParams extends Struct {
        ...
        public static PresentationServiceTerminateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PresentationServiceTerminateParams result = new PresentationServiceTerminateParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.presentationUrl = Url.decode(decoder1);
                result.presentationId = decoder0.readString(16, false);
                return result;

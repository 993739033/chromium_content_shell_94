...
public final class PrfValues extends Struct {
    ...
    public static PrfValues decode(Decoder decoder0) {
        ...
        try {
            ...
            result.id = decoder0.readBytes(8, 1, -1);
            result.first = decoder0.readBytes(16, 0, 32);
            result.second = decoder0.readBytes(24, 1, 32);
            return result;
        } finally {
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode(this.id, 8, 1, -1);
        encoder0.encode(this.first, 16, 0, 32);
        encoder0.encode(this.second, 24, 1, 32);
    }
}

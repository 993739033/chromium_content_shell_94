...
import org.chromium.blink.mojom.ProgressClient;
...
class ProgressClient_Internal {
    public static final Interface.Manager<ProgressClient, ProgressClient.Proxy> MANAGER = new Interface.Manager<ProgressClient, ProgressClient.Proxy>() { // from class: org.chromium.blink.mojom.ProgressClient_Internal.1
        ...
        public ProgressClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ProgressClient.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ProgressClient
    ...
    public static final class Stub extends Interface.Stub<ProgressClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ProgressClientOnProgressParams data = ProgressClientOnProgressParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ProgressClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ProgressClientOnProgressParams extends Struct {
        ...
        public static ProgressClientOnProgressParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ProgressClientOnProgressParams result = new ProgressClientOnProgressParams(elementsOrVersion);

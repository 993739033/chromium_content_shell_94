...
import org.chromium.blink.mojom.ReceivedSnapshotListener;
...
class ReceivedSnapshotListener_Internal {
    ...
    public static final Interface.Manager<ReceivedSnapshotListener, ReceivedSnapshotListener.Proxy> MANAGER = new Interface.Manager<ReceivedSnapshotListener, ReceivedSnapshotListener.Proxy>() { // from class: org.chromium.blink.mojom.ReceivedSnapshotListener_Internal.1
        ...
        public ReceivedSnapshotListener.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ReceivedSnapshotListener.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ReceivedSnapshotListener
    ...
    public static final class Stub extends Interface.Stub<ReceivedSnapshotListener> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ReceivedSnapshotListener_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ReceivedSnapshotListenerDidReceiveSnapshotFileParams extends Struct {
        ...
        public static ReceivedSnapshotListenerDidReceiveSnapshotFileParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ReceivedSnapshotListenerDidReceiveSnapshotFileParams result = new ReceivedSnapshotListenerDidReceiveSnapshotFileParams(elementsOrVersion);
                return result;
            } finally {

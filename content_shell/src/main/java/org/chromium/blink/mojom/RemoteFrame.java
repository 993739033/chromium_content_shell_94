...
public interface RemoteFrame extends Interface {
    public static final Manager<RemoteFrame, Proxy> MANAGER = RemoteFrame_Internal.MANAGER;
    ...
    void didSetFramePolicyHeaders(int i, ParsedPermissionsPolicyDeclaration[] parsedPermissionsPolicyDeclarationArr);
    ...
    void setReplicatedIsAdSubframe(boolean z);

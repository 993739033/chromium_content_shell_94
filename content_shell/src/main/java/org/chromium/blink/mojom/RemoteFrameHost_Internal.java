...
class RemoteFrameHost_Internal {
    ...
    public static final Interface.Manager<RemoteFrameHost, RemoteFrameHost.Proxy> MANAGER = new Interface.Manager<RemoteFrameHost, RemoteFrameHost.Proxy>() { // from class: org.chromium.blink.mojom.RemoteFrameHost_Internal.1
        ...
        public RemoteFrameHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements RemoteFrameHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.RemoteFrameHost
        public void updateRenderThrottlingStatus(boolean isThrottled, boolean subtreeThrottled, boolean displayLocked) {
        ...
        @Override // org.chromium.blink.mojom.RemoteFrameHost
        public void routeMessageEvent(LocalFrameToken sourceFrameToken, String16 sourceOrigin, String16 targetOrigin, TransferableMessage message) {
        ...
        @Override // org.chromium.blink.mojom.RemoteFrameHost
        public void updateViewportIntersection(ViewportIntersectionState intersectionState, FrameVisualProperties visualProperties) {
    ...
    public static final class Stub extends Interface.Stub<RemoteFrameHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(RemoteFrameHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        getImpl().setInheritedEffectiveTouchAction(RemoteFrameHostSetInheritedEffectiveTouchActionParams.deserialize(messageWithHeader.getPayload()).touchAction);
                        return true;
                    case 1:
                        RemoteFrameHostUpdateRenderThrottlingStatusParams data = RemoteFrameHostUpdateRenderThrottlingStatusParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateRenderThrottlingStatus(data.isThrottled, data.subtreeThrottled, data.displayLocked);
                        return true;
                    case 2:
                        RemoteFrameHostVisibilityChangedParams data2 = RemoteFrameHostVisibilityChangedParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 4:
                        ...
                        return true;
                    case 5:
                        RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams data3 = RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams.deserialize(messageWithHeader.getPayload());
                        getImpl().capturePaintPreviewOfCrossProcessSubframe(data3.clipRect, data3.guid);
                        return true;
                    case 6:
                        RemoteFrameHostSetIsInertParams data4 = RemoteFrameHostSetIsInertParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setIsInert(data4.inert);
                        return true;
                    case 7:
                        RemoteFrameHostDidChangeOpenerParams data5 = RemoteFrameHostDidChangeOpenerParams.deserialize(messageWithHeader.getPayload());
                        getImpl().didChangeOpener(data5.openerFrame);
                        return true;
                    case 8:
                        RemoteFrameHostAdvanceFocusParams data6 = RemoteFrameHostAdvanceFocusParams.deserialize(messageWithHeader.getPayload());
                        getImpl().advanceFocus(data6.focusType, data6.sourceFrameToken);
                        return true;
                    case 9:
                        RemoteFrameHostRouteMessageEventParams data7 = RemoteFrameHostRouteMessageEventParams.deserialize(messageWithHeader.getPayload());
                        getImpl().routeMessageEvent(data7.sourceFrameToken, data7.sourceOrigin, data7.targetOrigin, data7.message);
                        return true;
                    case 10:
                        RemoteFrameHostPrintCrossProcessSubframeParams data8 = RemoteFrameHostPrintCrossProcessSubframeParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 11:
                        ...
                        return true;
                    case 12:
                        RemoteFrameHostUpdateViewportIntersectionParams data9 = RemoteFrameHostUpdateViewportIntersectionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateViewportIntersection(data9.intersectionState, data9.visualProperties);
                        return true;
                    case 13:
                        RemoteFrameHostSynchronizeVisualPropertiesParams data10 = RemoteFrameHostSynchronizeVisualPropertiesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().synchronizeVisualProperties(data10.properties);
                        return true;
                    case 14:
                        RemoteFrameHostOpenUrlParams data11 = RemoteFrameHostOpenUrlParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), RemoteFrameHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class RemoteFrameHostSetInheritedEffectiveTouchActionParams extends Struct {
        ...
        public static RemoteFrameHostSetInheritedEffectiveTouchActionParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static RemoteFrameHostSetInheritedEffectiveTouchActionParams deserialize(ByteBuffer data) {
        ...
        public static RemoteFrameHostSetInheritedEffectiveTouchActionParams decode(Decoder decoder0) {
            ...
            try {
                ...
                RemoteFrameHostSetInheritedEffectiveTouchActionParams result = new RemoteFrameHostSetInheritedEffectiveTouchActionParams(elementsOrVersion);
    ...
    static final class RemoteFrameHostUpdateRenderThrottlingStatusParams extends Struct {
        ...
        public static RemoteFrameHostUpdateRenderThrottlingStatusParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostUpdateRenderThrottlingStatusParams result = new RemoteFrameHostUpdateRenderThrottlingStatusParams(elementsOrVersion);
    ...
    static final class RemoteFrameHostVisibilityChangedParams extends Struct {
        ...
        public static RemoteFrameHostVisibilityChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostVisibilityChangedParams result = new RemoteFrameHostVisibilityChangedParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class RemoteFrameHostDidFocusFrameParams extends Struct {
        ...
        public static RemoteFrameHostDidFocusFrameParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostDidFocusFrameParams result = new RemoteFrameHostDidFocusFrameParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class RemoteFrameHostCheckCompletedParams extends Struct {
        ...
        public static RemoteFrameHostCheckCompletedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostCheckCompletedParams result = new RemoteFrameHostCheckCompletedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams extends Struct {
        ...
        public static RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams result = new RemoteFrameHostCapturePaintPreviewOfCrossProcessSubframeParams(elementsOrVersion);
    ...
    static final class RemoteFrameHostSetIsInertParams extends Struct {
        ...
        public static RemoteFrameHostSetIsInertParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostSetIsInertParams result = new RemoteFrameHostSetIsInertParams(elementsOrVersion);
    ...
    static final class RemoteFrameHostDidChangeOpenerParams extends Struct {
        ...
        public static RemoteFrameHostDidChangeOpenerParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostDidChangeOpenerParams result = new RemoteFrameHostDidChangeOpenerParams(elementsOrVersion);
    ...
    static final class RemoteFrameHostAdvanceFocusParams extends Struct {
        ...
        public static RemoteFrameHostAdvanceFocusParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostAdvanceFocusParams result = new RemoteFrameHostAdvanceFocusParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class RemoteFrameHostRouteMessageEventParams extends Struct {
        ...
        public static RemoteFrameHostRouteMessageEventParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostRouteMessageEventParams result = new RemoteFrameHostRouteMessageEventParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);
                result.sourceFrameToken = LocalFrameToken.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, false);
    ...
    static final class RemoteFrameHostPrintCrossProcessSubframeParams extends Struct {
        ...
        public static RemoteFrameHostPrintCrossProcessSubframeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostPrintCrossProcessSubframeParams result = new RemoteFrameHostPrintCrossProcessSubframeParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class RemoteFrameHostUpdateViewportIntersectionParams extends Struct {
        ...
        public static RemoteFrameHostUpdateViewportIntersectionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostUpdateViewportIntersectionParams result = new RemoteFrameHostUpdateViewportIntersectionParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class RemoteFrameHostSynchronizeVisualPropertiesParams extends Struct {
        ...
        public static RemoteFrameHostSynchronizeVisualPropertiesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteFrameHostSynchronizeVisualPropertiesParams result = new RemoteFrameHostSynchronizeVisualPropertiesParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);

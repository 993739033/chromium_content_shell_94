...
class RemoteMainFrameHost_Internal {
    ...
    public static final Interface.Manager<RemoteMainFrameHost, RemoteMainFrameHost.Proxy> MANAGER = new Interface.Manager<RemoteMainFrameHost, RemoteMainFrameHost.Proxy>() { // from class: org.chromium.blink.mojom.RemoteMainFrameHost_Internal.1
        ...
        public RemoteMainFrameHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements RemoteMainFrameHost.Proxy {
        ...
        public void updateTargetUrl(Url url, UpdateTargetUrlResponse callback) {
            ...
            _message.url = url;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new RemoteMainFrameHostUpdateTargetUrlResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<RemoteMainFrameHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(RemoteMainFrameHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    case 2:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        RemoteMainFrameHostTakeFocusParams data = RemoteMainFrameHostTakeFocusParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), RemoteMainFrameHost_Internal.MANAGER, messageWithHeader, receiver);
                    case 2:
                        RemoteMainFrameHostUpdateTargetUrlParams data = RemoteMainFrameHostUpdateTargetUrlParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class RemoteMainFrameHostFocusPageParams extends Struct {
        ...
        public static RemoteMainFrameHostFocusPageParams decode(Decoder decoder0) {
            ...
            try {
                ...
                RemoteMainFrameHostFocusPageParams result = new RemoteMainFrameHostFocusPageParams(elementsOrVersion);
                return result;
            } finally {
    ...
    static final class RemoteMainFrameHostTakeFocusParams extends Struct {
        ...
        public static RemoteMainFrameHostTakeFocusParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteMainFrameHostTakeFocusParams result = new RemoteMainFrameHostTakeFocusParams(elementsOrVersion);
    ...
    static final class RemoteMainFrameHostUpdateTargetUrlParams extends Struct {
        ...
        public static RemoteMainFrameHostUpdateTargetUrlParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteMainFrameHostUpdateTargetUrlParams result = new RemoteMainFrameHostUpdateTargetUrlParams(elementsOrVersion);
    ...
    static final class RemoteMainFrameHostUpdateTargetUrlResponseParams extends Struct {
        ...
        public static RemoteMainFrameHostUpdateTargetUrlResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteMainFrameHostUpdateTargetUrlResponseParams result = new RemoteMainFrameHostUpdateTargetUrlResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    /* loaded from: classes2.dex */
    static class RemoteMainFrameHostUpdateTargetUrlResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
    ...
    static class RemoteMainFrameHostUpdateTargetUrlResponseParamsProxyToResponder implements RemoteMainFrameHost.UpdateTargetUrlResponse {
        ...
        RemoteMainFrameHostUpdateTargetUrlResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class RemoteMainFrameHostRouteCloseEventParams extends Struct {
        ...
        public static RemoteMainFrameHostRouteCloseEventParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteMainFrameHostRouteCloseEventParams result = new RemoteMainFrameHostRouteCloseEventParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

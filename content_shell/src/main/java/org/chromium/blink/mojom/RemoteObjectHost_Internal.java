...
class RemoteObjectHost_Internal {
    ...
    public static final Interface.Manager<RemoteObjectHost, RemoteObjectHost.Proxy> MANAGER = new Interface.Manager<RemoteObjectHost, RemoteObjectHost.Proxy>() { // from class: org.chromium.blink.mojom.RemoteObjectHost_Internal.1
        ...
        public RemoteObjectHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().acquireObject(RemoteObjectHostAcquireObjectParams.deserialize(messageWithHeader.getPayload()).objectId);
                        return true;
                    case 2:
    ...
    static final class RemoteObjectHostAcquireObjectParams extends Struct {
        ...
        public static RemoteObjectHostAcquireObjectParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RemoteObjectHostAcquireObjectParams result = new RemoteObjectHostAcquireObjectParams(elementsOrVersion);
                result.objectId = decoder0.readInt(8);
                return result;
            } finally {
                decoder0.decreaseStackDepth();

...
import org.chromium.blink.mojom.RendererAudioInputStreamFactory;
...
class RendererAudioInputStreamFactory_Internal {
    ...
    public static final Interface.Manager<RendererAudioInputStreamFactory, RendererAudioInputStreamFactory.Proxy> MANAGER = new Interface.Manager<RendererAudioInputStreamFactory, RendererAudioInputStreamFactory.Proxy>() { // from class: org.chromium.blink.mojom.RendererAudioInputStreamFactory_Internal.1
        ...
        public RendererAudioInputStreamFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements RendererAudioInputStreamFactory.Proxy {
        ...
        @Override // org.chromium.blink.mojom.RendererAudioInputStreamFactory
        public void createStream(RendererAudioInputStreamFactoryClient client, UnguessableToken sessionId, AudioParameters params, boolean automaticGainControl, int sharedMemoryCount) {
    ...
    public static final class Stub extends Interface.Stub<RendererAudioInputStreamFactory> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(RendererAudioInputStreamFactory_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        RendererAudioInputStreamFactoryCreateStreamParams data = RendererAudioInputStreamFactoryCreateStreamParams.deserialize(messageWithHeader.getPayload());
                        getImpl().createStream(data.client, data.sessionId, data.params, data.automaticGainControl, data.sharedMemoryCount);
                        return true;
                    case 1:
                        RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams data2 = RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), RendererAudioInputStreamFactory_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class RendererAudioInputStreamFactoryCreateStreamParams extends Struct {
        ...
        public static RendererAudioInputStreamFactoryCreateStreamParams decode(Decoder decoder0) {
            ...
            try {
                ...
                RendererAudioInputStreamFactoryCreateStreamParams result = new RendererAudioInputStreamFactoryCreateStreamParams(elementsOrVersion);
                result.client = (RendererAudioInputStreamFactoryClient) decoder0.readServiceInterface(8, false, RendererAudioInputStreamFactoryClient.MANAGER);
    ...
    /* loaded from: classes2.dex */
    static final class RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams result = new RendererAudioInputStreamFactoryAssociateInputAndOutputForAecParams(elementsOrVersion);

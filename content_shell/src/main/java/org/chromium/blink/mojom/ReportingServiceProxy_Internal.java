...
class ReportingServiceProxy_Internal {
    public static final Interface.Manager<ReportingServiceProxy, ReportingServiceProxy.Proxy> MANAGER = new Interface.Manager<ReportingServiceProxy, ReportingServiceProxy.Proxy>() { // from class: org.chromium.blink.mojom.ReportingServiceProxy_Internal.1
        ...
        public ReportingServiceProxy.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ReportingServiceProxy.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ReportingServiceProxy
        public void queuePermissionsPolicyViolationReport(Url url, String policyId, String disposition, String message, String sourceFile, int lineNumber, int columnNumber) {
        ...
        @Override // org.chromium.blink.mojom.ReportingServiceProxy
        public void queueDocumentPolicyViolationReport(Url url, String group, String policyId, String disposition, String message, String sourceFile, int lineNumber, int columnNumber) {
    ...
    public static final class Stub extends Interface.Stub<ReportingServiceProxy> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ReportingServiceProxyQueueInterventionReportParams data = ReportingServiceProxyQueueInterventionReportParams.deserialize(messageWithHeader.getPayload());
                        getImpl().queueInterventionReport(data.url, data.id, data.message, data.sourceFile, data.lineNumber, data.columnNumber);
                        return true;
                    case 1:
                        ReportingServiceProxyQueueDeprecationReportParams data2 = ReportingServiceProxyQueueDeprecationReportParams.deserialize(messageWithHeader.getPayload());
                        getImpl().queueDeprecationReport(data2.url, data2.id, data2.anticipatedRemoval, data2.message, data2.sourceFile, data2.lineNumber, data2.columnNumber);
                        return true;
                    case 2:
                        ReportingServiceProxyQueueCspViolationReportParams data3 = ReportingServiceProxyQueueCspViolationReportParams.deserialize(messageWithHeader.getPayload());
                        ...
                        impl.queueCspViolationReport(url, str, str2, str3, str4, str5, str6, str7, str8, str9, s, i, flags2);
                        return true;
                    case 3:
                        ReportingServiceProxyQueuePermissionsPolicyViolationReportParams data4 = ReportingServiceProxyQueuePermissionsPolicyViolationReportParams.deserialize(messageWithHeader.getPayload());
                        getImpl().queuePermissionsPolicyViolationReport(data4.url, data4.policyId, data4.disposition, data4.message, data4.sourceFile, data4.lineNumber, data4.columnNumber);
                        return true;
                    case 4:
                        ReportingServiceProxyQueueDocumentPolicyViolationReportParams data5 = ReportingServiceProxyQueueDocumentPolicyViolationReportParams.deserialize(messageWithHeader.getPayload());
                        getImpl().queueDocumentPolicyViolationReport(data5.url, data5.group, data5.policyId, data5.disposition, data5.message, data5.sourceFile, data5.lineNumber, data5.columnNumber);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ReportingServiceProxy_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ReportingServiceProxyQueueInterventionReportParams extends Struct {
        ...
        public static ReportingServiceProxyQueueInterventionReportParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ReportingServiceProxyQueueInterventionReportParams result = new ReportingServiceProxyQueueInterventionReportParams(elementsOrVersion);
    ...
    static final class ReportingServiceProxyQueueDeprecationReportParams extends Struct {
        ...
        public static ReportingServiceProxyQueueDeprecationReportParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ReportingServiceProxyQueueDeprecationReportParams result = new ReportingServiceProxyQueueDeprecationReportParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.url = Url.decode(decoder1);
                result.id = decoder0.readString(16, false);
    ...
    static final class ReportingServiceProxyQueueCspViolationReportParams extends Struct {
        ...
        public static ReportingServiceProxyQueueCspViolationReportParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ReportingServiceProxyQueueCspViolationReportParams result = new ReportingServiceProxyQueueCspViolationReportParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.url = Url.decode(decoder1);
    ...
    /* loaded from: classes2.dex */
    static final class ReportingServiceProxyQueuePermissionsPolicyViolationReportParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 56;
        private static final DataHeader[] VERSION_ARRAY;
        public int columnNumber;
        ...
        public static ReportingServiceProxyQueuePermissionsPolicyViolationReportParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static ReportingServiceProxyQueuePermissionsPolicyViolationReportParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ReportingServiceProxyQueuePermissionsPolicyViolationReportParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ReportingServiceProxyQueuePermissionsPolicyViolationReportParams result = new ReportingServiceProxyQueuePermissionsPolicyViolationReportParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.url = Url.decode(decoder1);
    ...
    static final class ReportingServiceProxyQueueDocumentPolicyViolationReportParams extends Struct {
        ...
        public static ReportingServiceProxyQueueDocumentPolicyViolationReportParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ReportingServiceProxyQueueDocumentPolicyViolationReportParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ReportingServiceProxyQueueDocumentPolicyViolationReportParams result = new ReportingServiceProxyQueueDocumentPolicyViolationReportParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.url = Url.decode(decoder1);
                result.group = decoder0.readString(16, false);

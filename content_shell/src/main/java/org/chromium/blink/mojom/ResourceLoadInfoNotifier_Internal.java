...
class ResourceLoadInfoNotifier_Internal {
    ...
    public static final Interface.Manager<ResourceLoadInfoNotifier, ResourceLoadInfoNotifier.Proxy> MANAGER = new Interface.Manager<ResourceLoadInfoNotifier, ResourceLoadInfoNotifier.Proxy>() { // from class: org.chromium.blink.mojom.ResourceLoadInfoNotifier_Internal.1
        ...
        public ResourceLoadInfoNotifier.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ResourceLoadInfoNotifier.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ResourceLoadInfoNotifier
        public void notifyResourceRedirectReceived(UrlRequestRedirectInfo redirectInfo, UrlResponseHead redirectResponse) {
        ...
        @Override // org.chromium.blink.mojom.ResourceLoadInfoNotifier
        public void notifyResourceResponseReceived(long requestId, Url responseUrl, UrlResponseHead head, int requestDestination, int previewsState) {
        ...
        @Override // org.chromium.blink.mojom.ResourceLoadInfoNotifier
        public void notifyResourceLoadCompleted(ResourceLoadInfo resourceLoadInfo, UrlLoaderCompletionStatus status) {
    ...
    public static final class Stub extends Interface.Stub<ResourceLoadInfoNotifier> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(ResourceLoadInfoNotifier_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams data = ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().notifyResourceRedirectReceived(data.redirectInfo, data.redirectResponse);
                        return true;
                    case 2:
                        ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams data2 = ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().notifyResourceResponseReceived(data2.requestId, data2.responseUrl, data2.head, data2.requestDestination, data2.previewsState);
                        return true;
                    case 3:
                        ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams data3 = ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().notifyResourceTransferSizeUpdated(data3.requestId, data3.transferSizeDiff);
                        return true;
                    case 4:
                        ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams data4 = ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().notifyResourceLoadCompleted(data4.resourceLoadInfo, data4.status);
                        return true;
                    case 5:
                        getImpl().notifyResourceLoadCanceled(ResourceLoadInfoNotifierNotifyResourceLoadCanceledParams.deserialize(messageWithHeader.getPayload()).requestId);
                        return true;
                    case 6:
                        getImpl().clone(ResourceLoadInfoNotifierCloneParams.deserialize(messageWithHeader.getPayload()).pendingResourceLoadInfoNotifier);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ResourceLoadInfoNotifier_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ResourceLoadInfoNotifierNotifyUpdateUserGestureCarryoverInfoParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierNotifyUpdateUserGestureCarryoverInfoParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ResourceLoadInfoNotifierNotifyUpdateUserGestureCarryoverInfoParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                ResourceLoadInfoNotifierNotifyUpdateUserGestureCarryoverInfoParams result = new ResourceLoadInfoNotifierNotifyUpdateUserGestureCarryoverInfoParams(elementsOrVersion);
                return result;
            } finally {
    ...
    static final class ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams result = new ResourceLoadInfoNotifierNotifyResourceRedirectReceivedParams(elementsOrVersion);
    ...
    static final class ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams result = new ResourceLoadInfoNotifierNotifyResourceResponseReceivedParams(elementsOrVersion);
                result.requestId = decoder0.readLong(8);
                Decoder decoder1 = decoder0.readPointer(16, false);
                result.responseUrl = Url.decode(decoder1);
        ...
        public final void encode(Encoder encoder) {
            ...
            encoder0.encode((Struct) this.responseUrl, 16, false);
    ...
    static final class ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams result = new ResourceLoadInfoNotifierNotifyResourceTransferSizeUpdatedParams(elementsOrVersion);
                result.requestId = decoder0.readLong(8);
    ...
    static final class ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams result = new ResourceLoadInfoNotifierNotifyResourceLoadCompletedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class ResourceLoadInfoNotifierNotifyResourceLoadCanceledParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierNotifyResourceLoadCanceledParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ResourceLoadInfoNotifierNotifyResourceLoadCanceledParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ResourceLoadInfoNotifierNotifyResourceLoadCanceledParams result = new ResourceLoadInfoNotifierNotifyResourceLoadCanceledParams(elementsOrVersion);
                result.requestId = decoder0.readLong(8);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    static final class ResourceLoadInfoNotifierCloneParams extends Struct {
        ...
        public static ResourceLoadInfoNotifierCloneParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ResourceLoadInfoNotifierCloneParams result = new ResourceLoadInfoNotifierCloneParams(elementsOrVersion);

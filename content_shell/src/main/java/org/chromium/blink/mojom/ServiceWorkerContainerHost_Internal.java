...
class ServiceWorkerContainerHost_Internal {
    ...
    public static final Interface.Manager<ServiceWorkerContainerHost, ServiceWorkerContainerHost.Proxy> MANAGER = new Interface.Manager<ServiceWorkerContainerHost, ServiceWorkerContainerHost.Proxy>() { // from class: org.chromium.blink.mojom.ServiceWorkerContainerHost_Internal.1
        ...
        public ServiceWorkerContainerHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ServiceWorkerContainerHost.Proxy {
        ...
        public void register(Url scriptUrl, ServiceWorkerRegistrationOptions options, FetchClientSettingsObject outsideFetchClientSettingsObject, RegisterResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new ServiceWorkerContainerHostRegisterResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ServiceWorkerContainerHost
        public void getRegistration(Url clientUrl, GetRegistrationResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new ServiceWorkerContainerHostGetRegistrationResponseParamsForwardToCallback(callback));
        }
        ...
        public void getRegistrations(GetRegistrationsResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new ServiceWorkerContainerHostGetRegistrationsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.ServiceWorkerContainerHost
        public void getRegistrationForReady(GetRegistrationForReadyResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new ServiceWorkerContainerHostGetRegistrationForReadyResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.ServiceWorkerContainerHost
        public void ensureFileAccess(FilePath[] files, EnsureFileAccessResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(7, 1, 0L)), new ServiceWorkerContainerHostEnsureFileAccessResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<ServiceWorkerContainerHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 4:
                        ServiceWorkerContainerHostEnsureControllerServiceWorkerParams data = ServiceWorkerContainerHostEnsureControllerServiceWorkerParams.deserialize(messageWithHeader.getPayload());
                        getImpl().ensureControllerServiceWorker(data.receiver, data.purpose);
                        return true;
                    case 5:
                        getImpl().cloneContainerHost(ServiceWorkerContainerHostCloneContainerHostParams.deserialize(messageWithHeader.getPayload()).containerHost);
                        return true;
                    case 6:
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ServiceWorkerContainerHost_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        ServiceWorkerContainerHostRegisterParams data = ServiceWorkerContainerHostRegisterParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 1:
                        getImpl().getRegistration(ServiceWorkerContainerHostGetRegistrationParams.deserialize(messageWithHeader.getPayload()).clientUrl, new ServiceWorkerContainerHostGetRegistrationResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                    ...
                    default:
                        return false;
                    case 7:
                        getImpl().ensureFileAccess(ServiceWorkerContainerHostEnsureFileAccessParams.deserialize(messageWithHeader.getPayload()).files, new ServiceWorkerContainerHostEnsureFileAccessResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class ServiceWorkerContainerHostRegisterParams extends Struct {
        ...
        public static ServiceWorkerContainerHostRegisterParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ServiceWorkerContainerHostRegisterParams result = new ServiceWorkerContainerHostRegisterParams(elementsOrVersion);
    ...
    public static final class ServiceWorkerContainerHostRegisterResponseParams extends Struct {
        ...
        public static ServiceWorkerContainerHostRegisterResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostRegisterResponseParams result = new ServiceWorkerContainerHostRegisterResponseParams(elementsOrVersion);
    ...
    static final class ServiceWorkerContainerHostGetRegistrationParams extends Struct {
        ...
        public static ServiceWorkerContainerHostGetRegistrationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostGetRegistrationParams result = new ServiceWorkerContainerHostGetRegistrationParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class ServiceWorkerContainerHostGetRegistrationResponseParams extends Struct {
        ...
        public static ServiceWorkerContainerHostGetRegistrationResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostGetRegistrationResponseParams result = new ServiceWorkerContainerHostGetRegistrationResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                ServiceWorkerErrorType.validate(readInt);
                result.error = ServiceWorkerErrorType.toKnownValue(result.error);
    ...
    static final class ServiceWorkerContainerHostGetRegistrationsParams extends Struct {
        ...
        public static ServiceWorkerContainerHostGetRegistrationsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostGetRegistrationsParams result = new ServiceWorkerContainerHostGetRegistrationsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class ServiceWorkerContainerHostGetRegistrationsResponseParams extends Struct {
        ...
        public static ServiceWorkerContainerHostGetRegistrationsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostGetRegistrationsResponseParams result = new ServiceWorkerContainerHostGetRegistrationsResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;
                ServiceWorkerErrorType.validate(readInt);
                result.error = ServiceWorkerErrorType.toKnownValue(result.error);
        ...
        public final void encode(Encoder encoder) {
            ...
            Encoder encoder1 = encoder0.encodePointerArray(serviceWorkerRegistrationObjectInfoArr.length, 24, -1);
            int i0 = 0;
            while (true) {
                ...
                if (i0 < serviceWorkerRegistrationObjectInfoArr2.length) {
                    encoder1.encode((Struct) serviceWorkerRegistrationObjectInfoArr2[i0], (i0 * 8) + 8, false);
                    i0++;
                } else {
                    return;
                }
    ...
    static final class ServiceWorkerContainerHostGetRegistrationForReadyParams extends Struct {
        ...
        public static ServiceWorkerContainerHostGetRegistrationForReadyParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostGetRegistrationForReadyParams result = new ServiceWorkerContainerHostGetRegistrationForReadyParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class ServiceWorkerContainerHostGetRegistrationForReadyResponseParams extends Struct {
        ...
        public static ServiceWorkerContainerHostGetRegistrationForReadyResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostGetRegistrationForReadyResponseParams result = new ServiceWorkerContainerHostGetRegistrationForReadyResponseParams(elementsOrVersion);
    ...
    static final class ServiceWorkerContainerHostEnsureControllerServiceWorkerParams extends Struct {
        ...
        public static ServiceWorkerContainerHostEnsureControllerServiceWorkerParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostEnsureControllerServiceWorkerParams result = new ServiceWorkerContainerHostEnsureControllerServiceWorkerParams(elementsOrVersion);
    ...
    static final class ServiceWorkerContainerHostCloneContainerHostParams extends Struct {
        ...
        public static ServiceWorkerContainerHostCloneContainerHostParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostCloneContainerHostParams result = new ServiceWorkerContainerHostCloneContainerHostParams(elementsOrVersion);
    ...
    static final class ServiceWorkerContainerHostHintToUpdateServiceWorkerParams extends Struct {
        ...
        public static ServiceWorkerContainerHostHintToUpdateServiceWorkerParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostHintToUpdateServiceWorkerParams result = new ServiceWorkerContainerHostHintToUpdateServiceWorkerParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class ServiceWorkerContainerHostEnsureFileAccessParams extends Struct {
        ...
        public static ServiceWorkerContainerHostEnsureFileAccessParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostEnsureFileAccessParams result = new ServiceWorkerContainerHostEnsureFileAccessParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
    ...
    static final class ServiceWorkerContainerHostEnsureFileAccessResponseParams extends Struct {
        ...
        public static ServiceWorkerContainerHostEnsureFileAccessResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static ServiceWorkerContainerHostEnsureFileAccessResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostEnsureFileAccessResponseParams result = new ServiceWorkerContainerHostEnsureFileAccessResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static class ServiceWorkerContainerHostEnsureFileAccessResponseParamsProxyToResponder implements ServiceWorkerContainerHost.EnsureFileAccessResponse {
        ...
        ServiceWorkerContainerHostEnsureFileAccessResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class ServiceWorkerContainerHostOnExecutionReadyParams extends Struct {
        ...
        public static ServiceWorkerContainerHostOnExecutionReadyParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerContainerHostOnExecutionReadyParams result = new ServiceWorkerContainerHostOnExecutionReadyParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

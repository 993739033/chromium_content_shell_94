...
public final class ServiceWorkerInstalledScriptsInfo extends Struct {
    ...
    public static ServiceWorkerInstalledScriptsInfo decode(Decoder decoder0) {
        ...
        try {
            ...
            ServiceWorkerInstalledScriptsInfo result = new ServiceWorkerInstalledScriptsInfo(elementsOrVersion);
            result.managerReceiver = decoder0.readInterfaceRequest(8, false);
            result.managerHostRemote = (ServiceWorkerInstalledScriptsManagerHost) decoder0.readServiceInterface(12, false, ServiceWorkerInstalledScriptsManagerHost.MANAGER);

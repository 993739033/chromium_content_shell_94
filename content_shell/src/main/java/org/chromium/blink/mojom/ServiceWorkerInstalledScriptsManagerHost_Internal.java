...
import org.chromium.blink.mojom.ServiceWorkerInstalledScriptsManagerHost;
...
class ServiceWorkerInstalledScriptsManagerHost_Internal {
    public static final Interface.Manager<ServiceWorkerInstalledScriptsManagerHost, ServiceWorkerInstalledScriptsManagerHost.Proxy> MANAGER = new Interface.Manager<ServiceWorkerInstalledScriptsManagerHost, ServiceWorkerInstalledScriptsManagerHost.Proxy>() { // from class: org.chromium.blink.mojom.ServiceWorkerInstalledScriptsManagerHost_Internal.1
        ...
        public ServiceWorkerInstalledScriptsManagerHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ServiceWorkerInstalledScriptsManagerHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ServiceWorkerInstalledScriptsManagerHost
    ...
    public static final class Stub extends Interface.Stub<ServiceWorkerInstalledScriptsManagerHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ServiceWorkerInstalledScriptsManagerHostRequestInstalledScriptParams data = ServiceWorkerInstalledScriptsManagerHostRequestInstalledScriptParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ServiceWorkerInstalledScriptsManagerHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ServiceWorkerInstalledScriptsManagerHostRequestInstalledScriptParams extends Struct {
        ...
        public static ServiceWorkerInstalledScriptsManagerHostRequestInstalledScriptParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ServiceWorkerInstalledScriptsManagerHostRequestInstalledScriptParams result = new ServiceWorkerInstalledScriptsManagerHostRequestInstalledScriptParams(elementsOrVersion);

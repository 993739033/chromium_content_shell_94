...
class ServiceWorkerObjectHost_Internal {
    public static final Interface.Manager<ServiceWorkerObjectHost, ServiceWorkerObjectHost.Proxy> MANAGER = new Interface.Manager<ServiceWorkerObjectHost, ServiceWorkerObjectHost.Proxy>() { // from class: org.chromium.blink.mojom.ServiceWorkerObjectHost_Internal.1
        ...
        public ServiceWorkerObjectHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ServiceWorkerObjectHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ServiceWorkerObjectHost
        public void terminateForTesting(TerminateForTestingResponse callback) {
            ServiceWorkerObjectHostTerminateForTestingParams _message = new ServiceWorkerObjectHostTerminateForTestingParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new ServiceWorkerObjectHostTerminateForTestingResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<ServiceWorkerObjectHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ServiceWorkerObjectHostPostMessageToServiceWorkerParams data = ServiceWorkerObjectHostPostMessageToServiceWorkerParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ServiceWorkerObjectHost_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    default:
                        return false;
                    case 1:
    ...
    static final class ServiceWorkerObjectHostPostMessageToServiceWorkerParams extends Struct {
        ...
        public static ServiceWorkerObjectHostPostMessageToServiceWorkerParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ServiceWorkerObjectHostPostMessageToServiceWorkerParams result = new ServiceWorkerObjectHostPostMessageToServiceWorkerParams(elementsOrVersion);
    ...
    static final class ServiceWorkerObjectHostTerminateForTestingParams extends Struct {
        ...
        public static ServiceWorkerObjectHostTerminateForTestingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerObjectHostTerminateForTestingParams result = new ServiceWorkerObjectHostTerminateForTestingParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class ServiceWorkerObjectHostTerminateForTestingResponseParams extends Struct {
        ...
        public static ServiceWorkerObjectHostTerminateForTestingResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ServiceWorkerObjectHostTerminateForTestingResponseParams result = new ServiceWorkerObjectHostTerminateForTestingResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

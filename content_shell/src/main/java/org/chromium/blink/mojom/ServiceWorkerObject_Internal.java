...
import org.chromium.blink.mojom.ServiceWorkerObject;
...
class ServiceWorkerObject_Internal {
    public static final Interface.Manager<ServiceWorkerObject, ServiceWorkerObject.Proxy> MANAGER = new Interface.Manager<ServiceWorkerObject, ServiceWorkerObject.Proxy>() { // from class: org.chromium.blink.mojom.ServiceWorkerObject_Internal.1
        ...
        public ServiceWorkerObject.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements ServiceWorkerObject.Proxy {
        ...
        @Override // org.chromium.blink.mojom.ServiceWorkerObject
    ...
    public static final class Stub extends Interface.Stub<ServiceWorkerObject> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        ServiceWorkerObjectStateChangedParams data = ServiceWorkerObjectStateChangedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ServiceWorkerObject_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ServiceWorkerObjectStateChangedParams extends Struct {
        ...
        public static ServiceWorkerObjectStateChangedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ServiceWorkerObjectStateChangedParams result = new ServiceWorkerObjectStateChangedParams(elementsOrVersion);

...
public final class ServiceWorkerProviderInfoForStartWorker extends Struct {
    ...
    public static ServiceWorkerProviderInfoForStartWorker decode(Decoder decoder0) {
        ...
        try {
            ...
            ServiceWorkerProviderInfoForStartWorker result = new ServiceWorkerProviderInfoForStartWorker(elementsOrVersion);
            result.hostRemote = decoder0.readAssociatedServiceInterfaceNotSupported(8, false);
            result.scriptLoaderFactoryRemote = (UrlLoaderFactory) decoder0.readServiceInterface(16, true, UrlLoaderFactory.MANAGER);
            result.cacheStorage = (CacheStorage) decoder0.readServiceInterface(24, true, CacheStorage.MANAGER);
            result.browserInterfaceBroker = (BrowserInterfaceBroker) decoder0.readServiceInterface(32, false, BrowserInterfaceBroker.MANAGER);
            return result;
        } finally {

...
class SharedStorageDocumentService_Internal {
    public static final Interface.Manager<SharedStorageDocumentService, SharedStorageDocumentService.Proxy> MANAGER = new Interface.Manager<SharedStorageDocumentService, SharedStorageDocumentService.Proxy>() { // from class: org.chromium.blink.mojom.SharedStorageDocumentService_Internal.1
        ...
        public SharedStorageDocumentService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
            return new Proxy(core, messageReceiver);
        }

        @Override // org.chromium.mojo.bindings.Interface.Manager
        public Stub buildStub(Core core, SharedStorageDocumentService impl) {
    ...
    SharedStorageDocumentService_Internal() {
    }
    ...
    public static final class Stub extends Interface.Stub<SharedStorageDocumentService> {
        Stub(Core core, SharedStorageDocumentService impl) {
            super(core, impl);
        }
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(SharedStorageDocumentService_Internal.MANAGER, messageWithHeader);
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SharedStorageDocumentService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {

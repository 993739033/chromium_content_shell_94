...
class SharedWorkerClient_Internal {
    public static final Interface.Manager<SharedWorkerClient, SharedWorkerClient.Proxy> MANAGER = new Interface.Manager<SharedWorkerClient, SharedWorkerClient.Proxy>() { // from class: org.chromium.blink.mojom.SharedWorkerClient_Internal.1
        ...
        public SharedWorkerClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        SharedWorkerClientOnScriptLoadFailedParams data3 = SharedWorkerClientOnScriptLoadFailedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onScriptLoadFailed(data3.errorMessage);
                        return true;
                    case 3:
                        SharedWorkerClientOnFeatureUsedParams data4 = SharedWorkerClientOnFeatureUsedParams.deserialize(messageWithHeader.getPayload());

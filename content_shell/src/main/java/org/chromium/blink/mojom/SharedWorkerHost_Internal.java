...
class SharedWorkerHost_Internal {
    public static final Interface.Manager<SharedWorkerHost, SharedWorkerHost.Proxy> MANAGER = new Interface.Manager<SharedWorkerHost, SharedWorkerHost.Proxy>() { // from class: org.chromium.blink.mojom.SharedWorkerHost_Internal.1
        ...
        public SharedWorkerHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements SharedWorkerHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.SharedWorkerHost
        public void onReadyForInspection(DevToolsAgent agent, InterfaceRequest<DevToolsAgentHost> agentHost) {
    ...
    public static final class Stub extends Interface.Stub<SharedWorkerHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        getImpl().onConnected(SharedWorkerHostOnConnectedParams.deserialize(messageWithHeader.getPayload()).connectionId);
                        return true;
                    case 1:
                        ...
                        return true;
                    case 2:
                        SharedWorkerHostOnReadyForInspectionParams data = SharedWorkerHostOnReadyForInspectionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onReadyForInspection(data.agent, data.agentHost);
                        return true;
                    case 3:
                        SharedWorkerHostOnScriptLoadFailedParams data2 = SharedWorkerHostOnScriptLoadFailedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onScriptLoadFailed(data2.errorMessage);
                        return true;
                    case 4:
                        SharedWorkerHostOnFeatureUsedParams data3 = SharedWorkerHostOnFeatureUsedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SharedWorkerHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SharedWorkerHostOnConnectedParams extends Struct {
        ...
        public static SharedWorkerHostOnConnectedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SharedWorkerHostOnConnectedParams result = new SharedWorkerHostOnConnectedParams(elementsOrVersion);
    ...
    static final class SharedWorkerHostOnContextClosedParams extends Struct {
        ...
        public static SharedWorkerHostOnContextClosedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SharedWorkerHostOnContextClosedParams result = new SharedWorkerHostOnContextClosedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SharedWorkerHostOnReadyForInspectionParams extends Struct {
        ...
        public static SharedWorkerHostOnReadyForInspectionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SharedWorkerHostOnReadyForInspectionParams result = new SharedWorkerHostOnReadyForInspectionParams(elementsOrVersion);
                result.agent = (DevToolsAgent) decoder0.readServiceInterface(8, false, DevToolsAgent.MANAGER);
    ...
    static final class SharedWorkerHostOnScriptLoadFailedParams extends Struct {
        ...
        public static SharedWorkerHostOnScriptLoadFailedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SharedWorkerHostOnScriptLoadFailedParams result = new SharedWorkerHostOnScriptLoadFailedParams(elementsOrVersion);
    ...
    static final class SharedWorkerHostOnFeatureUsedParams extends Struct {
        ...
        public static SharedWorkerHostOnFeatureUsedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SharedWorkerHostOnFeatureUsedParams result = new SharedWorkerHostOnFeatureUsedParams(elementsOrVersion);

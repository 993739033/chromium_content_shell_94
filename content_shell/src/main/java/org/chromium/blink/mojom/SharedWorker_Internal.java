...
import org.chromium.blink.mojom.SharedWorker;
...
class SharedWorker_Internal {
    ...
    public static final Interface.Manager<SharedWorker, SharedWorker.Proxy> MANAGER = new Interface.Manager<SharedWorker, SharedWorker.Proxy>() { // from class: org.chromium.blink.mojom.SharedWorker_Internal.1
        ...
        public SharedWorker.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements SharedWorker.Proxy {
        ...
        @Override // org.chromium.blink.mojom.SharedWorker
    ...
    public static final class Stub extends Interface.Stub<SharedWorker> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        SharedWorkerConnectParams data = SharedWorkerConnectParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SharedWorker_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {

...
class SpeechRecognitionSessionClient_Internal {
    ...
    public static final Interface.Manager<SpeechRecognitionSessionClient, SpeechRecognitionSessionClient.Proxy> MANAGER = new Interface.Manager<SpeechRecognitionSessionClient, SpeechRecognitionSessionClient.Proxy>() { // from class: org.chromium.blink.mojom.SpeechRecognitionSessionClient_Internal.1
        ...
        public SpeechRecognitionSessionClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<SpeechRecognitionSessionClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        SpeechRecognitionSessionClientResultRetrievedParams data = SpeechRecognitionSessionClientResultRetrievedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().resultRetrieved(data.results);
                        return true;
                    case 1:
                        SpeechRecognitionSessionClientErrorOccurredParams data2 = SpeechRecognitionSessionClientErrorOccurredParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SpeechRecognitionSessionClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SpeechRecognitionSessionClientResultRetrievedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientResultRetrievedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SpeechRecognitionSessionClientResultRetrievedParams result = new SpeechRecognitionSessionClientResultRetrievedParams(elementsOrVersion);
    ...
    static final class SpeechRecognitionSessionClientErrorOccurredParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientErrorOccurredParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientErrorOccurredParams result = new SpeechRecognitionSessionClientErrorOccurredParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class SpeechRecognitionSessionClientStartedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientStartedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientStartedParams result = new SpeechRecognitionSessionClientStartedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechRecognitionSessionClientAudioStartedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientAudioStartedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientAudioStartedParams result = new SpeechRecognitionSessionClientAudioStartedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechRecognitionSessionClientSoundStartedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientSoundStartedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientSoundStartedParams result = new SpeechRecognitionSessionClientSoundStartedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechRecognitionSessionClientSoundEndedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientSoundEndedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientSoundEndedParams result = new SpeechRecognitionSessionClientSoundEndedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechRecognitionSessionClientAudioEndedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientAudioEndedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientAudioEndedParams result = new SpeechRecognitionSessionClientAudioEndedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechRecognitionSessionClientEndedParams extends Struct {
        ...
        public static SpeechRecognitionSessionClientEndedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechRecognitionSessionClientEndedParams result = new SpeechRecognitionSessionClientEndedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

...
class SpeechRecognizer_Internal {
    public static final Interface.Manager<SpeechRecognizer, SpeechRecognizer.Proxy> MANAGER = new Interface.Manager<SpeechRecognizer, SpeechRecognizer.Proxy>() { // from class: org.chromium.blink.mojom.SpeechRecognizer_Internal.1
        ...
        public SpeechRecognizer.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<SpeechRecognizer> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        SpeechRecognizerStartParams data = SpeechRecognizerStartParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SpeechRecognizer_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {

...
class SpeechSynthesisClient_Internal {
    public static final Interface.Manager<SpeechSynthesisClient, SpeechSynthesisClient.Proxy> MANAGER = new Interface.Manager<SpeechSynthesisClient, SpeechSynthesisClient.Proxy>() { // from class: org.chromium.blink.mojom.SpeechSynthesisClient_Internal.1
        ...
        public SpeechSynthesisClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements SpeechSynthesisClient.Proxy {
    ...
    public static final class Stub extends Interface.Stub<SpeechSynthesisClient> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(SpeechSynthesisClient_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                    ...
                    case 3:
                        ...
                        return true;
                    case 4:
                        SpeechSynthesisClientOnEncounteredWordBoundaryParams data = SpeechSynthesisClientOnEncounteredWordBoundaryParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onEncounteredWordBoundary(data.charIndex, data.charLength);
                        return true;
                    case 5:
                        SpeechSynthesisClientOnEncounteredSentenceBoundaryParams data2 = SpeechSynthesisClientOnEncounteredSentenceBoundaryParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SpeechSynthesisClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SpeechSynthesisClientOnStartedSpeakingParams extends Struct {
        ...
        public static SpeechSynthesisClientOnStartedSpeakingParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SpeechSynthesisClientOnStartedSpeakingParams result = new SpeechSynthesisClientOnStartedSpeakingParams(elementsOrVersion);
                return result;
            } finally {
    ...
    static final class SpeechSynthesisClientOnFinishedSpeakingParams extends Struct {
        ...
        public static SpeechSynthesisClientOnFinishedSpeakingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechSynthesisClientOnFinishedSpeakingParams result = new SpeechSynthesisClientOnFinishedSpeakingParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechSynthesisClientOnPausedSpeakingParams extends Struct {
        ...
        public static SpeechSynthesisClientOnPausedSpeakingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechSynthesisClientOnPausedSpeakingParams result = new SpeechSynthesisClientOnPausedSpeakingParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechSynthesisClientOnResumedSpeakingParams extends Struct {
        ...
        public static SpeechSynthesisClientOnResumedSpeakingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechSynthesisClientOnResumedSpeakingParams result = new SpeechSynthesisClientOnResumedSpeakingParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SpeechSynthesisClientOnEncounteredWordBoundaryParams extends Struct {
        ...
        public static SpeechSynthesisClientOnEncounteredWordBoundaryParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static SpeechSynthesisClientOnEncounteredWordBoundaryParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static SpeechSynthesisClientOnEncounteredWordBoundaryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechSynthesisClientOnEncounteredWordBoundaryParams result = new SpeechSynthesisClientOnEncounteredWordBoundaryParams(elementsOrVersion);
    ...
    static final class SpeechSynthesisClientOnEncounteredSentenceBoundaryParams extends Struct {
        ...
        public static SpeechSynthesisClientOnEncounteredSentenceBoundaryParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static SpeechSynthesisClientOnEncounteredSentenceBoundaryParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static SpeechSynthesisClientOnEncounteredSentenceBoundaryParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechSynthesisClientOnEncounteredSentenceBoundaryParams result = new SpeechSynthesisClientOnEncounteredSentenceBoundaryParams(elementsOrVersion);
                result.charIndex = decoder0.readInt(8);
                result.charLength = decoder0.readInt(12);
                return result;
            } finally {
    ...
    static final class SpeechSynthesisClientOnEncounteredSpeakingErrorParams extends Struct {
        ...
        public static SpeechSynthesisClientOnEncounteredSpeakingErrorParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static SpeechSynthesisClientOnEncounteredSpeakingErrorParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static SpeechSynthesisClientOnEncounteredSpeakingErrorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SpeechSynthesisClientOnEncounteredSpeakingErrorParams result = new SpeechSynthesisClientOnEncounteredSpeakingErrorParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

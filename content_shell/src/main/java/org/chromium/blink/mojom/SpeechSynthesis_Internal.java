...
import org.chromium.blink.mojom.SpeechSynthesis;
...
class SpeechSynthesis_Internal {
    ...
    public static final Interface.Manager<SpeechSynthesis, SpeechSynthesis.Proxy> MANAGER = new Interface.Manager<SpeechSynthesis, SpeechSynthesis.Proxy>() { // from class: org.chromium.blink.mojom.SpeechSynthesis_Internal.1
        ...
        public SpeechSynthesis.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements SpeechSynthesis.Proxy {
        ...
        @Override // org.chromium.blink.mojom.SpeechSynthesis
    ...
    public static final class Stub extends Interface.Stub<SpeechSynthesis> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(SpeechSynthesis_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        getImpl().addVoiceListObserver(SpeechSynthesisAddVoiceListObserverParams.deserialize(messageWithHeader.getPayload()).observer);
                        return true;
                    case 1:
                        SpeechSynthesisSpeakParams data = SpeechSynthesisSpeakParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SpeechSynthesis_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SpeechSynthesisAddVoiceListObserverParams extends Struct {
        ...
        public static SpeechSynthesisAddVoiceListObserverParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SpeechSynthesisAddVoiceListObserverParams result = new SpeechSynthesisAddVoiceListObserverParams(elementsOrVersion);
                result.observer = (SpeechSynthesisVoiceListObserver) decoder0.readServiceInterface(8, false, SpeechSynthesisVoiceListObserver.MANAGER);
                return result;
            } finally {
    ...
    static final class SpeechSynthesisSpeakParams extends Struct {
        ...
        public static SpeechSynthesisSpeakParams decode(Decoder decoder0) {
            ...
            try {
                ...
                result.client = (SpeechSynthesisClient) decoder0.readServiceInterface(16, false, SpeechSynthesisClient.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

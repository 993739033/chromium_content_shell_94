...
class StorageAreaObserver_Internal {
    ...
    public static final Interface.Manager<StorageAreaObserver, StorageAreaObserver.Proxy> MANAGER = new Interface.Manager<StorageAreaObserver, StorageAreaObserver.Proxy>() { // from class: org.chromium.blink.mojom.StorageAreaObserver_Internal.1
        ...
        public StorageAreaObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<StorageAreaObserver> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        StorageAreaObserverKeyChangedParams data = StorageAreaObserverKeyChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().keyChanged(data.key, data.newValue, data.oldValue, data.source);
                        return true;
                    case 1:
                        StorageAreaObserverKeyChangeFailedParams data2 = StorageAreaObserverKeyChangeFailedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().keyChangeFailed(data2.key, data2.source);
                        return true;
                    case 2:
                        StorageAreaObserverKeyDeletedParams data3 = StorageAreaObserverKeyDeletedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().keyDeleted(data3.key, data3.oldValue, data3.source);
                        return true;
                    case 3:
                        StorageAreaObserverAllDeletedParams data4 = StorageAreaObserverAllDeletedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().allDeleted(data4.wasNonempty, data4.source);
                        return true;
                    case 4:
                        getImpl().shouldSendOldValueOnMutations(StorageAreaObserverShouldSendOldValueOnMutationsParams.deserialize(messageWithHeader.getPayload()).value);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), StorageAreaObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class StorageAreaObserverKeyChangedParams extends Struct {
        ...
        public static StorageAreaObserverKeyChangedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                StorageAreaObserverKeyChangedParams result = new StorageAreaObserverKeyChangedParams(elementsOrVersion);
    ...
    static final class StorageAreaObserverKeyChangeFailedParams extends Struct {
        ...
        public static StorageAreaObserverKeyChangeFailedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                StorageAreaObserverKeyChangeFailedParams result = new StorageAreaObserverKeyChangeFailedParams(elementsOrVersion);
                result.key = decoder0.readBytes(8, 0, -1);
    ...
    static final class StorageAreaObserverKeyDeletedParams extends Struct {
        ...
        public static StorageAreaObserverKeyDeletedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                StorageAreaObserverKeyDeletedParams result = new StorageAreaObserverKeyDeletedParams(elementsOrVersion);
                result.key = decoder0.readBytes(8, 0, -1);
    ...
    static final class StorageAreaObserverAllDeletedParams extends Struct {
        ...
        public static StorageAreaObserverAllDeletedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                StorageAreaObserverAllDeletedParams result = new StorageAreaObserverAllDeletedParams(elementsOrVersion);
    ...
    static final class StorageAreaObserverShouldSendOldValueOnMutationsParams extends Struct {
        ...
        public static StorageAreaObserverShouldSendOldValueOnMutationsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                StorageAreaObserverShouldSendOldValueOnMutationsParams result = new StorageAreaObserverShouldSendOldValueOnMutationsParams(elementsOrVersion);

...
class SynchronousCompositorHost_Internal {
    ...
    public static final Interface.Manager<SynchronousCompositorHost, SynchronousCompositorHost.Proxy> MANAGER = new Interface.Manager<SynchronousCompositorHost, SynchronousCompositorHost.Proxy>() { // from class: org.chromium.blink.mojom.SynchronousCompositorHost_Internal.1
        ...
        public SynchronousCompositorHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<SynchronousCompositorHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(SynchronousCompositorHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        SynchronousCompositorHostUpdateStateParams data = SynchronousCompositorHostUpdateStateParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateState(data.params);
                        return true;
                    case 2:
                        SynchronousCompositorHostSetNeedsBeginFramesParams data2 = SynchronousCompositorHostSetNeedsBeginFramesParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SynchronousCompositorHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SynchronousCompositorHostLayerTreeFrameSinkCreatedParams extends Struct {
        ...
        public static SynchronousCompositorHostLayerTreeFrameSinkCreatedParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static SynchronousCompositorHostLayerTreeFrameSinkCreatedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static SynchronousCompositorHostLayerTreeFrameSinkCreatedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                SynchronousCompositorHostLayerTreeFrameSinkCreatedParams result = new SynchronousCompositorHostLayerTreeFrameSinkCreatedParams(elementsOrVersion);
                return result;
            } finally {
    ...
    static final class SynchronousCompositorHostUpdateStateParams extends Struct {
        ...
        public static SynchronousCompositorHostUpdateStateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorHostUpdateStateParams result = new SynchronousCompositorHostUpdateStateParams(elementsOrVersion);
    ...
    static final class SynchronousCompositorHostSetNeedsBeginFramesParams extends Struct {
        ...
        public static SynchronousCompositorHostSetNeedsBeginFramesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorHostSetNeedsBeginFramesParams result = new SynchronousCompositorHostSetNeedsBeginFramesParams(elementsOrVersion);

...
class SynchronousCompositor_Internal {
    ...
    public static final Interface.Manager<SynchronousCompositor, SynchronousCompositor.Proxy> MANAGER = new Interface.Manager<SynchronousCompositor, SynchronousCompositor.Proxy>() { // from class: org.chromium.blink.mojom.SynchronousCompositor_Internal.1
        ...
        public SynchronousCompositor.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements SynchronousCompositor.Proxy {
        ...
        @Override // org.chromium.blink.mojom.SynchronousCompositor
        public void demandDrawHw(SyncCompositorDemandDrawHwParams drawParams, DemandDrawHwResponse callback) {
            SynchronousCompositorDemandDrawHwParams _message = new SynchronousCompositorDemandDrawHwParams();
            _message.drawParams = drawParams;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new SynchronousCompositorDemandDrawHwResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.SynchronousCompositor
        public void setSharedMemory(WritableSharedMemoryRegion shmRegion, SetSharedMemoryResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new SynchronousCompositorSetSharedMemoryResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.SynchronousCompositor
        public void demandDrawSw(SyncCompositorDemandDrawSwParams drawParams, DemandDrawSwResponse callback) {
            SynchronousCompositorDemandDrawSwParams _message = new SynchronousCompositorDemandDrawSwParams();
            _message.drawParams = drawParams;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new SynchronousCompositorDemandDrawSwResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.SynchronousCompositor
        public void zoomBy(float delta, Point anchor, ZoomByResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new SynchronousCompositorZoomByResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.SynchronousCompositor
        public void setScroll(ScrollOffset offset) {
    ...
    public static final class Stub extends Interface.Stub<SynchronousCompositor> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(SynchronousCompositor_Internal.MANAGER, messageWithHeader);
                    case -1:
                    case 1:
                    case 2:
                    case 3:
                    ...
                    default:
                        return false;
                    case 0:
                        SynchronousCompositorDemandDrawHwAsyncParams data = SynchronousCompositorDemandDrawHwAsyncParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 5:
                        ...
                        return true;
                    case 7:
                        SynchronousCompositorSetMemoryPolicyParams data2 = SynchronousCompositorSetMemoryPolicyParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setMemoryPolicy(data2.bytesLimit);
                        return true;
                    case 8:
                        SynchronousCompositorReclaimResourcesParams data3 = SynchronousCompositorReclaimResourcesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().reclaimResources(data3.layerTreeFrameSinkId, data3.resources);
                        return true;
                    case 9:
                        SynchronousCompositorSetScrollParams data4 = SynchronousCompositorSetScrollParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setScroll(data4.offset);
                        return true;
                    case 10:
                        SynchronousCompositorBeginFrameParams data5 = SynchronousCompositorBeginFrameParams.deserialize(messageWithHeader.getPayload());
                        getImpl().beginFrame(data5.args, data5.timingDetails);
                        return true;
                    case 11:
                        SynchronousCompositorSetBeginFrameSourcePausedParams data6 = SynchronousCompositorSetBeginFrameSourcePausedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setBeginFrameSourcePaused(data6.paused);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SynchronousCompositor_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    case 4:
                    case 5:
                    default:
                        return false;
                    case 1:
                        SynchronousCompositorDemandDrawHwParams data = SynchronousCompositorDemandDrawHwParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 2:
                        SynchronousCompositorSetSharedMemoryParams data2 = SynchronousCompositorSetSharedMemoryParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setSharedMemory(data2.shmRegion, new SynchronousCompositorSetSharedMemoryResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        SynchronousCompositorDemandDrawSwParams data3 = SynchronousCompositorDemandDrawSwParams.deserialize(messageWithHeader.getPayload());
                        getImpl().demandDrawSw(data3.drawParams, new SynchronousCompositorDemandDrawSwResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        SynchronousCompositorZoomByParams data4 = SynchronousCompositorZoomByParams.deserialize(messageWithHeader.getPayload());
                        getImpl().zoomBy(data4.delta, data4.anchor, new SynchronousCompositorZoomByResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class SynchronousCompositorDemandDrawHwAsyncParams extends Struct {
        ...
        public static SynchronousCompositorDemandDrawHwAsyncParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SynchronousCompositorDemandDrawHwAsyncParams result = new SynchronousCompositorDemandDrawHwAsyncParams(elementsOrVersion);
    ...
    static final class SynchronousCompositorDemandDrawHwParams extends Struct {
        ...
        public static SynchronousCompositorDemandDrawHwParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorDemandDrawHwParams result = new SynchronousCompositorDemandDrawHwParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.drawParams = SyncCompositorDemandDrawHwParams.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class SynchronousCompositorDemandDrawHwResponseParams extends Struct {
        ...
        public static SynchronousCompositorDemandDrawHwResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorDemandDrawHwResponseParams result = new SynchronousCompositorDemandDrawHwResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static class SynchronousCompositorDemandDrawHwResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.result, Integer.valueOf(response.layerTreeFrameSinkId), Integer.valueOf(response.metadataVersion), response.localSurfaceId, response.frame, response.hitTestRegionList);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class SynchronousCompositorDemandDrawHwResponseParamsProxyToResponder implements SynchronousCompositor.DemandDrawHwResponse {
        ...
        SynchronousCompositorDemandDrawHwResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
        ...
        public void call(SyncCompositorCommonRendererParams result, Integer layerTreeFrameSinkId, Integer metadataVersion, LocalSurfaceId localSurfaceId, CompositorFrame frame, HitTestRegionList hitTestRegionList) {
            SynchronousCompositorDemandDrawHwResponseParams _response = new SynchronousCompositorDemandDrawHwResponseParams();
            _response.result = result;
            _response.layerTreeFrameSinkId = layerTreeFrameSinkId.intValue();
            _response.metadataVersion = metadataVersion.intValue();
    ...
    static final class SynchronousCompositorSetSharedMemoryParams extends Struct {
        ...
        public static SynchronousCompositorSetSharedMemoryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorSetSharedMemoryParams result = new SynchronousCompositorSetSharedMemoryParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class SynchronousCompositorSetSharedMemoryResponseParams extends Struct {
        ...
        public static SynchronousCompositorSetSharedMemoryResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorSetSharedMemoryResponseParams result = new SynchronousCompositorSetSharedMemoryResponseParams(elementsOrVersion);
    ...
    static class SynchronousCompositorSetSharedMemoryResponseParamsProxyToResponder implements SynchronousCompositor.SetSharedMemoryResponse {
        ...
        SynchronousCompositorSetSharedMemoryResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class SynchronousCompositorDemandDrawSwParams extends Struct {
        ...
        public static SynchronousCompositorDemandDrawSwParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorDemandDrawSwParams result = new SynchronousCompositorDemandDrawSwParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class SynchronousCompositorDemandDrawSwResponseParams extends Struct {
        ...
        public static SynchronousCompositorDemandDrawSwResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorDemandDrawSwResponseParams result = new SynchronousCompositorDemandDrawSwResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = SyncCompositorCommonRendererParams.decode(decoder1);
    ...
    static class SynchronousCompositorDemandDrawSwResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.result, Integer.valueOf(response.metadataVersion), response.metaData);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class SynchronousCompositorDemandDrawSwResponseParamsProxyToResponder implements SynchronousCompositor.DemandDrawSwResponse {
        ...
        SynchronousCompositorDemandDrawSwResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
        ...
        public void call(SyncCompositorCommonRendererParams result, Integer metadataVersion, CompositorFrameMetadata metaData) {
    ...
    static final class SynchronousCompositorWillSkipDrawParams extends Struct {
        ...
        public static SynchronousCompositorWillSkipDrawParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorWillSkipDrawParams result = new SynchronousCompositorWillSkipDrawParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SynchronousCompositorZeroSharedMemoryParams extends Struct {
        ...
        public static SynchronousCompositorZeroSharedMemoryParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorZeroSharedMemoryParams result = new SynchronousCompositorZeroSharedMemoryParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SynchronousCompositorZoomByParams extends Struct {
        ...
        public static SynchronousCompositorZoomByParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorZoomByParams result = new SynchronousCompositorZoomByParams(elementsOrVersion);
    ...
    public static final class SynchronousCompositorZoomByResponseParams extends Struct {
        ...
        public static SynchronousCompositorZoomByResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorZoomByResponseParams result = new SynchronousCompositorZoomByResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.result = SyncCompositorCommonRendererParams.decode(decoder1);
                return result;
            } finally {
    ...
    static class SynchronousCompositorZoomByResponseParamsProxyToResponder implements SynchronousCompositor.ZoomByResponse {
        ...
        SynchronousCompositorZoomByResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class SynchronousCompositorSetMemoryPolicyParams extends Struct {
        ...
        public static SynchronousCompositorSetMemoryPolicyParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorSetMemoryPolicyParams result = new SynchronousCompositorSetMemoryPolicyParams(elementsOrVersion);
    ...
    static final class SynchronousCompositorReclaimResourcesParams extends Struct {
        ...
        public static SynchronousCompositorReclaimResourcesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorReclaimResourcesParams result = new SynchronousCompositorReclaimResourcesParams(elementsOrVersion);
    ...
    static final class SynchronousCompositorSetScrollParams extends Struct {
        ...
        public static SynchronousCompositorSetScrollParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorSetScrollParams result = new SynchronousCompositorSetScrollParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.offset = ScrollOffset.decode(decoder1);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class SynchronousCompositorBeginFrameParams extends Struct {
        ...
        public static SynchronousCompositorBeginFrameParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorBeginFrameParams result = new SynchronousCompositorBeginFrameParams(elementsOrVersion);
    ...
    static final class SynchronousCompositorSetBeginFrameSourcePausedParams extends Struct {
        ...
        public static SynchronousCompositorSetBeginFrameSourcePausedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static SynchronousCompositorSetBeginFrameSourcePausedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SynchronousCompositorSetBeginFrameSourcePausedParams result = new SynchronousCompositorSetBeginFrameSourcePausedParams(elementsOrVersion);

...
class TextSuggestionBackend_Internal {
    ...
    public static final Interface.Manager<TextSuggestionBackend, TextSuggestionBackend.Proxy> MANAGER = new Interface.Manager<TextSuggestionBackend, TextSuggestionBackend.Proxy>() { // from class: org.chromium.blink.mojom.TextSuggestionBackend_Internal.1
        ...
        public TextSuggestionBackend.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        getImpl().applySpellCheckSuggestion(TextSuggestionBackendApplySpellCheckSuggestionParams.deserialize(messageWithHeader.getPayload()).suggestion);
                        return true;
                    case 1:
                        TextSuggestionBackendApplyTextSuggestionParams data = TextSuggestionBackendApplyTextSuggestionParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        TextSuggestionBackendOnNewWordAddedToDictionaryParams data2 = TextSuggestionBackendOnNewWordAddedToDictionaryParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 4:
                        ...
                        return true;
                    case 5:
                        TextSuggestionBackendSuggestionMenuTimeoutCallbackParams data3 = TextSuggestionBackendSuggestionMenuTimeoutCallbackParams.deserialize(messageWithHeader.getPayload());

...
class TextSuggestionHost_Internal {
    public static final Interface.Manager<TextSuggestionHost, TextSuggestionHost.Proxy> MANAGER = new Interface.Manager<TextSuggestionHost, TextSuggestionHost.Proxy>() { // from class: org.chromium.blink.mojom.TextSuggestionHost_Internal.1
        ...
        public TextSuggestionHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements TextSuggestionHost.Proxy {
    ...
    public static final class Stub extends Interface.Stub<TextSuggestionHost> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        TextSuggestionHostShowSpellCheckSuggestionMenuParams data = TextSuggestionHostShowSpellCheckSuggestionMenuParams.deserialize(messageWithHeader.getPayload());
                        getImpl().showSpellCheckSuggestionMenu(data.caretX, data.caretY, data.markedText, data.suggestions);
                        return true;
                    case 2:
                        TextSuggestionHostShowTextSuggestionMenuParams data2 = TextSuggestionHostShowTextSuggestionMenuParams.deserialize(messageWithHeader.getPayload());
                        getImpl().showTextSuggestionMenu(data2.caretX, data2.caretY, data2.markedText, data2.suggestions);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), TextSuggestionHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class TextSuggestionHostStartSuggestionMenuTimerParams extends Struct {
        ...
        public static TextSuggestionHostStartSuggestionMenuTimerParams decode(Decoder decoder0) {
            ...
            try {
                ...
                TextSuggestionHostStartSuggestionMenuTimerParams result = new TextSuggestionHostStartSuggestionMenuTimerParams(elementsOrVersion);
                return result;
            } finally {
    ...
    static final class TextSuggestionHostShowSpellCheckSuggestionMenuParams extends Struct {
        ...
        public static TextSuggestionHostShowSpellCheckSuggestionMenuParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                TextSuggestionHostShowSpellCheckSuggestionMenuParams result = new TextSuggestionHostShowSpellCheckSuggestionMenuParams(elementsOrVersion);
    ...
    static final class TextSuggestionHostShowTextSuggestionMenuParams extends Struct {
        ...
        public static TextSuggestionHostShowTextSuggestionMenuParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                TextSuggestionHostShowTextSuggestionMenuParams result = new TextSuggestionHostShowTextSuggestionMenuParams(elementsOrVersion);
                result.caretX = decoder0.readDouble(8);
                result.caretY = decoder0.readDouble(16);
                result.markedText = decoder0.readString(24, false);
                Decoder decoder1 = decoder0.readPointer(32, false);

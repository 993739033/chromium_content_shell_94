...
public final class UntrustworthyContextMenuParams extends Struct {
    ...
    static {
        DataHeader[] dataHeaderArr = {new DataHeader(184, 0)};
    ...
    public static UntrustworthyContextMenuParams decode(Decoder decoder0) {
        ...
        try {
            ...
            int readInt4 = decoder0.readInt(164);
            result.inputFieldType = readInt4;
            ContextMenuDataInputFieldType.validate(readInt4);

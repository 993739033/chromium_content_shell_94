...
public final class ViewportIntersectionState extends Struct {
    ...
    public static ViewportIntersectionState decode(Decoder decoder0) {
        ...
        try {
            ...
            result.mainFrameViewportSize = Size.decode(decoder14);
            Decoder decoder15 = decoder0.readPointer(48, false);
            result.mainFrameScrollOffset = Point.decode(decoder15);
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode((Struct) this.mainFrameViewportSize, 40, false);
        encoder0.encode((Struct) this.mainFrameScrollOffset, 48, false);

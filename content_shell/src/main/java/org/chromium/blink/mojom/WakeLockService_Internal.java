...
class WakeLockService_Internal {
    ...
    public static final Interface.Manager<WakeLockService, WakeLockService.Proxy> MANAGER = new Interface.Manager<WakeLockService, WakeLockService.Proxy>() { // from class: org.chromium.blink.mojom.WakeLockService_Internal.1
        ...
        public WakeLockService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<WakeLockService> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        WakeLockServiceGetWakeLockParams data = WakeLockServiceGetWakeLockParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WakeLockService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class WakeLockServiceGetWakeLockParams extends Struct {
        ...
        public static WakeLockServiceGetWakeLockParams decode(Decoder decoder0) {
            ...
            try {
                ...
                WakeLockServiceGetWakeLockParams result = new WakeLockServiceGetWakeLockParams(elementsOrVersion);

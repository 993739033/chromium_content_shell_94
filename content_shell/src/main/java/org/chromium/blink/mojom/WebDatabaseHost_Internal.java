...
class WebDatabaseHost_Internal {
    ...
    public static final Interface.Manager<WebDatabaseHost, WebDatabaseHost.Proxy> MANAGER = new Interface.Manager<WebDatabaseHost, WebDatabaseHost.Proxy>() { // from class: org.chromium.blink.mojom.WebDatabaseHost_Internal.1
        ...
        public WebDatabaseHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WebDatabaseHost.Proxy {
        ...
        public void openFile(String16 vfsFileName, int desiredFlags, OpenFileResponse callback) {
        ...
        @Override // org.chromium.blink.mojom.WebDatabaseHost
        public void deleteFile(String16 vfsFileName, boolean syncDir, DeleteFileResponse callback) {
        ...
        @Override // org.chromium.blink.mojom.WebDatabaseHost
        public void getFileAttributes(String16 vfsFileName, GetFileAttributesResponse callback) {
        ...
        @Override // org.chromium.blink.mojom.WebDatabaseHost
        public void setFileSize(String16 vfsFileName, long expectedSize, SetFileSizeResponse callback) {
            WebDatabaseHostSetFileSizeParams _message = new WebDatabaseHostSetFileSizeParams();
            _message.vfsFileName = vfsFileName;
            _message.expectedSize = expectedSize;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new WebDatabaseHostSetFileSizeResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.WebDatabaseHost
        public void getSpaceAvailable(Origin origin, GetSpaceAvailableResponse callback) {
            WebDatabaseHostGetSpaceAvailableParams _message = new WebDatabaseHostGetSpaceAvailableParams();
            _message.origin = origin;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new WebDatabaseHostGetSpaceAvailableResponseParamsForwardToCallback(callback));
        }
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        getImpl().getFileAttributes(WebDatabaseHostGetFileAttributesParams.deserialize(messageWithHeader.getPayload()).vfsFileName, new WebDatabaseHostGetFileAttributesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        WebDatabaseHostSetFileSizeParams data3 = WebDatabaseHostSetFileSizeParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setFileSize(data3.vfsFileName, data3.expectedSize, new WebDatabaseHostSetFileSizeResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:

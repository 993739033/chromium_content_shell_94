...
import org.chromium.blink.mojom.WebDatabase;
...
class WebDatabase_Internal {
    ...
    public static final Interface.Manager<WebDatabase, WebDatabase.Proxy> MANAGER = new Interface.Manager<WebDatabase, WebDatabase.Proxy>() { // from class: org.chromium.blink.mojom.WebDatabase_Internal.1
        ...
        public WebDatabase.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WebDatabase.Proxy {
        ...
        @Override // org.chromium.blink.mojom.WebDatabase
    ...
    public static final class Stub extends Interface.Stub<WebDatabase> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        WebDatabaseUpdateSizeParams data = WebDatabaseUpdateSizeParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateSize(data.origin, data.name, data.size);
                        return true;
                    case 1:
                        WebDatabaseCloseImmediatelyParams data2 = WebDatabaseCloseImmediatelyParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WebDatabase_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class WebDatabaseCloseImmediatelyParams extends Struct {
        ...
        public static WebDatabaseCloseImmediatelyParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WebDatabaseCloseImmediatelyParams result = new WebDatabaseCloseImmediatelyParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.origin = Origin.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, false);
                result.name = String16.decode(decoder12);

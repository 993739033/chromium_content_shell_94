...
public final class WebFeature {
    ...
    public static final int COMPUTE_PRESSURE_OBSERVER_STOP = 3901;
    ...
    public static final int EXEC_COMMAND_WITH_TRUSTED_TYPES = 3970;
    ...
    public static final int HANDWRITING_RECOGNITION_QUERY_SUPPORT = 3893;
    ...
    public static final int MAX_VALUE = 3986;
    ...
    public static final int NEW_CANVAS2_DAPI = 3886;
    ...
    public static final int NUMBER_OF_FEATURES = 3986;
    ...
    public static final int OPEN_WEB_DATABASE_THIRD_PARTY_CONTEXT = 3865;
    ...
    public static final int READ_OR_WRITE_WEB_DATABASE_THIRD_PARTY_CONTEXT = 3985;
    ...
    public static final int SERVICE_WORKER_SUBRESOURCE_FILTER_BYPASSED_REQUEST = 3887;
    ...
    public static final int V8_SCREENS_ONCHANGE_ATTRIBUTE_GETTER = 3840;
    public static final int V8_SCREENS_ONCHANGE_ATTRIBUTE_SETTER = 3841;
    public static final int V8_SCREENS_ONCURRENTSCREENCHANGE_ATTRIBUTE_GETTER = 3907;
    public static final int V8_SCREENS_ONCURRENTSCREENCHANGE_ATTRIBUTE_SETTER = 3908;
    public static final int V8_SCREENS_ONSCREENSCHANGE_ATTRIBUTE_GETTER = 3905;
    public static final int V8_SCREENS_ONSCREENSCHANGE_ATTRIBUTE_SETTER = 3906;
    public static final int V8_SCREEN_ADVANCED_DEVICE_PIXEL_RATIO_ATTRIBUTE_GETTER = 3846;
    public static final int V8_SCREEN_ADVANCED_ID_ATTRIBUTE_GETTER = 3847;
    public static final int V8_SCREEN_ADVANCED_IS_INTERNAL_ATTRIBUTE_GETTER = 3845;
    public static final int V8_SCREEN_ADVANCED_IS_PRIMARY_ATTRIBUTE_GETTER = 3844;
    public static final int V8_SCREEN_ADVANCED_LABEL_ATTRIBUTE_GETTER = 3849;
    public static final int V8_SCREEN_ADVANCED_LEFT_ATTRIBUTE_GETTER = 3842;
    public static final int V8_SCREEN_ADVANCED_POINTER_TYPES_ATTRIBUTE_GETTER = 3848;
    public static final int V8_SCREEN_ADVANCED_TOP_ATTRIBUTE_GETTER = 3843;
    ...
    public static boolean isKnownValue(int value) {
        switch (value) {
            ...
            case 135:
            case 136:
            case EVENT_RETURN_VALUE /* 137 */:
            case SVGSVG_ELEMENT /* 138 */:
            case 143:
            case 144:
            case 145:
            case DOM_NODE_REMOVED_FROM_DOCUMENT_EVENT /* 146 */:
            case DOM_NODE_INSERTED_INTO_DOCUMENT_EVENT /* 147 */:
            ...
            case OBSOLETE_UPGRADE_INSECURE_REQUESTS_UPGRADED_REQUEST /* 741 */:
            ...
            case FRAGMENT_HAS_TILDE_AMPERSAND_TILDE /* 3039 */:
            case FRAGMENT_HAS_COLON_TILDE_COLON /* 3040 */:
            case FRAGMENT_HAS_TILDE_AT_TILDE /* 3041 */:
            case FRAGMENT_HAS_AMPERSAND_DELIMITER_QUESTION /* 3042 */:
            ...
            case CSS_STYLE_SHEET_REPLACE_WITH_IMPORT /* 3169 */:
            ...
            case OBSOLETEV8RTC_RTP_SENDER_CREATE_ENCODED_AUDIO_STREAMS_METHOD /* 3180 */:
            case OBSOLETEV8RTC_RTP_SENDER_CREATE_ENCODED_VIDEO_STREAMS_METHOD /* 3181 */:
            case OBSOLETEV8RTC_RTP_RECEIVER_CREATE_ENCODED_AUDIO_STREAMS_METHOD /* 3182 */:
            case OBSOLETEV8RTC_RTP_RECEIVER_CREATE_ENCODED_VIDEO_STREAMS_METHOD /* 3183 */:
            ...
            case SCHEDULER_CURRENT_TASK_SIGNAL /* 3190 */:
            ...
            case LEGACY_LAYOUT_BY_DETAILS_MARKER /* 3206 */:
            case LEGACY_LAYOUT_BY_EDITING /* 3207 */:
            case LEGACY_LAYOUT_BY_FRAME_SET /* 3211 */:
            case LEGACY_LAYOUT_BY_GRID /* 3212 */:
            case LEGACY_LAYOUT_BY_MULTI_COL /* 3214 */:
            case LEGACY_LAYOUT_BY_PRINTING /* 3215 */:
            case LEGACY_LAYOUT_BY_SVG /* 3217 */:
            case LEGACY_LAYOUT_BY_TABLE /* 3219 */:
            case LEGACY_LAYOUT_BY_TEXT_COMBINE /* 3220 */:
            case LEGACY_LAYOUT_BY_TEXT_CONTROL /* 3221 */:
            case LEGACY_LAYOUT_BY_VTT_CUE /* 3222 */:
            case LEGACY_LAYOUT_BY_TABLE_FLEX_GRID_BLOCK_IN_NG_FRAGMENTATION_CONTEXT /* 3224 */:
            ...
            case V8_WASM_BULK_MEMORY /* 3320 */:
            case V8_WASM_REF_TYPES /* 3321 */:
            case V8_WASM_MULTI_VALUE /* 3322 */:
            ...
            case RTC_CONSTRAINT_ENABLE_RTP_DATA_CHANNELS_TRUE /* 3344 */:
            case RTC_CONSTRAINT_ENABLE_RTP_DATA_CHANNELS_FALSE /* 3345 */:
            ...
            case MAIN_FRAME_CSP_VIA_ORIGIN_POLICY /* 3361 */:
            case HTML_CLIPBOARD_API_READ /* 3362 */:
            case HTML_CLIPBOARD_API_WRITE /* 3363 */:
            case CSS_SYSTEM_COLOR_COMPUTE_TO_SELF /* 3364 */:
            case CONVERSION_API_ALL /* 3365 */:
            case IMPRESSION_REGISTRATION /* 3366 */:
            case CONVERSION_REGISTRATION /* 3367 */:
            ...
            case ANY_PII_FIELD_DETECTED_PREDICTED_TYPE_MATCH /* 3379 */:
            case EMAIL_FIELD_DETECTED_PREDICTED_TYPE_MATCH /* 3380 */:
            case PHONE_FIELD_DETECTED_PREDICTED_TYPE_MATCH /* 3381 */:
            case EMAIL_FIELD_DETECTED_PATTERN_MATCH /* 3382 */:
            case LAST_LETTER_SPACING_AFFECTS_RENDERING /* 3383 */:
            case V8_FONT_METADATA_GET_TABLES_METHOD /* 3384 */:
            case V8_FONT_METADATA_BLOB_METHOD /* 3385 */:
            case V8_FONT_MANAGER_QUERY_METHOD /* 3386 */:
            case AUDIO_CONTEXT_BASE_LATENCY /* 3387 */:
            case V8_WINDOW_GET_SCREENS_METHOD /* 3388 */:
            ...
            case BATTERY_SAVINGS_META /* 3395 */:
            ...
            case SUBRESOURCE_WEB_BUNDLES /* 3446 */:
            ...
            case INTEREST_COHORT_API_INTEREST_COHORT_METHOD /* 3687 */:
            ...
            case RTC_PEER_CONNECTION_SDP_SEMANTICS_PLAN_B /* 3773 */:
            ...
            case POPUP_ELEMENT /* 3781 */:
            case V8HTML_POPUP_ELEMENT_SHOW_METHOD /* 3782 */:
            case V8HTML_POPUP_ELEMENT_HIDE_METHOD /* 3783 */:
            case OBSOLETE_WINDOW_OPEN_WITH_ADDITIONAL_BOOL_PARAMETER /* 3784 */:
            case RTC_PEER_CONNECTION_CONSTRUCTED_WITH_PLAN_B /* 3785 */:
            case RTC_PEER_CONNECTION_CONSTRUCTED_WITH_UNIFIED_PLAN /* 3786 */:
            case RTC_PEER_CONNECTION_USING_COMPLEX_PLAN_B /* 3787 */:
            case RTC_PEER_CONNECTION_USING_COMPLEX_UNIFIED_PLAN /* 3788 */:
            ...
            case WASM_MODULE_SHARING /* 3801 */:
            case CROSS_ORIGIN_WASM_MODULE_SHARING /* 3802 */:
            ...
            case SELECT_MENU_ELEMENT /* 3811 */:
            case RTC_PEER_CONNECTION_SDP_SEMANTICS_PLAN_B_WITH_REVERSE_ORIGIN_TRIAL /* 3812 */:
            ...
            case STORAGE_FOUNDATION_OPEN /* 3822 */:
            case STORAGE_FOUNDATION_READ /* 3823 */:
            case STORAGE_FOUNDATION_READ_SYNC /* 3824 */:
            case STORAGE_FOUNDATION_WRITE /* 3825 */:
            case STORAGE_FOUNDATION_WRITE_SYNC /* 3826 */:
            case STORAGE_FOUNDATION_FLUSH /* 3827 */:
            case STORAGE_FOUNDATION_FLUSH_SYNC /* 3828 */:
            ...
            case V8_SCREENS_ONCHANGE_ATTRIBUTE_GETTER /* 3840 */:
            case V8_SCREENS_ONCHANGE_ATTRIBUTE_SETTER /* 3841 */:
            case V8_SCREEN_ADVANCED_LEFT_ATTRIBUTE_GETTER /* 3842 */:
            case V8_SCREEN_ADVANCED_TOP_ATTRIBUTE_GETTER /* 3843 */:
            case V8_SCREEN_ADVANCED_IS_PRIMARY_ATTRIBUTE_GETTER /* 3844 */:
            case V8_SCREEN_ADVANCED_IS_INTERNAL_ATTRIBUTE_GETTER /* 3845 */:
            case V8_SCREEN_ADVANCED_DEVICE_PIXEL_RATIO_ATTRIBUTE_GETTER /* 3846 */:
            case V8_SCREEN_ADVANCED_ID_ATTRIBUTE_GETTER /* 3847 */:
            case V8_SCREEN_ADVANCED_POINTER_TYPES_ATTRIBUTE_GETTER /* 3848 */:
            case V8_SCREEN_ADVANCED_LABEL_ATTRIBUTE_GETTER /* 3849 */:
            ...
            case OPEN_WEB_DATABASE_THIRD_PARTY_CONTEXT /* 3865 */:
            ...
            case NEW_CANVAS2_DAPI /* 3886 */:
            case SERVICE_WORKER_SUBRESOURCE_FILTER_BYPASSED_REQUEST /* 3887 */:
            case WEB_GPU /* 3888 */:
            ...
            case HANDWRITING_RECOGNITION_QUERY_SUPPORT /* 3893 */:
            ...
            case COMPUTE_PRESSURE_OBSERVER_CONSTRUCTOR /* 3899 */:
            case COMPUTE_PRESSURE_OBSERVER_OBSERVE /* 3900 */:
            case COMPUTE_PRESSURE_OBSERVER_STOP /* 3901 */:
            ...
            case V8_SCREENS_ONSCREENSCHANGE_ATTRIBUTE_GETTER /* 3905 */:
            case V8_SCREENS_ONSCREENSCHANGE_ATTRIBUTE_SETTER /* 3906 */:
            case V8_SCREENS_ONCURRENTSCREENCHANGE_ATTRIBUTE_GETTER /* 3907 */:
            case V8_SCREENS_ONCURRENTSCREENCHANGE_ATTRIBUTE_SETTER /* 3908 */:
            ...
            case ARIA_TOUCHPASSTHROUGH_ATTRIBUTE /* 3918 */:
            case ARIA_VIRTUALCONTENT_ATTRIBUTE /* 3919 */:
            case ACCESSIBILITY_TOUCH_PASSTHROUGH_SET /* 3920 */:
            case TEXT_FRAGMENT_BLOCKED_BY_FORCE_LOAD_AT_TOP /* 3921 */:
            case URN_DOCUMENT_ACCESSED_COOKIES /* 3922 */:
            ...
            case WINDOW_OPEN_NEW_POPUP_BEHAVIOR_MISMATCH /* 3941 */:
            ...
            case EXEC_COMMAND_WITH_TRUSTED_TYPES /* 3970 */:
            case CSS_SELECTOR_PSEUDO_HAS_IN_SNAPSHOT_PROFILE /* 3971 */:
            case CSS_SELECTOR_PSEUDO_HAS_IN_LIVE_PROFILE /* 3972 */:
            ...
            case READ_OR_WRITE_WEB_DATABASE_THIRD_PARTY_CONTEXT /* 3985 */:
            case 3986:
                return true;
            case 1:
            case 2:
            ...
            case 140:
            case 141:
            case CssSampleId.TEXT_SHADOW /* 142 */:
            case CssSampleId.TOP /* 149 */:
            case CssSampleId.TRANSITION /* 150 */:
            case 151:
            case 152:
            case 153:
            case CssSampleId.TRANSITION_TIMING_FUNCTION /* 154 */:
            case CssSampleId.UNICODE_BIDI /* 155 */:
            case CssSampleId.UNICODE_RANGE /* 156 */:
            case CssSampleId.VERTICAL_ALIGN /* 157 */:
            case CssSampleId.VISIBILITY /* 158 */:
            case CssSampleId.WHITE_SPACE /* 159 */:
            case 160:
            case 161:
            case 162:
            case 163:
            ...
            case CssSampleId.ALIAS_WEBKIT_BORDER_RADIUS /* 197 */:
            case CssSampleId.ALIAS_WEBKIT_BORDER_START /* 198 */:
            case CssSampleId.ALIAS_WEBKIT_BORDER_START_COLOR /* 199 */:
            case 206:
            case 207:
            ...
            case 302:
            case CssSampleId.ORDER /* 303 */:
            case CssSampleId.ALIAS_WEBKIT_PADDING_BEFORE /* 305 */:
            case CssSampleId.WEBKIT_RTL_ORDERING /* 313 */:
            case CssSampleId.WEBKIT_RUBY_POSITION /* 314 */:
            case CssSampleId.WEBKIT_TEXT_COMBINE /* 315 */:
            case CssSampleId.WEBKIT_TEXT_DECORATIONS_IN_EFFECT /* 316 */:
            case CssSampleId.WEBKIT_TEXT_EMPHASIS /* 317 */:
            case CssSampleId.WEBKIT_TEXT_EMPHASIS_POSITION /* 319 */:
            ...
            case CssSampleId.GRID_TEMPLATE_AREAS /* 423 */:
            ...
            case ViewportIntersectionStateConstants.MIN_SCREEN_RECT_STABLE_TIME_MS /* 500 */:
            case 511:
            case 512:
            case 513:
            ...
            case 600:
            case CssSampleId.PADDING_INLINE_END /* 601 */:
            case CssSampleId.BORDER_BLOCK_END_COLOR /* 602 */:
            case CssSampleId.BORDER_BLOCK_END_WIDTH /* 604 */:
            case CssSampleId.BORDER_BLOCK_START_COLOR /* 605 */:

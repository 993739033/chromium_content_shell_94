...
import org.chromium.blink.mojom.WebTransportConnector;
...
class WebTransportConnector_Internal {
    ...
    public static final Interface.Manager<WebTransportConnector, WebTransportConnector.Proxy> MANAGER = new Interface.Manager<WebTransportConnector, WebTransportConnector.Proxy>() { // from class: org.chromium.blink.mojom.WebTransportConnector_Internal.1
        ...
        public WebTransportConnector.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements WebTransportConnector.Proxy {
        @Override
        ...
        @Override // org.chromium.blink.mojom.WebTransportConnector
        public void connect(Url url, WebTransportCertificateFingerprint[] fingerprints, WebTransportHandshakeClient client) {
    ...
    public static final class Stub extends Interface.Stub<WebTransportConnector> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(WebTransportConnector_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        WebTransportConnectorConnectParams data = WebTransportConnectorConnectParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WebTransportConnector_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class WebTransportConnectorConnectParams extends Struct {
        ...
        public static WebTransportConnectorConnectParams decode(Decoder decoder0) {
            ...
            try {
                ...
                WebTransportConnectorConnectParams result = new WebTransportConnectorConnectParams(elementsOrVersion);
                ...
                result.client = (WebTransportHandshakeClient) decoder0.readServiceInterface(24, false, WebTransportHandshakeClient.MANAGER);
                return result;
            } finally {
        ...
        public final void encode(Encoder encoder) {
            ...
            if (webTransportCertificateFingerprintArr == null) {
                ...
                Encoder encoder1 = encoder0.encodePointerArray(webTransportCertificateFingerprintArr.length, 16, -1);
                int i0 = 0;
                while (true) {

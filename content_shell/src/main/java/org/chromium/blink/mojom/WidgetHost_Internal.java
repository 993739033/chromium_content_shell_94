...
class WidgetHost_Internal {
    private static final int CREATE_FRAME_SINK_ORDINAL = 5;
    public static final Interface.Manager<WidgetHost, WidgetHost.Proxy> MANAGER = new Interface.Manager<WidgetHost, WidgetHost.Proxy>() { // from class: org.chromium.blink.mojom.WidgetHost_Internal.1
        ...
        public WidgetHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    private static final int REGISTER_RENDER_FRAME_METADATA_OBSERVER_ORDINAL = 6;
    private static final int SELECTION_BOUNDS_CHANGED_ORDINAL = 4;
    private static final int SET_CURSOR_ORDINAL = 0;
    private static final int TEXT_INPUT_STATE_CHANGED_ORDINAL = 3;
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WidgetHost.Proxy {
        ...
        @Override // org.chromium.blink.mojom.WidgetHost
        public void updateTooltipFromKeyboard(String16 tooltipText, int textDirectionHint, Rect bounds) {
        ...
        @Override // org.chromium.blink.mojom.WidgetHost
        public void selectionBoundsChanged(Rect anchorRect, int anchorDir, Rect focusRect, int focusDir, Rect boundingBoxRect, boolean isAnchorFirst) {
        ...
        @Override // org.chromium.blink.mojom.WidgetHost
        public void createFrameSink(InterfaceRequest<CompositorFrameSink> compositorFrameSinkReceiver, CompositorFrameSinkClient compositorFrameSinkClient) {
        ...
        @Override // org.chromium.blink.mojom.WidgetHost
        public void registerRenderFrameMetadataObserver(InterfaceRequest<RenderFrameMetadataObserverClient> renderFrameMetadataObserverClientReceiver, RenderFrameMetadataObserver renderFrameMetadataObserver) {
    ...
    public static final class Stub extends Interface.Stub<WidgetHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(WidgetHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        getImpl().setCursor(WidgetHostSetCursorParams.deserialize(messageWithHeader.getPayload()).cursor);
                        return true;
                    case 1:
                        WidgetHostUpdateTooltipUnderCursorParams data = WidgetHostUpdateTooltipUnderCursorParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateTooltipUnderCursor(data.tooltipText, data.textDirectionHint);
                        return true;
                    case 2:
                        WidgetHostUpdateTooltipFromKeyboardParams data2 = WidgetHostUpdateTooltipFromKeyboardParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateTooltipFromKeyboard(data2.tooltipText, data2.textDirectionHint, data2.bounds);
                        return true;
                    case 3:
                        WidgetHostTextInputStateChangedParams data3 = WidgetHostTextInputStateChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().textInputStateChanged(data3.state);
                        return true;
                    case 4:
                        WidgetHostSelectionBoundsChangedParams data4 = WidgetHostSelectionBoundsChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().selectionBoundsChanged(data4.anchorRect, data4.anchorDir, data4.focusRect, data4.focusDir, data4.boundingBoxRect, data4.isAnchorFirst);
                        return true;
                    case 5:
                        WidgetHostCreateFrameSinkParams data5 = WidgetHostCreateFrameSinkParams.deserialize(messageWithHeader.getPayload());
                        getImpl().createFrameSink(data5.compositorFrameSinkReceiver, data5.compositorFrameSinkClient);
                        return true;
                    case 6:
                        WidgetHostRegisterRenderFrameMetadataObserverParams data6 = WidgetHostRegisterRenderFrameMetadataObserverParams.deserialize(messageWithHeader.getPayload());
                        getImpl().registerRenderFrameMetadataObserver(data6.renderFrameMetadataObserverClientReceiver, data6.renderFrameMetadataObserver);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WidgetHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class WidgetHostUpdateTooltipUnderCursorParams extends Struct {
        ...
        public static WidgetHostUpdateTooltipUnderCursorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetHostUpdateTooltipUnderCursorParams result = new WidgetHostUpdateTooltipUnderCursorParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class WidgetHostUpdateTooltipFromKeyboardParams extends Struct {
        ...
        public static WidgetHostUpdateTooltipFromKeyboardParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetHostUpdateTooltipFromKeyboardParams result = new WidgetHostUpdateTooltipFromKeyboardParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.tooltipText = String16.decode(decoder1);
                int readInt = decoder0.readInt(16);
                result.textDirectionHint = readInt;
    ...
    static final class WidgetHostTextInputStateChangedParams extends Struct {
        ...
        public static WidgetHostTextInputStateChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetHostTextInputStateChangedParams result = new WidgetHostTextInputStateChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class WidgetHostSelectionBoundsChangedParams extends Struct {
        ...
        public static WidgetHostSelectionBoundsChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetHostSelectionBoundsChangedParams result = new WidgetHostSelectionBoundsChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class WidgetHostCreateFrameSinkParams extends Struct {
        ...
        public static WidgetHostCreateFrameSinkParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetHostCreateFrameSinkParams result = new WidgetHostCreateFrameSinkParams(elementsOrVersion);
                result.compositorFrameSinkReceiver = decoder0.readInterfaceRequest(8, false);
                result.compositorFrameSinkClient = (CompositorFrameSinkClient) decoder0.readServiceInterface(12, false, CompositorFrameSinkClient.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class WidgetHostRegisterRenderFrameMetadataObserverParams extends Struct {
        ...
        public static WidgetHostRegisterRenderFrameMetadataObserverParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetHostRegisterRenderFrameMetadataObserverParams result = new WidgetHostRegisterRenderFrameMetadataObserverParams(elementsOrVersion);
                result.renderFrameMetadataObserverClientReceiver = decoder0.readInterfaceRequest(8, false);
                result.renderFrameMetadataObserver = (RenderFrameMetadataObserver) decoder0.readServiceInterface(12, false, RenderFrameMetadataObserver.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public final void encode(Encoder encoder) {
            ...
            encoder0.encode( this.renderFrameMetadataObserver, 12, false,  RenderFrameMetadataObserver.MANAGER);
        }
    }
}

...
class WidgetInputHandler_Internal {
    ...
    public static final Interface.Manager<WidgetInputHandler, WidgetInputHandler.Proxy> MANAGER = new Interface.Manager<WidgetInputHandler, WidgetInputHandler.Proxy>() { // from class: org.chromium.blink.mojom.WidgetInputHandler_Internal.1
        ...
        public WidgetInputHandler.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WidgetInputHandler.Proxy {
        ...
        @Override // org.chromium.blink.mojom.WidgetInputHandler
        public void imeSetComposition(String16 text, ImeTextSpan[] imeTextSpans, Range range, int start, int end, ImeSetCompositionResponse callback) {
            ...
            _message.end = end;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new WidgetInputHandlerImeSetCompositionResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.WidgetInputHandler
        public void imeCommitText(String16 text, ImeTextSpan[] imeTextSpans, Range range, int relativeCursorPosition, ImeCommitTextResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new WidgetInputHandlerImeCommitTextResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.WidgetInputHandler
        public void dispatchEvent(Event event, DispatchEventResponse callback) {
            WidgetInputHandlerDispatchEventParams _message = new WidgetInputHandlerDispatchEventParams();
            _message.event = event;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(9, 1, 0L)), new WidgetInputHandlerDispatchEventResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.blink.mojom.WidgetInputHandler
        public void waitForInputProcessed(WaitForInputProcessedResponse callback) {
            WidgetInputHandlerWaitForInputProcessedParams _message = new WidgetInputHandlerWaitForInputProcessedParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(11, 1, 0L)), new WidgetInputHandlerWaitForInputProcessedResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.mojom.WidgetInputHandler
        public void attachSynchronousCompositor(SynchronousCompositorControlHost controlHost, AssociatedInterfaceNotSupported host, AssociatedInterfaceRequestNotSupported compositorRequest) {
        ...
        @Override // org.chromium.blink.mojom.WidgetInputHandler
        public void getFrameWidgetInputHandler(AssociatedInterfaceRequestNotSupported interfaceRequest) {
    ...
    public static final class Stub extends Interface.Stub<WidgetInputHandler> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(WidgetInputHandler_Internal.MANAGER, messageWithHeader);
                    case -1:
                    case 4:
                    case 5:
                    case 9:
                    ...
                    default:
                        return false;
                    case 0:
                        WidgetInputHandlerSetFocusParams data = WidgetInputHandlerSetFocusParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        WidgetInputHandlerSetEditCommandsForNextKeyEventParams data2 = WidgetInputHandlerSetEditCommandsForNextKeyEventParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setEditCommandsForNextKeyEvent(data2.commands);
                        return true;
                    case 3:
                        WidgetInputHandlerCursorVisibilityChangedParams data3 = WidgetInputHandlerCursorVisibilityChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().cursorVisibilityChanged(data3.visible);
                        return true;
                    case 6:
                        WidgetInputHandlerImeFinishComposingTextParams data4 = WidgetInputHandlerImeFinishComposingTextParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 7:
                        ...
                        return true;
                    case 8:
                        WidgetInputHandlerRequestCompositionUpdatesParams data5 = WidgetInputHandlerRequestCompositionUpdatesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().requestCompositionUpdates(data5.immediateRequest, data5.monitorRequest);
                        return true;
                    case 10:
                        WidgetInputHandlerDispatchNonBlockingEventParams data6 = WidgetInputHandlerDispatchNonBlockingEventParams.deserialize(messageWithHeader.getPayload());
                        getImpl().dispatchNonBlockingEvent(data6.event);
                        return true;
                    case 12:
                        WidgetInputHandlerAttachSynchronousCompositorParams data7 = WidgetInputHandlerAttachSynchronousCompositorParams.deserialize(messageWithHeader.getPayload());
                        getImpl().attachSynchronousCompositor(data7.controlHost, data7.host, data7.compositorRequest);
                        return true;
                    case 13:
                        WidgetInputHandlerGetFrameWidgetInputHandlerParams data8 = WidgetInputHandlerGetFrameWidgetInputHandlerParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WidgetInputHandler_Internal.MANAGER, messageWithHeader, receiver);
                    case 4:
                        WidgetInputHandlerImeSetCompositionParams data = WidgetInputHandlerImeSetCompositionParams.deserialize(messageWithHeader.getPayload());
                        ...
                        return true;
                    case 5:
                        WidgetInputHandlerImeCommitTextParams data2 = WidgetInputHandlerImeCommitTextParams.deserialize(messageWithHeader.getPayload());
                        getImpl().imeCommitText(data2.text, data2.imeTextSpans, data2.range, data2.relativeCursorPosition, new WidgetInputHandlerImeCommitTextResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 9:
                        getImpl().dispatchEvent(WidgetInputHandlerDispatchEventParams.deserialize(messageWithHeader.getPayload()).event, new WidgetInputHandlerDispatchEventResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 11:
    ...
    static final class WidgetInputHandlerSetFocusParams extends Struct {
        ...
        public static WidgetInputHandlerSetFocusParams decode(Decoder decoder0) {
            ...
            try {
                ...
                WidgetInputHandlerSetFocusParams result = new WidgetInputHandlerSetFocusParams(elementsOrVersion);
    ...
    static final class WidgetInputHandlerMouseCaptureLostParams extends Struct {
        ...
        public static WidgetInputHandlerMouseCaptureLostParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerMouseCaptureLostParams result = new WidgetInputHandlerMouseCaptureLostParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class WidgetInputHandlerSetEditCommandsForNextKeyEventParams extends Struct {
        ...
        public static WidgetInputHandlerSetEditCommandsForNextKeyEventParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static WidgetInputHandlerSetEditCommandsForNextKeyEventParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerSetEditCommandsForNextKeyEventParams result = new WidgetInputHandlerSetEditCommandsForNextKeyEventParams(elementsOrVersion);
    ...
    static final class WidgetInputHandlerCursorVisibilityChangedParams extends Struct {
        ...
        public static WidgetInputHandlerCursorVisibilityChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerCursorVisibilityChangedParams result = new WidgetInputHandlerCursorVisibilityChangedParams(elementsOrVersion);
    ...
    static final class WidgetInputHandlerImeSetCompositionParams extends Struct {
        ...
        public static WidgetInputHandlerImeSetCompositionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerImeSetCompositionParams result = new WidgetInputHandlerImeSetCompositionParams(elementsOrVersion);
    ...
    static final class WidgetInputHandlerImeSetCompositionResponseParams extends Struct {
        ...
        public static WidgetInputHandlerImeSetCompositionResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerImeSetCompositionResponseParams result = new WidgetInputHandlerImeSetCompositionResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    /* loaded from: classes2.dex */
    static class WidgetInputHandlerImeSetCompositionResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final WidgetInputHandler.ImeSetCompositionResponse mCallback;

        WidgetInputHandlerImeSetCompositionResponseParamsForwardToCallback(WidgetInputHandler.ImeSetCompositionResponse callback) {
    ...
    /* loaded from: classes2.dex */
    static class WidgetInputHandlerImeSetCompositionResponseParamsProxyToResponder implements WidgetInputHandler.ImeSetCompositionResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        WidgetInputHandlerImeSetCompositionResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class WidgetInputHandlerImeCommitTextParams extends Struct {
        ...
        public static WidgetInputHandlerImeCommitTextParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerImeCommitTextParams result = new WidgetInputHandlerImeCommitTextParams(elementsOrVersion);
                result.text = String16.decode(decoder0.readPointer(8, false));
                Decoder decoder1 = decoder0.readPointer(16, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.imeTextSpans = new ImeTextSpan[si1.elementsOrVersion];
    ...
    static final class WidgetInputHandlerImeCommitTextResponseParams extends Struct {
        ...
        public static WidgetInputHandlerImeCommitTextResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerImeCommitTextResponseParams result = new WidgetInputHandlerImeCommitTextResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static class WidgetInputHandlerImeCommitTextResponseParamsProxyToResponder implements WidgetInputHandler.ImeCommitTextResponse {
        ...
        WidgetInputHandlerImeCommitTextResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class WidgetInputHandlerImeFinishComposingTextParams extends Struct {
        ...
        public static WidgetInputHandlerImeFinishComposingTextParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerImeFinishComposingTextParams result = new WidgetInputHandlerImeFinishComposingTextParams(elementsOrVersion);
    ...
    static final class WidgetInputHandlerRequestTextInputStateUpdateParams extends Struct {
        ...
        public static WidgetInputHandlerRequestTextInputStateUpdateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerRequestTextInputStateUpdateParams result = new WidgetInputHandlerRequestTextInputStateUpdateParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class WidgetInputHandlerRequestCompositionUpdatesParams extends Struct {
        ...
        public static WidgetInputHandlerRequestCompositionUpdatesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerRequestCompositionUpdatesParams result = new WidgetInputHandlerRequestCompositionUpdatesParams(elementsOrVersion);
    ...
    static final class WidgetInputHandlerDispatchEventParams extends Struct {
        ...
        public static WidgetInputHandlerDispatchEventParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerDispatchEventParams result = new WidgetInputHandlerDispatchEventParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class WidgetInputHandlerDispatchEventResponseParams extends Struct {
        ...
        public static WidgetInputHandlerDispatchEventResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerDispatchEventResponseParams result = new WidgetInputHandlerDispatchEventResponseParams(elementsOrVersion);
    ...
    static class WidgetInputHandlerDispatchEventResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(Integer.valueOf(response.source), response.updatedLatency, Integer.valueOf(response.state), response.overscroll, response.touchAction);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class WidgetInputHandlerDispatchEventResponseParamsProxyToResponder implements WidgetInputHandler.DispatchEventResponse {
        ...
        WidgetInputHandlerDispatchEventResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
        ...
        public void call(Integer source, LatencyInfo updatedLatency, Integer state, DidOverscrollParams overscroll, TouchActionOptional touchAction) {
            WidgetInputHandlerDispatchEventResponseParams _response = new WidgetInputHandlerDispatchEventResponseParams();
            _response.source = source.intValue();
    ...
    static final class WidgetInputHandlerDispatchNonBlockingEventParams extends Struct {
        ...
        public static WidgetInputHandlerDispatchNonBlockingEventParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerDispatchNonBlockingEventParams result = new WidgetInputHandlerDispatchNonBlockingEventParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.event = Event.decode(decoder1);
                return result;
            } finally {
    ...
    static final class WidgetInputHandlerWaitForInputProcessedParams extends Struct {
        ...
        public static WidgetInputHandlerWaitForInputProcessedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerWaitForInputProcessedParams result = new WidgetInputHandlerWaitForInputProcessedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class WidgetInputHandlerWaitForInputProcessedResponseParams extends Struct {
        ...
        public static WidgetInputHandlerWaitForInputProcessedResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static WidgetInputHandlerWaitForInputProcessedResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerWaitForInputProcessedResponseParams result = new WidgetInputHandlerWaitForInputProcessedResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static class WidgetInputHandlerWaitForInputProcessedResponseParamsProxyToResponder implements WidgetInputHandler.WaitForInputProcessedResponse {
        ...
        WidgetInputHandlerWaitForInputProcessedResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class WidgetInputHandlerAttachSynchronousCompositorParams extends Struct {
        ...
        public static WidgetInputHandlerAttachSynchronousCompositorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerAttachSynchronousCompositorParams result = new WidgetInputHandlerAttachSynchronousCompositorParams(elementsOrVersion);
                result.controlHost = (SynchronousCompositorControlHost) decoder0.readServiceInterface(8, false, SynchronousCompositorControlHost.MANAGER);
    ...
    static final class WidgetInputHandlerGetFrameWidgetInputHandlerParams extends Struct {
        ...
        public static WidgetInputHandlerGetFrameWidgetInputHandlerParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WidgetInputHandlerGetFrameWidgetInputHandlerParams result = new WidgetInputHandlerGetFrameWidgetInputHandlerParams(elementsOrVersion);

...
class VirtualAuthenticatorManager_Internal {
    ...
    public static final Interface.Manager<VirtualAuthenticatorManager, VirtualAuthenticatorManager.Proxy> MANAGER = new Interface.Manager<VirtualAuthenticatorManager, VirtualAuthenticatorManager.Proxy>() { // from class: org.chromium.blink.test.mojom.VirtualAuthenticatorManager_Internal.1
        ...
        public VirtualAuthenticatorManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements VirtualAuthenticatorManager.Proxy {
        ...
        public void createAuthenticator(VirtualAuthenticatorOptions options, CreateAuthenticatorResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new VirtualAuthenticatorManagerCreateAuthenticatorResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.test.mojom.VirtualAuthenticatorManager
        public void getAuthenticators(GetAuthenticatorsResponse callback) {
            VirtualAuthenticatorManagerGetAuthenticatorsParams _message = new VirtualAuthenticatorManagerGetAuthenticatorsParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new VirtualAuthenticatorManagerGetAuthenticatorsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.test.mojom.VirtualAuthenticatorManager
        public void removeAuthenticator(String id, RemoveAuthenticatorResponse callback) {
            VirtualAuthenticatorManagerRemoveAuthenticatorParams _message = new VirtualAuthenticatorManagerRemoveAuthenticatorParams();
            _message.id = id;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new VirtualAuthenticatorManagerRemoveAuthenticatorResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.blink.test.mojom.VirtualAuthenticatorManager
        public void clearAuthenticators(ClearAuthenticatorsResponse callback) {
            VirtualAuthenticatorManagerClearAuthenticatorsParams _message = new VirtualAuthenticatorManagerClearAuthenticatorsParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new VirtualAuthenticatorManagerClearAuthenticatorsResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<VirtualAuthenticatorManager> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), VirtualAuthenticatorManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        VirtualAuthenticatorManagerCreateAuthenticatorParams data = VirtualAuthenticatorManagerCreateAuthenticatorParams.deserialize(messageWithHeader.getPayload());
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        VirtualAuthenticatorManagerRemoveAuthenticatorParams data2 = VirtualAuthenticatorManagerRemoveAuthenticatorParams.deserialize(messageWithHeader.getPayload());
                        getImpl().removeAuthenticator(data2.id, new VirtualAuthenticatorManagerRemoveAuthenticatorResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
    ...
    static final class VirtualAuthenticatorManagerCreateAuthenticatorParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerCreateAuthenticatorParams decode(Decoder decoder0) {
            ...
            try {
                ...
                VirtualAuthenticatorManagerCreateAuthenticatorParams result = new VirtualAuthenticatorManagerCreateAuthenticatorParams(elementsOrVersion);
    ...
    public static final class VirtualAuthenticatorManagerCreateAuthenticatorResponseParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerCreateAuthenticatorResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerCreateAuthenticatorResponseParams result = new VirtualAuthenticatorManagerCreateAuthenticatorResponseParams(elementsOrVersion);
    ...
    static final class VirtualAuthenticatorManagerGetAuthenticatorsParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerGetAuthenticatorsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerGetAuthenticatorsParams result = new VirtualAuthenticatorManagerGetAuthenticatorsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class VirtualAuthenticatorManagerGetAuthenticatorsResponseParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerGetAuthenticatorsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerGetAuthenticatorsResponseParams result = new VirtualAuthenticatorManagerGetAuthenticatorsResponseParams(elementsOrVersion);
    ...
    static final class VirtualAuthenticatorManagerRemoveAuthenticatorParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerRemoveAuthenticatorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerRemoveAuthenticatorParams result = new VirtualAuthenticatorManagerRemoveAuthenticatorParams(elementsOrVersion);
    ...
    public static final class VirtualAuthenticatorManagerRemoveAuthenticatorResponseParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerRemoveAuthenticatorResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerRemoveAuthenticatorResponseParams result = new VirtualAuthenticatorManagerRemoveAuthenticatorResponseParams(elementsOrVersion);
    ...
    static final class VirtualAuthenticatorManagerClearAuthenticatorsParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerClearAuthenticatorsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerClearAuthenticatorsParams result = new VirtualAuthenticatorManagerClearAuthenticatorsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class VirtualAuthenticatorManagerClearAuthenticatorsResponseParams extends Struct {
        ...
        public static VirtualAuthenticatorManagerClearAuthenticatorsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VirtualAuthenticatorManagerClearAuthenticatorsResponseParams result = new VirtualAuthenticatorManagerClearAuthenticatorsResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

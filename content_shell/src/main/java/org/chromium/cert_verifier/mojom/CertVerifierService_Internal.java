...
class CertVerifierService_Internal {
    ...
    public static final Interface.Manager<CertVerifierService, CertVerifierService.Proxy> MANAGER = new Interface.Manager<CertVerifierService, CertVerifierService.Proxy>() { // from class: org.chromium.cert_verifier.mojom.CertVerifierService_Internal.1
        ...
        public CertVerifierService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements CertVerifierService.Proxy {
        ...
        public void enableNetworkAccess(UrlLoaderFactory urlLoaderFactory, UrlLoaderFactoryConnector reconnector) {
        ...
        @Override // org.chromium.cert_verifier.mojom.CertVerifierService
        public void verify(RequestParams params, CertVerifierRequest certVerifierRequest) {
    ...
    public static final class Stub extends Interface.Stub<CertVerifierService> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(CertVerifierService_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        CertVerifierServiceVerifyParams data2 = CertVerifierServiceVerifyParams.deserialize(messageWithHeader.getPayload());
                        getImpl().verify(data2.params, data2.certVerifierRequest);
                        return true;
                    case 2:
                        getImpl().setConfig(CertVerifierServiceSetConfigParams.deserialize(messageWithHeader.getPayload()).config);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CertVerifierService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class CertVerifierServiceEnableNetworkAccessParams extends Struct {
        ...
        public static CertVerifierServiceEnableNetworkAccessParams decode(Decoder decoder0) {
            ...
            try {
                ...
                CertVerifierServiceEnableNetworkAccessParams result = new CertVerifierServiceEnableNetworkAccessParams(elementsOrVersion);
                result.urlLoaderFactory = (UrlLoaderFactory) decoder0.readServiceInterface(8, false, UrlLoaderFactory.MANAGER);
                result.reconnector = (UrlLoaderFactoryConnector) decoder0.readServiceInterface(16, true, UrlLoaderFactoryConnector.MANAGER);
                return result;
            } finally {
    ...
    static final class CertVerifierServiceVerifyParams extends Struct {
        ...
        public static CertVerifierServiceVerifyParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CertVerifierServiceVerifyParams result = new CertVerifierServiceVerifyParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.params = RequestParams.decode(decoder1);
                result.certVerifierRequest = (CertVerifierRequest) decoder0.readServiceInterface(16, false, CertVerifierRequest.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class CertVerifierServiceSetConfigParams extends Struct {
        ...
        public static CertVerifierServiceSetConfigParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CertVerifierServiceSetConfigParams result = new CertVerifierServiceSetConfigParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);

...
public final class RendererContentSettingRules extends Struct {
    ...
    public final void encode(Encoder encoder) {
        ...
        if (contentSettingPatternSourceArr3 == null) {
            ...
            Encoder encoder12 = encoder0.encodePointerArray(contentSettingPatternSourceArr3.length, 16, -1);
            int i02 = 0;
            while (true) {
        ...
        if (contentSettingPatternSourceArr5 == null) {
            ...
            Encoder encoder13 = encoder0.encodePointerArray(contentSettingPatternSourceArr5.length, 24, -1);
            int i03 = 0;
            while (true) {
        ...
        Encoder encoder14 = encoder0.encodePointerArray(contentSettingPatternSourceArr7.length, 32, -1);
        int i04 = 0;
        while (true) {

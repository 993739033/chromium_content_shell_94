...
class Fingerprint_Internal {
    ...
    public static final Interface.Manager<Fingerprint, Fingerprint.Proxy> MANAGER = new Interface.Manager<Fingerprint, Fingerprint.Proxy>() { // from class: org.chromium.device.mojom.Fingerprint_Internal.1
        ...
        public Fingerprint.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Fingerprint.Proxy {
        ...
        public void getRecordsForUser(String userId, GetRecordsForUserResponse callback) {
            FingerprintGetRecordsForUserParams _message = new FingerprintGetRecordsForUserParams();
            _message.userId = userId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new FingerprintGetRecordsForUserResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.device.mojom.Fingerprint
        public void cancelCurrentEnrollSession(CancelCurrentEnrollSessionResponse callback) {
            FingerprintCancelCurrentEnrollSessionParams _message = new FingerprintCancelCurrentEnrollSessionParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new FingerprintCancelCurrentEnrollSessionResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.Fingerprint
        public void requestRecordLabel(String recordPath, RequestRecordLabelResponse callback) {
            FingerprintRequestRecordLabelParams _message = new FingerprintRequestRecordLabelParams();
            _message.recordPath = recordPath;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new FingerprintRequestRecordLabelResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.Fingerprint
        public void setRecordLabel(String recordPath, String newLabel, SetRecordLabelResponse callback) {
            FingerprintSetRecordLabelParams _message = new FingerprintSetRecordLabelParams();
            _message.recordPath = recordPath;
            _message.newLabel = newLabel;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new FingerprintSetRecordLabelResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.Fingerprint
        public void removeRecord(String recordPath, RemoveRecordResponse callback) {
            FingerprintRemoveRecordParams _message = new FingerprintRemoveRecordParams();
            _message.recordPath = recordPath;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new FingerprintRemoveRecordResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.device.mojom.Fingerprint
        public void endCurrentAuthSession(EndCurrentAuthSessionResponse callback) {
            FingerprintEndCurrentAuthSessionParams _message = new FingerprintEndCurrentAuthSessionParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(7, 1, 0L)), new FingerprintEndCurrentAuthSessionResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.Fingerprint
        public void destroyAllRecords(DestroyAllRecordsResponse callback) {
            FingerprintDestroyAllRecordsParams _message = new FingerprintDestroyAllRecordsParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(8, 1, 0L)), new FingerprintDestroyAllRecordsResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.device.mojom.Fingerprint
        public void requestType(RequestTypeResponse callback) {
            FingerprintRequestTypeParams _message = new FingerprintRequestTypeParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(10, 1, 0L)), new FingerprintRequestTypeResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<Fingerprint> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 6:
                        ...
                        return true;
                    case 9:
                        getImpl().addFingerprintObserver(FingerprintAddFingerprintObserverParams.deserialize(messageWithHeader.getPayload()).observer);
                        return true;
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), Fingerprint_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        FingerprintRequestRecordLabelParams data2 = FingerprintRequestRecordLabelParams.deserialize(messageWithHeader.getPayload());
                        getImpl().requestRecordLabel(data2.recordPath, new FingerprintRequestRecordLabelResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        FingerprintSetRecordLabelParams data3 = FingerprintSetRecordLabelParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setRecordLabel(data3.recordPath, data3.newLabel, new FingerprintSetRecordLabelResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 5:
                        FingerprintRemoveRecordParams data4 = FingerprintRemoveRecordParams.deserialize(messageWithHeader.getPayload());
                        getImpl().removeRecord(data4.recordPath, new FingerprintRemoveRecordResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 7:
    ...
    static final class FingerprintGetRecordsForUserParams extends Struct {
        ...
        public static FingerprintGetRecordsForUserParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FingerprintGetRecordsForUserParams result = new FingerprintGetRecordsForUserParams(elementsOrVersion);
    ...
    public static final class FingerprintGetRecordsForUserResponseParams extends Struct {
        ...
        public static FingerprintGetRecordsForUserResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintGetRecordsForUserResponseParams result = new FingerprintGetRecordsForUserResponseParams(elementsOrVersion);
    ...
    static final class FingerprintStartEnrollSessionParams extends Struct {
        ...
        public static FingerprintStartEnrollSessionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintStartEnrollSessionParams result = new FingerprintStartEnrollSessionParams(elementsOrVersion);
                result.userId = decoder0.readString(8, false);
    ...
    static final class FingerprintCancelCurrentEnrollSessionParams extends Struct {
        ...
        public static FingerprintCancelCurrentEnrollSessionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintCancelCurrentEnrollSessionParams result = new FingerprintCancelCurrentEnrollSessionParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class FingerprintCancelCurrentEnrollSessionResponseParams extends Struct {
        ...
        public static FingerprintCancelCurrentEnrollSessionResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintCancelCurrentEnrollSessionResponseParams result = new FingerprintCancelCurrentEnrollSessionResponseParams(elementsOrVersion);
    ...
    static final class FingerprintRequestRecordLabelParams extends Struct {
        ...
        public static FingerprintRequestRecordLabelParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintRequestRecordLabelParams result = new FingerprintRequestRecordLabelParams(elementsOrVersion);
    ...
    public static final class FingerprintRequestRecordLabelResponseParams extends Struct {
        ...
        public static FingerprintRequestRecordLabelResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintRequestRecordLabelResponseParams result = new FingerprintRequestRecordLabelResponseParams(elementsOrVersion);
    ...
    static final class FingerprintSetRecordLabelParams extends Struct {
        ...
        public static FingerprintSetRecordLabelParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintSetRecordLabelParams result = new FingerprintSetRecordLabelParams(elementsOrVersion);
                result.recordPath = decoder0.readString(8, false);
    ...
    public static final class FingerprintSetRecordLabelResponseParams extends Struct {
        ...
        public static FingerprintSetRecordLabelResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintSetRecordLabelResponseParams result = new FingerprintSetRecordLabelResponseParams(elementsOrVersion);
                result.success = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    public static final class FingerprintRemoveRecordResponseParams extends Struct {
        ...
        public static FingerprintRemoveRecordResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintRemoveRecordResponseParams result = new FingerprintRemoveRecordResponseParams(elementsOrVersion);
                result.success = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    static final class FingerprintStartAuthSessionParams extends Struct {
        ...
        public static FingerprintStartAuthSessionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintStartAuthSessionParams result = new FingerprintStartAuthSessionParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class FingerprintEndCurrentAuthSessionParams extends Struct {
        ...
        public static FingerprintEndCurrentAuthSessionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintEndCurrentAuthSessionParams result = new FingerprintEndCurrentAuthSessionParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class FingerprintEndCurrentAuthSessionResponseParams extends Struct {
        ...
        public static FingerprintEndCurrentAuthSessionResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintEndCurrentAuthSessionResponseParams result = new FingerprintEndCurrentAuthSessionResponseParams(elementsOrVersion);
                result.success = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    static final class FingerprintDestroyAllRecordsParams extends Struct {
        ...
        public static FingerprintDestroyAllRecordsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintDestroyAllRecordsParams result = new FingerprintDestroyAllRecordsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class FingerprintDestroyAllRecordsResponseParams extends Struct {
        ...
        public static FingerprintDestroyAllRecordsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintDestroyAllRecordsResponseParams result = new FingerprintDestroyAllRecordsResponseParams(elementsOrVersion);
                result.success = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    static final class FingerprintAddFingerprintObserverParams extends Struct {
        ...
        public static FingerprintAddFingerprintObserverParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintAddFingerprintObserverParams result = new FingerprintAddFingerprintObserverParams(elementsOrVersion);
    ...
    public static final class FingerprintRequestTypeResponseParams extends Struct {
        ...
        public static FingerprintRequestTypeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FingerprintRequestTypeResponseParams result = new FingerprintRequestTypeResponseParams(elementsOrVersion);

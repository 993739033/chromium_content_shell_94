...
class HidConnectionClient_Internal {
    public static final Interface.Manager<HidConnectionClient, HidConnectionClient.Proxy> MANAGER = new Interface.Manager<HidConnectionClient, HidConnectionClient.Proxy>() { // from class: org.chromium.device.mojom.HidConnectionClient_Internal.1
        ...
        public HidConnectionClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements HidConnectionClient.Proxy {
        ...
        @Override // org.chromium.device.mojom.HidConnectionClient
    ...
    public static final class Stub extends Interface.Stub<HidConnectionClient> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), HidConnectionClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class HidConnectionClientOnInputReportParams extends Struct {
        ...
        public static HidConnectionClientOnInputReportParams decode(Decoder decoder0) {
            ...
            try {
                ...
                HidConnectionClientOnInputReportParams result = new HidConnectionClientOnInputReportParams(elementsOrVersion);

...
class HidManager_Internal {
    ...
    public static final Interface.Manager<HidManager, HidManager.Proxy> MANAGER = new Interface.Manager<HidManager, HidManager.Proxy>() { // from class: org.chromium.device.mojom.HidManager_Internal.1
        ...
        public HidManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements HidManager.Proxy {
        ...
        public void getDevicesAndSetClient(AssociatedInterfaceNotSupported client, GetDevicesAndSetClientResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new HidManagerGetDevicesAndSetClientResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.HidManager
        public void getDevices(GetDevicesResponse callback) {
            HidManagerGetDevicesParams _message = new HidManagerGetDevicesParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new HidManagerGetDevicesResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.HidManager
        public void connect(String deviceGuid, HidConnectionClient connectionClient, HidConnectionWatcher watcher, boolean allowProtectedReports, boolean allowFidoReports, ConnectResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new HidManagerConnectResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<HidManager> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), HidManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        getImpl().getDevicesAndSetClient(HidManagerGetDevicesAndSetClientParams.deserialize(messageWithHeader.getPayload()).client, new HidManagerGetDevicesAndSetClientResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 1:
    ...
    static final class HidManagerGetDevicesAndSetClientParams extends Struct {
        ...
        public static HidManagerGetDevicesAndSetClientParams decode(Decoder decoder0) {
            ...
            try {
                ...
                HidManagerGetDevicesAndSetClientParams result = new HidManagerGetDevicesAndSetClientParams(elementsOrVersion);
    ...
    public static final class HidManagerGetDevicesAndSetClientResponseParams extends Struct {
        ...
        public static HidManagerGetDevicesAndSetClientResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                HidManagerGetDevicesAndSetClientResponseParams result = new HidManagerGetDevicesAndSetClientResponseParams(elementsOrVersion);
    ...
    public static final class HidManagerGetDevicesResponseParams extends Struct {
        ...
        public static HidManagerGetDevicesResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                HidManagerGetDevicesResponseParams result = new HidManagerGetDevicesResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.devices = new HidDeviceInfo[si1.elementsOrVersion];
                for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
    ...
    static final class HidManagerConnectParams extends Struct {
        ...
        public static HidManagerConnectParams decode(Decoder decoder0) {
            ...
            try {
                ...
                result.watcher = (HidConnectionWatcher) decoder0.readServiceInterface(24, true, HidConnectionWatcher.MANAGER);
    ...
    public static final class HidManagerConnectResponseParams extends Struct {
        ...
        public static HidManagerConnectResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                HidManagerConnectResponseParams result = new HidManagerConnectResponseParams(elementsOrVersion);

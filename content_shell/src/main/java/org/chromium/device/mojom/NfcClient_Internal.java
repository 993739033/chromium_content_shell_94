...
class NfcClient_Internal {
    public static final Interface.Manager<NfcClient, NfcClient.Proxy> MANAGER = new Interface.Manager<NfcClient, NfcClient.Proxy>() { // from class: org.chromium.device.mojom.NfcClient_Internal.1
    ...
    public static final class Proxy extends Interface.AbstractProxy implements NfcClient.Proxy {
        ...
        @Override // org.chromium.device.mojom.NfcClient
    ...
    public static final class Stub extends Interface.Stub<NfcClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().onError(NfcClientOnErrorParams.deserialize(messageWithHeader.getPayload()).error);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), NfcClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {

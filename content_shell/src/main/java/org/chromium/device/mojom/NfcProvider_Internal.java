...
class NfcProvider_Internal {
    ...
    public static final Interface.Manager<NfcProvider, NfcProvider.Proxy> MANAGER = new Interface.Manager<NfcProvider, NfcProvider.Proxy>() { // from class: org.chromium.device.mojom.NfcProvider_Internal.1
        ...
        public NfcProvider.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<NfcProvider> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), NfcProvider_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class NfcProviderGetNfcForHostParams extends Struct {
        ...
        public static NfcProviderGetNfcForHostParams decode(Decoder decoder0) {
            ...
            try {
                ...
                NfcProviderGetNfcForHostParams result = new NfcProviderGetNfcForHostParams(elementsOrVersion);
    ...
    static final class NfcProviderSuspendNfcOperationsParams extends Struct {
        ...
        public static NfcProviderSuspendNfcOperationsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                NfcProviderSuspendNfcOperationsParams result = new NfcProviderSuspendNfcOperationsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class NfcProviderResumeNfcOperationsParams extends Struct {
        ...
        public static NfcProviderResumeNfcOperationsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                NfcProviderResumeNfcOperationsParams result = new NfcProviderResumeNfcOperationsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

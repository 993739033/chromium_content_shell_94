...
class PowerMonitorClient_Internal {
    public static final Interface.Manager<PowerMonitorClient, PowerMonitorClient.Proxy> MANAGER = new Interface.Manager<PowerMonitorClient, PowerMonitorClient.Proxy>() { // from class: org.chromium.device.mojom.PowerMonitorClient_Internal.1
        ...
        public PowerMonitorClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements PowerMonitorClient.Proxy {
        ...
        @Override // org.chromium.device.mojom.PowerMonitorClient
    ...
    public static final class Stub extends Interface.Stub<PowerMonitorClient> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PowerMonitorClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class PowerMonitorClientPowerStateChangeParams extends Struct {
        ...
        public static PowerMonitorClientPowerStateChangeParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PowerMonitorClientPowerStateChangeParams result = new PowerMonitorClientPowerStateChangeParams(elementsOrVersion);
    ...
    static final class PowerMonitorClientSuspendParams extends Struct {
        ...
        public static PowerMonitorClientSuspendParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PowerMonitorClientSuspendParams result = new PowerMonitorClientSuspendParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PowerMonitorClientResumeParams extends Struct {
        ...
        public static PowerMonitorClientResumeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PowerMonitorClientResumeParams result = new PowerMonitorClientResumeParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

...
class PublicIpAddressGeolocationProvider_Internal {
    ...
    public static final Interface.Manager<PublicIpAddressGeolocationProvider, PublicIpAddressGeolocationProvider.Proxy> MANAGER = new Interface.Manager<PublicIpAddressGeolocationProvider, PublicIpAddressGeolocationProvider.Proxy>() { // from class: org.chromium.device.mojom.PublicIpAddressGeolocationProvider_Internal.1
        ...
        public PublicIpAddressGeolocationProvider.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements PublicIpAddressGeolocationProvider.Proxy {
        ...
        @Override // org.chromium.device.mojom.PublicIpAddressGeolocationProvider
        public void createGeolocation(MutablePartialNetworkTrafficAnnotationTag tag, InterfaceRequest<Geolocation> receiver) {
    ...
    public static final class Stub extends Interface.Stub<PublicIpAddressGeolocationProvider> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PublicIpAddressGeolocationProvider_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class PublicIpAddressGeolocationProviderCreateGeolocationParams extends Struct {
        ...
        public static PublicIpAddressGeolocationProviderCreateGeolocationParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PublicIpAddressGeolocationProviderCreateGeolocationParams result = new PublicIpAddressGeolocationProviderCreateGeolocationParams(elementsOrVersion);

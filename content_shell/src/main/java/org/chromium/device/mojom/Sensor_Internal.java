...
class Sensor_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Sensor.Proxy {
        ...
        public void getDefaultConfiguration(GetDefaultConfigurationResponse callback) {
            SensorGetDefaultConfigurationParams _message = new SensorGetDefaultConfigurationParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new SensorGetDefaultConfigurationResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.Sensor
        public void addConfiguration(SensorConfiguration configuration, AddConfigurationResponse callback) {
            SensorAddConfigurationParams _message = new SensorAddConfigurationParams();
            _message.configuration = configuration;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new SensorAddConfigurationResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<Sensor> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 4:
                        ...
                        return true;
                    case 5:
                        SensorConfigureReadingChangeNotificationsParams data2 = SensorConfigureReadingChangeNotificationsParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), Sensor_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
    ...
    static final class SensorGetDefaultConfigurationParams extends Struct {
        ...
        public static SensorGetDefaultConfigurationParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SensorGetDefaultConfigurationParams result = new SensorGetDefaultConfigurationParams(elementsOrVersion);
                return result;
            } finally {
    ...
    public static final class SensorGetDefaultConfigurationResponseParams extends Struct {
        ...
        public static SensorGetDefaultConfigurationResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SensorGetDefaultConfigurationResponseParams result = new SensorGetDefaultConfigurationResponseParams(elementsOrVersion);
    ...
    public static final class SensorAddConfigurationResponseParams extends Struct {
        ...
        public static SensorAddConfigurationResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SensorAddConfigurationResponseParams result = new SensorAddConfigurationResponseParams(elementsOrVersion);
    ...
    static final class SensorRemoveConfigurationParams extends Struct {
        ...
        public static SensorRemoveConfigurationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SensorRemoveConfigurationParams result = new SensorRemoveConfigurationParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.configuration = SensorConfiguration.decode(decoder1);
                return result;
            } finally {
    ...
    static final class SensorConfigureReadingChangeNotificationsParams extends Struct {
        ...
        public static SensorConfigureReadingChangeNotificationsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SensorConfigureReadingChangeNotificationsParams result = new SensorConfigureReadingChangeNotificationsParams(elementsOrVersion);

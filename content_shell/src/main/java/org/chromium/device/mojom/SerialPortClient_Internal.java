...
class SerialPortClient_Internal {
    public static final Interface.Manager<SerialPortClient, SerialPortClient.Proxy> MANAGER = new Interface.Manager<SerialPortClient, SerialPortClient.Proxy>() { // from class: org.chromium.device.mojom.SerialPortClient_Internal.1
        ...
        public SerialPortClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements SerialPortClient.Proxy {
        ...
        @Override // org.chromium.device.mojom.SerialPortClient
    ...
    public static final class Stub extends Interface.Stub<SerialPortClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        SerialPortClientOnSendErrorParams data2 = SerialPortClientOnSendErrorParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SerialPortClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SerialPortClientOnReadErrorParams extends Struct {
        ...
        public static SerialPortClientOnReadErrorParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SerialPortClientOnReadErrorParams result = new SerialPortClientOnReadErrorParams(elementsOrVersion);
    ...
    static final class SerialPortClientOnSendErrorParams extends Struct {
        ...
        public static SerialPortClientOnSendErrorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SerialPortClientOnSendErrorParams result = new SerialPortClientOnSendErrorParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.error = readInt;

...
import org.chromium.device.mojom.SerialPortManagerClient;
...
class SerialPortManagerClient_Internal {
    public static final Interface.Manager<SerialPortManagerClient, SerialPortManagerClient.Proxy> MANAGER = new Interface.Manager<SerialPortManagerClient, SerialPortManagerClient.Proxy>() { // from class: org.chromium.device.mojom.SerialPortManagerClient_Internal.1
        ...
        public SerialPortManagerClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements SerialPortManagerClient.Proxy {
        ...
        @Override // org.chromium.device.mojom.SerialPortManagerClient
    ...
    public static final class Stub extends Interface.Stub<SerialPortManagerClient> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(SerialPortManagerClient_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        SerialPortManagerClientOnPortRemovedParams data2 = SerialPortManagerClientOnPortRemovedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SerialPortManagerClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class SerialPortManagerClientOnPortAddedParams extends Struct {
        ...
        public static SerialPortManagerClientOnPortAddedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SerialPortManagerClientOnPortAddedParams result = new SerialPortManagerClientOnPortAddedParams(elementsOrVersion);
    ...
    static final class SerialPortManagerClientOnPortRemovedParams extends Struct {
        ...
        public static SerialPortManagerClientOnPortRemovedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SerialPortManagerClientOnPortRemovedParams result = new SerialPortManagerClientOnPortRemovedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.portInfo = SerialPortInfo.decode(decoder1);
                return result;
            } finally {

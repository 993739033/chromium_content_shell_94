...
class SerialPortManager_Internal {
    ...
    public static final Interface.Manager<SerialPortManager, SerialPortManager.Proxy> MANAGER = new Interface.Manager<SerialPortManager, SerialPortManager.Proxy>() { // from class: org.chromium.device.mojom.SerialPortManager_Internal.1
        ...
        public SerialPortManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements SerialPortManager.Proxy {
        ...
        public void getDevices(GetDevicesResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new SerialPortManagerGetDevicesResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.SerialPortManager
        public void openPort(UnguessableToken token, boolean useAlternatePath, SerialConnectionOptions options, SerialPortClient client, SerialPortConnectionWatcher watcher, OpenPortResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new SerialPortManagerOpenPortResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<SerialPortManager> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), SerialPortManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    default:
                        return false;
                    case 1:
    ...
    static final class SerialPortManagerSetClientParams extends Struct {
        ...
        public static SerialPortManagerSetClientParams decode(Decoder decoder0) {
            ...
            try {
                ...
                SerialPortManagerSetClientParams result = new SerialPortManagerSetClientParams(elementsOrVersion);
                result.client = (SerialPortManagerClient) decoder0.readServiceInterface(8, false, SerialPortManagerClient.MANAGER);
                return result;
            } finally {
    ...
    static final class SerialPortManagerGetDevicesParams extends Struct {
        ...
        public static SerialPortManagerGetDevicesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SerialPortManagerGetDevicesParams result = new SerialPortManagerGetDevicesParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class SerialPortManagerGetDevicesResponseParams extends Struct {
        ...
        public static SerialPortManagerGetDevicesResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SerialPortManagerGetDevicesResponseParams result = new SerialPortManagerGetDevicesResponseParams(elementsOrVersion);
    ...
    static final class SerialPortManagerOpenPortParams extends Struct {
        ...
        public static SerialPortManagerOpenPortParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SerialPortManagerOpenPortParams result = new SerialPortManagerOpenPortParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                ...
                result.client = (SerialPortClient) decoder0.readServiceInterface(32, false, SerialPortClient.MANAGER);
                result.watcher = (SerialPortConnectionWatcher) decoder0.readServiceInterface(40, true, SerialPortConnectionWatcher.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class SerialPortManagerOpenPortResponseParams extends Struct {
        ...
        public static SerialPortManagerOpenPortResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                SerialPortManagerOpenPortResponseParams result = new SerialPortManagerOpenPortResponseParams(elementsOrVersion);
    ...
    static class SerialPortManagerOpenPortResponseParamsProxyToResponder implements SerialPortManager.OpenPortResponse {
        ...
        SerialPortManagerOpenPortResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }

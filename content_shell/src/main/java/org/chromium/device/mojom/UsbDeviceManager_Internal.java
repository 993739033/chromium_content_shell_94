...
class UsbDeviceManager_Internal {
    ...
    public static final Interface.Manager<UsbDeviceManager, UsbDeviceManager.Proxy> MANAGER = new Interface.Manager<UsbDeviceManager, UsbDeviceManager.Proxy>() { // from class: org.chromium.device.mojom.UsbDeviceManager_Internal.1
        ...
        public UsbDeviceManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements UsbDeviceManager.Proxy {
        ...
        public void enumerateDevicesAndSetClient(AssociatedInterfaceNotSupported client, EnumerateDevicesAndSetClientResponse callback) {
            UsbDeviceManagerEnumerateDevicesAndSetClientParams _message = new UsbDeviceManagerEnumerateDevicesAndSetClientParams();
            _message.client = client;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new UsbDeviceManagerEnumerateDevicesAndSetClientResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.UsbDeviceManager
        public void getDevices(UsbEnumerationOptions options, GetDevicesResponse callback) {
            UsbDeviceManagerGetDevicesParams _message = new UsbDeviceManagerGetDevicesParams();
            _message.options = options;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new UsbDeviceManagerGetDevicesResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.UsbDeviceManager
        public void getDevice(String guid, byte[] blockedInterfaceClasses, InterfaceRequest<UsbDevice> deviceReceiver, UsbDeviceClient deviceClient) {
        ...
        @Override // org.chromium.device.mojom.UsbDeviceManager
        public void getSecurityKeyDevice(String guid, InterfaceRequest<UsbDevice> deviceReceiver, UsbDeviceClient deviceClient) {
        ...
        @Override // org.chromium.device.mojom.UsbDeviceManager
        public void refreshDeviceInfo(String guid, RefreshDeviceInfoResponse callback) {
            UsbDeviceManagerRefreshDeviceInfoParams _message = new UsbDeviceManagerRefreshDeviceInfoParams();
            _message.guid = guid;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new UsbDeviceManagerRefreshDeviceInfoResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<UsbDeviceManager> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        UsbDeviceManagerGetSecurityKeyDeviceParams data2 = UsbDeviceManagerGetSecurityKeyDeviceParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getSecurityKeyDevice(data2.guid, data2.deviceReceiver, data2.deviceClient);
                        return true;
                    case 5:
                        getImpl().setClient(UsbDeviceManagerSetClientParams.deserialize(messageWithHeader.getPayload()).client);
                        return true;
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), UsbDeviceManager_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        ...
                        return true;
                    case 1:
                        UsbDeviceManagerGetDevicesParams data2 = UsbDeviceManagerGetDevicesParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getDevices(data2.options, new UsbDeviceManagerGetDevicesResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                    case 3:
                    default:
                        return false;
                    case 4:
                        UsbDeviceManagerRefreshDeviceInfoParams data3 = UsbDeviceManagerRefreshDeviceInfoParams.deserialize(messageWithHeader.getPayload());
                        getImpl().refreshDeviceInfo(data3.guid, new UsbDeviceManagerRefreshDeviceInfoResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class UsbDeviceManagerEnumerateDevicesAndSetClientParams extends Struct {
        ...
        public static UsbDeviceManagerEnumerateDevicesAndSetClientParams decode(Decoder decoder0) {
            ...
            try {
                ...
                UsbDeviceManagerEnumerateDevicesAndSetClientParams result = new UsbDeviceManagerEnumerateDevicesAndSetClientParams(elementsOrVersion);
    ...
    public static final class UsbDeviceManagerEnumerateDevicesAndSetClientResponseParams extends Struct {
        ...
        public static UsbDeviceManagerEnumerateDevicesAndSetClientResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerEnumerateDevicesAndSetClientResponseParams result = new UsbDeviceManagerEnumerateDevicesAndSetClientResponseParams(elementsOrVersion);
    ...
    static final class UsbDeviceManagerGetDevicesParams extends Struct {
        ...
        public static UsbDeviceManagerGetDevicesParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerGetDevicesParams result = new UsbDeviceManagerGetDevicesParams(elementsOrVersion);
    ...
    public static final class UsbDeviceManagerGetDevicesResponseParams extends Struct {
        ...
        public static UsbDeviceManagerGetDevicesResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerGetDevicesResponseParams result = new UsbDeviceManagerGetDevicesResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.results = new UsbDeviceInfo[si1.elementsOrVersion];
                for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
    ...
    static final class UsbDeviceManagerGetDeviceParams extends Struct {
        ...
        public static UsbDeviceManagerGetDeviceParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerGetDeviceParams result = new UsbDeviceManagerGetDeviceParams(elementsOrVersion);
                ...
                result.deviceClient = (UsbDeviceClient) decoder0.readServiceInterface(28, true, UsbDeviceClient.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class UsbDeviceManagerGetSecurityKeyDeviceParams extends Struct {
        ...
        public static UsbDeviceManagerGetSecurityKeyDeviceParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerGetSecurityKeyDeviceParams result = new UsbDeviceManagerGetSecurityKeyDeviceParams(elementsOrVersion);
                result.guid = decoder0.readString(8, false);
    ...
    static final class UsbDeviceManagerRefreshDeviceInfoParams extends Struct {
        ...
        public static UsbDeviceManagerRefreshDeviceInfoParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerRefreshDeviceInfoParams result = new UsbDeviceManagerRefreshDeviceInfoParams(elementsOrVersion);
                result.guid = decoder0.readString(8, false);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    public static final class UsbDeviceManagerRefreshDeviceInfoResponseParams extends Struct {
        ...
        public static UsbDeviceManagerRefreshDeviceInfoResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerRefreshDeviceInfoResponseParams result = new UsbDeviceManagerRefreshDeviceInfoResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);
    ...
    static final class UsbDeviceManagerSetClientParams extends Struct {
        ...
        public static UsbDeviceManagerSetClientParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                UsbDeviceManagerSetClientParams result = new UsbDeviceManagerSetClientParams(elementsOrVersion);
                result.client = decoder0.readAssociatedServiceInterfaceNotSupported(8, false);
                return result;
            } finally {
                decoder0.decreaseStackDepth();

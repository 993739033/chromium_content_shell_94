...
class VibrationManager_Internal {
    ...
    public static final Interface.Manager<VibrationManager, VibrationManager.Proxy> MANAGER = new Interface.Manager<VibrationManager, VibrationManager.Proxy>() { // from class: org.chromium.device.mojom.VibrationManager_Internal.1
        ...
        public VibrationManager.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements VibrationManager.Proxy {
        ...
        public void vibrate(long milliseconds, VibrateResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new VibrationManagerVibrateResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.VibrationManager
        public void cancel(CancelResponse callback) {
            VibrationManagerCancelParams _message = new VibrationManagerCancelParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new VibrationManagerCancelResponseParamsForwardToCallback(callback));
        }
    }
    ...
    static final class VibrationManagerVibrateResponseParams extends Struct {
        ...
        public static VibrationManagerVibrateResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VibrationManagerVibrateResponseParams result = new VibrationManagerVibrateResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class VibrationManagerCancelResponseParams extends Struct {
        ...
        public static VibrationManagerCancelResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VibrationManagerCancelResponseParams result = new VibrationManagerCancelResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

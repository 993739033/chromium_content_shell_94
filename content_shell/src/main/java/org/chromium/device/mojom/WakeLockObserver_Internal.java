...
class WakeLockObserver_Internal {
    public static final Interface.Manager<WakeLockObserver, WakeLockObserver.Proxy> MANAGER = new Interface.Manager<WakeLockObserver, WakeLockObserver.Proxy>() { // from class: org.chromium.device.mojom.WakeLockObserver_Internal.1
        ...
        public WakeLockObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements WakeLockObserver.Proxy {
        ...
        @Override // org.chromium.device.mojom.WakeLockObserver
    ...
    public static final class Stub extends Interface.Stub<WakeLockObserver> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WakeLockObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class WakeLockObserverOnWakeLockDeactivatedParams extends Struct {
        ...
        public static WakeLockObserverOnWakeLockDeactivatedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                WakeLockObserverOnWakeLockDeactivatedParams result = new WakeLockObserverOnWakeLockDeactivatedParams(elementsOrVersion);

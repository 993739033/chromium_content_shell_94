...
class WakeLockProvider_Internal {
    ...
    public static final Interface.Manager<WakeLockProvider, WakeLockProvider.Proxy> MANAGER = new Interface.Manager<WakeLockProvider, WakeLockProvider.Proxy>() { // from class: org.chromium.device.mojom.WakeLockProvider_Internal.1
        ...
        public WakeLockProvider.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WakeLockProvider.Proxy {
        ...
        @Override // org.chromium.device.mojom.WakeLockProvider
        public void getActiveWakeLocksForTests(int type, GetActiveWakeLocksForTestsResponse callback) {
            WakeLockProviderGetActiveWakeLocksForTestsParams _message = new WakeLockProviderGetActiveWakeLocksForTestsParams();
            _message.type = type;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new WakeLockProviderGetActiveWakeLocksForTestsResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<WakeLockProvider> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        WakeLockProviderGetWakeLockWithoutContextParams data2 = WakeLockProviderGetWakeLockWithoutContextParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getWakeLockWithoutContext(data2.type, data2.reason, data2.description, data2.wakeLock);
                        return true;
                    case 2:
                        WakeLockProviderNotifyOnWakeLockDeactivationParams data3 = WakeLockProviderNotifyOnWakeLockDeactivationParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WakeLockProvider_Internal.MANAGER, messageWithHeader, receiver);
                    case 3:
    ...
    static final class WakeLockProviderGetWakeLockContextForIdParams extends Struct {
        ...
        public static WakeLockProviderGetWakeLockContextForIdParams decode(Decoder decoder0) {
            ...
            try {
                ...
                WakeLockProviderGetWakeLockContextForIdParams result = new WakeLockProviderGetWakeLockContextForIdParams(elementsOrVersion);
    ...
    static final class WakeLockProviderGetWakeLockWithoutContextParams extends Struct {
        ...
        public static WakeLockProviderGetWakeLockWithoutContextParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockProviderGetWakeLockWithoutContextParams result = new WakeLockProviderGetWakeLockWithoutContextParams(elementsOrVersion);
    ...
    static final class WakeLockProviderNotifyOnWakeLockDeactivationParams extends Struct {
        ...
        public static WakeLockProviderNotifyOnWakeLockDeactivationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockProviderNotifyOnWakeLockDeactivationParams result = new WakeLockProviderNotifyOnWakeLockDeactivationParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.type = readInt;
                WakeLockType.validate(readInt);
                result.type = WakeLockType.toKnownValue(result.type);
    ...
    static final class WakeLockProviderGetActiveWakeLocksForTestsParams extends Struct {
        ...
        public static WakeLockProviderGetActiveWakeLocksForTestsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockProviderGetActiveWakeLocksForTestsParams result = new WakeLockProviderGetActiveWakeLocksForTestsParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.type = readInt;
                WakeLockType.validate(readInt);
                result.type = WakeLockType.toKnownValue(result.type);
    ...
    public static final class WakeLockProviderGetActiveWakeLocksForTestsResponseParams extends Struct {
        ...
        public static WakeLockProviderGetActiveWakeLocksForTestsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockProviderGetActiveWakeLocksForTestsResponseParams result = new WakeLockProviderGetActiveWakeLocksForTestsResponseParams(elementsOrVersion);

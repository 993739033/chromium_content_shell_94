...
class WakeLock_Internal {
    ...
    public static final Interface.Manager<WakeLock, WakeLock.Proxy> MANAGER = new Interface.Manager<WakeLock, WakeLock.Proxy>() { // from class: org.chromium.device.mojom.WakeLock_Internal.1
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WakeLock.Proxy {
        ...
        @Override // org.chromium.device.mojom.WakeLock
        public void changeType(int type, ChangeTypeResponse callback) {
            WakeLockChangeTypeParams _message = new WakeLockChangeTypeParams();
            _message.type = type;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new WakeLockChangeTypeResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.device.mojom.WakeLock
        public void hasWakeLockForTests(HasWakeLockForTestsResponse callback) {
            WakeLockHasWakeLockForTestsParams _message = new WakeLockHasWakeLockForTestsParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new WakeLockHasWakeLockForTestsResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<WakeLock> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WakeLock_Internal.MANAGER, messageWithHeader, receiver);
                    case 3:
    ...
    public static final class WakeLockChangeTypeResponseParams extends Struct {
        ...
        public static WakeLockChangeTypeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockChangeTypeResponseParams result = new WakeLockChangeTypeResponseParams(elementsOrVersion);
    ...
    static final class WakeLockHasWakeLockForTestsParams extends Struct {
        ...
        public static WakeLockHasWakeLockForTestsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockHasWakeLockForTestsParams result = new WakeLockHasWakeLockForTestsParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class WakeLockHasWakeLockForTestsResponseParams extends Struct {
        ...
        public static WakeLockHasWakeLockForTestsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WakeLockHasWakeLockForTestsResponseParams result = new WakeLockHasWakeLockForTestsResponseParams(elementsOrVersion);
                result.result = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();

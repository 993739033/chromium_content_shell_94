...
import org.chromium.gfx.mojom.DelegatedInkPointRenderer;
...
class DelegatedInkPointRenderer_Internal {
    public static final Interface.Manager<DelegatedInkPointRenderer, DelegatedInkPointRenderer.Proxy> MANAGER = new Interface.Manager<DelegatedInkPointRenderer, DelegatedInkPointRenderer.Proxy>() { // from class: org.chromium.gfx.mojom.DelegatedInkPointRenderer_Internal.1
        ...
        public DelegatedInkPointRenderer.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements DelegatedInkPointRenderer.Proxy {
        ...
        @Override // org.chromium.gfx.mojom.DelegatedInkPointRenderer
    ...
    public static final class Stub extends Interface.Stub<DelegatedInkPointRenderer> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(DelegatedInkPointRenderer_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DelegatedInkPointRenderer_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DelegatedInkPointRendererStoreDelegatedInkPointParams extends Struct {
        ...
        public static DelegatedInkPointRendererStoreDelegatedInkPointParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static DelegatedInkPointRendererStoreDelegatedInkPointParams deserialize(ByteBuffer data) {
        ...
        public static DelegatedInkPointRendererStoreDelegatedInkPointParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DelegatedInkPointRendererStoreDelegatedInkPointParams result = new DelegatedInkPointRendererStoreDelegatedInkPointParams(elementsOrVersion);
    ...
    static final class DelegatedInkPointRendererResetPredictionParams extends Struct {
        ...
        public static DelegatedInkPointRendererResetPredictionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DelegatedInkPointRendererResetPredictionParams result = new DelegatedInkPointRendererResetPredictionParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

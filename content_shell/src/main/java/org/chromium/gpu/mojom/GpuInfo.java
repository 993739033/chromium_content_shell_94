...
public final class GpuInfo extends Struct {
    ...
    public static GpuInfo decode(Decoder decoder0) {
        ...
        try {
            ...
            result.videoDecoderCapabilities = new VideoDecodeAcceleratorSupportedProfile[si12.elementsOrVersion];
            for (int i12 = 0; i12 < si12.elementsOrVersion; i12++) {
                Decoder decoder22 = decoder15.readPointer((i12 * 8) + 8, false);
                result.videoDecoderCapabilities[i12] = VideoDecodeAcceleratorSupportedProfile.decode(decoder22);
            }
            Decoder decoder16 = decoder0.readPointer(160, false);
            DataHeader si13 = decoder16.readDataHeaderForPointerArray(-1);
            result.videoEncodeAcceleratorSupportedProfiles = new VideoEncodeAcceleratorSupportedProfile[si13.elementsOrVersion];
            for (int i13 = 0; i13 < si13.elementsOrVersion; i13++) {
                Decoder decoder23 = decoder16.readPointer((i13 * 8) + 8, false);
                result.videoEncodeAcceleratorSupportedProfiles[i13] = VideoEncodeAcceleratorSupportedProfile.decode(decoder23);
            }
            Decoder decoder17 = decoder0.readPointer(168, false);
            DataHeader si14 = decoder17.readDataHeaderForPointerArray(-1);
            result.imageDecodeAcceleratorSupportedProfiles = new ImageDecodeAcceleratorSupportedProfile[si14.elementsOrVersion];
            for (int i14 = 0; i14 < si14.elementsOrVersion; i14++) {
                Decoder decoder24 = decoder17.readPointer((i14 * 8) + 8, false);
                result.imageDecodeAcceleratorSupportedProfiles[i14] = ImageDecodeAcceleratorSupportedProfile.decode(decoder24);
            }
            result.visibilityCallbackCallCount = decoder0.readInt(176);
            Decoder decoder18 = decoder0.readPointer(184, true);
    ...
    public final void encode(Encoder encoder) {
        ...
        if (videoDecodeAcceleratorSupportedProfileArr == null) {
            ...
            Encoder encoder12 = encoder0.encodePointerArray(videoDecodeAcceleratorSupportedProfileArr.length, 152, -1);
            int i02 = 0;
            while (true) {
                ...
                encoder12.encode((Struct) videoDecodeAcceleratorSupportedProfileArr2[i02], (i02 * 8) + 8, false);
                i02++;
            }
        }
        ...
        if (videoEncodeAcceleratorSupportedProfileArr == null) {
            ...
            Encoder encoder13 = encoder0.encodePointerArray(videoEncodeAcceleratorSupportedProfileArr.length, 160, -1);
            int i03 = 0;
            while (true) {
                ...
                encoder13.encode((Struct) videoEncodeAcceleratorSupportedProfileArr2[i03], (i03 * 8) + 8, false);
                i03++;
            }
        }
        ...
        if (imageDecodeAcceleratorSupportedProfileArr == null) {
            ...
            Encoder encoder14 = encoder0.encodePointerArray(imageDecodeAcceleratorSupportedProfileArr.length, 168, -1);
            int i04 = 0;
            while (true) {
                ...
                encoder14.encode((Struct) imageDecodeAcceleratorSupportedProfileArr2[i04], (i04 * 8) + 8, false);
                i04++;
            }
        }
        encoder0.encode(this.visibilityCallbackCallCount, 176);
        encoder0.encode((Struct) this.vulkanInfo, 184, true);
    }
}

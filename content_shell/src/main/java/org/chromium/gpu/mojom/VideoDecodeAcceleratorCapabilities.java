...
public final class VideoDecodeAcceleratorCapabilities extends Struct {
    ...
    public final void encode(Encoder encoder) {
        ...
        VideoDecodeAcceleratorSupportedProfile[] videoDecodeAcceleratorSupportedProfileArr = this.supportedProfiles;
        if (videoDecodeAcceleratorSupportedProfileArr == null) {
            encoder0.encodeNullPointer(8, false);
        } else {
            Encoder encoder1 = encoder0.encodePointerArray(videoDecodeAcceleratorSupportedProfileArr.length, 8, -1);
            int i0 = 0;
            while (true) {
                VideoDecodeAcceleratorSupportedProfile[] videoDecodeAcceleratorSupportedProfileArr2 = this.supportedProfiles;
                if (i0 >= videoDecodeAcceleratorSupportedProfileArr2.length) {
                    break;
                }
                encoder1.encode((Struct) videoDecodeAcceleratorSupportedProfileArr2[i0], (i0 * 8) + 8, false);
                i0++;
            }
        }

    ...
    public static boolean isResolutionSupportedForType(String mimeType, Size targetResolution) {
        ...
        for (MediaCodecInfo codecInfo : codecInfos) {
            try {
                ...
                if (codecCapabilities != null && (videoCapabilities = codecCapabilities.getVideoCapabilities()) != null && videoCapabilities.isSizeSupported(targetResolution.getWidth(), targetResolution.getHeight())) {
                    return true;
                }

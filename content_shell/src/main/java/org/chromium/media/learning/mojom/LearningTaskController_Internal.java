...
class LearningTaskController_Internal {
    ...
    public static final Interface.Manager<LearningTaskController, LearningTaskController.Proxy> MANAGER = new Interface.Manager<LearningTaskController, LearningTaskController.Proxy>() { // from class: org.chromium.media.learning.mojom.LearningTaskController_Internal.1
        ...
        public LearningTaskController.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements LearningTaskController.Proxy {
        ...
        public void beginObservation(UnguessableToken id, FeatureValue[] features, TargetValue defaultTarget) {
        ...
        @Override // org.chromium.media.learning.mojom.LearningTaskController
        public void predictDistribution(FeatureValue[] features, PredictDistributionResponse callback) {
            LearningTaskControllerPredictDistributionParams _message = new LearningTaskControllerPredictDistributionParams();
            _message.features = features;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new LearningTaskControllerPredictDistributionResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<LearningTaskController> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(LearningTaskController_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        LearningTaskControllerCompleteObservationParams data2 = LearningTaskControllerCompleteObservationParams.deserialize(messageWithHeader.getPayload());
                        getImpl().completeObservation(data2.id, data2.completion);
                        return true;
                    case 2:
                        getImpl().cancelObservation(LearningTaskControllerCancelObservationParams.deserialize(messageWithHeader.getPayload()).id);
                        return true;
                    case 3:
                        LearningTaskControllerUpdateDefaultTargetParams data3 = LearningTaskControllerUpdateDefaultTargetParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), LearningTaskController_Internal.MANAGER, messageWithHeader, receiver);
                    case 4:
    ...
    static final class LearningTaskControllerBeginObservationParams extends Struct {
        ...
        public static LearningTaskControllerBeginObservationParams decode(Decoder decoder0) {
            ...
            try {
                ...
                LearningTaskControllerBeginObservationParams result = new LearningTaskControllerBeginObservationParams(elementsOrVersion);
    ...
    static final class LearningTaskControllerCompleteObservationParams extends Struct {
        ...
        public static LearningTaskControllerCompleteObservationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                LearningTaskControllerCompleteObservationParams result = new LearningTaskControllerCompleteObservationParams(elementsOrVersion);
    ...
    static final class LearningTaskControllerCancelObservationParams extends Struct {
        ...
        public static LearningTaskControllerCancelObservationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                LearningTaskControllerCancelObservationParams result = new LearningTaskControllerCancelObservationParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.id = UnguessableToken.decode(decoder1);
                return result;
            } finally {
    ...
    static final class LearningTaskControllerUpdateDefaultTargetParams extends Struct {
        ...
        public static LearningTaskControllerUpdateDefaultTargetParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                LearningTaskControllerUpdateDefaultTargetParams result = new LearningTaskControllerUpdateDefaultTargetParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.id = UnguessableToken.decode(decoder1);
    ...
    static final class LearningTaskControllerPredictDistributionParams extends Struct {
        ...
        public static LearningTaskControllerPredictDistributionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                LearningTaskControllerPredictDistributionParams result = new LearningTaskControllerPredictDistributionParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.features = new FeatureValue[si1.elementsOrVersion];
                for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
    ...
    public static final class LearningTaskControllerPredictDistributionResponseParams extends Struct {
        ...
        public static LearningTaskControllerPredictDistributionResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static LearningTaskControllerPredictDistributionResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                LearningTaskControllerPredictDistributionResponseParams result = new LearningTaskControllerPredictDistributionResponseParams(elementsOrVersion);
    ...
    static class LearningTaskControllerPredictDistributionResponseParamsProxyToResponder implements LearningTaskController.PredictDistributionResponse {
        ...
        LearningTaskControllerPredictDistributionResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;

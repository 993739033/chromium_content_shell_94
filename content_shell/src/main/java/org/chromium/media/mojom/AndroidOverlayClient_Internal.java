...
class AndroidOverlayClient_Internal {
    public static final Interface.Manager<AndroidOverlayClient, AndroidOverlayClient.Proxy> MANAGER = new Interface.Manager<AndroidOverlayClient, AndroidOverlayClient.Proxy>() { // from class: org.chromium.media.mojom.AndroidOverlayClient_Internal.1
        ...
        public AndroidOverlayClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements AndroidOverlayClient.Proxy {
        ...
        @Override // org.chromium.media.mojom.AndroidOverlayClient
        public void onSynchronouslyDestroyed(OnSynchronouslyDestroyedResponse callback) {
            AndroidOverlayClientOnSynchronouslyDestroyedParams _message = new AndroidOverlayClientOnSynchronouslyDestroyedParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new AndroidOverlayClientOnSynchronouslyDestroyedResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<AndroidOverlayClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 3:
                        AndroidOverlayClientOnPowerEfficientStateParams data2 = AndroidOverlayClientOnPowerEfficientStateParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AndroidOverlayClient_Internal.MANAGER, messageWithHeader, receiver);
                    case 2:
    ...
    static final class AndroidOverlayClientOnSurfaceReadyParams extends Struct {
        ...
        public static AndroidOverlayClientOnSurfaceReadyParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AndroidOverlayClientOnSurfaceReadyParams result = new AndroidOverlayClientOnSurfaceReadyParams(elementsOrVersion);
    ...
    static final class AndroidOverlayClientOnDestroyedParams extends Struct {
        ...
        public static AndroidOverlayClientOnDestroyedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AndroidOverlayClientOnDestroyedParams result = new AndroidOverlayClientOnDestroyedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class AndroidOverlayClientOnSynchronouslyDestroyedParams extends Struct {
        ...
        public static AndroidOverlayClientOnSynchronouslyDestroyedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AndroidOverlayClientOnSynchronouslyDestroyedParams result = new AndroidOverlayClientOnSynchronouslyDestroyedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class AndroidOverlayClientOnSynchronouslyDestroyedResponseParams extends Struct {
        ...
        public static AndroidOverlayClientOnSynchronouslyDestroyedResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static AndroidOverlayClientOnSynchronouslyDestroyedResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static AndroidOverlayClientOnSynchronouslyDestroyedResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AndroidOverlayClientOnSynchronouslyDestroyedResponseParams result = new AndroidOverlayClientOnSynchronouslyDestroyedResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static class AndroidOverlayClientOnSynchronouslyDestroyedResponseParamsProxyToResponder implements AndroidOverlayClient.OnSynchronouslyDestroyedResponse {
        ...
        AndroidOverlayClientOnSynchronouslyDestroyedResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class AndroidOverlayClientOnPowerEfficientStateParams extends Struct {
        ...
        public static AndroidOverlayClientOnPowerEfficientStateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AndroidOverlayClientOnPowerEfficientStateParams result = new AndroidOverlayClientOnPowerEfficientStateParams(elementsOrVersion);

...
class AndroidOverlayProvider_Internal {
    ...
    public static final Interface.Manager<AndroidOverlayProvider, AndroidOverlayProvider.Proxy> MANAGER = new Interface.Manager<AndroidOverlayProvider, AndroidOverlayProvider.Proxy>() { // from class: org.chromium.media.mojom.AndroidOverlayProvider_Internal.1
        ...
        public AndroidOverlayProvider.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<AndroidOverlayProvider> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AndroidOverlayProvider_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AndroidOverlayProviderCreateOverlayParams extends Struct {
        ...
        public static AndroidOverlayProviderCreateOverlayParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AndroidOverlayProviderCreateOverlayParams result = new AndroidOverlayProviderCreateOverlayParams(elementsOrVersion);

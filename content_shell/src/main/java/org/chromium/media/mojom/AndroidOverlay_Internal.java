...
class AndroidOverlay_Internal {
    public static final Interface.Manager<AndroidOverlay, AndroidOverlay.Proxy> MANAGER = new Interface.Manager<AndroidOverlay, AndroidOverlay.Proxy>() { // from class: org.chromium.media.mojom.AndroidOverlay_Internal.1
        ...
        public AndroidOverlay.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<AndroidOverlay> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AndroidOverlay_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AndroidOverlayScheduleLayoutParams extends Struct {
        ...
        public static AndroidOverlayScheduleLayoutParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AndroidOverlayScheduleLayoutParams result = new AndroidOverlayScheduleLayoutParams(elementsOrVersion);

...
class AudioDecoder_Internal {
    ...
    public static final Interface.Manager<AudioDecoder, AudioDecoder.Proxy> MANAGER = new Interface.Manager<AudioDecoder, AudioDecoder.Proxy>() { // from class: org.chromium.media.mojom.AudioDecoder_Internal.1
        ...
        public AudioDecoder.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements AudioDecoder.Proxy {
        ...
        @Override // org.chromium.media.mojom.AudioDecoder
        public void initialize(AudioDecoderConfig config, UnguessableToken cdmId, InitializeResponse callback) {
            AudioDecoderInitializeParams _message = new AudioDecoderInitializeParams();
            _message.config = config;
            _message.cdmId = cdmId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new AudioDecoderInitializeResponseParamsForwardToCallback(callback));
        }
        ...
        public void decode(DecoderBuffer buffer, DecodeResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new AudioDecoderDecodeResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.AudioDecoder
        public void reset(ResetResponse callback) {
            AudioDecoderResetParams _message = new AudioDecoderResetParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new AudioDecoderResetResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<AudioDecoder> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 2:
                        AudioDecoderSetDataSourceParams data2 = AudioDecoderSetDataSourceParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setDataSource(data2.receivePipe);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioDecoder_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    case 2:
                    default:
                        return false;
                    case 1:
                        ...
                        return true;
                    case 3:
                        getImpl().decode(AudioDecoderDecodeParams.deserialize(messageWithHeader.getPayload()).buffer, new AudioDecoderDecodeResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
    ...
    public static final class AudioDecoderInitializeResponseParams extends Struct {
        ...
        public static AudioDecoderInitializeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioDecoderInitializeResponseParams result = new AudioDecoderInitializeResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static class AudioDecoderInitializeResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.success, Boolean.valueOf(response.needsBitstreamConversion), Integer.valueOf(response.decoderType));
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static final class AudioDecoderSetDataSourceParams extends Struct {
        ...
        public static AudioDecoderSetDataSourceParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioDecoderSetDataSourceParams result = new AudioDecoderSetDataSourceParams(elementsOrVersion);
    ...
    public static final class AudioDecoderDecodeResponseParams extends Struct {
        ...
        public static AudioDecoderDecodeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioDecoderDecodeResponseParams result = new AudioDecoderDecodeResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class AudioDecoderResetResponseParams extends Struct {
        ...
        public static AudioDecoderResetResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioDecoderResetResponseParams result = new AudioDecoderResetResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

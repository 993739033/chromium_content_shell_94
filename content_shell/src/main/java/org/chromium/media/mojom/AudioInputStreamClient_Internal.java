...
class AudioInputStreamClient_Internal {
    public static final Interface.Manager<AudioInputStreamClient, AudioInputStreamClient.Proxy> MANAGER = new Interface.Manager<AudioInputStreamClient, AudioInputStreamClient.Proxy>() { // from class: org.chromium.media.mojom.AudioInputStreamClient_Internal.1
        ...
        public AudioInputStreamClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AudioInputStreamClient.Proxy {
        ...
        @Override // org.chromium.media.mojom.AudioInputStreamClient
    ...
    public static final class Stub extends Interface.Stub<AudioInputStreamClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        AudioInputStreamClientOnMutedStateChangedParams data2 = AudioInputStreamClientOnMutedStateChangedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioInputStreamClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioInputStreamClientOnErrorParams extends Struct {
        ...
        public static AudioInputStreamClientOnErrorParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AudioInputStreamClientOnErrorParams result = new AudioInputStreamClientOnErrorParams(elementsOrVersion);
    ...
    static final class AudioInputStreamClientOnMutedStateChangedParams extends Struct {
        ...
        public static AudioInputStreamClientOnMutedStateChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioInputStreamClientOnMutedStateChangedParams result = new AudioInputStreamClientOnMutedStateChangedParams(elementsOrVersion);

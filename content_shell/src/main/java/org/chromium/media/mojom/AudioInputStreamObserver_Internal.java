...
class AudioInputStreamObserver_Internal {
    ...
    public static final Interface.Manager<AudioInputStreamObserver, AudioInputStreamObserver.Proxy> MANAGER = new Interface.Manager<AudioInputStreamObserver, AudioInputStreamObserver.Proxy>() { // from class: org.chromium.media.mojom.AudioInputStreamObserver_Internal.1
        ...
        public AudioInputStreamObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AudioInputStreamObserver.Proxy {
        ...
        @Override // org.chromium.media.mojom.AudioInputStreamObserver
    ...
    public static final class Stub extends Interface.Stub<AudioInputStreamObserver> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioInputStreamObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioInputStreamObserverDidStartRecordingParams extends Struct {
        ...
        public static AudioInputStreamObserverDidStartRecordingParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AudioInputStreamObserverDidStartRecordingParams result = new AudioInputStreamObserverDidStartRecordingParams(elementsOrVersion);
                return result;
            } finally {

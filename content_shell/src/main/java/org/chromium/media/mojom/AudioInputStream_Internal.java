...
class AudioInputStream_Internal {
    public static final Interface.Manager<AudioInputStream, AudioInputStream.Proxy> MANAGER = new Interface.Manager<AudioInputStream, AudioInputStream.Proxy>() { // from class: org.chromium.media.mojom.AudioInputStream_Internal.1
        ...
        public AudioInputStream.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AudioInputStream.Proxy {
        ...
        @Override // org.chromium.media.mojom.AudioInputStream
        public void record() {
    ...
    public static final class Stub extends Interface.Stub<AudioInputStream> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioInputStream_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioInputStreamSetVolumeParams extends Struct {
        ...
        public static AudioInputStreamSetVolumeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioInputStreamSetVolumeParams result = new AudioInputStreamSetVolumeParams(elementsOrVersion);

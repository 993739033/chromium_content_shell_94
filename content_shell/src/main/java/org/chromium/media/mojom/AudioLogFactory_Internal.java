...
class AudioLogFactory_Internal {
    ...
    public static final Interface.Manager<AudioLogFactory, AudioLogFactory.Proxy> MANAGER = new Interface.Manager<AudioLogFactory, AudioLogFactory.Proxy>() { // from class: org.chromium.media.mojom.AudioLogFactory_Internal.1
        ...
        public AudioLogFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements AudioLogFactory.Proxy {
        ...
        @Override // org.chromium.media.mojom.AudioLogFactory
        public void createAudioLog(int component, int componentId, InterfaceRequest<AudioLog> audioLogReceiver) {
    ...
    public static final class Stub extends Interface.Stub<AudioLogFactory> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioLogFactory_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioLogFactoryCreateAudioLogParams extends Struct {
        ...
        public static AudioLogFactoryCreateAudioLogParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AudioLogFactoryCreateAudioLogParams result = new AudioLogFactoryCreateAudioLogParams(elementsOrVersion);

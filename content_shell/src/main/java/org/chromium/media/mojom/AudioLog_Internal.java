    ...
    public static final class Stub extends Interface.Stub<AudioLog> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 4:
                        ...
                        return true;
                    case 5:
                        getImpl().onSetVolume(AudioLogOnSetVolumeParams.deserialize(messageWithHeader.getPayload()).volume);
                        return true;
                    case 6:
                        getImpl().onProcessingStateChanged(AudioLogOnProcessingStateChangedParams.deserialize(messageWithHeader.getPayload()).message);
                        return true;
                    case 7:
                        getImpl().onLogMessage(AudioLogOnLogMessageParams.deserialize(messageWithHeader.getPayload()).message);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioLog_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioLogOnProcessingStateChangedParams extends Struct {
        ...
        public static AudioLogOnProcessingStateChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioLogOnProcessingStateChangedParams result = new AudioLogOnProcessingStateChangedParams(elementsOrVersion);

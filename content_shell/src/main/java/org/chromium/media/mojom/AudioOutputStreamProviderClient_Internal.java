...
class AudioOutputStreamProviderClient_Internal {
    ...
    public static final Interface.Manager<AudioOutputStreamProviderClient, AudioOutputStreamProviderClient.Proxy> MANAGER = new Interface.Manager<AudioOutputStreamProviderClient, AudioOutputStreamProviderClient.Proxy>() { // from class: org.chromium.media.mojom.AudioOutputStreamProviderClient_Internal.1
        ...
        public AudioOutputStreamProviderClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements AudioOutputStreamProviderClient.Proxy {
        @Override
        ...
        @Override // org.chromium.media.mojom.AudioOutputStreamProviderClient
    ...
    public static final class Stub extends Interface.Stub<AudioOutputStreamProviderClient> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioOutputStreamProviderClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioOutputStreamProviderClientCreatedParams extends Struct {
        ...
        public static AudioOutputStreamProviderClientCreatedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AudioOutputStreamProviderClientCreatedParams result = new AudioOutputStreamProviderClientCreatedParams(elementsOrVersion);

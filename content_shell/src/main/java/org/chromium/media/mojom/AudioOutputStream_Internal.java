...
class AudioOutputStream_Internal {
    ...
    public static final Interface.Manager<AudioOutputStream, AudioOutputStream.Proxy> MANAGER = new Interface.Manager<AudioOutputStream, AudioOutputStream.Proxy>() { // from class: org.chromium.media.mojom.AudioOutputStream_Internal.1
        ...
        public AudioOutputStream.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<AudioOutputStream> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioOutputStream_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class AudioOutputStreamSetVolumeParams extends Struct {
        ...
        public static AudioOutputStreamSetVolumeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioOutputStreamSetVolumeParams result = new AudioOutputStreamSetVolumeParams(elementsOrVersion);

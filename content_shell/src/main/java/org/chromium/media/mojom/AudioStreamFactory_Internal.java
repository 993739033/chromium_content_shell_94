...
class AudioStreamFactory_Internal {
    ...
    public static final Interface.Manager<AudioStreamFactory, AudioStreamFactory.Proxy> MANAGER = new Interface.Manager<AudioStreamFactory, AudioStreamFactory.Proxy>() { // from class: org.chromium.media.mojom.AudioStreamFactory_Internal.1
        ...
        public AudioStreamFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements AudioStreamFactory.Proxy {
        ...
        public void createInputStream(InterfaceRequest<AudioInputStream> stream, AudioInputStreamClient client, AudioInputStreamObserver observer, AudioLog log, String deviceId, AudioParameters params, int sharedMemoryCount, boolean enableAgc, ReadOnlySharedMemoryRegion keyPressCountBuffer, CreateInputStreamResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new AudioStreamFactoryCreateInputStreamResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.AudioStreamFactory
        public void associateInputAndOutputForAec(UnguessableToken inputStreamId, String outputDeviceId) {
        ...
        @Override // org.chromium.media.mojom.AudioStreamFactory
        public void createOutputStream(InterfaceRequest<AudioOutputStream> stream, AssociatedInterfaceNotSupported observer, AudioLog log, String deviceId, AudioParameters params, UnguessableToken groupId, CreateOutputStreamResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new AudioStreamFactoryCreateOutputStreamResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.AudioStreamFactory
        public void bindMuter(AssociatedInterfaceRequestNotSupported receiver, UnguessableToken groupId) {
        ...
        @Override // org.chromium.media.mojom.AudioStreamFactory
        public void createLoopbackStream(InterfaceRequest<AudioInputStream> receiver, AudioInputStreamClient client, AudioInputStreamObserver observer, AudioParameters params, int sharedMemoryCount, UnguessableToken groupId, CreateLoopbackStreamResponse callback) {
            ...
            _message.sharedMemoryCount = sharedMemoryCount;
            _message.groupId = groupId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new AudioStreamFactoryCreateLoopbackStreamResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<AudioStreamFactory> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(AudioStreamFactory_Internal.MANAGER, messageWithHeader);
                    case 1:
                        ...
                        return true;
                    case 3:
                        AudioStreamFactoryBindMuterParams data2 = AudioStreamFactoryBindMuterParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), AudioStreamFactory_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                        ...
                        getImpl().createInputStream(data.stream, data.client, data.observer, data.log, data.deviceId, data.params, data.sharedMemoryCount, data.enableAgc, data.keyPressCountBuffer, new AudioStreamFactoryCreateInputStreamResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 1:
                    case 3:
                    default:
                        return false;
                    case 2:
                        AudioStreamFactoryCreateOutputStreamParams data2 = AudioStreamFactoryCreateOutputStreamParams.deserialize(messageWithHeader.getPayload());
                        getImpl().createOutputStream(data2.stream, data2.observer, data2.log, data2.deviceId, data2.params, data2.groupId, new AudioStreamFactoryCreateOutputStreamResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        AudioStreamFactoryCreateLoopbackStreamParams data3 = AudioStreamFactoryCreateLoopbackStreamParams.deserialize(messageWithHeader.getPayload());
                        getImpl().createLoopbackStream(data3.receiver, data3.client, data3.observer, data3.params, data3.sharedMemoryCount, data3.groupId, new AudioStreamFactoryCreateLoopbackStreamResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class AudioStreamFactoryCreateInputStreamParams extends Struct {
        ...
        public static AudioStreamFactoryCreateInputStreamParams decode(Decoder decoder0) {
            ...
            try {
                ...
                AudioStreamFactoryCreateInputStreamParams result = new AudioStreamFactoryCreateInputStreamParams(elementsOrVersion);
                result.stream = decoder0.readInterfaceRequest(8, false);
                result.client = (AudioInputStreamClient) decoder0.readServiceInterface(12, false, AudioInputStreamClient.MANAGER);
                result.observer = (AudioInputStreamObserver) decoder0.readServiceInterface(20, true, AudioInputStreamObserver.MANAGER);
    ...
    public static final class AudioStreamFactoryCreateInputStreamResponseParams extends Struct {
        ...
        public static AudioStreamFactoryCreateInputStreamResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryCreateInputStreamResponseParams result = new AudioStreamFactoryCreateInputStreamResponseParams(elementsOrVersion);
    ...
    /* loaded from: classes2.dex */
    static class AudioStreamFactoryCreateInputStreamResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final AudioStreamFactory.CreateInputStreamResponse mCallback;

        AudioStreamFactoryCreateInputStreamResponseParamsForwardToCallback(AudioStreamFactory.CreateInputStreamResponse callback) {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.dataPipe, Boolean.valueOf(response.initiallyMuted), response.streamId);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    /* loaded from: classes2.dex */
    static class AudioStreamFactoryCreateInputStreamResponseParamsProxyToResponder implements AudioStreamFactory.CreateInputStreamResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        AudioStreamFactoryCreateInputStreamResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
        ...
        public void call(ReadOnlyAudioDataPipe dataPipe, Boolean initiallyMuted, UnguessableToken streamId) {
            ...
            _response.initiallyMuted = initiallyMuted.booleanValue();
    ...
    static final class AudioStreamFactoryAssociateInputAndOutputForAecParams extends Struct {
        ...
        public static AudioStreamFactoryAssociateInputAndOutputForAecParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static AudioStreamFactoryAssociateInputAndOutputForAecParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryAssociateInputAndOutputForAecParams result = new AudioStreamFactoryAssociateInputAndOutputForAecParams(elementsOrVersion);
    ...
    static final class AudioStreamFactoryCreateOutputStreamParams extends Struct {
        ...
        public static AudioStreamFactoryCreateOutputStreamParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryCreateOutputStreamParams result = new AudioStreamFactoryCreateOutputStreamParams(elementsOrVersion);
                result.stream = decoder0.readInterfaceRequest(8, false);
    ...
    public static final class AudioStreamFactoryCreateOutputStreamResponseParams extends Struct {
        ...
        public static AudioStreamFactoryCreateOutputStreamResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryCreateOutputStreamResponseParams result = new AudioStreamFactoryCreateOutputStreamResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);
    ...
    /* loaded from: classes2.dex */
    static class AudioStreamFactoryCreateOutputStreamResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final AudioStreamFactory.CreateOutputStreamResponse mCallback;

        AudioStreamFactoryCreateOutputStreamResponseParamsForwardToCallback(AudioStreamFactory.CreateOutputStreamResponse callback) {
            this.mCallback = callback;
        }
    ...
    /* loaded from: classes2.dex */
    static class AudioStreamFactoryCreateOutputStreamResponseParamsProxyToResponder implements AudioStreamFactory.CreateOutputStreamResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        AudioStreamFactoryCreateOutputStreamResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class AudioStreamFactoryBindMuterParams extends Struct {
        ...
        public static AudioStreamFactoryBindMuterParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryBindMuterParams result = new AudioStreamFactoryBindMuterParams(elementsOrVersion);
    ...
    static final class AudioStreamFactoryCreateLoopbackStreamParams extends Struct {
        ...
        public static AudioStreamFactoryCreateLoopbackStreamParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryCreateLoopbackStreamParams result = new AudioStreamFactoryCreateLoopbackStreamParams(elementsOrVersion);
                result.receiver = decoder0.readInterfaceRequest(8, false);
                result.client = (AudioInputStreamClient) decoder0.readServiceInterface(12, false, AudioInputStreamClient.MANAGER);
                result.observer = (AudioInputStreamObserver) decoder0.readServiceInterface(20, false, AudioInputStreamObserver.MANAGER);
    ...
    public static final class AudioStreamFactoryCreateLoopbackStreamResponseParams extends Struct {
        ...
        public static AudioStreamFactoryCreateLoopbackStreamResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static AudioStreamFactoryCreateLoopbackStreamResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioStreamFactoryCreateLoopbackStreamResponseParams result = new AudioStreamFactoryCreateLoopbackStreamResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);
                result.dataPipe = ReadOnlyAudioDataPipe.decode(decoder1);
                return result;
            } finally {
    ...
    /* loaded from: classes2.dex */
    static class AudioStreamFactoryCreateLoopbackStreamResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        private final AudioStreamFactory.CreateLoopbackStreamResponse mCallback;

        AudioStreamFactoryCreateLoopbackStreamResponseParamsForwardToCallback(AudioStreamFactory.CreateLoopbackStreamResponse callback) {
            this.mCallback = callback;
        }
    ...
    /* loaded from: classes2.dex */
    static class AudioStreamFactoryCreateLoopbackStreamResponseParamsProxyToResponder implements AudioStreamFactory.CreateLoopbackStreamResponse {
        private final Core mCore;
        private final MessageReceiver mMessageReceiver;
        private final long mRequestId;

        AudioStreamFactoryCreateLoopbackStreamResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }

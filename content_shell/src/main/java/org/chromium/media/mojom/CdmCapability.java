...
public final class CdmCapability extends Struct {
    ...
    public Map<Integer, int[]> videoCodecs;
    ...
    public static CdmCapability decode(Decoder decoder0) {
        ...
        try {
            ...
            int[][] values0 = new int[si2.elementsOrVersion][];
            for (int i2 = 0; i2 < si2.elementsOrVersion; i2++) {
                values0[i2] = decoder2.readInts((i2 * 8) + 8, 0, -1);
    ...
    public final void encode(Encoder encoder) {
        ...
        if (this.videoCodecs == null) {
            ...
            int index0 = 0;
            for (Map.Entry<Integer, int[]> entry0 : this.videoCodecs.entrySet()) {
            ...
            for (int i1 = 0; i1 < values0.length; i1++) {
                encoder2.encode(values0[i1], (i1 * 8) + 8, 0, -1);
            }
        }

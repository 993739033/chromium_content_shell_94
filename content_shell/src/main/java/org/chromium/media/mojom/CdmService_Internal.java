...
class CdmService_Internal {
    ...
    public static final Interface.Manager<CdmService, CdmService.Proxy> MANAGER = new Interface.Manager<CdmService, CdmService.Proxy>() { // from class: org.chromium.media.mojom.CdmService_Internal.1
        ...
        public CdmService.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements CdmService.Proxy {
        ...
        @Override // org.chromium.media.mojom.CdmService
        public void createCdmFactory(InterfaceRequest<CdmFactory> factory, FrameInterfaceFactory frameInterfaces) {
    ...
    public static final class Stub extends Interface.Stub<CdmService> {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CdmService_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class CdmServiceCreateCdmFactoryParams extends Struct {
        ...
        public static CdmServiceCreateCdmFactoryParams decode(Decoder decoder0) {
            ...
            try {
                ...
                CdmServiceCreateCdmFactoryParams result = new CdmServiceCreateCdmFactoryParams(elementsOrVersion);
                result.factory = decoder0.readInterfaceRequest(8, false);
                result.frameInterfaces = (FrameInterfaceFactory) decoder0.readServiceInterface(12, false, FrameInterfaceFactory.MANAGER);
                return result;
            } finally {

...
class ContentDecryptionModuleClient_Internal {
    public static final Interface.Manager<ContentDecryptionModuleClient, ContentDecryptionModuleClient.Proxy> MANAGER = new Interface.Manager<ContentDecryptionModuleClient, ContentDecryptionModuleClient.Proxy>() { // from class: org.chromium.media.mojom.ContentDecryptionModuleClient_Internal.1
        ...
        public ContentDecryptionModuleClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<ContentDecryptionModuleClient> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        ContentDecryptionModuleClientOnSessionClosedParams data2 = ContentDecryptionModuleClientOnSessionClosedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onSessionClosed(data2.sessionId, data2.reason);
                        return true;
                    case 2:
                        ContentDecryptionModuleClientOnSessionKeysChangeParams data3 = ContentDecryptionModuleClientOnSessionKeysChangeParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onSessionKeysChange(data3.sessionId, data3.hasAdditionalUsableKey, data3.keysInfo);
                        return true;
                    case 3:
                        ContentDecryptionModuleClientOnSessionExpirationUpdateParams data4 = ContentDecryptionModuleClientOnSessionExpirationUpdateParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), ContentDecryptionModuleClient_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class ContentDecryptionModuleClientOnSessionMessageParams extends Struct {
        ...
        public static ContentDecryptionModuleClientOnSessionMessageParams decode(Decoder decoder0) {
            ...
            try {
                ...
                ContentDecryptionModuleClientOnSessionMessageParams result = new ContentDecryptionModuleClientOnSessionMessageParams(elementsOrVersion);
    ...
    static final class ContentDecryptionModuleClientOnSessionClosedParams extends Struct {
        ...
        public static ContentDecryptionModuleClientOnSessionClosedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentDecryptionModuleClientOnSessionClosedParams result = new ContentDecryptionModuleClientOnSessionClosedParams(elementsOrVersion);
                result.sessionId = decoder0.readString(8, false);
                int readInt = decoder0.readInt(16);
    ...
    static final class ContentDecryptionModuleClientOnSessionKeysChangeParams extends Struct {
        ...
        public static ContentDecryptionModuleClientOnSessionKeysChangeParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentDecryptionModuleClientOnSessionKeysChangeParams result = new ContentDecryptionModuleClientOnSessionKeysChangeParams(elementsOrVersion);
                result.sessionId = decoder0.readString(8, false);
    ...
    static final class ContentDecryptionModuleClientOnSessionExpirationUpdateParams extends Struct {
        ...
        public static ContentDecryptionModuleClientOnSessionExpirationUpdateParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                ContentDecryptionModuleClientOnSessionExpirationUpdateParams result = new ContentDecryptionModuleClientOnSessionExpirationUpdateParams(elementsOrVersion);
                result.sessionId = decoder0.readString(8, false);

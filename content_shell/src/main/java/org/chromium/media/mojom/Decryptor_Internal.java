...
class Decryptor_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Decryptor.Proxy {
        ...
        @Override // org.chromium.media.mojom.Decryptor
        public void decrypt(int streamType, DecoderBuffer encrypted, DecryptResponse callback) {
            DecryptorDecryptParams _message = new DecryptorDecryptParams();
            _message.streamType = streamType;
            _message.encrypted = encrypted;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new DecryptorDecryptResponseParamsForwardToCallback(callback));
        }
        ...
        @Override // org.chromium.media.mojom.Decryptor
        public void initializeAudioDecoder(AudioDecoderConfig config, InitializeAudioDecoderResponse callback) {
            DecryptorInitializeAudioDecoderParams _message = new DecryptorInitializeAudioDecoderParams();
            _message.config = config;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new DecryptorInitializeAudioDecoderResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.Decryptor
        public void initializeVideoDecoder(VideoDecoderConfig config, InitializeVideoDecoderResponse callback) {
            DecryptorInitializeVideoDecoderParams _message = new DecryptorInitializeVideoDecoderParams();
            _message.config = config;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new DecryptorInitializeVideoDecoderResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.Decryptor
        public void decryptAndDecodeAudio(DecoderBuffer encrypted, DecryptAndDecodeAudioResponse callback) {
            DecryptorDecryptAndDecodeAudioParams _message = new DecryptorDecryptAndDecodeAudioParams();
            _message.encrypted = encrypted;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(5, 1, 0L)), new DecryptorDecryptAndDecodeAudioResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.Decryptor
        public void decryptAndDecodeVideo(DecoderBuffer encrypted, DecryptAndDecodeVideoResponse callback) {
            DecryptorDecryptAndDecodeVideoParams _message = new DecryptorDecryptAndDecodeVideoParams();
            _message.encrypted = encrypted;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(6, 1, 0L)), new DecryptorDecryptAndDecodeVideoResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<Decryptor> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 2:
                        getImpl().cancelDecrypt(DecryptorCancelDecryptParams.deserialize(messageWithHeader.getPayload()).streamType);
                        return true;
                    case 7:
                        getImpl().resetDecoder(DecryptorResetDecoderParams.deserialize(messageWithHeader.getPayload()).streamType);
                        return true;
                    case 8:
                        getImpl().deinitializeDecoder(DecryptorDeinitializeDecoderParams.deserialize(messageWithHeader.getPayload()).streamType);
                        return true;
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), Decryptor_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    case 2:
                    default:
                        return false;
                    case 1:
                        ...
                        return true;
                    case 3:
                        getImpl().initializeAudioDecoder(DecryptorInitializeAudioDecoderParams.deserialize(messageWithHeader.getPayload()).config, new DecryptorInitializeAudioDecoderResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
                        getImpl().initializeVideoDecoder(DecryptorInitializeVideoDecoderParams.deserialize(messageWithHeader.getPayload()).config, new DecryptorInitializeVideoDecoderResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 5:
                        getImpl().decryptAndDecodeAudio(DecryptorDecryptAndDecodeAudioParams.deserialize(messageWithHeader.getPayload()).encrypted, new DecryptorDecryptAndDecodeAudioResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        getImpl().decryptAndDecodeVideo(DecryptorDecryptAndDecodeVideoParams.deserialize(messageWithHeader.getPayload()).encrypted, new DecryptorDecryptAndDecodeVideoResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    public static final class DecryptorDecryptResponseParams extends Struct {
        ...
        public static DecryptorDecryptResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorDecryptResponseParams result = new DecryptorDecryptResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
    ...
    static final class DecryptorInitializeAudioDecoderParams extends Struct {
        ...
        public static DecryptorInitializeAudioDecoderParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorInitializeAudioDecoderParams result = new DecryptorInitializeAudioDecoderParams(elementsOrVersion);
    ...
    public static final class DecryptorInitializeAudioDecoderResponseParams extends Struct {
        ...
        public static DecryptorInitializeAudioDecoderResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorInitializeAudioDecoderResponseParams result = new DecryptorInitializeAudioDecoderResponseParams(elementsOrVersion);
    ...
    static final class DecryptorInitializeVideoDecoderParams extends Struct {
        ...
        public static DecryptorInitializeVideoDecoderParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorInitializeVideoDecoderParams result = new DecryptorInitializeVideoDecoderParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    public static final class DecryptorInitializeVideoDecoderResponseParams extends Struct {
        ...
        public static DecryptorInitializeVideoDecoderResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorInitializeVideoDecoderResponseParams result = new DecryptorInitializeVideoDecoderResponseParams(elementsOrVersion);
                result.success = decoder0.readBoolean(8, 0);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
    ...
    static final class DecryptorDecryptAndDecodeAudioParams extends Struct {
        ...
        public static DecryptorDecryptAndDecodeAudioParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorDecryptAndDecodeAudioParams result = new DecryptorDecryptAndDecodeAudioParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.encrypted = DecoderBuffer.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class DecryptorDecryptAndDecodeAudioResponseParams extends Struct {
        ...
        public static DecryptorDecryptAndDecodeAudioResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorDecryptAndDecodeAudioResponseParams result = new DecryptorDecryptAndDecodeAudioResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.status = readInt;
                Decryptor.Status.validate(readInt);
                result.status = Decryptor.Status.toKnownValue(result.status);
    ...
    static final class DecryptorDecryptAndDecodeVideoParams extends Struct {
        ...
        public static DecryptorDecryptAndDecodeVideoParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorDecryptAndDecodeVideoParams result = new DecryptorDecryptAndDecodeVideoParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.encrypted = DecoderBuffer.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class DecryptorDecryptAndDecodeVideoResponseParams extends Struct {
        ...
        public static DecryptorDecryptAndDecodeVideoResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorDecryptAndDecodeVideoResponseParams result = new DecryptorDecryptAndDecodeVideoResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.status = readInt;
                Decryptor.Status.validate(readInt);
                result.status = Decryptor.Status.toKnownValue(result.status);
    ...
    static final class DecryptorDeinitializeDecoderParams extends Struct {
        ...
        public static DecryptorDeinitializeDecoderParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DecryptorDeinitializeDecoderParams result = new DecryptorDeinitializeDecoderParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.streamType = readInt;
                Decryptor.StreamType.validate(readInt);
                result.streamType = Decryptor.StreamType.toKnownValue(result.streamType);

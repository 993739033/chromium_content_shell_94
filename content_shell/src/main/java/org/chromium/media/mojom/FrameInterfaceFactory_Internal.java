...
class FrameInterfaceFactory_Internal {
    ...
    public static final Interface.Manager<FrameInterfaceFactory, FrameInterfaceFactory.Proxy> MANAGER = new Interface.Manager<FrameInterfaceFactory, FrameInterfaceFactory.Proxy>() { // from class: org.chromium.media.mojom.FrameInterfaceFactory_Internal.1
        ...
        public FrameInterfaceFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements FrameInterfaceFactory.Proxy {
        ...
        @Override // org.chromium.media.mojom.FrameInterfaceFactory
        public void getCdmOrigin(GetCdmOriginResponse callback) {
            FrameInterfaceFactoryGetCdmOriginParams _message = new FrameInterfaceFactoryGetCdmOriginParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new FrameInterfaceFactoryGetCdmOriginResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<FrameInterfaceFactory> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(FrameInterfaceFactory_Internal.MANAGER, messageWithHeader);
                    case -1:
                    case 2:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        FrameInterfaceFactoryCreateCdmStorageParams data2 = FrameInterfaceFactoryCreateCdmStorageParams.deserialize(messageWithHeader.getPayload());
                        getImpl().createCdmStorage(data2.cdmStorage);
                        return true;
                    case 3:
                        FrameInterfaceFactoryBindEmbedderReceiverParams data3 = FrameInterfaceFactoryBindEmbedderReceiverParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), FrameInterfaceFactory_Internal.MANAGER, messageWithHeader, receiver);
                    case 2:
    ...
    static final class FrameInterfaceFactoryCreateProvisionFetcherParams extends Struct {
        ...
        public static FrameInterfaceFactoryCreateProvisionFetcherParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FrameInterfaceFactoryCreateProvisionFetcherParams result = new FrameInterfaceFactoryCreateProvisionFetcherParams(elementsOrVersion);
    ...
    static final class FrameInterfaceFactoryCreateCdmStorageParams extends Struct {
        ...
        public static FrameInterfaceFactoryCreateCdmStorageParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameInterfaceFactoryCreateCdmStorageParams result = new FrameInterfaceFactoryCreateCdmStorageParams(elementsOrVersion);
    ...
    static final class FrameInterfaceFactoryGetCdmOriginParams extends Struct {
        ...
        public static FrameInterfaceFactoryGetCdmOriginParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameInterfaceFactoryGetCdmOriginParams result = new FrameInterfaceFactoryGetCdmOriginParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    public static final class FrameInterfaceFactoryGetCdmOriginResponseParams extends Struct {
        ...
        public static FrameInterfaceFactoryGetCdmOriginResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameInterfaceFactoryGetCdmOriginResponseParams result = new FrameInterfaceFactoryGetCdmOriginResponseParams(elementsOrVersion);
    ...
    static class FrameInterfaceFactoryGetCdmOriginResponseParamsProxyToResponder implements FrameInterfaceFactory.GetCdmOriginResponse {
        ...
        FrameInterfaceFactoryGetCdmOriginResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
    ...
    static final class FrameInterfaceFactoryBindEmbedderReceiverParams extends Struct {
        ...
        public static FrameInterfaceFactoryBindEmbedderReceiverParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameInterfaceFactoryBindEmbedderReceiverParams result = new FrameInterfaceFactoryBindEmbedderReceiverParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);

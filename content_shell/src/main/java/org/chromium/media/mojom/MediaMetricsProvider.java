...
public interface MediaMetricsProvider extends Interface {
    public static final Manager<MediaMetricsProvider, Proxy> MANAGER = MediaMetricsProvider_Internal.MANAGER;

    /* loaded from: classes2.dex */
    public interface Proxy extends MediaMetricsProvider, Interface.Proxy {
    }

    void acquireLearningTaskController(String str, InterfaceRequest<LearningTaskController> interfaceRequest);

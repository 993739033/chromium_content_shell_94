...
import org.chromium.media.mojom.MediaPlayerHost;
...
class MediaPlayerHost_Internal {
    public static final Interface.Manager<MediaPlayerHost, MediaPlayerHost.Proxy> MANAGER = new Interface.Manager<MediaPlayerHost, MediaPlayerHost.Proxy>() { // from class: org.chromium.media.mojom.MediaPlayerHost_Internal.1
        ...
        public MediaPlayerHost.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements MediaPlayerHost.Proxy {
        ...
        @Override // org.chromium.media.mojom.MediaPlayerHost
        public void onMediaPlayerAdded(AssociatedInterfaceNotSupported playerRemote, AssociatedInterfaceRequestNotSupported observer, int playerId) {
    ...
    public static final class Stub extends Interface.Stub<MediaPlayerHost> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(MediaPlayerHost_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), MediaPlayerHost_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class MediaPlayerHostOnMediaPlayerAddedParams extends Struct {
        ...
        public static MediaPlayerHostOnMediaPlayerAddedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                MediaPlayerHostOnMediaPlayerAddedParams result = new MediaPlayerHostOnMediaPlayerAddedParams(elementsOrVersion);

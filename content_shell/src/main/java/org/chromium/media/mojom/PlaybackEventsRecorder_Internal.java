...
class PlaybackEventsRecorder_Internal {
    public static final Interface.Manager<PlaybackEventsRecorder, PlaybackEventsRecorder.Proxy> MANAGER = new Interface.Manager<PlaybackEventsRecorder, PlaybackEventsRecorder.Proxy>() { // from class: org.chromium.media.mojom.PlaybackEventsRecorder_Internal.1
        ...
        public PlaybackEventsRecorder.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<PlaybackEventsRecorder> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(PlaybackEventsRecorder_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                    ...
                    case 6:
                        ...
                        return true;
                    case 7:
                        PlaybackEventsRecorderOnNaturalSizeChangedParams data2 = PlaybackEventsRecorderOnNaturalSizeChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onNaturalSizeChanged(data2.size);
                        return true;
                    case 8:
                        PlaybackEventsRecorderOnPipelineStatisticsParams data3 = PlaybackEventsRecorderOnPipelineStatisticsParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), PlaybackEventsRecorder_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class PlaybackEventsRecorderOnPlayingParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnPlayingParams decode(Decoder decoder0) {
            ...
            try {
                ...
                PlaybackEventsRecorderOnPlayingParams result = new PlaybackEventsRecorderOnPlayingParams(elementsOrVersion);
                return result;
            } finally {
    ...
    static final class PlaybackEventsRecorderOnPausedParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnPausedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnPausedParams result = new PlaybackEventsRecorderOnPausedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PlaybackEventsRecorderOnSeekingParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnSeekingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnSeekingParams result = new PlaybackEventsRecorderOnSeekingParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PlaybackEventsRecorderOnEndedParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnEndedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnEndedParams result = new PlaybackEventsRecorderOnEndedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PlaybackEventsRecorderOnErrorParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnErrorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnErrorParams result = new PlaybackEventsRecorderOnErrorParams(elementsOrVersion);
    ...
    static final class PlaybackEventsRecorderOnBufferingParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnBufferingParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnBufferingParams result = new PlaybackEventsRecorderOnBufferingParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PlaybackEventsRecorderOnBufferingCompleteParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnBufferingCompleteParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnBufferingCompleteParams result = new PlaybackEventsRecorderOnBufferingCompleteParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class PlaybackEventsRecorderOnNaturalSizeChangedParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnNaturalSizeChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnNaturalSizeChangedParams result = new PlaybackEventsRecorderOnNaturalSizeChangedParams(elementsOrVersion);
    ...
    static final class PlaybackEventsRecorderOnPipelineStatisticsParams extends Struct {
        ...
        public static PlaybackEventsRecorderOnPipelineStatisticsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PlaybackEventsRecorderOnPipelineStatisticsParams result = new PlaybackEventsRecorderOnPipelineStatisticsParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);

            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        getImpl().onError(RendererClientOnErrorParams.deserialize(messageWithHeader.getPayload()).status);
                        return true;
                    case 4:
                        getImpl().onAudioConfigChange(RendererClientOnAudioConfigChangeParams.deserialize(messageWithHeader.getPayload()).config);
                        return true;
                    case 5:
                        getImpl().onVideoConfigChange(RendererClientOnVideoConfigChangeParams.deserialize(messageWithHeader.getPayload()).config);
                        return true;
                    case 6:
                        getImpl().onVideoNaturalSizeChange(RendererClientOnVideoNaturalSizeChangeParams.deserialize(messageWithHeader.getPayload()).size);
                        return true;
                    case 7:
                        getImpl().onVideoOpacityChange(RendererClientOnVideoOpacityChangeParams.deserialize(messageWithHeader.getPayload()).opaque);
                        return true;
                    case 8:
                        getImpl().onStatisticsUpdate(RendererClientOnStatisticsUpdateParams.deserialize(messageWithHeader.getPayload()).stats);
                        return true;
                    case 9:
                        getImpl().onWaiting(RendererClientOnWaitingParams.deserialize(messageWithHeader.getPayload()).reason);
                        return true;
                }

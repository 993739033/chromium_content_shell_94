...
class Renderer_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Renderer.Proxy {
        ...
        public void initialize(AssociatedInterfaceNotSupported client, DemuxerStream[] streams, MediaUrlParams mediaUrlParams, InitializeResponse callback) {
        ...
        @Override // org.chromium.media.mojom.Renderer
        public void setCdm(UnguessableToken cdmId, SetCdmResponse callback) {

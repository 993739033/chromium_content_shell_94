...
class VideoCaptureHost_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements VideoCaptureHost.Proxy {
        ...
        public void start(UnguessableToken deviceId, UnguessableToken sessionId, VideoCaptureParams params, VideoCaptureObserver observer) {
        ...
        @Override // org.chromium.media.mojom.VideoCaptureHost
        public void resume(UnguessableToken deviceId, UnguessableToken sessionId, VideoCaptureParams params) {
        ...
        @Override // org.chromium.media.mojom.VideoCaptureHost
        public void releaseBuffer(UnguessableToken deviceId, int bufferId, VideoCaptureFeedback feedback) {
        ...
        @Override // org.chromium.media.mojom.VideoCaptureHost
        public void getDeviceSupportedFormats(UnguessableToken deviceId, UnguessableToken sessionId, GetDeviceSupportedFormatsResponse callback) {
        ...
        @Override // org.chromium.media.mojom.VideoCaptureHost
        public void getDeviceFormatsInUse(UnguessableToken deviceId, UnguessableToken sessionId, GetDeviceFormatsInUseResponse callback) {
        ...
        @Override // org.chromium.media.mojom.VideoCaptureHost
        public void onFrameDropped(UnguessableToken deviceId, int reason) {
    ...
    static final class VideoCaptureHostStartParams extends Struct {
        ...
        public static VideoCaptureHostStartParams decode(Decoder decoder0) {
            ...
            try {
                ...
                result.observer = (VideoCaptureObserver) decoder0.readServiceInterface(32, false, VideoCaptureObserver.MANAGER);
                return result;
            } finally {

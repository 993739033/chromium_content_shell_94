            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().onWaiting(VideoDecoderClientOnWaitingParams.deserialize(messageWithHeader.getPayload()).reason);
                        return true;
                    case 2:
                        getImpl().requestOverlayInfo(VideoDecoderClientRequestOverlayInfoParams.deserialize(messageWithHeader.getPayload()).restartForTransitions);
                        return true;
                }

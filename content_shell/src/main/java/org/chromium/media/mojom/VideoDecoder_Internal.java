...
class VideoDecoder_Internal {
    ...
    public static final Interface.Manager<VideoDecoder, VideoDecoder.Proxy> MANAGER = new Interface.Manager<VideoDecoder, VideoDecoder.Proxy>() { // from class: org.chromium.media.mojom.VideoDecoder_Internal.1
        ...
        public VideoDecoder.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements VideoDecoder.Proxy {
        ...
        public void getSupportedConfigs(GetSupportedConfigsResponse callback) {
            VideoDecoderGetSupportedConfigsParams _message = new VideoDecoderGetSupportedConfigsParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new VideoDecoderGetSupportedConfigsResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.VideoDecoder
        public void construct(AssociatedInterfaceNotSupported client, AssociatedInterfaceNotSupported mediaLog, InterfaceRequest<VideoFrameHandleReleaser> videoFrameHandleReleaser, DataPipe.ConsumerHandle decoderBufferPipe, CommandBufferId commandBufferId, ColorSpace targetColorSpace) {
        ...
        @Override // org.chromium.media.mojom.VideoDecoder
        public void initialize(VideoDecoderConfig config, boolean lowDelay, UnguessableToken cdmId, InitializeResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new VideoDecoderInitializeResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.VideoDecoder
        public void decode(DecoderBuffer buffer, DecodeResponse callback) {
            VideoDecoderDecodeParams _message = new VideoDecoderDecodeParams();
            _message.buffer = buffer;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(3, 1, 0L)), new VideoDecoderDecodeResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.media.mojom.VideoDecoder
        public void reset(ResetResponse callback) {
            VideoDecoderResetParams _message = new VideoDecoderResetParams();
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(4, 1, 0L)), new VideoDecoderResetResponseParamsForwardToCallback(callback));
        }
    ...
    public static final class Stub extends Interface.Stub<VideoDecoder> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 5:
                        getImpl().onOverlayInfoChanged(VideoDecoderOnOverlayInfoChangedParams.deserialize(messageWithHeader.getPayload()).overlayInfo);
                        return true;
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), VideoDecoder_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
                    ...
                    case 2:
                        ...
                        return true;
                    case 3:
                        getImpl().decode(VideoDecoderDecodeParams.deserialize(messageWithHeader.getPayload()).buffer, new VideoDecoderDecodeResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 4:
    ...
    static final class VideoDecoderGetSupportedConfigsParams extends Struct {
        ...
        public static VideoDecoderGetSupportedConfigsParams decode(Decoder decoder0) {
            ...
            try {
                ...
                VideoDecoderGetSupportedConfigsParams result = new VideoDecoderGetSupportedConfigsParams(elementsOrVersion);
                return result;
            } finally {
    ...
    public static final class VideoDecoderGetSupportedConfigsResponseParams extends Struct {
        ...
        public static VideoDecoderGetSupportedConfigsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VideoDecoderGetSupportedConfigsResponseParams result = new VideoDecoderGetSupportedConfigsResponseParams(elementsOrVersion);
        ...
        public final void encode(Encoder encoder) {
            ...
            if (supportedVideoDecoderConfigArr == null) {
                ...
                Encoder encoder1 = encoder0.encodePointerArray(supportedVideoDecoderConfigArr.length, 8, -1);
                int i0 = 0;
                while (true) {
    ...
    static class VideoDecoderGetSupportedConfigsResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.supportedConfigs, Integer.valueOf(response.decoderType));
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class VideoDecoderGetSupportedConfigsResponseParamsProxyToResponder implements VideoDecoder.GetSupportedConfigsResponse {
        ...
        public void call(SupportedVideoDecoderConfig[] supportedConfigs, Integer decoderType) {
            ...
            _response.decoderType = decoderType.intValue();
    ...
    public static final class VideoDecoderInitializeResponseParams extends Struct {
        ...
        public static VideoDecoderInitializeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VideoDecoderInitializeResponseParams result = new VideoDecoderInitializeResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static class VideoDecoderInitializeResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(response.status, Boolean.valueOf(response.needsBitstreamConversion), Integer.valueOf(response.maxDecodeRequests), Integer.valueOf(response.decoderType));
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    public static final class VideoDecoderDecodeResponseParams extends Struct {
        ...
        public static VideoDecoderDecodeResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VideoDecoderDecodeResponseParams result = new VideoDecoderDecodeResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.status = Status.decode(decoder1);
                return result;
            } finally {
    ...
    static final class VideoDecoderResetResponseParams extends Struct {
        ...
        public static VideoDecoderResetResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VideoDecoderResetResponseParams result = new VideoDecoderResetResponseParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class VideoDecoderOnOverlayInfoChangedParams extends Struct {
        ...
        public static VideoDecoderOnOverlayInfoChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                VideoDecoderOnOverlayInfoChangedParams result = new VideoDecoderOnOverlayInfoChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);

...
class WatchTimeRecorder_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WatchTimeRecorder.Proxy {
        ...
        @Override // org.chromium.media.mojom.WatchTimeRecorder
        public void onCurrentTimestampChanged(TimeDelta lastTimestamp) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().finalizeWatchTime(WatchTimeRecorderFinalizeWatchTimeParams.deserialize(messageWithHeader.getPayload()).watchTimeKeys);
                        return true;
                    case 2:
                        getImpl().onError(WatchTimeRecorderOnErrorParams.deserialize(messageWithHeader.getPayload()).status);
                        return true;
                    case 3:
                        getImpl().updateSecondaryProperties(WatchTimeRecorderUpdateSecondaryPropertiesParams.deserialize(messageWithHeader.getPayload()).secondaryProperties);
                        return true;
                    case 4:
                        getImpl().setAutoplayInitiated(WatchTimeRecorderSetAutoplayInitiatedParams.deserialize(messageWithHeader.getPayload()).value);
                        return true;
                    case 5:
                        getImpl().onDurationChanged(WatchTimeRecorderOnDurationChangedParams.deserialize(messageWithHeader.getPayload()).duration);
                        return true;
                    case 6:
                        WatchTimeRecorderUpdateVideoDecodeStatsParams data2 = WatchTimeRecorderUpdateVideoDecodeStatsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateVideoDecodeStats(data2.framesDecoded, data2.framesDropped);
                        return true;
                    case 7:
                        getImpl().updateUnderflowCount(WatchTimeRecorderUpdateUnderflowCountParams.deserialize(messageWithHeader.getPayload()).totalCount);
                        return true;
                    case 8:
                        WatchTimeRecorderUpdateUnderflowDurationParams data3 = WatchTimeRecorderUpdateUnderflowDurationParams.deserialize(messageWithHeader.getPayload());
                        getImpl().updateUnderflowDuration(data3.totalCompletedCount, data3.totalDuration);
                        return true;
                    case 9:
                        getImpl().onCurrentTimestampChanged(WatchTimeRecorderOnCurrentTimestampChangedParams.deserialize(messageWithHeader.getPayload()).lastTimestamp);
                        return true;
                }
    ...
    static final class WatchTimeRecorderUpdateVideoDecodeStatsParams extends Struct {
        ...
        public static WatchTimeRecorderUpdateVideoDecodeStatsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WatchTimeRecorderUpdateVideoDecodeStatsParams result = new WatchTimeRecorderUpdateVideoDecodeStatsParams(elementsOrVersion);
    ...
    static final class WatchTimeRecorderUpdateUnderflowDurationParams extends Struct {
        ...
        public static WatchTimeRecorderUpdateUnderflowDurationParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WatchTimeRecorderUpdateUnderflowDurationParams result = new WatchTimeRecorderUpdateUnderflowDurationParams(elementsOrVersion);
    ...
    static final class WatchTimeRecorderOnCurrentTimestampChangedParams extends Struct {
        ...
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        public TimeDelta lastTimestamp;
        ...
        public static WatchTimeRecorderOnCurrentTimestampChangedParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static WatchTimeRecorderOnCurrentTimestampChangedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static WatchTimeRecorderOnCurrentTimestampChangedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WatchTimeRecorderOnCurrentTimestampChangedParams result = new WatchTimeRecorderOnCurrentTimestampChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.lastTimestamp = TimeDelta.decode(decoder1);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public final void encode(Encoder encoder) {
            Encoder encoder0 = encoder.getEncoderAtDataOffset(DEFAULT_STRUCT_INFO);
            encoder0.encode((Struct) this.lastTimestamp, 8, false);
        }
    }
}

...
class AudioFocusManager_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements AudioFocusManager.Proxy {
        ...
        public void requestAudioFocus(InterfaceRequest<AudioFocusRequestClient> client, MediaSession session, MediaSessionInfo sessionInfo, int type, RequestAudioFocusResponse callback) {
        ...
        @Override // org.chromium.media_session.mojom.AudioFocusManager
        public void requestGroupedAudioFocus(UnguessableToken requestId, InterfaceRequest<AudioFocusRequestClient> client, MediaSession session, MediaSessionInfo sessionInfo, int type, UnguessableToken groupId, RequestGroupedAudioFocusResponse callback) {
        ...
        @Override // org.chromium.media_session.mojom.AudioFocusManager
        public void getFocusRequests(GetFocusRequestsResponse callback) {
        ...
        @Override // org.chromium.media_session.mojom.AudioFocusManager
        public void getSourceFocusRequests(UnguessableToken sourceId, GetSourceFocusRequestsResponse callback) {
            AudioFocusManagerGetSourceFocusRequestsParams _message = new AudioFocusManagerGetSourceFocusRequestsParams();
            _message.sourceId = sourceId;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(8, 1, 0L)), new AudioFocusManagerGetSourceFocusRequestsResponseParamsForwardToCallback(callback));
        }
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 2:
                        ...
                        return true;
                    case 5:
                        AudioFocusManagerSetEnforcementModeParams data2 = AudioFocusManagerSetEnforcementModeParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setEnforcementMode(data2.mode);
                        return true;
                    case 6:
                        AudioFocusManagerSetSourceParams data3 = AudioFocusManagerSetSourceParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setSource(data3.identity, data3.name);
                        return true;
                    case 7:
                        AudioFocusManagerAddSourceObserverParams data4 = AudioFocusManagerAddSourceObserverParams.deserialize(messageWithHeader.getPayload());
                        getImpl().addSourceObserver(data4.sourceId, data4.observer);
                        return true;
                    case 9:
                        AudioFocusManagerRequestIdReleasedParams data5 = AudioFocusManagerRequestIdReleasedParams.deserialize(messageWithHeader.getPayload());
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 4:
                        ...
                        getImpl().requestGroupedAudioFocus(data2.requestId, data2.client, data2.session, data2.sessionInfo, data2.type, data2.groupId, new AudioFocusManagerRequestGroupedAudioFocusResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 8:
                        getImpl().getSourceFocusRequests(AudioFocusManagerGetSourceFocusRequestsParams.deserialize(messageWithHeader.getPayload()).sourceId, new AudioFocusManagerGetSourceFocusRequestsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class AudioFocusManagerRequestAudioFocusParams extends Struct {
        ...
        public static AudioFocusManagerRequestAudioFocusParams decode(Decoder decoder0) {
            ...
            try {
                ...
                result.session = (MediaSession) decoder0.readServiceInterface(12, false, MediaSession.MANAGER);
    ...
    static final class AudioFocusManagerRequestGroupedAudioFocusParams extends Struct {
        ...
        public static AudioFocusManagerRequestGroupedAudioFocusParams decode(Decoder decoder0) {
            ...
            try {
                ...
                result.session = (MediaSession) decoder0.readServiceInterface(20, false, MediaSession.MANAGER);
    ...
    static final class AudioFocusManagerSetSourceParams extends Struct {
        ...
        public static AudioFocusManagerSetSourceParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioFocusManagerSetSourceParams result = new AudioFocusManagerSetSourceParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class AudioFocusManagerAddSourceObserverParams extends Struct {
        ...
        public static AudioFocusManagerAddSourceObserverParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioFocusManagerAddSourceObserverParams result = new AudioFocusManagerAddSourceObserverParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.sourceId = UnguessableToken.decode(decoder1);
                result.observer = (AudioFocusObserver) decoder0.readServiceInterface(16, false, AudioFocusObserver.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class AudioFocusManagerGetSourceFocusRequestsParams extends Struct {
        ...
        public static AudioFocusManagerGetSourceFocusRequestsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioFocusManagerGetSourceFocusRequestsParams result = new AudioFocusManagerGetSourceFocusRequestsParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.sourceId = UnguessableToken.decode(decoder1);
                return result;
            } finally {
    ...
    public static final class AudioFocusManagerGetSourceFocusRequestsResponseParams extends Struct {
        ...
        public static AudioFocusManagerGetSourceFocusRequestsResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static AudioFocusManagerGetSourceFocusRequestsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioFocusManagerGetSourceFocusRequestsResponseParams result = new AudioFocusManagerGetSourceFocusRequestsResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
                result.requests = new AudioFocusRequestState[si1.elementsOrVersion];
                for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
    ...
    static class AudioFocusManagerGetSourceFocusRequestsResponseParamsProxyToResponder implements AudioFocusManager.GetSourceFocusRequestsResponse {
        ...
        AudioFocusManagerGetSourceFocusRequestsResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class AudioFocusManagerRequestIdReleasedParams extends Struct {
        ...
        public static AudioFocusManagerRequestIdReleasedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                AudioFocusManagerRequestIdReleasedParams result = new AudioFocusManagerRequestIdReleasedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.requestId = UnguessableToken.decode(decoder1);
                return result;
            } finally {

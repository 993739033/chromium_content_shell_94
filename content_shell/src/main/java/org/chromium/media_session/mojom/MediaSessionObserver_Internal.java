...
class MediaSessionObserver_Internal {
    public static final Interface.Manager<MediaSessionObserver, MediaSessionObserver.Proxy> MANAGER = new Interface.Manager<MediaSessionObserver, MediaSessionObserver.Proxy>() { // from class: org.chromium.media_session.mojom.MediaSessionObserver_Internal.1
        ...
        public MediaSessionObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<MediaSessionObserver> {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        MediaSessionObserverMediaSessionMetadataChangedParams data2 = MediaSessionObserverMediaSessionMetadataChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().mediaSessionMetadataChanged(data2.metadata);
                        return true;
                    case 2:
                        MediaSessionObserverMediaSessionActionsChangedParams data3 = MediaSessionObserverMediaSessionActionsChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().mediaSessionActionsChanged(data3.action);
                        return true;
                    case 3:
                        MediaSessionObserverMediaSessionImagesChangedParams data4 = MediaSessionObserverMediaSessionImagesChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().mediaSessionImagesChanged(data4.images);
                        return true;
                    case 4:
                        MediaSessionObserverMediaSessionPositionChangedParams data5 = MediaSessionObserverMediaSessionPositionChangedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), MediaSessionObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class MediaSessionObserverMediaSessionInfoChangedParams extends Struct {
        ...
        public static MediaSessionObserverMediaSessionInfoChangedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                MediaSessionObserverMediaSessionInfoChangedParams result = new MediaSessionObserverMediaSessionInfoChangedParams(elementsOrVersion);
    ...
    static final class MediaSessionObserverMediaSessionMetadataChangedParams extends Struct {
        ...
        public static MediaSessionObserverMediaSessionMetadataChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionObserverMediaSessionMetadataChangedParams result = new MediaSessionObserverMediaSessionMetadataChangedParams(elementsOrVersion);
    ...
    static final class MediaSessionObserverMediaSessionActionsChangedParams extends Struct {
        ...
        public static MediaSessionObserverMediaSessionActionsChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionObserverMediaSessionActionsChangedParams result = new MediaSessionObserverMediaSessionActionsChangedParams(elementsOrVersion);
    ...
    static final class MediaSessionObserverMediaSessionImagesChangedParams extends Struct {
        ...
        public static MediaSessionObserverMediaSessionImagesChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionObserverMediaSessionImagesChangedParams result = new MediaSessionObserverMediaSessionImagesChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    static final class MediaSessionObserverMediaSessionPositionChangedParams extends Struct {
        ...
        public static MediaSessionObserverMediaSessionPositionChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                MediaSessionObserverMediaSessionPositionChangedParams result = new MediaSessionObserverMediaSessionPositionChangedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, true);

...
class CookieAccessObserver_Internal {
    ...
    public static final Interface.Manager<CookieAccessObserver, CookieAccessObserver.Proxy> MANAGER = new Interface.Manager<CookieAccessObserver, CookieAccessObserver.Proxy>() { // from class: org.chromium.network.mojom.CookieAccessObserver_Internal.1
        ...
        @Override // org.chromium.mojo.bindings.Interface.Manager
        public CookieAccessObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Stub extends Interface.Stub<CookieAccessObserver> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(CookieAccessObserver_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        CookieAccessObserverCloneParams data2 = CookieAccessObserverCloneParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CookieAccessObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class CookieAccessObserverOnCookiesAccessedParams extends Struct {
        ...
        public static CookieAccessObserverOnCookiesAccessedParams decode(Decoder decoder0) {
            ...
            try {
                ...
                CookieAccessObserverOnCookiesAccessedParams result = new CookieAccessObserverOnCookiesAccessedParams(elementsOrVersion);
    ...
    static final class CookieAccessObserverCloneParams extends Struct {
        ...
        public static CookieAccessObserverCloneParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CookieAccessObserverCloneParams result = new CookieAccessObserverCloneParams(elementsOrVersion);

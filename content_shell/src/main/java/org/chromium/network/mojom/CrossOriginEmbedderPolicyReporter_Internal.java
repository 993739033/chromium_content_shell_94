...
class CrossOriginEmbedderPolicyReporter_Internal {
    ...
    public static final Interface.Manager<CrossOriginEmbedderPolicyReporter, CrossOriginEmbedderPolicyReporter.Proxy> MANAGER = new Interface.Manager<CrossOriginEmbedderPolicyReporter, CrossOriginEmbedderPolicyReporter.Proxy>() { // from class: org.chromium.network.mojom.CrossOriginEmbedderPolicyReporter_Internal.1
        ...
        @Override // org.chromium.mojo.bindings.Interface.Manager
        public CrossOriginEmbedderPolicyReporter.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements CrossOriginEmbedderPolicyReporter.Proxy {
        ...
        @Override // org.chromium.network.mojom.CrossOriginEmbedderPolicyReporter
    ...
    public static final class Stub extends Interface.Stub<CrossOriginEmbedderPolicyReporter> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(CrossOriginEmbedderPolicyReporter_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().clone(CrossOriginEmbedderPolicyReporterCloneParams.deserialize(messageWithHeader.getPayload()).receiver);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), CrossOriginEmbedderPolicyReporter_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    /* loaded from: classes2.dex */
    static final class CrossOriginEmbedderPolicyReporterQueueCorpViolationReportParams extends Struct {
        ...
        public static CrossOriginEmbedderPolicyReporterQueueCorpViolationReportParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static CrossOriginEmbedderPolicyReporterQueueCorpViolationReportParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static CrossOriginEmbedderPolicyReporterQueueCorpViolationReportParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            ...
            try {
                ...
                CrossOriginEmbedderPolicyReporterQueueCorpViolationReportParams result = new CrossOriginEmbedderPolicyReporterQueueCorpViolationReportParams(elementsOrVersion);
    ...
    static final class CrossOriginEmbedderPolicyReporterCloneParams extends Struct {
        ...
        public static CrossOriginEmbedderPolicyReporterCloneParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                CrossOriginEmbedderPolicyReporterCloneParams result = new CrossOriginEmbedderPolicyReporterCloneParams(elementsOrVersion);

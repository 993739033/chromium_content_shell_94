...
class DevToolsObserver_Internal {
    ...
    public static final Interface.Manager<DevToolsObserver, DevToolsObserver.Proxy> MANAGER = new Interface.Manager<DevToolsObserver, DevToolsObserver.Proxy>() { // from class: org.chromium.network.mojom.DevToolsObserver_Internal.1
        ...
        @Override // org.chromium.mojo.bindings.Interface.Manager
        public DevToolsObserver.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements DevToolsObserver.Proxy {
        ...
        public void onRawRequest(String devtoolRequestId, CookieWithAccessResult[] cookiesWithAccessResult, HttpRawHeaderPair[] headers, ClientSecurityState clientSecurityState) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onRawResponse(String devtoolRequestId, CookieAndLineWithAccessResult[] cookiesWithAccessResult, HttpRawHeaderPair[] headers, String rawResponseHeaders, int resourceAddressSpace, int httpStatusCode) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onPrivateNetworkRequest(String devtoolRequestId, Url url, boolean isWarning, int resourceAddressSpace, ClientSecurityState clientSecurityState) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onCorsPreflightRequest(UnguessableToken devtoolRequestId, HttpRequestHeaders requestHeaders, UrlRequestDevToolsInfo requestInfo, Url initiatorUrl, String initiatorDevtoolRequestId) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onCorsPreflightResponse(UnguessableToken devtoolRequestId, Url url, UrlResponseHead head) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onCorsPreflightRequestCompleted(UnguessableToken devtoolRequestId, UrlLoaderCompletionStatus status) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onCorsError(String devtoolRequestId, Origin initiatorOrigin, Url url, CorsErrorStatus status) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onSubresourceWebBundleInnerResponse(String innerRequestDevtoolsId, Url url, String bundleRequestDevtoolsId) {
        ...
        @Override // org.chromium.network.mojom.DevToolsObserver
        public void onSubresourceWebBundleInnerResponseError(String innerRequestDevtoolsId, Url url, String errorMessage, String bundleRequestDevtoolsId) {
    ...
    public static final class Stub extends Interface.Stub<DevToolsObserver> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(DevToolsObserver_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        DevToolsObserverOnRawRequestParams data = DevToolsObserverOnRawRequestParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onRawRequest(data.devtoolRequestId, data.cookiesWithAccessResult, data.headers, data.clientSecurityState);
                        return true;
                    case 1:
                        DevToolsObserverOnRawResponseParams data2 = DevToolsObserverOnRawResponseParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onRawResponse(data2.devtoolRequestId, data2.cookiesWithAccessResult, data2.headers, data2.rawResponseHeaders, data2.resourceAddressSpace, data2.httpStatusCode);
                        return true;
                    case 2:
                        DevToolsObserverOnPrivateNetworkRequestParams data3 = DevToolsObserverOnPrivateNetworkRequestParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onPrivateNetworkRequest(data3.devtoolRequestId, data3.url, data3.isWarning, data3.resourceAddressSpace, data3.clientSecurityState);
                        return true;
                    case 3:
                        DevToolsObserverOnCorsPreflightRequestParams data4 = DevToolsObserverOnCorsPreflightRequestParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onCorsPreflightRequest(data4.devtoolRequestId, data4.requestHeaders, data4.requestInfo, data4.initiatorUrl, data4.initiatorDevtoolRequestId);
                        return true;
                    case 4:
                        DevToolsObserverOnCorsPreflightResponseParams data5 = DevToolsObserverOnCorsPreflightResponseParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onCorsPreflightResponse(data5.devtoolRequestId, data5.url, data5.head);
                        return true;
                    case 5:
                        DevToolsObserverOnCorsPreflightRequestCompletedParams data6 = DevToolsObserverOnCorsPreflightRequestCompletedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onCorsPreflightRequestCompleted(data6.devtoolRequestId, data6.status);
                        return true;
                    case 6:
                        DevToolsObserverOnTrustTokenOperationDoneParams data7 = DevToolsObserverOnTrustTokenOperationDoneParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onTrustTokenOperationDone(data7.devtoolRequestId, data7.result);
                        return true;
                    case 7:
                        DevToolsObserverOnCorsErrorParams data8 = DevToolsObserverOnCorsErrorParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onCorsError(data8.devtoolRequestId, data8.initiatorOrigin, data8.url, data8.status);
                        return true;
                    case 8:
                        DevToolsObserverOnSubresourceWebBundleMetadataParams data9 = DevToolsObserverOnSubresourceWebBundleMetadataParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onSubresourceWebBundleMetadata(data9.devtoolRequestId, data9.urls);
                        return true;
                    case 9:
                        DevToolsObserverOnSubresourceWebBundleMetadataErrorParams data10 = DevToolsObserverOnSubresourceWebBundleMetadataErrorParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onSubresourceWebBundleMetadataError(data10.devtoolRequestId, data10.errorMessage);
                        return true;
                    case 10:
                        DevToolsObserverOnSubresourceWebBundleInnerResponseParams data11 = DevToolsObserverOnSubresourceWebBundleInnerResponseParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onSubresourceWebBundleInnerResponse(data11.innerRequestDevtoolsId, data11.url, data11.bundleRequestDevtoolsId);
                        return true;
                    case 11:
                        DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams data12 = DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onSubresourceWebBundleInnerResponseError(data12.innerRequestDevtoolsId, data12.url, data12.errorMessage, data12.bundleRequestDevtoolsId);
                        return true;
                    case 12:
                        getImpl().clone(DevToolsObserverCloneParams.deserialize(messageWithHeader.getPayload()).listener);
                        return true;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DevToolsObserver_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class DevToolsObserverOnRawRequestParams extends Struct {
        ...
        public static DevToolsObserverOnRawRequestParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DevToolsObserverOnRawRequestParams result = new DevToolsObserverOnRawRequestParams(elementsOrVersion);
                ...
                result.clientSecurityState = ClientSecurityState.decode(decoder0.readPointer(32, true));
                return result;
            } finally {
        ...
        public final void encode(Encoder encoder) {
            ...
            encoder0.encode((Struct) this.clientSecurityState, 32, true);
        }
    }
    ...
    static final class DevToolsObserverOnRawResponseParams extends Struct {
        ...
        public static DevToolsObserverOnRawResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnRawResponseParams result = new DevToolsObserverOnRawResponseParams(elementsOrVersion);
                result.devtoolRequestId = decoder0.readString(8, false);
                Decoder decoder1 = decoder0.readPointer(16, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
        ...
        public final void encode(Encoder encoder) {
            ...
            if (cookieAndLineWithAccessResultArr == null) {
                ...
                Encoder encoder1 = encoder0.encodePointerArray(cookieAndLineWithAccessResultArr.length, 16, -1);
                int i0 = 0;
                while (true) {
    ...
    static final class DevToolsObserverOnPrivateNetworkRequestParams extends Struct {
        ...
        public static DevToolsObserverOnPrivateNetworkRequestParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnPrivateNetworkRequestParams result = new DevToolsObserverOnPrivateNetworkRequestParams(elementsOrVersion);
    ...
    static final class DevToolsObserverOnCorsPreflightRequestParams extends Struct {
        ...
        public static DevToolsObserverOnCorsPreflightRequestParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnCorsPreflightRequestParams result = new DevToolsObserverOnCorsPreflightRequestParams(elementsOrVersion);
    ...
    static final class DevToolsObserverOnCorsPreflightResponseParams extends Struct {
        ...
        public static DevToolsObserverOnCorsPreflightResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnCorsPreflightResponseParams result = new DevToolsObserverOnCorsPreflightResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.devtoolRequestId = UnguessableToken.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, false);
                result.url = Url.decode(decoder12);
                Decoder decoder13 = decoder0.readPointer(24, false);
                result.head = UrlResponseHead.decode(decoder13);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    static final class DevToolsObserverOnCorsPreflightRequestCompletedParams extends Struct {
        ...
        public static DevToolsObserverOnCorsPreflightRequestCompletedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static DevToolsObserverOnCorsPreflightRequestCompletedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnCorsPreflightRequestCompletedParams result = new DevToolsObserverOnCorsPreflightRequestCompletedParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.devtoolRequestId = UnguessableToken.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, false);
    ...
    static final class DevToolsObserverOnTrustTokenOperationDoneParams extends Struct {
        ...
        public static DevToolsObserverOnTrustTokenOperationDoneParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnTrustTokenOperationDoneParams result = new DevToolsObserverOnTrustTokenOperationDoneParams(elementsOrVersion);
                result.devtoolRequestId = decoder0.readString(8, false);
                Decoder decoder1 = decoder0.readPointer(16, false);
    ...
    static final class DevToolsObserverOnCorsErrorParams extends Struct {
        ...
        public static DevToolsObserverOnCorsErrorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnCorsErrorParams result = new DevToolsObserverOnCorsErrorParams(elementsOrVersion);
                result.devtoolRequestId = decoder0.readString(8, true);
                ...
                result.status = CorsErrorStatus.decode(decoder13);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
        ...
        public final void encode(Encoder encoder) {
            ...
            encoder0.encode((Struct) this.status, 32, false);
        }
    }
    ...
    static final class DevToolsObserverOnSubresourceWebBundleMetadataParams extends Struct {
        ...
        public static DevToolsObserverOnSubresourceWebBundleMetadataParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static DevToolsObserverOnSubresourceWebBundleMetadataParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnSubresourceWebBundleMetadataParams result = new DevToolsObserverOnSubresourceWebBundleMetadataParams(elementsOrVersion);
                result.devtoolRequestId = decoder0.readString(8, false);
                Decoder decoder1 = decoder0.readPointer(16, false);
                DataHeader si1 = decoder1.readDataHeaderForPointerArray(-1);
    ...
    static final class DevToolsObserverOnSubresourceWebBundleMetadataErrorParams extends Struct {
        ...
        public static DevToolsObserverOnSubresourceWebBundleMetadataErrorParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static DevToolsObserverOnSubresourceWebBundleMetadataErrorParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnSubresourceWebBundleMetadataErrorParams result = new DevToolsObserverOnSubresourceWebBundleMetadataErrorParams(elementsOrVersion);
                result.devtoolRequestId = decoder0.readString(8, false);
    ...
    static final class DevToolsObserverOnSubresourceWebBundleInnerResponseParams extends Struct {
        ...
        public static DevToolsObserverOnSubresourceWebBundleInnerResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static DevToolsObserverOnSubresourceWebBundleInnerResponseParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnSubresourceWebBundleInnerResponseParams result = new DevToolsObserverOnSubresourceWebBundleInnerResponseParams(elementsOrVersion);
    ...
    static final class DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams extends Struct {
        ...
        public static DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams result = new DevToolsObserverOnSubresourceWebBundleInnerResponseErrorParams(elementsOrVersion);
                result.innerRequestDevtoolsId = decoder0.readString(8, false);
                Decoder decoder1 = decoder0.readPointer(16, false);
                result.url = Url.decode(decoder1);

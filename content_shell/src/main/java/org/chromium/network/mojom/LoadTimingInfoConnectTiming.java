...
public final class LoadTimingInfoConnectTiming extends Struct {
    ...
    public static LoadTimingInfoConnectTiming decode(Decoder decoder0) {
        ...
        try {
            ...
            result.dnsStart = TimeTicks.decode(decoder1);
            Decoder decoder12 = decoder0.readPointer(16, false);
            result.dnsEnd = TimeTicks.decode(decoder12);
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode((Struct) this.dnsStart, 8, false);
        encoder0.encode((Struct) this.dnsEnd, 16, false);

...
class NetLogExporter_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements NetLogExporter.Proxy {
        ...
        public void start(File destination, DictionaryValue extraConstants, int captureMode, long maxFileSize, StartResponse callback) {
        ...
        @Override // org.chromium.network.mojom.NetLogExporter
        public void stop(DictionaryValue polledValues, StopResponse callback) {

            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 0:
                        getImpl().requestNotifications(NetworkChangeManagerRequestNotificationsParams.deserialize(messageWithHeader.getPayload()).clientRemote);
                        return true;
                    case 1:
    ...
    static final class NetworkChangeManagerRequestNotificationsParams extends Struct {
        ...
        public static NetworkChangeManagerRequestNotificationsParams decode(Decoder decoder0) {
            ...
            try {
                ...
                result.clientRemote = (NetworkChangeManagerClient) decoder0.readServiceInterface(8, false, NetworkChangeManagerClient.MANAGER);
                return result;
            } finally {

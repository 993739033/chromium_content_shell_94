...
class ProxyResolvingSocket_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ProxyResolvingSocket.Proxy {
        ...
        public void upgradeToTls(HostPortPair hostPortPair, MutableNetworkTrafficAnnotationTag trafficAnnotation, InterfaceRequest<TlsClientSocket> receiver, SocketObserver observer, UpgradeToTlsResponse callback) {

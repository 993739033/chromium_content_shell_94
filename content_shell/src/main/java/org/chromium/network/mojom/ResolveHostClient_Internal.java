...
class ResolveHostClient_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements ResolveHostClient.Proxy {
        ...
        public void onComplete(int result, ResolveErrorInfo resolveErrorInfo, AddressList resolvedAddresses) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        getImpl().onTextResults(ResolveHostClientOnTextResultsParams.deserialize(messageWithHeader.getPayload()).textResults);
                        return true;
                    case 2:
                        getImpl().onHostnameResults(ResolveHostClientOnHostnameResultsParams.deserialize(messageWithHeader.getPayload()).hosts);
                        return true;
                }

...
class TcpBoundSocket_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements TcpBoundSocket.Proxy {
        ...
        public void listen(int backlog, InterfaceRequest<TcpServerSocket> socket, ListenResponse callback) {
        ...
        @Override // org.chromium.network.mojom.TcpBoundSocket
        public void connect(AddressList remoteAddrList, TcpConnectedSocketOptions tcpConnectedSocketOptions, InterfaceRequest<TcpConnectedSocket> socket, SocketObserver observer, ConnectResponse callback) {

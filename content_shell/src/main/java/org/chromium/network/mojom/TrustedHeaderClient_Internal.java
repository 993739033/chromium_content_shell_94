...
class TrustedHeaderClient_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements TrustedHeaderClient.Proxy {
        ...
        public void onBeforeSendHeaders(HttpRequestHeaders headers, OnBeforeSendHeadersResponse callback) {
        ...
        @Override // org.chromium.network.mojom.TrustedHeaderClient
        public void onHeadersReceived(String headers, IpEndPoint remoteEndpoint, OnHeadersReceivedResponse callback) {
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        getImpl().onBeforeSendHeaders(TrustedHeaderClientOnBeforeSendHeadersParams.deserialize(messageWithHeader.getPayload()).headers, new TrustedHeaderClientOnBeforeSendHeadersResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 1:
    ...
    static class TrustedHeaderClientOnHeadersReceivedResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(Integer.valueOf(response.result), response.headers, response.preserveFragmentOnRedirectUrl);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class TrustedHeaderClientOnHeadersReceivedResponseParamsProxyToResponder implements TrustedHeaderClient.OnHeadersReceivedResponse {
        ...
        public void call(Integer result, String headers, Url preserveFragmentOnRedirectUrl) {

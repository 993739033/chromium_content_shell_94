...
class UrlLoaderFactory_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements UrlLoaderFactory.Proxy {
        ...
        public void createLoaderAndStart(InterfaceRequest<UrlLoader> loader, int requestId, int options, UrlRequest request, UrlLoaderClient client, MutableNetworkTrafficAnnotationTag trafficAnnotation) {

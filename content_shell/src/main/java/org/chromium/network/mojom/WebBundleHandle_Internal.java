...
import org.chromium.network.mojom.WebBundleHandle;
/* loaded from: classes2.dex */
class WebBundleHandle_Internal {
    private static final int CLONE_ORDINAL = 0;
    public static final Interface.Manager<WebBundleHandle, WebBundleHandle.Proxy> MANAGER = new Interface.Manager<WebBundleHandle, WebBundleHandle.Proxy>() { // from class: org.chromium.network.mojom.WebBundleHandle_Internal.1
        ...
        @Override // org.chromium.mojo.bindings.Interface.Manager
        public WebBundleHandle.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WebBundleHandle.Proxy {
        ...
        @Override // org.chromium.network.mojom.WebBundleHandle
    ...
    public static final class Stub extends Interface.Stub<WebBundleHandle> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(WebBundleHandle_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        getImpl().clone(WebBundleHandleCloneParams.deserialize(messageWithHeader.getPayload()).receiver);
                        return true;
                    case 1:
                        ...
                        return true;
                    case 2:
                        WebBundleHandleOnWebBundleLoadFinishedParams data2 = WebBundleHandleOnWebBundleLoadFinishedParams.deserialize(messageWithHeader.getPayload());
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), WebBundleHandle_Internal.MANAGER, messageWithHeader, receiver);
                    default:
                        return false;
                }
            } catch (DeserializationException e) {
    ...
    static final class WebBundleHandleOnWebBundleErrorParams extends Struct {
        ...
        public static WebBundleHandleOnWebBundleErrorParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WebBundleHandleOnWebBundleErrorParams result = new WebBundleHandleOnWebBundleErrorParams(elementsOrVersion);
    ...
    static final class WebBundleHandleOnWebBundleLoadFinishedParams extends Struct {
        ...
        public static WebBundleHandleOnWebBundleLoadFinishedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WebBundleHandleOnWebBundleLoadFinishedParams result = new WebBundleHandleOnWebBundleLoadFinishedParams(elementsOrVersion);

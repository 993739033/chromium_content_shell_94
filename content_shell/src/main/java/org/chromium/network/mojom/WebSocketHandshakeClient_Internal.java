...
class WebSocketHandshakeClient_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements WebSocketHandshakeClient.Proxy {
        ...
        @Override // org.chromium.network.mojom.WebSocketHandshakeClient
        public void onConnectionEstablished(WebSocket socket, InterfaceRequest<WebSocketClient> clientReceiver, WebSocketHandshakeResponse response, DataPipe.ConsumerHandle readable, DataPipe.ProducerHandle writable) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        WebSocketHandshakeClientOnConnectionEstablishedParams data2 = WebSocketHandshakeClientOnConnectionEstablishedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onConnectionEstablished(data2.socket, data2.clientReceiver, data2.response, data2.readable, data2.writable);
                        return true;
                }
    ...
    static final class WebSocketHandshakeClientOnFailureParams extends Struct {
        ...
        public static WebSocketHandshakeClientOnFailureParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                WebSocketHandshakeClientOnFailureParams result = new WebSocketHandshakeClientOnFailureParams(elementsOrVersion);

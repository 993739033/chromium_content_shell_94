...
class DigitalGoodsFactory_Internal {
    ...
    public static final Interface.Manager<DigitalGoodsFactory, DigitalGoodsFactory.Proxy> MANAGER = new Interface.Manager<DigitalGoodsFactory, DigitalGoodsFactory.Proxy>() { // from class: org.chromium.payments.mojom.DigitalGoodsFactory_Internal.1
        ...
        @Override // org.chromium.mojo.bindings.Interface.Manager
        public DigitalGoodsFactory.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
    ...
    /* loaded from: classes2.dex */
    public static final class Proxy extends Interface.AbstractProxy implements DigitalGoodsFactory.Proxy {
        ...
        public void createDigitalGoods(String paymentMethod, CreateDigitalGoodsResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(0, 1, 0L)), new DigitalGoodsFactoryCreateDigitalGoodsResponseParamsForwardToCallback(callback));
        }
    }
    ...
    public static final class Stub extends Interface.Stub<DigitalGoodsFactory> {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(DigitalGoodsFactory_Internal.MANAGER, messageWithHeader);
                    default:
                        return false;
                }
        ...
        public boolean acceptWithResponder(Message message, MessageReceiver receiver) {
            try {
                ...
                switch (header.getType()) {
                    case -1:
                        return InterfaceControlMessagesHelper.handleRun(getCore(), DigitalGoodsFactory_Internal.MANAGER, messageWithHeader, receiver);
                    case 0:
    ...
    static final class DigitalGoodsFactoryCreateDigitalGoodsParams extends Struct {
        ...
        public static DigitalGoodsFactoryCreateDigitalGoodsParams decode(Decoder decoder0) {
            ...
            try {
                ...
                DigitalGoodsFactoryCreateDigitalGoodsParams result = new DigitalGoodsFactoryCreateDigitalGoodsParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class DigitalGoodsFactoryCreateDigitalGoodsResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        ...
        public static DigitalGoodsFactoryCreateDigitalGoodsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                DigitalGoodsFactoryCreateDigitalGoodsResponseParams result = new DigitalGoodsFactoryCreateDigitalGoodsResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.code = readInt;
                CreateDigitalGoodsResponseCode.validate(readInt);
                result.code = CreateDigitalGoodsResponseCode.toKnownValue(result.code);
                result.digitalGoods = (DigitalGoods) decoder0.readServiceInterface(12, true, DigitalGoods.MANAGER);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }
    ...
    /* loaded from: classes2.dex */
    static class DigitalGoodsFactoryCreateDigitalGoodsResponseParamsForwardToCallback extends SideEffectFreeCloseable implements MessageReceiver {
        ...
        public boolean accept(Message message) {
            try {
                ...
                this.mCallback.call(Integer.valueOf(response.code), response.digitalGoods);
                return true;
            } catch (DeserializationException e) {
                return false;
            }
    ...
    static class DigitalGoodsFactoryCreateDigitalGoodsResponseParamsProxyToResponder implements DigitalGoodsFactory.CreateDigitalGoodsResponse {
        ...
        DigitalGoodsFactoryCreateDigitalGoodsResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;

...
class PaymentHandlerHost_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements PaymentHandlerHost.Proxy {
        ...
        public void changePaymentMethod(PaymentHandlerMethodData methodData, ChangePaymentMethodResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentHandlerHost
        public void changeShippingOption(String shippingOptionId, ChangeShippingOptionResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(1, 1, 0L)), new PaymentHandlerHostChangeShippingOptionResponseParamsForwardToCallback(callback));
        }

        @Override // org.chromium.payments.mojom.PaymentHandlerHost
        public void changeShippingAddress(PaymentAddress shippingAddress, ChangeShippingAddressResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new PaymentHandlerHostChangeShippingAddressResponseParamsForwardToCallback(callback));
        }
    }
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 0:
                        ...
                        return true;
                    case 1:
                        PaymentHandlerHostChangeShippingOptionParams data2 = PaymentHandlerHostChangeShippingOptionParams.deserialize(messageWithHeader.getPayload());
                        getImpl().changeShippingOption(data2.shippingOptionId, new PaymentHandlerHostChangeShippingOptionResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 2:
                        PaymentHandlerHostChangeShippingAddressParams data3 = PaymentHandlerHostChangeShippingAddressParams.deserialize(messageWithHeader.getPayload());
                        getImpl().changeShippingAddress(data3.shippingAddress, new PaymentHandlerHostChangeShippingAddressResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    default:
                        return false;
                }
    ...
    static final class PaymentHandlerHostChangeShippingOptionParams extends Struct {
        ...
        public static PaymentHandlerHostChangeShippingOptionParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentHandlerHostChangeShippingOptionParams result = new PaymentHandlerHostChangeShippingOptionParams(elementsOrVersion);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class PaymentHandlerHostChangeShippingOptionResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        public PaymentRequestDetailsUpdate responseData;
        ...
        public static PaymentHandlerHostChangeShippingOptionResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static PaymentHandlerHostChangeShippingOptionResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static PaymentHandlerHostChangeShippingOptionResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentHandlerHostChangeShippingOptionResponseParams result = new PaymentHandlerHostChangeShippingOptionResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.responseData = PaymentRequestDetailsUpdate.decode(decoder1);
                return result;
            } finally {
    ...
    static class PaymentHandlerHostChangeShippingOptionResponseParamsProxyToResponder implements PaymentHandlerHost.ChangeShippingOptionResponse {
        ...
        PaymentHandlerHostChangeShippingOptionResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
    ...
    static final class PaymentHandlerHostChangeShippingAddressParams extends Struct {
        ...
        public static PaymentHandlerHostChangeShippingAddressParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentHandlerHostChangeShippingAddressParams result = new PaymentHandlerHostChangeShippingAddressParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class PaymentHandlerHostChangeShippingAddressResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        public PaymentRequestDetailsUpdate responseData;
        ...
        public static PaymentHandlerHostChangeShippingAddressResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static PaymentHandlerHostChangeShippingAddressResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static PaymentHandlerHostChangeShippingAddressResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentHandlerHostChangeShippingAddressResponseParams result = new PaymentHandlerHostChangeShippingAddressResponseParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.responseData = PaymentRequestDetailsUpdate.decode(decoder1);
                return result;
            } finally {
    ...
    static class PaymentHandlerHostChangeShippingAddressResponseParamsProxyToResponder implements PaymentHandlerHost.ChangeShippingAddressResponse {
        ...
        PaymentHandlerHostChangeShippingAddressResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }

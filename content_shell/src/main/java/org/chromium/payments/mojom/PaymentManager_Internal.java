...
class PaymentManager_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements PaymentManager.Proxy {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void deletePaymentInstrument(String instrumentKey, DeletePaymentInstrumentResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void getPaymentInstrument(String instrumentKey, GetPaymentInstrumentResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void keysOfPaymentInstruments(KeysOfPaymentInstrumentsResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void hasPaymentInstrument(String instrumentKey, HasPaymentInstrumentResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void setPaymentInstrument(String instrumentKey, PaymentInstrument instrument, SetPaymentInstrumentResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void clearPaymentInstruments(ClearPaymentInstrumentsResponse callback) {
        ...
        @Override // org.chromium.payments.mojom.PaymentManager
        public void enableDelegations(int[] delegations, EnableDelegationsResponse callback) {
            PaymentManagerEnableDelegationsParams _message = new PaymentManagerEnableDelegationsParams();
            _message.delegations = delegations;
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(8, 1, 0L)), new PaymentManagerEnableDelegationsResponseParamsForwardToCallback(callback));
        }
    }
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        PaymentManagerGetPaymentInstrumentParams data2 = PaymentManagerGetPaymentInstrumentParams.deserialize(messageWithHeader.getPayload());
                        getImpl().getPaymentInstrument(data2.instrumentKey, new PaymentManagerGetPaymentInstrumentResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 3:
                        ...
                        return true;
                    case 4:
                        PaymentManagerHasPaymentInstrumentParams data3 = PaymentManagerHasPaymentInstrumentParams.deserialize(messageWithHeader.getPayload());
                        getImpl().hasPaymentInstrument(data3.instrumentKey, new PaymentManagerHasPaymentInstrumentResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 5:
                        PaymentManagerSetPaymentInstrumentParams data4 = PaymentManagerSetPaymentInstrumentParams.deserialize(messageWithHeader.getPayload());
                        getImpl().setPaymentInstrument(data4.instrumentKey, data4.instrument, new PaymentManagerSetPaymentInstrumentResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                    case 6:
                        ...
                        return true;
                    case 8:
                        PaymentManagerEnableDelegationsParams data5 = PaymentManagerEnableDelegationsParams.deserialize(messageWithHeader.getPayload());
                        getImpl().enableDelegations(data5.delegations, new PaymentManagerEnableDelegationsResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class PaymentManagerEnableDelegationsParams extends Struct {
        ...
        public static PaymentManagerEnableDelegationsParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentManagerEnableDelegationsParams result = new PaymentManagerEnableDelegationsParams(elementsOrVersion);
    ...
    public static final class PaymentManagerEnableDelegationsResponseParams extends Struct {
        ...
        public static PaymentManagerEnableDelegationsResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentManagerEnableDelegationsResponseParams result = new PaymentManagerEnableDelegationsResponseParams(elementsOrVersion);
                int readInt = decoder0.readInt(8);
                result.status = readInt;
                PaymentHandlerStatus.validate(readInt);
                result.status = PaymentHandlerStatus.toKnownValue(result.status);
    ...
    static class PaymentManagerEnableDelegationsResponseParamsProxyToResponder implements PaymentManager.EnableDelegationsResponse {
        ...
        PaymentManagerEnableDelegationsResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }

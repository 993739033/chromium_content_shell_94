...
class PaymentRequest_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements PaymentRequest.Proxy {
        ...
        public void init(PaymentRequestClient client, PaymentMethodData[] methodData, PaymentDetails details, PaymentOptions options, boolean googlePayBridgeEligible) {
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    case 1:
                        ...
                        return true;
                    case 2:
                        getImpl().updateWith(PaymentRequestUpdateWithParams.deserialize(messageWithHeader.getPayload()).details);
                        return true;
                    case 3:
                    ...
                    case 4:
                        ...
                        return true;
                    case 5:
                        getImpl().complete(PaymentRequestCompleteParams.deserialize(messageWithHeader.getPayload()).result);
                        return true;
                    case 6:
                        getImpl().retry(PaymentRequestRetryParams.deserialize(messageWithHeader.getPayload()).errors);
                        return true;
                    case 7:
    ...
    static final class PaymentRequestOnPaymentDetailsNotUpdatedParams extends Struct {
        ...
        public static PaymentRequestOnPaymentDetailsNotUpdatedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                PaymentRequestOnPaymentDetailsNotUpdatedParams result = new PaymentRequestOnPaymentDetailsNotUpdatedParams(elementsOrVersion);
                return result;
            } finally {
                decoder0.decreaseStackDepth();
            }

...
class Connector_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Connector.Proxy {
        ...
        public void bindInterface(ServiceFilter filter, String interfaceName, MessagePipeHandle interfacePipe, int priority, BindInterfaceResponse callback) {
        ...
        @Override // org.chromium.service_manager.mojom.Connector
        public void queryService(String serviceName, QueryServiceResponse callback) {
        ...
        @Override // org.chromium.service_manager.mojom.Connector
        public void warmService(ServiceFilter filter, WarmServiceResponse callback) {
        ...
        @Override // org.chromium.service_manager.mojom.Connector
        public void registerServiceInstance(Identity identity, MessagePipeHandle service, InterfaceRequest<ProcessMetadata> metadataReceiver, RegisterServiceInstanceResponse callback) {

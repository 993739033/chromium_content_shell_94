...
class Service_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements Service.Proxy {
        ...
        public void onStart(Identity identity, OnStartResponse callback) {
        ...
        @Override // org.chromium.service_manager.mojom.Service
        public void onBindInterface(BindSourceInfo source, String interfaceName, MessagePipeHandle interfacePipe, OnBindInterfaceResponse callback) {
    ...
    static class ServiceOnStartResponseParamsProxyToResponder implements Service.OnStartResponse {
        ...
        public void call(InterfaceRequest<Connector> connectorReceiver, AssociatedInterfaceRequestNotSupported controlReceiver) {

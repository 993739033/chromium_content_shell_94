...
public final class CompositorRenderPass extends Struct {
    ...
    public static CompositorRenderPass decode(Decoder decoder0) {
        ...
        try {
            ...
            result.hasTransparentBackground = decoder0.readBoolean(80, 0);
            result.cacheRenderPass = decoder0.readBoolean(80, 1);
            result.hasDamageFromContributingContent = decoder0.readBoolean(80, 2);
            result.generateMipmap = decoder0.readBoolean(80, 3);
            result.hasPerQuadDamage = decoder0.readBoolean(80, 4);
            Decoder decoder110 = decoder0.readPointer(88, false);
            DataHeader si1 = decoder110.readDataHeaderForPointerArray(-1);
            result.copyRequests = new CopyOutputRequest[si1.elementsOrVersion];
            for (int i1 = 0; i1 < si1.elementsOrVersion; i1++) {
                Decoder decoder2 = decoder110.readPointer((i1 * 8) + 8, false);
            ...
            for (int i12 = 0; i12 < si12.elementsOrVersion; i12++) {
                Decoder decoder22 = decoder111.readPointer((i12 * 8) + 8, false);
    ...
    public final void encode(Encoder encoder) {
        ...
        encoder0.encode(this.hasTransparentBackground, 80, 0);
        encoder0.encode(this.cacheRenderPass, 80, 1);
        encoder0.encode(this.hasDamageFromContributingContent, 80, 2);
        encoder0.encode(this.generateMipmap, 80, 3);
        encoder0.encode(this.hasPerQuadDamage, 80, 4);
        CopyOutputRequest[] copyOutputRequestArr = this.copyRequests;
        if (copyOutputRequestArr == null) {
            encoder0.encodeNullPointer(88, false);
        } else {
            Encoder encoder1 = encoder0.encodePointerArray(copyOutputRequestArr.length, 88, -1);
            int i0 = 0;
            while (true) {
        ...
        Encoder encoder12 = encoder0.encodePointerArray(drawQuadArr.length, 96, -1);
        int i02 = 0;
        while (true) {

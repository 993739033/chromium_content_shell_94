...
class FrameSinkBundleClient_Internal {
    ...
    public static final Interface.Manager<FrameSinkBundleClient, FrameSinkBundleClient.Proxy> MANAGER = new Interface.Manager<FrameSinkBundleClient, FrameSinkBundleClient.Proxy>() { // from class: org.chromium.viz.mojom.FrameSinkBundleClient_Internal.1
        ...
        @Override // org.chromium.mojo.bindings.Interface.Manager
        public FrameSinkBundleClient.Proxy buildProxy(Core core, MessageReceiverWithResponder messageReceiver) {
        ...
        public boolean accept(Message message) {
            try {
                ...
                switch (header.getType()) {
                    case -2:
                        return InterfaceControlMessagesHelper.handleRunOrClosePipe(FrameSinkBundleClient_Internal.MANAGER, messageWithHeader);
                    case -1:
                    default:
                        return false;
                    case 0:
                        ...
                        return true;
                    case 1:
                        FrameSinkBundleClientOnBeginFramePausedChangedParams data2 = FrameSinkBundleClientOnBeginFramePausedChangedParams.deserialize(messageWithHeader.getPayload());
                        getImpl().onBeginFramePausedChanged(data2.sinkId, data2.paused);
                        return true;
                    case 2:
                        FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams data3 = FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams.deserialize(messageWithHeader.getPayload());
    ...
    static final class FrameSinkBundleClientFlushNotificationsParams extends Struct {
        ...
        public static FrameSinkBundleClientFlushNotificationsParams decode(Decoder decoder0) {
            ...
            try {
                ...
                FrameSinkBundleClientFlushNotificationsParams result = new FrameSinkBundleClientFlushNotificationsParams(elementsOrVersion);
    ...
    static final class FrameSinkBundleClientOnBeginFramePausedChangedParams extends Struct {
        ...
        public static FrameSinkBundleClientOnBeginFramePausedChangedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static FrameSinkBundleClientOnBeginFramePausedChangedParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameSinkBundleClientOnBeginFramePausedChangedParams result = new FrameSinkBundleClientOnBeginFramePausedChangedParams(elementsOrVersion);
    ...
    static final class FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams extends Struct {
        ...
        public static FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }

        public static FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams decode(Decoder decoder0) {
            if (decoder0 == null) {
                return null;
            }
            decoder0.increaseStackDepth();
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams result = new FrameSinkBundleClientOnCompositorFrameTransitionDirectiveProcessedParams(elementsOrVersion);
                result.sinkId = decoder0.readInt(8);

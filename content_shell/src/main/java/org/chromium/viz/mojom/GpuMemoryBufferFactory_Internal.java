...
class GpuMemoryBufferFactory_Internal {
    ...
    public static final class Proxy extends Interface.AbstractProxy implements GpuMemoryBufferFactory.Proxy {
        ...
        public void createGpuMemoryBuffer(GpuMemoryBufferId id, Size size, int format, int usage, CreateGpuMemoryBufferResponse callback) {
        ...
        @Override // org.chromium.viz.mojom.GpuMemoryBufferFactory
        public void copyGpuMemoryBuffer(GpuMemoryBufferHandle bufferHandle, UnsafeSharedMemoryRegion sharedMemory, CopyGpuMemoryBufferResponse callback) {
            ...
            getProxyHandler().getMessageReceiver().acceptWithResponder(_message.serializeWithHeader(getProxyHandler().getCore(), new MessageHeader(2, 1, 0L)), new GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParamsForwardToCallback(callback));
        }
    }
            ...
            try {
                ...
                switch (header.getType()) {
                    ...
                    default:
                        return false;
                    case 2:
                        GpuMemoryBufferFactoryCopyGpuMemoryBufferParams data2 = GpuMemoryBufferFactoryCopyGpuMemoryBufferParams.deserialize(messageWithHeader.getPayload());
                        getImpl().copyGpuMemoryBuffer(data2.bufferHandle, data2.sharedMemory, new GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParamsProxyToResponder(getCore(), receiver, header.getRequestId()));
                        return true;
                }
            } catch (DeserializationException e) {
                System.err.println(e.toString());
    ...
    static final class GpuMemoryBufferFactoryCopyGpuMemoryBufferParams extends Struct {
        ...
        public static GpuMemoryBufferFactoryCopyGpuMemoryBufferParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                GpuMemoryBufferFactoryCopyGpuMemoryBufferParams result = new GpuMemoryBufferFactoryCopyGpuMemoryBufferParams(elementsOrVersion);
                Decoder decoder1 = decoder0.readPointer(8, false);
                result.bufferHandle = GpuMemoryBufferHandle.decode(decoder1);
                Decoder decoder12 = decoder0.readPointer(16, false);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public static final class GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParams extends Struct {
        private static final DataHeader DEFAULT_STRUCT_INFO;
        private static final int STRUCT_SIZE = 16;
        private static final DataHeader[] VERSION_ARRAY;
        ...
        public static GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParams deserialize(Message message) {
            return decode(new Decoder(message));
        }

        public static GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParams deserialize(ByteBuffer data) {
            return deserialize(new Message(data, new ArrayList()));
        }
        ...
        public static GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParams decode(Decoder decoder0) {
            ...
            try {
                DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
                int elementsOrVersion = mainDataHeader.elementsOrVersion;
                GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParams result = new GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParams(elementsOrVersion);
    ...
    static class GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParamsProxyToResponder implements GpuMemoryBufferFactory.CopyGpuMemoryBufferResponse {
        ...
        GpuMemoryBufferFactoryCopyGpuMemoryBufferResponseParamsProxyToResponder(Core core, MessageReceiver messageReceiver, long requestId) {
            this.mCore = core;
            this.mMessageReceiver = messageReceiver;
            this.mRequestId = requestId;
        }
